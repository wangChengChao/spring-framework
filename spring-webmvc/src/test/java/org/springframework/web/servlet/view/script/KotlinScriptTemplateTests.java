...
public class KotlinScriptTemplateTests {
  ...
  public void renderTemplateWithFrenchLocale() throws Exception {
    ...
    MockHttpServletResponse response =
        render(url, model, Locale.FRENCH, ScriptTemplatingConfiguration.class);
  ...
  public void renderTemplateWithoutRenderFunction() throws Exception {
    ...
    MockHttpServletResponse response =
        render(
            ...
            model,
            Locale.ENGLISH,
            ScriptTemplatingConfigurationWithoutRenderFunction.class);
    assertThat(response.getContentAsString())
        .isEqualTo("<html><body>\n<p>Hello Foo</p>\n</body></html>");
  }

  private MockHttpServletResponse render(
      String viewUrl, Map<String, Object> model, Locale locale, Class<?> configuration)
      throws Exception {
