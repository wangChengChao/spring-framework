...
public class DelegatingWebMvcConfigurationTests {
  ...
  private final DelegatingWebMvcConfiguration delegatingConfig =
  ...
  public void requestMappingHandlerAdapter() throws Exception {
    ...
    RequestMappingHandlerAdapter adapter =
        this.delegatingConfig.requestMappingHandlerAdapter(
            this.delegatingConfig.mvcContentNegotiationManager(),
            this.delegatingConfig.mvcConversionService(),
  ...
  public void configureMessageConverters() {
    ...
    RequestMappingHandlerAdapter adapter =
        delegatingConfig.requestMappingHandlerAdapter(
            this.delegatingConfig.mvcContentNegotiationManager(),
            this.delegatingConfig.mvcConversionService(),
            this.delegatingConfig.mvcValidator());
    assertThat(adapter.getMessageConverters().size())
        .as("Only one custom converter should be registered")
        .isEqualTo(2);
  ...
  public void handlerExceptionResolver() throws Exception {
    ...
    boolean condition2 =
        exceptionResolvers.getValue().get(0) instanceof ExceptionHandlerExceptionResolver;
    assertThat(condition2).isTrue();
    boolean condition1 =
        exceptionResolvers.getValue().get(1) instanceof ResponseStatusExceptionResolver;
    assertThat(condition1).isTrue();
    boolean condition =
        exceptionResolvers.getValue().get(2) instanceof DefaultHandlerExceptionResolver;
    assertThat(condition).isTrue();
    ...
    HandlerExceptionResolverComposite composite =
        (HandlerExceptionResolverComposite)
            delegatingConfig.handlerExceptionResolver(
                delegatingConfig.mvcContentNegotiationManager());
  ...
  public void configurePathMatch() throws Exception {
    ...
    RequestMappingHandlerMapping handlerMapping =
        delegatingConfig.requestMappingHandlerMapping(
            delegatingConfig.mvcContentNegotiationManager(),
            delegatingConfig.mvcConversionService(),
