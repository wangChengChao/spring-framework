...
public class VersionResourceResolverTests {
  ...
  public void resolveResourceNoResourceAfterVersionRemoved() throws Exception {
    ...
    this.resolver.setStrategyMap(Collections.singletonMap("/**", this.versionStrategy));
    Resource actual =
        this.resolver.resolveResourceInternal(null, versionFile, this.locations, this.chain);
    assertThat((Object) actual).isNull();
  ...
  public void resolveResourceSuccess() throws Exception {
    ...
    MockHttpServletRequest request =
        new MockHttpServletRequest("GET", "/resources/bar-version.css");
    ...
    this.resolver.setStrategyMap(Collections.singletonMap("/**", this.versionStrategy));
    Resource actual =
        this.resolver.resolveResourceInternal(request, versionFile, this.locations, this.chain);
