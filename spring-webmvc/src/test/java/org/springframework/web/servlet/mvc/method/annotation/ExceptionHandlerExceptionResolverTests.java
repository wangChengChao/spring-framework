...
public class ExceptionHandlerExceptionResolverTests {
  ...
  public void resolveNoExceptionHandlerForException() throws NoSuchMethodException {
    ...
    this.resolver.afterPropertiesSet();
    ModelAndView mav =
        this.resolver.resolveException(this.request, this.response, handlerMethod, npe);
  ...
  @Test
  public void resolveExceptionResponseBody()
  ...
  public void resolveRedirectAttributesAtArgument() throws Exception {
    ...
    FlashMap flashMap =
        (FlashMap) this.request.getAttribute(DispatcherServlet.OUTPUT_FLASH_MAP_ATTRIBUTE);
  ...
  public void resolveExceptionGlobalHandlerOrdered() throws Exception {
    ...
    assertThat(mav.isEmpty()).isTrue();
    assertThat(this.response.getContentAsString())
        .isEqualTo("TestExceptionResolver: IllegalStateException");
  }
  ...
  public void resolveExceptionControllerAdviceHandler() throws Exception {
    AnnotationConfigApplicationContext ctx =
        new AnnotationConfigApplicationContext(MyControllerAdviceConfig.class);
    this.resolver.setApplicationContext(ctx);
    this.resolver.afterPropertiesSet();
  ...
  public void resolveExceptionControllerAdviceNoHandler() throws Exception {
    ...
    assertThat(mav.isEmpty()).isTrue();
    assertThat(this.response.getContentAsString())
        .isEqualTo("DefaultTestExceptionResolver: IllegalStateException");
  }
  ...
  public void resolveExceptionControllerAdviceAgainstProxy() throws Exception {
    ...
    HandlerMethod handlerMethod =
        new HandlerMethod(new ProxyFactory(new ResponseBodyController()).getProxy(), "handle");
    ModelAndView mav =
        this.resolver.resolveException(this.request, this.response, handlerMethod, ex);
  ...
  @Controller
  static class ResponseBodyController extends WebApplicationObjectSupport
      implements ResponseBodyInterface {
  ...
  static class RedirectAttributesController {
    ...
    public String handleException(Exception ex, RedirectAttributes redirectAttributes) {
      redirectAttributes.addFlashAttribute(
          "exceptionClassName", ClassUtils.getShortName(ex.getClass()));
      return "redirect:/";
    }
  }
