...
public class ResourceTransformerSupportTests {
  ...
  public void setUp() {
    ...
    this.transformerChain =
        new DefaultResourceTransformerChain(new DefaultResourceResolverChain(resolvers), null);
  ...
  public void resolveUrlPath() {
    ...
    assertThat(actual)
        .isEqualTo("/context/servlet/resources/bar-11e16cf79faee7ac698c805cf28248d2.css");
  }
  ...
  public void resolveUrlPathWithRelativePath() {
    Resource resource = getResource("main.css");
    String actual =
        this.transformer.resolveUrlPath("bar.css", this.request, resource, this.transformerChain);
