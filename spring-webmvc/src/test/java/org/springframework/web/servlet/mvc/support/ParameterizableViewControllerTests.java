...
/**
 * Unit tests for {@link org.springframework.web.servlet.mvc.ParameterizableViewController}.
 *
...
public class ParameterizableViewControllerTests {
  ...
  public void redirectStatus() throws Exception {
    ...
    assertThat(this.response.getStatus())
        .as("3xx status should be left to RedirectView to set")
        .isEqualTo(200);
    assertThat(this.request.getAttribute(View.RESPONSE_STATUS_ATTRIBUTE))
