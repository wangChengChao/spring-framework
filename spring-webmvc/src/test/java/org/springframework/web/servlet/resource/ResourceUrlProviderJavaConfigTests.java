...
public class ResourceUrlProviderJavaConfigTests {
        ...
        new MockFilterChain(
            ...
            (request, response, chain) -> {
              ...
              request.setAttribute(
                  ResourceUrlProviderExposingInterceptor.RESOURCE_URL_PROVIDER_ATTR, urlProvider);
  ...
  public void resolvePathNoMatch() throws Exception {
    ...
    assertThat(resolvePublicResourceUrlPath("/myapp/myservlet/index"))
        .isEqualTo("/myapp/myservlet/index");
  }
