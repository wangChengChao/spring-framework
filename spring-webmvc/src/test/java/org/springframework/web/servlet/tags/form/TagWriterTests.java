...
public class TagWriterTests {
  ...
  public void blockTagWithAttributes() throws Exception {
    ...
    assertThat(this.data.toString())
        .isEqualTo("<textarea width=\"10\" height=\"20\">foobar</textarea>");
  }
  ...
  public void nestedTags() throws Exception {
    ...
    assertThat(this.data.toString())
        .isEqualTo("<span style=\"foo\"><strong>Rob Harrop</strong></span>");
  }
  ...
  public void multipleNestedTags() throws Exception {
    ...
    assertThat(this.data.toString())
        .isEqualTo(
            "<span class=\"highlight\"><strong>Rob</strong> <emphasis>Harrop</emphasis></span>");
  }
