...
public abstract class AbstractServletHandlerMethodTests {
  ...
  /**
   * Initialize a DispatcherServlet instance registering zero or more controller classes and also
   * providing additional bean definitions through a callback.
   */
    ...
    servlet =
        new DispatcherServlet() {
          ...
          protected WebApplicationContext createWebApplicationContext(
            ...
            wac.registerBeanDefinition(
                "defaultResolver", new RootBeanDefinition(DefaultHandlerExceptionResolver.class));
