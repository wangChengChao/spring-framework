...
public class CssLinkResourceTransformerTests {
  ...
  private ResourceUrlProvider createUrlProvider(List<ResourceResolver> resolvers) {
    ...
    resourceHandler.setLocations(
        Collections.singletonList(new ClassPathResource("test/", getClass())));
  ...
  public void transform() throws Exception {
    ...
    TransformedResource actual =
        (TransformedResource) this.transformerChain.transform(this.request, css);
  ...
  public void transformExtLinksNotAllowed() throws Exception {
    ...
    TransformedResource transformedResource =
        (TransformedResource) chain.transform(this.request, resource);
