...
public class ContentBasedVersionStrategyTests {
  ...
  public void removeVersion() {
    ...
    assertThat(this.versionStrategy.removeVersion(String.format(file, "-", hash), hash))
        .isEqualTo(String.format(file, "", ""));
  }
  ...
  public void getResourceVersion() throws IOException {
    ...
    String hash =
        DigestUtils.md5DigestAsHex(FileCopyUtils.copyToByteArray(expected.getInputStream()));
  ...
  public void addVersionToUrl() {
    assertThat(this.versionStrategy.addVersion("test/bar.css", "123"))
        .isEqualTo("test/bar-123.css");
  }
}
