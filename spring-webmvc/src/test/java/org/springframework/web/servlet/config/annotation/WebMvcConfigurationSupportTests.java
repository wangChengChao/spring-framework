...
/**
 * Integration tests for {@link WebMvcConfigurationSupport} (imported via {@link
...
public class WebMvcConfigurationSupportTests {
  ...
  public void requestMappingHandlerMapping() throws Exception {
    ApplicationContext context =
        initContext(WebConfig.class, ScopedController.class, ScopedProxyController.class);
    ...
    assertThat(chain.getInterceptors()[0].getClass())
    ...
    assertThat(chain)
        .as("HandlerExecutionChain for '/scoped' mapping should not be null.")
        .isNotNull();

    chain = handlerMapping.getHandler(new MockHttpServletRequest("GET", "/scopedProxy"));
    assertThat(chain)
        .as("HandlerExecutionChain for '/scopedProxy' mapping should not be null.")
        .isNotNull();
  }
  ...
  public void beanNameHandlerMapping() throws Exception {
    ...
    assertThat(chain.getInterceptors()[1].getClass())
        .isEqualTo(ConversionServiceExposingInterceptor.class);
  ...
  public void requestMappingHandlerAdapter() throws Exception {
    ...
    converters.stream()
        ...
        .forEach(
            converter -> {
              ...
              assertThat(mapper.getDeserializationConfig().isEnabled(DEFAULT_VIEW_INCLUSION))
                  .isFalse();
              assertThat(mapper.getSerializationConfig().isEnabled(DEFAULT_VIEW_INCLUSION))
                  .isFalse();
              assertThat(mapper.getDeserializationConfig().isEnabled(FAIL_ON_UNKNOWN_PROPERTIES))
                  .isFalse();
    ...
    List<Object> bodyAdvice =
        (List<Object>) fieldAccessor.getPropertyValue("requestResponseBodyAdvice");
  ...
  public void handlerExceptionResolver() throws Exception {
    ...
    assertThat(expectedResolvers.get(0).getClass())
        .isEqualTo(ExceptionHandlerExceptionResolver.class);
    assertThat(expectedResolvers.get(1).getClass())
        .isEqualTo(ResponseStatusExceptionResolver.class);
    assertThat(expectedResolvers.get(2).getClass())
        .isEqualTo(DefaultHandlerExceptionResolver.class);

    ExceptionHandlerExceptionResolver eher =
        (ExceptionHandlerExceptionResolver) expectedResolvers.get(0);
    ...
    try {
      ResponseStatusExceptionResolver rser =
          (ResponseStatusExceptionResolver) expectedResolvers.get(1);
      MockHttpServletRequest request = new MockHttpServletRequest("GET", "/");
      MockHttpServletResponse response = new MockHttpServletResponse();
      rser.resolveException(
          request,
          response,
  ...
  public void customArgumentResolvers() {
    ...
    HandlerExceptionResolverComposite composite =
        context.getBean(HandlerExceptionResolverComposite.class);

    assertThat(adapter).isNotNull();
    assertThat(adapter.getCustomArgumentResolvers().size()).isEqualTo(1);
    assertThat(adapter.getCustomArgumentResolvers().get(0).getClass())
        .isEqualTo(TestArgumentResolver.class);
    assertThat(adapter.getCustomReturnValueHandlers().size()).isEqualTo(1);
    assertThat(adapter.getCustomReturnValueHandlers().get(0).getClass())
        .isEqualTo(TestReturnValueHandler.class);
    ...
    assertThat(resolver.getCustomArgumentResolvers().get(0).getClass())
        .isEqualTo(TestArgumentResolver.class);
    assertThat(resolver.getCustomReturnValueHandlers().size()).isEqualTo(1);
    assertThat(resolver.getCustomReturnValueHandlers().get(0).getClass())
        .isEqualTo(TestReturnValueHandler.class);
  }
  ...
  public void mvcViewResolver() {
    ApplicationContext context = initContext(WebConfig.class);
    ViewResolverComposite resolver =
        context.getBean("mvcViewResolver", ViewResolverComposite.class);

    assertThat(resolver).isNotNull();
    assertThat(resolver.getViewResolvers().size()).isEqualTo(1);
    assertThat(resolver.getViewResolvers().get(0).getClass())
        .isEqualTo(InternalResourceViewResolver.class);
  ...
  private static class TestController {
    ...
    public HttpEntity<Void> methodWithTwoPathVariables(
