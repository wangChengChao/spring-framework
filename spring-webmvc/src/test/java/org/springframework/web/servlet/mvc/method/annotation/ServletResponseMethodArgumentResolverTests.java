...
public class ServletResponseMethodArgumentResolverTests {
  ...
  public void setup() throws Exception {
    ...
    method =
        getClass()
            .getMethod("supportedParams", ServletResponse.class, OutputStream.class, Writer.class);
  }
  ...
  public void outputStream() throws Exception {
    ...
    assertThat(resolver.supportsParameter(outputStreamParameter))
        .as("OutputStream not supported")
        .isTrue();
