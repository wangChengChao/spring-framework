...
public class HandlerMappingTests {
  ...
  public void orderedInterceptors() throws Exception {
    ...
    HandlerExecutionChain chain =
        this.handlerMapping.getHandlerExecutionChain(new SimpleHandler(), this.request);
    assertThat(chain.getInterceptors())
        .contains(mappedInterceptor1.getInterceptor(), i2, mappedInterceptor3.getInterceptor(), i4);
  }
