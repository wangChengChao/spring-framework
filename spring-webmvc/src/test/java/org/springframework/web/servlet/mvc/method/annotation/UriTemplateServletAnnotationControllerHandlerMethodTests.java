 ...
 * @since 3.1
 */
public class UriTemplateServletAnnotationControllerHandlerMethodTests
  ...
  public void multiple() throws Exception {
    ...
    MockHttpServletRequest request =
        new MockHttpServletRequest("GET", "/hotels/42;q=24/bookings/21-other;q=12");
    MockHttpServletResponse response = new MockHttpServletResponse();
    getServlet().service(request, response);
            ...
            new ApplicationContextInitializer<GenericWebApplicationContext>() {
              ...
              public void initialize(GenericWebApplicationContext context) {
                RootBeanDefinition beanDef =
                    new RootBeanDefinition(ModelValidatingViewResolver.class);
  ...
  public void binding() throws Exception {
    ...
    MockHttpServletRequest request =
        new MockHttpServletRequest("GET", "/hotels/42/dates/2008-11-18");
    MockHttpServletResponse response = new MockHttpServletResponse();
    getServlet().service(request, response);
    assertThat(response.getStatus()).isEqualTo(200);
  ...
  public void extension() throws Exception {
    ...
    MockHttpServletRequest request =
        new MockHttpServletRequest("GET", "/42;jsessionid=c0o7fszeb1;q=24.xml");
    MockHttpServletResponse response = new MockHttpServletResponse();
    getServlet().service(request, response);
  ...
  public static class SimpleUriTemplateController {
    ...
    @RequestMapping("/{root}")
    public void handle(
        @PathVariable("root") int root,
        @MatrixVariable(required = false, defaultValue = "7") int q,
        Writer writer)
        throws IOException {
  ...
  public static class RelativePathUriTemplateController {
    ...
    public void handle(
        @PathVariable("hotel") String hotel, @PathVariable int booking, Writer writer)
        throws IOException {
      assertThat(hotel).as("Invalid path variable value").isEqualTo("42");
      assertThat(booking).as("Invalid path variable value").isEqualTo(21);
  ...
  public static class CustomRegexController {
    ...
    public void handle(
        @PathVariable("root") int root,
        @PathVariable("params") String paramString,
        @MatrixVariable List<Integer> q,
        Writer writer)
        throws IOException {
  ...
  public static class DoubleController {
    ...
    public void testLatLong(
        @PathVariable Double latitude, @PathVariable Double longitude, Writer writer)
        throws IOException {
  ...
  public static class MultiPathController {
    ...
    public void category(@PathVariable String category, @PathVariable int page, Writer writer)
        throws IOException {
  ...
  public static class MenuTreeController {
    ...
    public void getFirstLevelFunctionNodes(@PathVariable("var") String var, Writer writer)
        throws IOException {
      writer.write(var);
    }
  }
  ...
  public static class Spr6978Controller {
    ...
    public void loadEntity(
        @PathVariable final String type, @PathVariable final long id, Writer writer)
        throws IOException {
      ...
      return new AbstractView() {
        ...
        protected void renderMergedOutputModel(
          ...
          for (String key : attrsToValidate.keySet()) {
            assertThat(model.containsKey(key))
                .as("Model should contain attribute named " + key)
                .isTrue();
