...
public class ComplexWebApplicationContext extends StaticWebApplicationContext {
  ...
  public static class MyHandlerAdapter extends ApplicationObjectSupport
    ...
    public ModelAndView handle(
        HttpServletRequest request, HttpServletResponse response, Object delegate)
  ...
  public static class ComplexLocaleChecker implements MyHandler {
    ...
    public void doSomething(HttpServletRequest request)
      ...
      if (!"theme"
          .equals(RequestContextUtils.getThemeResolver(request).resolveThemeName(request))) {
