 ...
 * HandlerExceptionResolver} implementations that support handling exceptions from handlers of type
 * {@link HandlerMethod}.
 *
...
public abstract class AbstractHandlerMethodExceptionResolver
  ...
  /**
   * Checks if the handler is a {@link HandlerMethod} and then delegates to the base class
   * implementation of {@code #shouldApplyTo(HttpServletRequest, Object)} passing the bean of the
   * {@code HandlerMethod}. Otherwise returns {@code false}.
   */
  @Override
   ...
   * @param handlerMethod the executed handler method, or {@code null} if none chosen at the time of
