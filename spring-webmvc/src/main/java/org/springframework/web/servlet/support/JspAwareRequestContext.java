...
/**
 * JSP-aware (and JSTL-aware) subclass of RequestContext, allowing for population of the context
 * from a {@code javax.servlet.jsp.PageContext}.
 *
 * <p>This context will detect a JSTL locale attribute in page/request/session/application scope, in
 * addition to the fallback locale strategy provided by the base class.
 *
...
public class JspAwareRequestContext extends RequestContext {
  ...
  /**
   * Create a new JspAwareRequestContext for the given page context, using the request attributes
  ...
  /**
   * Create a new JspAwareRequestContext for the given page context, using the given model
  ...
  /**
   * This implementation checks for a JSTL locale attribute in page, request, session or application
   * scope; if not found, returns the {@code HttpServletRequest.getLocale()}.
   */
  @Override
  ...
  /**
   * This implementation checks for a JSTL time zone attribute in page, request, session or
   * application scope; if not found, returns {@code null}.
   */
  @Override
