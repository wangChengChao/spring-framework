...
/**
 * Abstract base class for Atom and RSS Feed views, using the <a
 * href="https://github.com/rometools/rome">ROME</a> package.
 *
 * <p>><b>NOTE: As of Spring 4.1, this is based on the {@code com.rometools} variant of ROME,
 * version 1.5. Please upgrade your build dependency.</b>
 *
 * <p>Application-specific view classes will typically extend from either {@link
 * AbstractRssFeedView} or {@link AbstractAtomFeedView} instead of from this class.
 *
...
public abstract class AbstractFeedView<T extends WireFeed> extends AbstractView {
   ...
   *
   * <p>Default is an empty implementation. Subclasses can override this method to add meta fields
   * such as title, link description, etc.
   *
   ...
   * other HTTP headers. The built feed itself will automatically get written to the response after
   * this method returns.
   *
  ...
  protected abstract void buildFeedEntries(
      Map<String, Object> model, T feed, HttpServletRequest request, HttpServletResponse response)
      throws Exception;
}
