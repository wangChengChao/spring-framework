...
public class InterceptorRegistration {
  ...
  /**
   * A PathMatcher implementation to use with this interceptor. This is an optional, advanced
   * property required only if using custom PathMatcher implementations that support mapping
  ...
  /**
   * Build the underlying interceptor. If URL patterns are provided, the returned type is {@link
   * MappedInterceptor}; otherwise {@link HandlerInterceptor}.
   */
