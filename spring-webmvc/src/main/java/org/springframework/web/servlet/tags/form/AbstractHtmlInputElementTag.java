 ...
 *
 * <p>Provides a set of properties corresponding to the set of HTML attributes that are common
...
public abstract class AbstractHtmlInputElementTag extends AbstractHtmlElementTag {
  ...
  @Nullable private String onfocus;

  @Nullable private String onblur;

  @Nullable private String onchange;
