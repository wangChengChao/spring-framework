...
/**
 * Parse the <code>&lt;mvc:script-template-configurer&gt;</code> MVC namespace element and register
 * a {@code ScriptTemplateConfigurer} bean.
 *
...
public class ScriptTemplateConfigurerBeanDefinitionParser
  ...
  protected boolean isEligibleAttribute(String name) {
    return (name.equals("engine-name")
        || name.equals("scripts")
        || name.equals("render-object")
        || name.equals("render-function")
