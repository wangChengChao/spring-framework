...
/**
 * The {@code <checkbox>} tag renders an HTML 'input' tag with type 'checkbox'. May be used in one
 * of three different approaches depending on the type of the {@link #getValue bound value}.
 *
 * <h3>Approach One</h3>
 *
 * When the bound value is of type {@link Boolean} then the '{@code input(checkbox)}' is marked as
 * 'checked' if the bound value is {@code true}. The '{@code value}' attribute corresponds to the
 * resolved value of the {@link #setValue(Object) value} property.
 *
 * <h3>Approach Two</h3>
 *
 * When the bound value is of type {@link Collection} then the '{@code input(checkbox)}' is marked
 * as 'checked' if the configured {@link #setValue(Object) value} is present in the bound {@link
 * Collection}.
 *
 * <h3>Approach Three</h3>
 *
 * For any other bound value type, the '{@code input(checkbox)}' is marked as 'checked' if the
 * configured {@link #setValue(Object) value} is equal to the bound value.
 *
 * <p>
 *
 * <table>
