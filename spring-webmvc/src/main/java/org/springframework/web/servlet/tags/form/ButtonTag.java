...
/**
 * The {@code <button>} tag renders a form field label in an HTML 'button' tag. It is provided for
 * completeness if the application relies on a {@link RequestDataValueProcessor}.
 *
 * <p>
 *
 * <table>
...
public class ButtonTag extends AbstractHtmlElementTag {
   ...
   * of '{@code input}' element rendered. Default value is '{@code submit}'.
   */
