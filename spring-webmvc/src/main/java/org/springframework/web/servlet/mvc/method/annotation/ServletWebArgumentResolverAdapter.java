...
/**
 * A Servlet-specific {@link
 * org.springframework.web.method.annotation.AbstractWebArgumentResolverAdapter} that creates a
 ...
 * For more details see javadoc of {@link
...
public class ServletWebArgumentResolverAdapter extends AbstractWebArgumentResolverAdapter {
  ...
  protected NativeWebRequest getWebRequest() {
    ...
    Assert.state(
        requestAttributes instanceof ServletRequestAttributes, "No ServletRequestAttributes");
