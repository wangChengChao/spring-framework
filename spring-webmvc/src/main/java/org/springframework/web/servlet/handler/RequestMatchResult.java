...
/**
 * Container for the result from request pattern matching via {@link MatchableHandlerMapping} with a
 * method to further extract URI template variables from the pattern.
 *
...
public class RequestMatchResult {
   ...
   *
   * @param matchingPattern the matching pattern, possibly not the same as the input pattern, e.g.
   *     inputPattern="/foo" and matchingPattern="/foo/".
  ...
  /**
   * Extract URI template variables from the matching pattern as defined in {@link
