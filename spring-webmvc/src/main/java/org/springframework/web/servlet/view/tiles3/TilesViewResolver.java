...
/**
 * Convenience subclass of {@link UrlBasedViewResolver} that supports {@link TilesView} (i.e. Tiles
 * definitions) and custom subclasses of it.
 *
...
public class TilesViewResolver extends UrlBasedViewResolver {
  ...
  /**
   * Set the {@link Renderer} to use. If not specified, a default {@link
