...
/**
 * Helps with configuring HandlerMappings path matching options such as trailing slash match, suffix
 * registration, path matcher and path helper.
 *
...
public class PathMatchConfigurer {
  ...
  @Nullable private Boolean suffixPatternMatch;
   ...
   * when you {@link WebMvcConfigurer#configureContentNegotiation configure content negotiation}.
