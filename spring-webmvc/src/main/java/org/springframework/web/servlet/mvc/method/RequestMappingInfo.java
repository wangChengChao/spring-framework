...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
  ...
  public RequestMappingInfo(
      ...
      @Nullable PatternsRequestCondition patterns,
      @Nullable RequestMethodsRequestCondition methods,
      @Nullable ParamsRequestCondition params,
      @Nullable HeadersRequestCondition headers,
      @Nullable ConsumesRequestCondition consumes,
      @Nullable ProducesRequestCondition produces,
  ...
  public RequestMappingInfo(
      RequestMappingInfo info, @Nullable RequestCondition<?> customRequestCondition) {
    this(
        info.name,
        info.patternsCondition,
  ...
  /**
   * Return the URL patterns of this {@link RequestMappingInfo}; or instance with 0 patterns (never
   * {@code null}).
   */
  ...
  /**
   * Return the HTTP request methods of this {@link RequestMappingInfo}; or instance with 0 request
   * methods (never {@code null}).
   */
  ...
  /**
   * Return the "parameters" condition of this {@link RequestMappingInfo}; or instance with 0
   * parameter expressions (never {@code null}).
   */
  ...
  /**
   * Return the "headers" condition of this {@link RequestMappingInfo}; or instance with 0 header
   * expressions (never {@code null}).
   */
  ...
  /**
   * Return the "consumes" condition of this {@link RequestMappingInfo}; or instance with 0 consumes
   * expressions (never {@code null}).
   */
  ...
  /**
   * Return the "produces" condition of this {@link RequestMappingInfo}; or instance with 0 produces
   * expressions (never {@code null}).
   */
  ...
  /**
   * Combine "this" request mapping info (i.e. the current instance) with another request mapping
   * info instance.
   *
  ...
  public RequestMappingInfo combine(RequestMappingInfo other) {
    ...
    return new RequestMappingInfo(
        name, patterns, methods, params, headers, consumes, produces, custom.getCondition());
  }
  ...
  public RequestMappingInfo getMatchingCondition(HttpServletRequest request) {
    ...
    return new RequestMappingInfo(
        this.name, patterns, methods, params, headers, consumes, produces, custom.getCondition());
  }
   ...
   * #getMatchingCondition(HttpServletRequest)} to ensure they have conditions with content relevant
   * to current request.
   */
  @Override
  ...
  public int hashCode() {
    return (this.patternsCondition.hashCode() * 31
        ...
        + this.paramsCondition.hashCode()
        + this.headersCondition.hashCode()
        + this.consumesCondition.hashCode()
        + this.producesCondition.hashCode()
  ...
  private static class DefaultBuilder implements Builder {
    ...
    @Nullable private String mappingName;

    @Nullable private RequestCondition<?> customCondition;
    ...
    public RequestMappingInfo build() {
      ...
      PatternsRequestCondition patternsCondition =
          new PatternsRequestCondition(
              this.paths,
              this.options.getUrlPathHelper(),
              this.options.getPathMatcher(),
              this.options.useSuffixPatternMatch(),
  ...
  /**
   * Container for configuration options used for request mapping purposes. Such configuration is
   * required to create RequestMappingInfo instances but is typically used across all
  ...
  public static class BuilderConfiguration {
     ...
     * Setting this property also sets {@code suffixPatternMatch=true} and requires that a {@link
     * #setContentNegotiationManager} is also configured in order to obtain the registered file
     * extensions.
     */
    ...
    /**
     * Return whether suffix pattern matching should be restricted to registered file extensions
     * only.
     */
    ...
    /**
     * Return the file extensions to use for suffix pattern matching. If {@code
     * registeredSuffixPatternMatch=true}, the extensions are obtained from the configured {@code
