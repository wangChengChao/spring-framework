...
/**
 * The {@code <input>} tag renders an HTML 'input' tag with type 'text' using the bound value.
 *
 * <p>
 *
 * <table>
...
public class InputTag extends AbstractHtmlInputElementTag {
  ...
  @Nullable private String maxlength;
  ...
  /**
   * Writes the '{@code input}' tag to the supplied {@link TagWriter}. Uses the value returned by
   * {@link #getType()} to determine which type of '{@code input}' element to render.
   */
  @Override
  ...
  /**
   * Writes the '{@code value}' attribute to the supplied {@link TagWriter}. Subclasses may choose
   * to override this implementation to control exactly when the value is written.
   */
  ...
  /**
   * Get the value of the '{@code type}' attribute. Subclasses can override this to change the type
   * of '{@code input}' element rendered. Default value is '{@code text}'.
   */
