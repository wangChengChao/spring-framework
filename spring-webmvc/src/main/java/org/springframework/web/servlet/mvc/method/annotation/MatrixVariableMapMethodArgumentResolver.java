 ...
 * variable.
 *
 * <p>When a name is specified, an argument of type Map is considered to be a single attribute with
 * a Map value, and is resolved by {@link MatrixVariableMethodArgumentResolver} instead.
 *
