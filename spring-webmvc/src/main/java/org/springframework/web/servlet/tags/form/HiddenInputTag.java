...
/**
 * The {@code <hidden>} tag renders an HTML 'input' tag with type 'hidden' using the bound value.
 *
...
public class HiddenInputTag extends AbstractHtmlElementTag {
  ...
  /**
   * Writes the HTML '{@code input}' tag to the supplied {@link TagWriter} including the databound
   * value.
   *
