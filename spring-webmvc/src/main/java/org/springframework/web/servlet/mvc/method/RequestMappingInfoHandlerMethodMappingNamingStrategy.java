 ...
 *
 * <p>If the {@code RequestMappingInfo} name attribute is set, its value is used. Otherwise the name
 * is based on the capital letters of the class name, followed by "#" as a separator, and the method
 * name. For example "TC#getFoo" for a class named TestController with method getFoo.
 *
