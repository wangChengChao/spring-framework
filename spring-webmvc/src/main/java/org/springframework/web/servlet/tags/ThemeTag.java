...
/**
 * The {@code <theme>} tag looks up a theme message in the scope of this page. Messages are looked
 * up using the ApplicationContext's ThemeSource, and thus should support internationalization.
 *
 * <p>Regards a HTML escaping setting, either on this tag instance, the page level, or the web.xml
 * level.
 *
 * <p>If "code" isn't set or cannot be resolved, "text" will be used as default message.
 *
