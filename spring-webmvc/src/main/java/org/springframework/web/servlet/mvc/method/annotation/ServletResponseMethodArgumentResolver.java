...
/**
 * Resolves servlet backed response-related method arguments. Supports values of the following
 * types:
 *
 * <ul>
...
public class ServletResponseMethodArgumentResolver implements HandlerMethodArgumentResolver {
  ...
  /**
   * Set {@link ModelAndViewContainer#setRequestHandled(boolean)} to {@code false} to indicate that
   * the method signature provides access to the response. If subsequently the underlying method
   * returns {@code null}, the request is considered directly handled.
   */
  @Override
