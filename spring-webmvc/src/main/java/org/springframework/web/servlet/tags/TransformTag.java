...
public class TransformTag extends HtmlEscapingAwareTag {
   ...
   *
   * <p>The value can either be a plain value to transform (a hard-coded String value in a JSP or a
   * JSP expression), or a JSP EL expression to be evaluated (transforming the result of the
   * expression).
   */
  ...
  /**
   * Set PageContext attribute name under which to expose a variable that contains the result of the
   * transformation.
   *
   * @see #setScope
