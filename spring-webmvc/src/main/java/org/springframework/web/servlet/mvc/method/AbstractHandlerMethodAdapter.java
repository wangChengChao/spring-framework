...
/**
 * Abstract base class for {@link HandlerAdapter} implementations that support handlers of type
 * {@link HandlerMethod}.
 *
...
public abstract class AbstractHandlerMethodAdapter extends WebContentGenerator
   ...
   *     {@link #supportsInternal(HandlerMethod)} this interface, which must have returned {@code
   *     true}.
   ...
   */
  protected abstract long getLastModifiedInternal(
