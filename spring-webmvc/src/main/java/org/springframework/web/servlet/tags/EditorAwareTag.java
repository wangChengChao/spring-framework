...
/**
 * Interface to be implemented by JSP tags that expose a PropertyEditor for a property that they are
 * currently bound to.
 *
...
public interface EditorAwareTag {
  ...
  /**
   * Retrieve the PropertyEditor for the property that this tag is currently bound to. Intended for
