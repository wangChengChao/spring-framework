...
/**
 * Simple {@code Controller} implementation that transforms the virtual path of a URL into a view
 * name and returns that view.
 *
 * <p>Can optionally prepend a {@link #setPrefix prefix} and/or append a {@link #setSuffix suffix}
 ...
 *   <li>{@code "/index.html"} + prefix {@code "pre_"} and suffix {@code "_suf" -> "pre_index_suf"}
 *   <li>{@code "/products/view.html" -> "products/view"}
 * </ol>
 *
...
public class UrlFilenameViewController extends AbstractUrlViewController {
   ...
   *
   * <p>The default implementation simply applies prefix and suffix. This can be overridden, for
   * example, to manipulate upper case / lower case, etc.
   *
