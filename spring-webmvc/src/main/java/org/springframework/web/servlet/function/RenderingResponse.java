...
public interface RenderingResponse extends ServerResponse {
  ...
  interface Builder {
    ...
    /**
     * Add the supplied attribute to the model using a {@linkplain
     ...
     * for {@code null} rather than for empty collections.</em>
     *
    ...
    /**
     * Copy all attributes in the supplied array into the model, using attribute name generation for
     * each element.
     *
    ...
    /**
     * Copy all attributes in the supplied {@code Collection} into the model, using attribute name
