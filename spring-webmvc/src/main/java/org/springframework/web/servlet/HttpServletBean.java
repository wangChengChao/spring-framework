 ...
 * properties.
 *
 * <p>A handy superclass for any type of servlet. Type conversion of config parameters is automatic,
 ...
 *
 * <p>This servlet leaves request handling to subclasses, inheriting the default behavior of
 * HttpServlet ({@code doGet}, {@code doPost}, etc).
 *
 * <p>This generic servlet base class has no dependency on the Spring {@link
 * org.springframework.context.ApplicationContext} concept. Simple servlets usually don't load their
 * own context but rather access service beans from the Spring root application context, accessible
 * via the filter's {@link #getServletContext() ServletContext} (see {@link
 * org.springframework.web.context.support.WebApplicationContextUtils}).
 *
 * <p>The {@link FrameworkServlet} class is a more specific servlet base class which loads its own
 * application context. FrameworkServlet serves as direct base class of Spring's full-fledged {@link
 * DispatcherServlet}.
 *
 * @author Rod Johnson
...
public abstract class HttpServletBean extends HttpServlet
   ...
   *
   * <p>This method is only relevant in case of traditional initialization driven by a ServletConfig
   * instance.
   *
  ...
  public void setEnvironment(Environment environment) {
    Assert.isInstanceOf(
        ConfigurableEnvironment.class, environment, "ConfigurableEnvironment required");
