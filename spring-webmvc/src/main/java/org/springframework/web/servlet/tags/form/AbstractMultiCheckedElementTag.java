...
/**
 * Abstract base class to provide common methods for implementing databinding-aware JSP tags for
 * rendering <i>multiple</i> HTML '{@code input}' elements with a '{@code type}' of '{@code
 * checkbox}' or '{@code radio}'.
 *
...
public abstract class AbstractMultiCheckedElementTag extends AbstractCheckedElementTag {
   ...
   * the '{@code input type="checkbox/radio"}' tags.
   */
  @Nullable private Object items;

  /**
   * The name of the property mapped to the '{@code value}' attribute of the '{@code input
   ...
   * generate the '{@code input type="checkbox/radio"}' tags.
   *
  ...
  /**
   * Set the name of the property mapped to the '{@code value}' attribute of the '{@code input
   * type="checkbox/radio"}' tag.
   *
  ...
  /**
   * Get the name of the property mapped to the '{@code value}' attribute of the '{@code input
   * type="checkbox/radio"}' tag.
   */
  @Nullable
  ...
  /**
   * Set the value to be displayed as part of the '{@code input type="checkbox/radio"}' tag.
   *
   * <p>May be a runtime expression.
   */
  ...
  /**
   * Set the delimiter to be used between each '{@code input type="checkbox/radio"}' tag.
   *
  ...
  /**
   * Set the HTML element used to enclose the '{@code input type="checkbox/radio"}' tag.
   *
  ...
  /**
   * Renders the '{@code input type="radio"}' element with the configured {@link #setItems(Object)}
   * values. Marks the element as checked if the value matches the bound value.
   */
  @Override
