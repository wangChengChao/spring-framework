...
/**
 * Base class for databinding-aware JSP tags that render HTML element. Provides a set of properties
 * corresponding to the set of HTML attributes that are common across elements.
 *
 * <p>Additionally, this base class allows for rendering non-standard attributes as part of the
 * tag's output. These attributes are accessible to subclasses if needed via the {@link
 * AbstractHtmlElementTag#getDynamicAttributes() dynamicAttributes} map.
 *
 * @author Rob Harrop
...
public abstract class AbstractHtmlElementTag extends AbstractDataBoundFormElementTag
  ...
  @Nullable private String cssErrorClass;
  ...
  @Nullable private String tabindex;

  @Nullable private String onclick;

  @Nullable private String ondblclick;

  @Nullable private String onmousedown;

  @Nullable private String onmouseup;

  @Nullable private String onmouseover;

  @Nullable private String onmousemove;

  @Nullable private String onmouseout;

  @Nullable private String onkeypress;

  @Nullable private String onkeyup;

  @Nullable private String onkeydown;

  @Nullable private Map<String, Object> dynamicAttributes;
  ...
  /**
   * The CSS class to use when the field bound to a particular tag has errors. May be a runtime
   * expression.
   */
