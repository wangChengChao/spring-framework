...
/**
 * {@link BeanDefinitionParser} that parses a {@code default-servlet-handler} element to register a
 * {@link DefaultServletHttpRequestHandler}. Will also register a {@link SimpleUrlHandlerMapping}
 * for mapping resource requests, and a {@link HttpRequestHandlerAdapter}.
 *
...
class DefaultServletHandlerBeanDefinitionParser implements BeanDefinitionParser {
  ...
  public BeanDefinition parse(Element element, ParserContext parserContext) {
    ...
    parserContext
        .getRegistry()
        .registerBeanDefinition(defaultServletHandlerName, defaultServletHandlerDef);
    ...
    String handlerMappingBeanName =
        parserContext.getReaderContext().generateBeanName(handlerMappingDef);
