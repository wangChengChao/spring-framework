...
/**
 * Parse the <code>&lt;mvc:tiles-configurer&gt;</code> MVC namespace element and register a
 * corresponding {@code TilesConfigurer} bean.
 *
  ...
  protected void doParse(
    ...
    if (element.hasAttribute("definitions-factory")) {
      builder.addPropertyValue(
          "definitionsFactoryClass", element.getAttribute("definitions-factory"));
    }
