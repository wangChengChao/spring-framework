...
/**
 * Convenient superclass for Excel document views in traditional XLS format. Compatible with Apache
 * POI 3.5 and higher.
 *
 * <p>For working with the workbook in the subclass, see <a href="https://poi.apache.org">Apache's
 * POI site</a>
 *
...
public abstract class AbstractXlsView extends AbstractView {
   ...
   *
   * <p>The default implementation creates a traditional {@link HSSFWorkbook}. Spring-provided
   * subclasses are overriding this for the OOXML-based variants; custom subclasses may override
   * this for reading a workbook from a file.
   *
  ...
  /**
   * Application-provided subclasses must implement this method to populate the Excel workbook
