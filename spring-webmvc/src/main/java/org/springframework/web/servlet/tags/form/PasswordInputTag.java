...
/**
 * The {@code <password>} tag renders an HTML 'input' tag with type 'password' using the bound
 * value.
 *
 * <p>
 *
...
public class PasswordInputTag extends InputTag {
  ...
  /**
   * Return '{@code password}' causing the rendered HTML '{@code input}' element to have a '{@code
   * type}' of '{@code password}'.
   */
  @Override
  ...
  /**
   * The {@link PasswordInputTag} only writes it's value if the {@link #setShowPassword(boolean)
   * 'showPassword'} property value is {@link Boolean#TRUE true}.
   */
  @Override
