...
/**
 * Supports "name=value" style expressions as described in: {@link
 * org.springframework.web.bind.annotation.RequestMapping#params()} and {@link
...
abstract class AbstractNameValueExpression<T> implements NameValueExpression<T> {
  ...
  public int hashCode() {
    int result =
        (isCaseSensitiveName() ? this.name.hashCode() : this.name.toLowerCase().hashCode());
