 ...
 * rendering an HTML '{@code input}' element with a '{@code type}' of '{@code checkbox}' or '{@code
 * radio}'.
 *
...
public abstract class AbstractCheckedElementTag extends AbstractHtmlInputElementTag {
  ...
  /**
   * Render the '{@code input(checkbox)}' with the supplied value, marking the '{@code input}'
   * element as 'checked' if the supplied value matches the bound value.
   */
  ...
  /**
   * Determines whether the supplied value matched the selected value through delegating to {@link
   * SelectedValueComparator#isSelected}.
   */
  ...
  /**
   * Render the '{@code input(checkbox)}' with the supplied value, marking the '{@code input}'
   * element as 'checked' if the supplied Boolean is {@code true}.
   */
  ...
  /**
   * Writes the '{@code input}' element to the supplied {@link TagWriter}, marking it as 'checked'
   * if appropriate.
   */
  @Override
