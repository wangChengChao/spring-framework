...
/**
 * Interceptor that allows for changing the current locale on every request, via a configurable
...
public class LocaleChangeInterceptor extends HandlerInterceptorAdapter {
  ...
  /**
   * Specify whether to parse request parameter values as BCP 47 language tags instead of Java's
   * legacy locale specification format.
   *
   * <p><b>NOTE: As of 5.1, this resolver leniently accepts the legacy {@link Locale#toString}
   * format as well as BCP 47 language tags.</b>
   *
   * @since 4.3
  ...
  public void setLanguageTagCompliant(boolean languageTagCompliant) {
    if (!languageTagCompliant) {
      throw new IllegalArgumentException(
          "LocaleChangeInterceptor always accepts BCP 47 language tags");
    }
  }

  /**
   * Return whether to use BCP 47 language tags instead of Java's legacy locale specification
   * format.
   *
   * @since 4.3
