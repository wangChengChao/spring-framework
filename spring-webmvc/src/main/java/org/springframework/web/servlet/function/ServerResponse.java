...
public interface ServerResponse {
  ...
  /**
   * Create a builder with a {@linkplain HttpStatus#CREATED 201 Created} status and a location
  ...
  /**
   * Create a builder with a {@linkplain HttpStatus#UNPROCESSABLE_ENTITY 422 Unprocessable Entity}
   * status.
   *
   * @return the created builder
   */
  ...
  interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
    ...
    /**
     * Set the body of the response to the given {@code Object} and return it. The parameter {@code
     * bodyType} is used to capture the generic type.
     *
     * @param body the body of the response
  ...
  /**
   * Defines the context used during the {@link #writeTo(HttpServletRequest, HttpServletResponse,
   * Context)}.
   */
  interface Context {

    /**
     * Return the {@link HttpMessageConverter HttpMessageConverters} to be used for response body
     * conversion.
     *
