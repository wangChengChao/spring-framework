...
public class UrlBasedViewResolverRegistration {
  ...
  /**
   * Set the view names (or name patterns) that can be handled by this view resolver. View names can
   * contain simple wildcards such that 'my*', '*Report' and '*Repo*' will all match the view name
   * 'myReport'.
   *
  ...
  /**
   * Set static attributes to be added to the model of every request for all views resolved by this
   * view resolver. This allows for setting any kind of attribute values, for example bean
   * references.
   *
   ...
   *
   * <p>This is equivalent to setting the {@link #cacheLimit "cacheLimit"} property to the default
