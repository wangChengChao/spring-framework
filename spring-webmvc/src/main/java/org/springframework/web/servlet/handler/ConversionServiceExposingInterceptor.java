...
/**
 * Interceptor that places the configured {@link ConversionService} in request scope so it's
 * available during request processing. The request attribute name is
 * "org.springframework.core.convert.ConversionService", the value of {@code
...
public class ConversionServiceExposingInterceptor extends HandlerInterceptorAdapter {
   ...
   *
   * @param conversionService the conversion service to export to request scope when this
