...
public class MessageTag extends HtmlEscapingAwareTag implements ArgumentAware {
  ...
  /**
   * Set optional message arguments for this tag, as a comma-delimited String (each String argument
   * can contain JSP EL), an Object array (used as argument array), or a single Object (used as
   * single argument).
   */
  ...
  private Object[] appendArguments(
    ...
    System.arraycopy(
        additionalArguments, 0, arguments, sourceArguments.length, additionalArguments.length);
    return arguments;
  }
