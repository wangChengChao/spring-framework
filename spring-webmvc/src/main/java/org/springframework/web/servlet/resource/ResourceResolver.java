 ...
 *
 * <p>Provides mechanisms for resolving an incoming request to an actual {@link
 * org.springframework.core.io.Resource} and for obtaining the public URL path that clients should
 * use when requesting the resource.
 *
