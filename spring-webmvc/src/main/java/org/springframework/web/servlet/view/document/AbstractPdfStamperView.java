...
public abstract class AbstractPdfStamperView extends AbstractUrlBasedView {
   ...
   *
   * <p>The default implementation resolve the specified "url" property as ApplicationContext
   * resource.
   *
   ...
   *
   * <p>This is where you are able to set values on the AcroForm. An example of what can be done at
   * this level is:
   *
   * <pre class="code">
   ...
   * @param stamper the PdfStamper instance that will contain the AcroFields. You may also customize
   *     this PdfStamper instance according to your needs, e.g. setting the "formFlattening"
   *     property.
