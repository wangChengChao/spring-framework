...
/**
 * Interface to be implemented by any object that wishes to be notified of the BootstrapContext
 * (typically determined by the {@link ResourceAdapterApplicationContext}) that it runs in.
 *
