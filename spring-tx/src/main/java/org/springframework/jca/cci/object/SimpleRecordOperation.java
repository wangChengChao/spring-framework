...
/**
 * EIS operation object that accepts a passed-in CCI input Record and returns a corresponding CCI
 * output Record.
 *
...
public class SimpleRecordOperation extends EisOperation {
   ...
   *
   * <p>This method will call CCI's {@code Interaction.execute} variant that returns an output
   * Record.
   *
   ...
   * Execute the CCI interaction encapsulated by this operation object.
   *
   * <p>This method will call CCI's {@code Interaction.execute} variant with a passed-in output
   * Record.
   *
   * @param inputRecord the input record
