...
/**
 * Adapter for a JTA Synchronization, invoking the {@code afterCommit} / {@code afterCompletion}
 * callbacks of Spring {@link TransactionSynchronization} objects callbacks after the outer JTA
 * transaction has completed. Applied when participating in an existing (non-Spring) JTA
 * transaction.
 *
