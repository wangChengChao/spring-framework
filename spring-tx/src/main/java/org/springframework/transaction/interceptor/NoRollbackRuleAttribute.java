...
/**
 * Tag subclass of {@link RollbackRuleAttribute} that has the opposite behavior to the {@code
...
public class NoRollbackRuleAttribute extends RollbackRuleAttribute {
  ...
  /**
   * Create a new instance of the {@code NoRollbackRuleAttribute} class for the supplied {@link
   * Throwable} class.
   *
  ...
  /**
   * Create a new instance of the {@code NoRollbackRuleAttribute} class for the supplied {@code
   * exceptionName}.
   *
