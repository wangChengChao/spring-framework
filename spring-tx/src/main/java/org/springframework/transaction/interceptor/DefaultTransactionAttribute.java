...
public class DefaultTransactionAttribute extends DefaultTransactionDefinition
   ...
   *
   * <p>This may be used for choosing a corresponding transaction manager to process this specific
   * transaction.
   *
   * @since 3.0
   */
   ...
   *
   * <p>This is largely consistent with TransactionTemplate's default behavior, except that
   * TransactionTemplate also rolls back on undeclared checked exceptions (a corner case). For
   * declarative transactions, we expect checked exceptions to be intentionally declared as business
   * exceptions, leading to a commit by default.
   *
