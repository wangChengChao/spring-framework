...
/**
 * Composite {@link TransactionAttributeSource} implementation that iterates over a given array of
 * {@link TransactionAttributeSource} instances.
 *
...
public class CompositeTransactionAttributeSource
  ...
  public CompositeTransactionAttributeSource(
    ...
    Assert.notNull(
        transactionAttributeSources, "TransactionAttributeSource array must not be null");
    this.transactionAttributeSources = transactionAttributeSources;
  }

  /**
   * Return the TransactionAttributeSource instances that this CompositeTransactionAttributeSource
   * combines.
   */
