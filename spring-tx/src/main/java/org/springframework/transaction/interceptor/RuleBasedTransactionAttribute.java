...
public class RuleBasedTransactionAttribute extends DefaultTransactionAttribute
  ...
  @Nullable private List<RollbackRuleAttribute> rollbackRules;

  /**
   * Create a new RuleBasedTransactionAttribute, with default settings. Can be modified through bean
   * property setters.
   *
  ...
  public RuleBasedTransactionAttribute(RuleBasedTransactionAttribute other) {
    super(other);
    this.rollbackRules =
        (other.rollbackRules != null ? new ArrayList<>(other.rollbackRules) : null);
  }
  ...
  /**
   * Set the list of {@code RollbackRuleAttribute} objects (and/or {@code NoRollbackRuleAttribute}
   * objects) to apply.
   *
  ...
  public String toString() {
    ...
    if (this.rollbackRules != null) {
      for (RollbackRuleAttribute rule : this.rollbackRules) {
        String sign =
            (rule instanceof NoRollbackRuleAttribute ? PREFIX_COMMIT_RULE : PREFIX_ROLLBACK_RULE);
