...
/**
 * Exception that gets thrown when an invalid isolation level is specified, i.e. an isolation level
 * that the transaction manager implementation doesn't support.
 *
