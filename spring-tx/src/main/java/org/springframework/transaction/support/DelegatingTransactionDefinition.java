...
/**
 * {@link TransactionDefinition} implementation that delegates all calls to a given target {@link
 * TransactionDefinition} instance. Abstract because it is meant to be subclassed, with subclasses
 * overriding specific methods that are not supposed to simply delegate to the target instance.
 *
