...
/**
 * Default implementation of the {@link ReactiveTransaction} interface, used by {@link
 * AbstractReactiveTransactionManager}. Based on the concept of an underlying "transaction object".
 *
 * <p>Holds all status information that {@link AbstractReactiveTransactionManager} needs internally,
...
public class GenericReactiveTransaction implements ReactiveTransaction {
   ...
   * AbstractReactiveTransactionManager} as an optimization, to prevent repeated calls to {@code
   ...
   *
   * <p>Will only return "true" if the application called {@code setRollbackOnly} on this
