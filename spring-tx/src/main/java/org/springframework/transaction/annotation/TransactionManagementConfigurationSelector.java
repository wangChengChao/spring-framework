 ...
 * based on the value of {@link EnableTransactionManagement#mode} on the importing
...
public class TransactionManagementConfigurationSelector
   ...
   * AspectJ(Jta)TransactionManagementConfiguration} for {@code PROXY} and {@code ASPECTJ} values of
   * {@link EnableTransactionManagement#mode()}, respectively.
   */
  @Override
