...
/**
 * Exception that gets thrown when an invalid timeout is specified, that is, the specified timeout
 * valid is out of range or the transaction manager implementation doesn't support timeouts.
 *
