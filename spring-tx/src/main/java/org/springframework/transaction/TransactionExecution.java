...
/**
 * Common representation of the current state of a transaction. Serves as base interface for {@link
 * TransactionStatus} as well as {@link ReactiveTransaction}.
 *
...
public interface TransactionExecution {
   ...
   * possible outcome of the transaction may be a rollback, as alternative to throwing an exception
  ...
  /**
   * Return whether this transaction is completed, that is, whether it has already been committed or
   * rolled back.
   */
  boolean isCompleted();
}
