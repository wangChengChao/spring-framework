 ...
 * implementation that allows users to easily configure all the infrastructure beans required to
  ...
  private void registerTransactionalEventListenerFactory(ParserContext parserContext) {
    ...
    parserContext.registerBeanComponent(
        new BeanComponentDefinition(
            def, TransactionManagementConfigUtils.TRANSACTIONAL_EVENT_LISTENER_FACTORY_BEAN_NAME));
  }
  ...
  private static class AopAutoProxyConfigurer {
    ...
    public static void configureAutoProxyCreator(Element element, ParserContext parserContext) {
      ...
      if (!parserContext.getRegistry().containsBeanDefinition(txAdvisorBeanName)) {
        ...
        interceptorDef
            .getPropertyValues()
            .add("transactionAttributeSource", new RuntimeBeanReference(sourceName));
