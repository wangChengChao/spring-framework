...
/**
 * Exception thrown when a general transaction system error is encountered, like on commit or
 * rollback.
 *
...
public class TransactionSystemException extends TransactionException {
  ...
  @Nullable private Throwable applicationException;
  ...
  /**
   * Set an application exception that was thrown before this transaction exception, preserving the
   * original exception despite the overriding TransactionSystemException.
   *
  ...
  public void initApplicationException(Throwable ex) {
    ...
    if (this.applicationException != null) {
      throw new IllegalStateException(
          "Already holding an application exception: " + this.applicationException);
    }
  ...
  /**
   * Return the exception that was the first to be thrown within the failed transaction: i.e. the
   * application exception, if any, or the TransactionSystemException's own cause.
   *
