...
/**
 * Data access exception thrown when something unintended appears to have happened with an update,
 * but the transaction hasn't already been rolled back. Thrown, for example, when we wanted to
 * update 1 row in an RDBMS but actually updated 3.
 *
 * @author Rod Johnson
 */
...
public class IncorrectUpdateSemanticsDataAccessException
   ...
   *
   * <p>The default implementation always returns true. This can be overridden in subclasses.
   */
