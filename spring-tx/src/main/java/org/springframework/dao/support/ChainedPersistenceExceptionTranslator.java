...
/**
 * Implementation of {@link PersistenceExceptionTranslator} that supports chaining, allowing the
 * addition of PersistenceExceptionTranslator instances in order. Returns {@code non-null} on the
 * first (if any) match.
 *
 * @author Rod Johnson
