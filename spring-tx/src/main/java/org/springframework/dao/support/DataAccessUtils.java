...
public abstract class DataAccessUtils {
   ...
   *
   * <p>Returns {@code null} if 0 result objects found; throws an exception if more than 1 element
   * found.
   *
   * @param results the result Collection (can be {@code null})
   * @return the single result object, or {@code null} if none
   * @throws IncorrectResultSizeDataAccessException if more than one element has been found in the
   *     given Collection
   */
  @Nullable
   ...
   *
   * @param results the result Collection (can be {@code null} but is not expected to contain {@code
   *     null} elements)
   * @return the single result object
   * @throws IncorrectResultSizeDataAccessException if more than one element has been found in the
   *     given Collection
   * @throws EmptyResultDataAccessException if no element at all has been found in the given
   *     Collection
   */
   ...
   * <p>Throws an exception if 0 or more than 1 element found.
   *
   * @param results the result Collection (can be {@code null} and is also expected to contain
   *     {@code null} elements)
   * @return the single result object
   * @throws IncorrectResultSizeDataAccessException if more than one element has been found in the
   *     given Collection
   ...
   *
   * <p>Returns {@code null} if 0 result objects found; throws an exception if more than 1 instance
   * found.
   *
   * @param results the result Collection (can be {@code null})
   * @return the unique result object, or {@code null} if none
   * @throws IncorrectResultSizeDataAccessException if more than one result object has been found in
   ...
   * @throws IncorrectResultSizeDataAccessException if more than one result object has been found in
   *     the given Collection
   * @throws EmptyResultDataAccessException if no result object at all has been found in the given
   *     Collection
   * @see org.springframework.util.CollectionUtils#hasUniqueObject
   */
  ...
  /**
   * Return a unique result object from the given Collection. Throws an exception if 0 or more than
   * 1 result objects found, of if the unique result object is not convertible to the specified
   * required type.
   *
   * @param results the result Collection (can be {@code null} but is not expected to contain {@code
   *     null} elements)
   ...
   * @throws EmptyResultDataAccessException if no result object at all has been found in the given
   *     Collection
   * @throws TypeMismatchDataAccessException if the unique object does not match the specified
   *     required type
   */
        ...
        try {
          result =
              NumberUtils.convertNumberToTargetClass(
                  ((Number) result), (Class<? extends Number>) requiredType);
        } catch (IllegalArgumentException ex) {
          throw new TypeMismatchDataAccessException(ex.getMessage());
        }
      } else {
        throw new TypeMismatchDataAccessException(
            "Result object is of type ["
  ...
  /**
   * Return a unique int result from the given Collection. Throws an exception if 0 or more than 1
   * result objects found, of if the unique result object is not convertible to an int.
   *
   * @param results the result Collection (can be {@code null} but is not expected to contain {@code
   *     null} elements)
   ...
   * @throws EmptyResultDataAccessException if no result object at all has been found in the given
   *     Collection
   * @throws TypeMismatchDataAccessException if the unique object in the collection is not
  ...
  /**
   * Return a unique long result from the given Collection. Throws an exception if 0 or more than 1
   * result objects found, of if the unique result object is not convertible to a long.
   *
   * @param results the result Collection (can be {@code null} but is not expected to contain {@code
   *     null} elements)
  ...
  /**
   * Return a translated exception if this is appropriate, otherwise return the given exception
   * as-is.
   *
   ...
   * @return a translated persistence exception if translation is possible, or the raw exception if
   *     it is not
   */
