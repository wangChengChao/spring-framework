 ...
 *
 * <p>Extended by Spring's specific DAO support classes, such as: JdbcDaoSupport, JdoDaoSupport,
 * etc.
 *
...
public abstract class DaoSupport implements InitializingBean {
   ...
   *
   * <p>Implementors should be marked as {@code final} if concrete subclasses are not supposed to
   * override this template method themselves.
   *
   ...
   *
   * @throws Exception if DAO initialization fails (will be rethrown as a
