...
/**
 * Root of the hierarchy of data access exceptions discussed in <a
 ...
 * without knowing the details of the particular data access API in use (e.g. JDBC). Thus it is
