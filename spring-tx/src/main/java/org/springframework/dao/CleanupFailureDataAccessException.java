 ...
 *
 * <p>Note that data access code might perform resources cleanup in a finally block and therefore
 * log cleanup failure rather than rethrow it, to keep the original data access exception, if any.
 *
 * @author Rod Johnson
 */
