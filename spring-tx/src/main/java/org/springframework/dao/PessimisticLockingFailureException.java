...
/**
 * Exception thrown on a pessimistic locking violation. Thrown by Spring's SQLException translation
 * mechanism if a corresponding database error is encountered.
 *
