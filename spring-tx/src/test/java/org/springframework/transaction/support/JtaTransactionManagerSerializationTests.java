...
public class JtaTransactionManagerSerializationTests {
  ...
  public void serializable() throws Exception {
    ...
    assertThat(serializedJtatm.getUserTransaction() == ut2)
        .as("UserTransaction looked up on client")
        .isTrue();
    assertThat(serializedJtatm.getTransactionManager())
        .as("TransactionManager didn't survive")
        .isNull();
