...
public class AnnotationTransactionAttributeSourceTests {
  ...
  public void serializable() throws Exception {
    ...
    TransactionInterceptor serializedTi =
        (TransactionInterceptor) advised.getAdvisors()[0].getAdvice();
  ...
  /**
   * Test the important case where the invocation is on a proxied interface method but the attribute
   * is defined on the target class.
   */
  @Test
  public void transactionAttributeDeclaredOnClassMethod() throws Exception {
    ...
    assertThat(((RuleBasedTransactionAttribute) actual).getRollbackRules())
        .isEqualTo(rbta.getRollbackRules());
  }
  ...
  public void transactionAttributeOnTargetClassMethodOverridesAttributeOnInterfaceMethod()
    ...
    assertThat(actual.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRES_NEW);
    assertThat(actual.getIsolationLevel())
        .isEqualTo(TransactionAttribute.ISOLATION_REPEATABLE_READ);
  ...
  /** Test that transaction attribute is inherited from class if not specified on method. */
  @Test
  ...
  public void customClassAttributeWithReadOnlyOverrideOnInterface() throws Exception {
    ...
    assertThat(annotation)
        .as("AnnotationUtils.findAnnotation should not find @Transactional for TestBean9.getAge()")
        .isNull();
    annotation = AnnotationUtils.findAnnotation(TestBean9.class, Transactional.class);
    assertThat(annotation)
        .as("AnnotationUtils.findAnnotation failed to find @Transactional for TestBean9")
        .isNotNull();

    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute actual = atas.getTransactionAttribute(method, TestBean9.class);
    assertThat(actual)
        .as("Failed to retrieve TransactionAttribute for TestBean9.getAge()")
        .isNotNull();
  ...
  public void customMethodAttributeWithReadOnlyOverrideOnInterface() throws Exception {
    ...
    Transactional annotation = AnnotationUtils.findAnnotation(method, Transactional.class);
    assertThat(annotation)
        .as("AnnotationUtils.findAnnotation failed to find @Transactional for TestBean10.getAge()")
        .isNotNull();
    annotation = AnnotationUtils.findAnnotation(TestBean10.class, Transactional.class);
    assertThat(annotation)
        .as("AnnotationUtils.findAnnotation should not find @Transactional for TestBean10")
        .isNull();

    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute actual = atas.getTransactionAttribute(method, TestBean10.class);
    assertThat(actual)
        .as("Failed to retrieve TransactionAttribute for TestBean10.getAge()")
        .isNotNull();
  ...
  public void transactionAttributeDeclaredOnClassMethodWithEjb3() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, Ejb3AnnotatedBean1.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, Ejb3AnnotatedBean1.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_SUPPORTS);
  }
  ...
  public void transactionAttributeDeclaredOnClassWithEjb3() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, Ejb3AnnotatedBean2.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, Ejb3AnnotatedBean2.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_SUPPORTS);
  }
  ...
  public void transactionAttributeDeclaredOnInterfaceWithEjb3() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, Ejb3AnnotatedBean3.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, Ejb3AnnotatedBean3.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_SUPPORTS);
  }
  ...
  public void transactionAttributeDeclaredOnClassMethodWithJta() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, JtaAnnotatedBean1.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, JtaAnnotatedBean1.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_SUPPORTS);
  }
  ...
  public void transactionAttributeDeclaredOnClassWithJta() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, JtaAnnotatedBean2.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, JtaAnnotatedBean2.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_SUPPORTS);
  }
  ...
  public void transactionAttributeDeclaredOnInterfaceWithJta() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, JtaAnnotatedBean3.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, JtaAnnotatedBean3.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_SUPPORTS);
  }
  ...
  public void transactionAttributeDeclaredOnGroovyClass() throws Exception {
    ...
    AnnotationTransactionAttributeSource atas = new AnnotationTransactionAttributeSource();
    TransactionAttribute getAgeAttr =
        atas.getTransactionAttribute(getAgeMethod, GroovyTestBean.class);
    assertThat(getAgeAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
    TransactionAttribute getNameAttr =
        atas.getTransactionAttribute(getNameMethod, GroovyTestBean.class);
    assertThat(getNameAttr.getPropagationBehavior())
        .isEqualTo(TransactionAttribute.PROPAGATION_REQUIRED);
