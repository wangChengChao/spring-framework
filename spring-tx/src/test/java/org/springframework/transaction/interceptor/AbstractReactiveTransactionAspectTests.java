...
public abstract class AbstractReactiveTransactionAspectTests {
  ...
  /**
   * Check that the when exception thrown by the target can produce the desired behavior with the
  ...
  protected Object advised(
      Object target, ReactiveTransactionManager rtm, TransactionAttributeSource[] tas)
      throws Exception {
  ...
  /**
   * Subclasses must implement this to create an advised object based on the when target. In the
