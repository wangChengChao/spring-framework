...
/**
 * Used for testing only (for example, when we must replace the behavior of a
 * PlatformTransactionManager bean we don't have access to).
 *
 * <p>Allows behavior of an entire class to change with static delegate change. Not multi-threaded.
 *
 * @author Rod Johnson
 * @since 26.04.2003
 */
