...
public abstract class AnnotationBeanUtils {
  ...
  /**
   * Copy the properties of the supplied {@link Annotation} to the supplied target bean. Any
   * properties defined in {@code excludedProperties} will not be copied.
   *
  ...
  public static void copyPropertiesToBean(
      Annotation ann, Object bean, String... excludedProperties) {
