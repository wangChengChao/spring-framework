 ...
 * java.beans.PropertyEditor PropertyEditors} which aren't thread-safe, TypeConverters themselves
 * are <em>not</em> to be considered as thread-safe either.
 *
...
public interface TypeConverter {
   ...
   * @param requiredType the type we must convert to (or {@code null} if not known, for example in
   *     case of a collection element)
   * @param methodParam the method parameter that is the target of the conversion (for analysis of
   *     generic types; may be {@code null})
   * @return the new value, possibly the result of type conversion
   * @throws TypeMismatchException if type conversion failed
   * @see java.beans.PropertyEditor#setAsText(String)
   * @see java.beans.PropertyEditor#getValue()
   ...
   * @param requiredType the type we must convert to (or {@code null} if not known, for example in
   *     case of a collection element)
   * @param field the reflective field that is the target of the conversion (for analysis of generic
