...
/**
 * PropertyComparator performs a comparison of two beans, evaluating the specified bean property via
 * a BeanWrapper.
 *
...
public class PropertyComparator<T> implements Comparator<T> {
  ...
  private Object getPropertyValue(Object obj) {
    ...
    try {
      ...
      logger.debug(
          "PropertyComparator could not access property - treating as null for sorting", ex);
      return null;
    }
  }
   ...
   *
   * <p>Note: Contained objects have to provide the given property in the form of a bean property,
   * i.e. a getXXX method.
   *
