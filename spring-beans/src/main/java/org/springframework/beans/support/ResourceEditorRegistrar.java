...
public class ResourceEditorRegistrar implements PropertyEditorRegistrar {
  ...
  /**
   * Create a new ResourceEditorRegistrar for the given {@link ResourceLoader} and {@link
   * PropertyResolver}.
   *
   * @param resourceLoader the ResourceLoader (or ResourcePatternResolver) to create editors for
   ...
   * ClassArrayEditor.
   *
   * <p>If this registrar has been configured with a {@link ResourcePatternResolver}, a
