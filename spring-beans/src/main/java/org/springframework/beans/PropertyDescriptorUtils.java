...
abstract class PropertyDescriptorUtils {
  ...
  public static Class<?> findIndexedPropertyType(
      ...
      @Nullable Method indexedWriteMethod)
      throws IntrospectionException {
  ...
  /**
   * Compare the given {@code PropertyDescriptors} and return {@code true} if they are equivalent,
   * i.e. their read method, write method, property type, property editor and flags are equivalent.
   *
  ...
  public static boolean equals(PropertyDescriptor pd, PropertyDescriptor otherPd) {
    return (ObjectUtils.nullSafeEquals(pd.getReadMethod(), otherPd.getReadMethod())
        ...
        && pd.isBound() == otherPd.isBound()
        && pd.isConstrained() == otherPd.isConstrained());
  }
}
