...
public class BeanInstantiationException extends FatalBeanException {
  ...
  @Nullable private final Method constructingMethod;
  ...
  public BeanInstantiationException(
      Constructor<?> constructor, String msg, @Nullable Throwable cause) {
    super(
        "Failed to instantiate [" + constructor.getDeclaringClass().getName() + "]: " + msg, cause);
   ...
   */
  public BeanInstantiationException(
      Method constructingMethod, String msg, @Nullable Throwable cause) {
    super(
        "Failed to instantiate [" + constructingMethod.getReturnType().getName() + "]: " + msg,
        cause);
   ...
   *
   * @return the method in use (typically a static factory method), or {@code null} in case of
