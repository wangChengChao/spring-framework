...
/**
 * Helper class for calculating property matches, according to a configurable distance. Provide the
 * list of potential matches and an easy way to generate an error message. Works for both java bean
...
public abstract class PropertyMatches {
   ...
   */
  public static PropertyMatches forProperty(
      String propertyName, Class<?> beanClass, int maxDistance) {
  ...
  /**
   * Build an error message for the given invalid property name, indicating the possible property
   * matches.
   */
  ...
  private static class BeanPropertyMatches extends PropertyMatches {
    ...
    /**
     * Generate possible property alternatives for the given property and class. Internally uses the
     * {@code getStringDistance} method, which in turn uses the Levenshtein algorithm to determine
     * the distance between two Strings.
     *
     * @param descriptors the JavaBeans property descriptors to search
     * @param maxDistance the maximum distance to accept
     */
    private static String[] calculateMatches(
        String name, PropertyDescriptor[] descriptors, int maxDistance) {
  ...
  private static class FieldPropertyMatches extends PropertyMatches {
    ...
    private static String[] calculateMatches(
        final String name, Class<?> clazz, final int maxDistance) {
