 ...
 * property values (individually or in bulk), get property descriptors, and query the
 * readability/writability of properties.
 *
 * <p>This interface supports <b>nested properties</b> enabling the setting of properties on
 * subproperties to an unlimited depth.
 *
 * <p>A BeanWrapper's default for the "extractOldValueForEditor" setting is "false", to avoid side
 * effects caused by getter method invocations. Turn this to "true" to expose present property
 * values to custom editors.
 *
 * @author Rod Johnson
