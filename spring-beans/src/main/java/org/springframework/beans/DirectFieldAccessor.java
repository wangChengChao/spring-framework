 ...
 *
 * <p>As of Spring 4.2, the vast majority of the {@link BeanWrapper} features have been merged to
 * {@link AbstractPropertyAccessor}, which means that property traversal as well as collections and
 * map access is now supported here as well.
 *
 * <p>A DirectFieldAccessor's default for the "extractOldValueForEditor" setting is "true", since a
 * field can always be read without side effects.
 *
...
public class DirectFieldAccessor extends AbstractNestablePropertyAccessor {
  ...
  /**
   * Create a new DirectFieldAccessor for the given object, registering a nested path that the
   * object is in.
   *
   * @param object object wrapped by this DirectFieldAccessor
    ...
    public Object getValue() throws Exception {
      try {
        ...
        throw new InvalidPropertyException(
            getWrappedClass(), this.field.getName(), "Field is not accessible", ex);
      }
    }
