...
public interface Mergeable {
   ...
   *
   * <p>The supplied object is considered the parent, and values in the callee's value set must
   ...
   * @throws IllegalStateException if merging is not enabled for this instance (i.e. {@code
   *     mergeEnabled} equals {@code false}).
   */
