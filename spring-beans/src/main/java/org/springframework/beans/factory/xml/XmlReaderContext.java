...
/**
 * Extension of {@link org.springframework.beans.factory.parsing.ReaderContext}, specific to use
 * with an {@link XmlBeanDefinitionReader}. Provides access to the {@link NamespaceHandlerResolver}
 * configured in the {@link XmlBeanDefinitionReader}.
 *
 * @author Rob Harrop
...
public class XmlReaderContext extends ReaderContext {
   ...
   *
   * <p>This will be non-null in regular scenarios, also allowing access to the resource class
   * loader.
   *
   ...
   *
   * <p>Note that this will be null in regular scenarios, as an indication to lazily resolve bean
   * classes.
   *
  ...
  /**
   * Call the bean name generator for the given bean definition and register the bean definition
