 ...
 *
 * <p>Note that the override mechanism is <em>not</em> intended as a generic means of inserting
...
public abstract class MethodOverride implements BeanMetadataElement {
  ...
  /**
   * Set whether the overridden method is <em>overloaded</em> (i.e., whether argument type matching
   * needs to occur to disambiguate methods of the same name).
   *
   * <p>Default is {@code true}; can be switched to {@code false} to optimize runtime performance.
   */
  ...
  /**
   * Return whether the overridden method is <em>overloaded</em> (i.e., whether argument type
  ...
  /**
   * Subclasses must override this to indicate whether they <em>match</em> the given method. This
   * allows for argument list checking as well as method name checking.
   *
