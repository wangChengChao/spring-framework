 ...
 * Configurable annotation to identify which classes need autowiring. The bean name to look up will
 * be taken from the {@link Configurable} annotation if specified; otherwise the default will be the
 * fully-qualified name of the class being configured.
 *
 * @author Rod Johnson
...
public class AnnotationBeanWiringInfoResolver implements BeanWiringInfoResolver {
   ...
   *
   * <p>The default implementation returns the superclass name for a CGLIB proxy and the name of the
   * plain bean class else.
   *
