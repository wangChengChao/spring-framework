...
/**
 * Exception thrown when a BeanFactory encounters an error when attempting to create a bean from a
 * bean definition.
 *
...
public class BeanCreationException extends FatalBeanException {
  ...
  @Nullable private final String resourceDescription;

  @Nullable private List<Throwable> relatedCauses;
  ...
  public BeanCreationException(
      @Nullable String resourceDescription, @Nullable String beanName, String msg) {
    super(
  ...
  /**
   * Add a related cause to this bean creation exception, not being a direct cause of the failure
   * but having occurred earlier in the creation of the same bean instance.
   *
