...
/**
 * Internal wrapper for a Spring BeanDefinition, allowing for Groovy-style property access within a
 * {@link GroovyBeanDefinitionReader} closure.
 *
 * @author Jeff Brown
...
class GroovyBeanDefinitionWrapper extends GroovyObjectSupport {
  ...
  public GroovyBeanDefinitionWrapper(
      String beanName, Class<?> clazz, Collection<?> constructorArgs) {
    this.beanName = beanName;
    this.clazz = clazz;
  ...
  public void setParent(Object obj) {
    if (obj == null) {
      throw new IllegalArgumentException(
          "Parent bean cannot be set to a null runtime bean reference!");
    }
