...
/**
 * Basic {@link AutowireCandidateResolver} that performs a full generic type match with the
 * candidate's type if the dependency is declared as a generic type (e.g.
 * Repository&lt;Customer&gt;).
 *
 * <p>This is the base class for {@link
...
public class GenericTypeAwareAutowireCandidateResolver extends SimpleAutowireCandidateResolver
  ...
  /**
   * Match the given dependency type with its generic type information against the given candidate
   * bean definition.
   */
  ...
  @Nullable
  protected ResolvableType getReturnTypeForFactoryMethod(
      RootBeanDefinition rbd, DependencyDescriptor descriptor) {
