...
public interface BeanDefinitionRegistryPostProcessor extends BeanFactoryPostProcessor {
   ...
   * initialization. All regular bean definitions will have been loaded, but no beans will have been
   * instantiated yet. This allows for adding further bean definitions before the next
   * post-processing phase kicks in.
   *
