...
public class YamlPropertiesFactoryBean extends YamlProcessor
   ...
   * The default implementation returns a properties with the content of all resources.
   *
   * <p>Invoked lazily the first time {@link #getObject()} is invoked in case of a shared singleton;
