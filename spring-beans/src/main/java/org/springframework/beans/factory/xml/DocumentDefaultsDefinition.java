...
/**
 * Simple JavaBean that holds the defaults specified at the {@code <beans>} level in a standard
 * Spring XML bean definition document: {@code default-lazy-init}, {@code default-autowire}, etc.
 *
...
public class DocumentDefaultsDefinition implements DefaultsDefinition {
  ...
  @Nullable private String lazyInit;

  @Nullable private String merge;

  @Nullable private String autowire;

  @Nullable private String autowireCandidates;

  @Nullable private String initMethod;

  @Nullable private String destroyMethod;
  ...
  /**
   * Set the default autowire-candidate pattern for the document that's currently parsed. Also
   * accepts a comma-separated list of patterns.
   */
  ...
  /**
   * Return the default autowire-candidate pattern for the document that's currently parsed. May
   * also return a comma-separated list of patterns.
   */
  @Nullable
