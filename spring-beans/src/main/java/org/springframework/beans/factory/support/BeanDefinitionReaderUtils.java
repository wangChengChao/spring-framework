...
/**
 * Utility methods that are useful for bean definition reader implementations. Mainly intended for
 * internal use.
 *
...
public abstract class BeanDefinitionReaderUtils {
  ...
  /**
   * Separator for generated bean names. If a class name or parent name is not unique, "#1", "#2"
  ...
  /**
   * Create a new GenericBeanDefinition for the given parent name and class name, eagerly loading
   * the bean class if a ClassLoader has been specified.
   *
   * @param parentName the name of the parent bean, if any
   * @param className the name of the bean class, if any
   * @param classLoader the ClassLoader to use for loading bean classes (can be {@code null} to just
   *     register bean classes by name)
  ...
  /**
   * Generate a bean name for the given top-level bean definition, unique within the given bean
   * factory.
   *
   * @param beanDefinition the bean definition to generate a bean name for
   * @param registry the bean factory that the definition is going to be registered with (to check
   ...
   *     top-level bean (allowing for special name generation for inner beans versus top-level
   *     beans)
   * @return the generated bean name
   * @throws BeanDefinitionStoreException if no unique name can be generated for the given bean
   *     definition
  ...
  /**
   * Turn the given bean name into a unique bean name for the given bean factory, appending a unique
   * counter as suffix if necessary.
   *
   ...
   * @return the generated bean name
   * @throws BeanDefinitionStoreException if no unique name can be generated for the given bean
   *     definition or the definition cannot be registered
   */
