...
/**
 * Holder for a typed String value. Can be added to bean definitions in order to explicitly specify
 * a target type for a String value, for example for collection elements.
 *
 * <p>This holder will just store the String value and the target type. The actual conversion will
 * be performed by the bean factory.
 *
...
public class TypedStringValue implements BeanMetadataElement {
  ...
  @Nullable private volatile Object targetType;

  @Nullable private Object source;

  @Nullable private String specifiedTypeName;
   ...
   *
   * <p>Only necessary for manipulating a registered value, for example in
  ...
  /**
   * Determine the type to convert to, resolving it from a specified class name if necessary. Will
   * also reload a specified Class from its name when called with the target type already resolved.
   *
   ...
   */
  @Nullable
  public Class<?> resolveTargetType(@Nullable ClassLoader classLoader)
  ...
  /**
   * Mark this value as dynamic, i.e. as containing an expression and hence not being subject to
   * caching.
   */
