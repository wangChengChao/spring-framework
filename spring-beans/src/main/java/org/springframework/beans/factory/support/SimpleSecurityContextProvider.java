...
public class SimpleSecurityContextProvider implements SecurityContextProvider {
   ...
   *
   * <p>The security context will be retrieved on each call from the current thread.
   */
   ...
   * Construct a new {@code SimpleSecurityContextProvider} instance.
   *
   * <p>If the given control context is null, the security context will be retrieved on each call
