...
/**
 * Exception thrown when a bean depends on other beans or simple properties that were not specified
 * in the bean factory definition, although dependency checking was enabled.
 *
 * @author Rod Johnson
...
public class UnsatisfiedDependencyException extends BeanCreationException {
  ...
  @Nullable private final InjectionPoint injectionPoint;
