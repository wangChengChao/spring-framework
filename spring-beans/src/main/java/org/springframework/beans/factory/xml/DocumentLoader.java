...
public interface DocumentLoader {
   ...
   * @param validationMode the type of validation {@link
   *     org.springframework.util.xml.XmlValidationModeDetector#VALIDATION_DTD DTD} or {@link
   *     org.springframework.util.xml.XmlValidationModeDetector#VALIDATION_XSD XSD})
