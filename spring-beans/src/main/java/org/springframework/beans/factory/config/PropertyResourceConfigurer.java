 ...
 *   <li>{@link PropertyPlaceholderConfigurer} for replacing "${...}" placeholders (<i>pulling</i>
 *       values from a properties file into bean definitions)
 * </ul>
 *
 * <p>Property values can be converted after reading them in, through overriding the {@link
...
public abstract class PropertyResourceConfigurer extends PropertiesLoaderSupport
  ...
  /**
   * {@linkplain #mergeProperties Merge}, {@linkplain #convertProperties convert} and {@linkplain
   * #processProperties process} properties against the given bean factory.
   *
   ...
   *
   * @param originalValue the original value from the properties source (properties file or local
   *     "properties")
   * @return the converted value, to be used for processing
   * @see #setProperties
   * @see #setLocations
