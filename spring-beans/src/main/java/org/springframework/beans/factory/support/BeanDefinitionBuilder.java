...
/**
 * Programmatic means of constructing {@link org.springframework.beans.factory.config.BeanDefinition
 * BeanDefinitions} using the builder pattern. Intended primarily for use when implementing Spring
 * 2.0 {@link org.springframework.beans.factory.xml.NamespaceHandler NamespaceHandlers}.
 *
 * @author Rod Johnson
 * @author Rob Harrop
...
public final class BeanDefinitionBuilder {
  ...
  public static BeanDefinitionBuilder rootBeanDefinition(
      String beanClassName, @Nullable String factoryMethodName) {
   ...
   */
  public static BeanDefinitionBuilder rootBeanDefinition(
      Class<?> beanClass, @Nullable String factoryMethodName) {
    BeanDefinitionBuilder builder = new BeanDefinitionBuilder(new RootBeanDefinition());
    builder.beanDefinition.setBeanClass(beanClass);
    builder.beanDefinition.setFactoryMethodName(factoryMethodName);
    return builder;
  ...
  /**
   * Set the name of a static factory method to use for this definition, to be called on this bean's
   * class.
   */
  ...
  /**
   * Set the name of a non-static factory method to use for this definition, including the bean name
   * of the factory instance to call the method on.
   *
  ...
  /**
   * Add an indexed constructor arg value. The current index is tracked internally and all additions
   * are at the present point.
   */
  public BeanDefinitionBuilder addConstructorArgValue(@Nullable Object value) {
    this.beanDefinition
        .getConstructorArgumentValues()
        .addIndexedArgumentValue(this.constructorArgIndex++, value);
    return this;
  }
  ...
  public BeanDefinitionBuilder addConstructorArgReference(String beanName) {
    this.beanDefinition
        .getConstructorArgumentValues()
        .addIndexedArgumentValue(this.constructorArgIndex++, new RuntimeBeanReference(beanName));
    return this;
  }
