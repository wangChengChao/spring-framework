...
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader
  ...
  /**
   * Checks whether there are any {@link RuntimeBeanReference RuntimeBeanReferences} inside the
   * {@link Map} and converts it to a {@link ManagedMap} if necessary.
   *
  ...
  /**
   * Checks whether there are any {@link RuntimeBeanReference RuntimeBeanReferences} inside the
   * {@link List} and converts it to a {@link ManagedList} if necessary.
   *
  ...
  /**
   * This method overrides property retrieval in the scope of the {@code
  ...
  private class GroovyRuntimeBeanReference extends RuntimeBeanReference implements GroovyObject {
    ...
    /**
     * Wraps a bean definition property and ensures that any RuntimeBeanReference additions to it
     * are deferred for resolution later.
     */
