...
/**
 * Represents a problem with a bean definition configuration. Mainly serves as common argument
 * passed into a {@link ProblemReporter}.
 *
...
public class Problem {
  ...
  @Nullable private final ParseState parseState;
  ...
  public Problem(
      String message,
      Location location,
      @Nullable ParseState parseState,
   ...
   * within this Problem's Location object.
   *
   * @see #getLocation()
   */
