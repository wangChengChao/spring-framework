...
/**
 * A simple descriptor for an injection point, pointing to a method/constructor parameter or a
 * field. Exposed by {@link UnsatisfiedDependencyException}. Also available as an argument for
 * factory methods, reacting to the requesting injection point for building a customized bean
 * instance.
 *
...
public class InjectionPoint {
  ...
  @Nullable private volatile Annotation[] fieldAnnotations;
  ...
  public <A extends Annotation> A getAnnotation(Class<A> annotationType) {
    return (this.field != null
        ? this.field.getAnnotation(annotationType)
   ...
   *
   * <p>Note: In case of a method/constructor parameter, this exposes the annotations declared on
   * the method or constructor itself (i.e. at the method/constructor level, not at the parameter
   * level). Use {@link #getAnnotations()} to obtain parameter-level annotations in such a scenario,
   * transparently with corresponding field annotations.
   *
