 ...
 * (to be resolved into bean objects).
 *
...
public class ManagedMap<K, V> extends LinkedHashMap<K, V>
    implements Mergeable, BeanMetadataElement {

  @Nullable private Object source;

  @Nullable private String keyTypeName;

  @Nullable private String valueTypeName;
  ...
  /**
   * Set whether merging should be enabled for this collection, in case of a 'parent' collection
   * value being present.
   */
  ...
  public Object merge(@Nullable Object parent) {
    ...
    if (!(parent instanceof Map)) {
      throw new IllegalArgumentException(
          "Cannot merge with object of type [" + parent.getClass() + "]");
    }
