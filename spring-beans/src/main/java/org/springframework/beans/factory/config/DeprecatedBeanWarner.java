...
public class DeprecatedBeanWarner implements BeanFactoryPostProcessor {
   ...
   *
   * <p>This can be specified to not log into the category of this warner class but rather into a
   ...
   */
  protected void logDeprecatedBean(
   ...
   *
   * <p>Default is {@code true} when the "warn" level is enabled. Subclasses can override this to
   * change the level under which logging occurs.
   */
