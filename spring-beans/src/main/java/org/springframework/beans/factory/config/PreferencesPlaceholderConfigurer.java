...
/**
 * Subclass of PropertyPlaceholderConfigurer that supports JDK 1.4's Preferences API ({@code
 * java.util.prefs}).
 *
 * <p>Tries to resolve placeholders as keys first in the user preferences, then in the system
 ...
 *
 * <p>Supports custom paths for the system and user preferences trees. Also supports custom paths
 * specified in placeholders ("myPath/myPlaceholderKey"). Uses the respective root node if not
 * specified.
 *
...
public class PreferencesPlaceholderConfigurer extends PropertyPlaceholderConfigurer
  ...
  @Nullable private String systemTreePath;

  @Nullable private String userTreePath;
  ...
  /**
   * Set the path in the system preferences tree to use for resolving placeholders. Default is the
   * root node.
   */
  ...
  /**
   * This implementation eagerly fetches the Preferences instances for the required system and user
   * tree nodes.
   */
  @Override
  ...
  /**
   * This implementation tries to resolve placeholders as keys first in the user preferences, then
   * in the system preferences, then in the passed-in properties.
   */
  @Override
