...
public abstract class PlaceholderConfigurerSupport extends PropertyResourceConfigurer
   ...
   *
   * <p>Note that this will only apply to full property values, not to parts of concatenated values.
   *
   * <p>By default, no such null value is defined. This means that there is no way to express {@code
   * null} as a property value unless you explicitly map a corresponding value here.
   */
