...
/**
 * Extension of MethodOverride that represents an arbitrary override of a method by the IoC
 * container.
 *
 * <p>Any non-final method can be overridden, irrespective of its parameters and return types.
 *
 * @author Rod Johnson
...
public class ReplaceOverride extends MethodOverride {
  ...
  /**
   * Add a fragment of a class string, like "Exception" or "java.lang.Exc", to identify a parameter
   * type.
   *
