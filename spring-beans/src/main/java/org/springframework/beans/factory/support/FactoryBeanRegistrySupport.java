...
/**
 * Support base class for singleton registries which need to handle {@link
 * org.springframework.beans.factory.FactoryBean} instances, integrated with {@link
 * DefaultSingletonBeanRegistry}'s singleton management.
 *
...
public abstract class FactoryBeanRegistrySupport extends DefaultSingletonBeanRegistry {
  ...
  /**
   * Obtain an object to expose from the given FactoryBean, if available in cached form. Quick check
  ...
  /**
   * Post-process the given object that has been obtained from the FactoryBean. The resulting object
   * will get exposed for bean references.
   *
   * <p>The default implementation simply returns the given object as-is. Subclasses may override
   * this, for example, to apply post-processors.
   *
  ...
  /**
   * Return the security context for this bean factory. If a security manager is set, interaction
   * with the user code will be executed using the privileged of the security context returned by
   * this method.
   *
