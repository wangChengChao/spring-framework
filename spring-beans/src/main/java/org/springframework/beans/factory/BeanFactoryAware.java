 ...
 *
 * <p>For example, beans can look up collaborating beans via the factory (Dependency Lookup). Note
 * that most beans will choose to receive references to collaborating beans via corresponding bean
 * properties or constructor arguments (Dependency Injection).
 *
