...
/**
 * XML-specific BeanDefinitionStoreException subclass that wraps a {@link org.xml.sax.SAXException},
 * typically a {@link org.xml.sax.SAXParseException} which contains information about the error
 * location.
 *
...
public class XmlBeanDefinitionStoreException extends BeanDefinitionStoreException {
   ...
   * @see org.xml.sax.SAXParseException
   */
  public XmlBeanDefinitionStoreException(
      String resourceDescription, String msg, SAXException cause) {
