...
/**
 * Simple factory for shared Set instances. Allows for central setup of Sets via the "set" element
...
public class SetFactoryBean extends AbstractFactoryBean<Set<Object>> {
  ...
  @Nullable private Set<?> sourceSet;
  ...
  /**
   * Set the class to use for the target Set. Can be populated with a fully qualified class name
