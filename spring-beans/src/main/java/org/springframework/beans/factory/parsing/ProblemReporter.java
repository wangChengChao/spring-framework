...
/**
 * SPI interface allowing tools and other external processes to handle errors and warnings reported
...
public interface ProblemReporter {
   ...
   *
   * <p>Implementations must treat the given problem as fatal, i.e. they have to eventually raise an
   * exception.
   *
