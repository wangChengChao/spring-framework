 ...
 * </pre>
 *
 * <p>If you are using Spring 2.0, you can also use the following style of configuration for public
 * static fields.
 *
 * <pre class="code">
 * &lt;util:constant static-field="java.sql.Connection.TRANSACTION_SERIALIZABLE"/&gt;</pre>
 *
...
public class FieldRetrievingFactoryBean
  ...
  @Nullable private String targetField;

  @Nullable private String staticField;
  ...
  @Nullable private Field fieldObject;

  /**
   * Set the target class on which the field is defined. Only necessary when the target field is
   * static; else, a target object needs to be specified anyway.
   *
   * @see #setTargetObject
   * @see #setTargetField
   */
  ...
  /**
   * Set the target object on which the field is defined. Only necessary when the target field is
   * not static; else, a target class is sufficient.
   *
   * @see #setTargetClass
   * @see #setTargetField
   */
  ...
  /**
   * Set the name of the field to be retrieved. Refers to either a static field or a non-static
   * field, depending on a target object being set.
   *
   * @see #setTargetClass
   * @see #setTargetObject
   */
   ...
   * "example.MyExampleClass.MY_EXAMPLE_FIELD". Convenient alternative to specifying targetClass and
   * targetField.
   *
   * @see #setTargetClass
   * @see #setTargetField
  ...
  /**
   * The bean name of this FieldRetrievingFactoryBean will be interpreted as "staticField" pattern,
   * if neither "targetClass" nor "targetObject" nor "targetField" have been specified. This allows
   * for concise bean definitions with just an id/name.
   */
  @Override
  ...
  public void afterPropertiesSet() throws ClassNotFoundException, NoSuchFieldException {
    ...
    Class<?> targetClass =
        (this.targetObject != null ? this.targetObject.getClass() : this.targetClass);
