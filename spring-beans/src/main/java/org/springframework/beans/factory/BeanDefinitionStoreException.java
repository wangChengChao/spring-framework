...
/**
 * Exception thrown when a BeanFactory encounters an invalid bean definition: e.g. in case of
 * incomplete or contradictory bean metadata.
 *
 * @author Rod Johnson
...
public class BeanDefinitionStoreException extends FatalBeanException {
  ...
  public BeanDefinitionStoreException(
      @Nullable String resourceDescription, String msg, @Nullable Throwable cause) {
    super(msg, cause);
    this.resourceDescription = resourceDescription;
    this.beanName = null;
  }
   ...
   * @param msg the detail message (appended to an introductory message that indicates the resource
   *     and the name of the bean)
   */
  public BeanDefinitionStoreException(
      @Nullable String resourceDescription, String beanName, String msg) {
