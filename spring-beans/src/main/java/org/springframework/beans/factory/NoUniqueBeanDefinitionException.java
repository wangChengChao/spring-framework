...
/**
 * Exception thrown when a {@code BeanFactory} is asked for a bean instance for which multiple
 * matching candidates have been found when only one matching bean was expected.
 *
...
public class NoUniqueBeanDefinitionException extends NoSuchBeanDefinitionException {
  ...
  @Nullable private final Collection<String> beanNamesFound;
  ...
  /**
   * Return the names of all beans found when only one matching bean was expected. Note that this
   * may be {@code null} if not specified at construction time.
   *
   * @since 4.3
   * @see #getBeanType()
   */
