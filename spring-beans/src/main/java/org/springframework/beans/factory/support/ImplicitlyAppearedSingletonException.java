...
/**
 * Internal exception to be propagated from {@link ConstructorResolver}, passed through to the
 * initiating {@link DefaultSingletonBeanRegistry} (without wrapping in a {@code
