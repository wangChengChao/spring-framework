...
public class LookupOverride extends MethodOverride {
   ...
   * @param beanName the name of the bean in the current {@code BeanFactory} that the overridden
   *     method should return (may be {@code null})
   */
   ...
   *
   * <p>For backwards compatibility reasons, in a scenario with overloaded non-abstract methods of
   * the given name, only the no-arg variant of a method will be turned into a container-driven
   * lookup method.
   *
   * <p>In case of a provided {@link Method}, only straight matches will be considered, usually
   * demarcated by the {@code @Lookup} annotation.
   */
  @Override
