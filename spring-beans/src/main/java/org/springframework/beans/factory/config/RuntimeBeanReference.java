...
/**
 * Immutable placeholder class used for a property value object when it's a reference to another
 * bean in the factory, to be resolved at runtime.
 *
 * @author Rod Johnson
...
public class RuntimeBeanReference implements BeanReference {
  ...
  /**
   * Create a new RuntimeBeanReference to the given bean name, with the option to mark it as
   * reference to a bean in the parent factory.
   *
   * @param beanName name of the target bean
   * @param toParent whether this is an explicit reference to a bean in the parent factory
   */
  ...
  /**
   * Create a new RuntimeBeanReference to a bean of the given type, with the option to mark it as
   * reference to a bean in the parent factory.
   *
   * @param beanType type of the target bean
   * @param toParent whether this is an explicit reference to a bean in the parent factory
