...
/**
 * Simple marker class for an individually autowired property value, to be added to {@link
 * BeanDefinition#getPropertyValues()} for a specific bean property.
 *
 * <p>At runtime, this will be replaced with a {@link DependencyDescriptor} for the corresponding
 * bean property's write method, eventually to be resolved through a {@link
 * AutowireCapableBeanFactory#resolveDependency} step.
 *
