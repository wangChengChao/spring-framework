...
class ConstructorResolver {
  ...
  /**
   * Marker for autowired arguments in a cached argument array, to be later replaced by a
   * {@linkplain #resolveAutowiredArgument resolved autowired argument}.
   */
  ...
  public BeanWrapper instantiateUsingFactoryMethod(
    ...
    if (explicitArgs != null) {
      ...
      if (argsToResolve != null) {
        argsToUse =
            resolvePreparedArguments(beanName, mbd, bw, factoryMethodToUse, argsToResolve, true);
      }
    }
