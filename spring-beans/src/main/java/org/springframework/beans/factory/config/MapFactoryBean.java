...
/**
 * Simple factory for shared Map instances. Allows for central setup of Maps via the "map" element
...
public class MapFactoryBean extends AbstractFactoryBean<Map<Object, Object>> {
  ...
  @Nullable private Map<?, ?> sourceMap;
  ...
  /**
   * Set the class to use for the target Map. Can be populated with a fully qualified class name
