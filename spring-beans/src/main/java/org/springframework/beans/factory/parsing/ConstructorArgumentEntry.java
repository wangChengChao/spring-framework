...
public class ConstructorArgumentEntry implements ParseState.Entry {
  ...
  /**
   * Creates a new instance of the {@link ConstructorArgumentEntry} class representing a constructor
   * argument with a (currently) unknown index.
   */
  ...
  /**
   * Creates a new instance of the {@link ConstructorArgumentEntry} class representing a constructor
   * argument at the supplied {@code index}.
   *
