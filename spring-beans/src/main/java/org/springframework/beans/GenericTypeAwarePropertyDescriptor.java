...
/**
 * Extension of the standard JavaBeans {@link PropertyDescriptor} class, overriding {@code
 * getPropertyType()} such that a generically declared type variable will be resolved against the
 * containing bean class.
 *
...
final class GenericTypeAwarePropertyDescriptor extends PropertyDescriptor {
  ...
  @Nullable private volatile Set<Method> ambiguousWriteMethods;

  @Nullable private MethodParameter writeMethodParameter;
  ...
  public GenericTypeAwarePropertyDescriptor(
    ...
    Method readMethodToUse =
        (readMethod != null ? BridgeMethodResolver.findBridgedMethod(readMethod) : null);
    Method writeMethodToUse =
        (writeMethod != null ? BridgeMethodResolver.findBridgedMethod(writeMethod) : null);
    ...
    if (this.writeMethod != null) {
      ...
      this.writeMethodParameter =
          new MethodParameter(this.writeMethod, 0).withContainingClass(this.beanClass);
    }
