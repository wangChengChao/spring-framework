...
/**
 * Property editor for an array of {@link Class Classes}, to enable the direct population of a
 * {@code Class[]} property without having to use a {@code String} class name property as bridge.
 *
 * <p>Also supports "java.lang.String[]"-style array class names, in contrast to the standard {@link
...
public class ClassArrayEditor extends PropertyEditorSupport {
   ...
   *
   * @param classLoader the {@code ClassLoader} to use (or pass {@code null} for the thread context
   *     {@code ClassLoader})
   */
