 ...
 *
 * <p>Strings must be in CSV format, with a customizable separator. By default values in the result
...
public class StringArrayPropertyEditor extends PropertyEditorSupport {
  ...
  @Nullable private final String charsToDelete;
   ...
   *
   * @param separator the separator to use for splitting a {@link String}
   * @param emptyArrayAsNull {@code true} if an empty String array is to be transformed into {@code
   *     null}
   */
   ...
   * @param emptyArrayAsNull {@code true} if an empty String array is to be transformed into {@code
   *     null}
   * @param trimValues {@code true} if the values in the parsed arrays are to be trimmed of
   ...
   *
   * @param separator the separator to use for splitting a {@link String}
   * @param charsToDelete a set of characters to delete, in addition to trimming an input String.
   ...
   */
  public StringArrayPropertyEditor(
      String separator, @Nullable String charsToDelete, boolean emptyArrayAsNull) {
  ...
  public void setAsText(String text) throws IllegalArgumentException {
    String[] array =
        StringUtils.delimitedListToStringArray(text, this.separator, this.charsToDelete);
    if (this.trimValues) {
