...
public class CustomDateEditor extends PropertyEditorSupport {
   ...
   * interpreted as null value. Otherwise, an IllegalArgumentException gets thrown in that case.
   *
   ...
   * However, even with an "exactDateLength" specified, prepended zeros in the day or month part may
   * still allow for a shorter year part, so consider this as just one more assertion that gets you
