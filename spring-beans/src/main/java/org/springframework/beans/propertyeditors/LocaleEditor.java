 ...
 *
 * <p>Expects the same syntax as Locale's {@code toString}, i.e. language + optionally country +
 * optionally variant, separated by "_" (e.g. "en", "en_US"). Also accepts spaces as separators, as
