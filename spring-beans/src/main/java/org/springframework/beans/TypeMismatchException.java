...
public class TypeMismatchException extends PropertyAccessException {
   ...
   */
  public TypeMismatchException(
      @Nullable Object value, @Nullable Class<?> requiredType, @Nullable Throwable cause) {
    super(
  ...
  /**
   * Initialize this exception's property name for exposure through {@link #getPropertyName()}, as
   * an alternative to having it initialized via a {@link PropertyChangeEvent}.
   *
