...
public class QualifierAnnotationAutowireBeanFactoryTests {
  ...
  public void testAutowireCandidateDefaultWithIrrelevantDescriptor() throws Exception {
    ...
    assertThat(
            lbf.isAutowireCandidate(
                JUERGEN, new DependencyDescriptor(Person.class.getDeclaredField("name"), false)))
        .isTrue();
    assertThat(
            lbf.isAutowireCandidate(
                JUERGEN, new DependencyDescriptor(Person.class.getDeclaredField("name"), true)))
        .isTrue();
  }
  ...
  public void testAutowireCandidateWithFieldDescriptor() throws Exception {
    ...
    DependencyDescriptor qualifiedDescriptor =
        new DependencyDescriptor(QualifiedTestBean.class.getDeclaredField("qualified"), false);
    DependencyDescriptor nonqualifiedDescriptor =
        new DependencyDescriptor(QualifiedTestBean.class.getDeclaredField("nonqualified"), false);
    assertThat(lbf.isAutowireCandidate(JUERGEN, null)).isTrue();
  ...
  public void testAutowireCandidateWithShortClassName() throws Exception {
    ...
    RootBeanDefinition person = new RootBeanDefinition(Person.class, cavs, null);
    person.addQualifier(
        new AutowireCandidateQualifier(ClassUtils.getShortName(TestQualifier.class)));
    lbf.registerBeanDefinition(JUERGEN, person);
    DependencyDescriptor qualifiedDescriptor =
        new DependencyDescriptor(QualifiedTestBean.class.getDeclaredField("qualified"), false);
    DependencyDescriptor nonqualifiedDescriptor =
  ...
  public void testAutowireCandidateWithMethodDescriptor() throws Exception {
    ...
    DependencyDescriptor nonqualifiedDescriptor =
        new DependencyDescriptor(nonqualifiedParam, false);
  ...
  private static class QualifiedTestBean {
    ...
    @TestQualifier private Person qualified;
