...
public class DefinitionMetadataEqualsHashCodeTests {
  ...
  public void rootBeanDefinitionAndMethodOverridesWithDifferentOverloadedValues() {
    ...
    assertThat(equal.hashCode())
        .as("Hash code for equal instances must match")
        .isEqualTo(master.hashCode());
  }
  ...
  private void assertEqualsAndHashCodeContracts(
      Object master, Object equal, Object notEqual, Object subclass) {
    assertThat(equal).as("Should be equal").isEqualTo(master);
    assertThat(equal.hashCode())
        .as("Hash code for equal instances should match")
        .isEqualTo(master.hashCode());

    assertThat(notEqual).as("Should not be equal").isNotEqualTo(master);
    assertThat(notEqual.hashCode())
        .as("Hash code for non-equal instances should not match")
        .isNotEqualTo((long) master.hashCode());

    assertThat(subclass).as("Subclass should be equal").isEqualTo(master);
    assertThat(subclass.hashCode())
        .as("Hash code for subclass should match")
        .isEqualTo(master.hashCode());
  }
}
