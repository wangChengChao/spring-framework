...
public class XmlListableBeanFactoryTests extends AbstractListableBeanFactoryTests {
  ...
  public void setup() {
    ...
    new XmlBeanDefinitionReader(this.factory)
        .loadBeanDefinitions(new ClassPathResource("test.xml", getClass()));
  ...
  public void protectedLifecycleMethods() {
    ProtectedLifecycleBean bean =
        (ProtectedLifecycleBean) getBeanFactory().getBean("protectedLifecycle");
    bean.businessMethod();
  }
  ...
  public void factoryReferences() {
    ...
    DummyReferencer ref2 =
        (DummyReferencer) getBeanFactory().getBean("factoryReferencerWithConstructor");
  ...
  public void prototypeReferences() {
    ...
    assertThat(ref1.getTestBean1() != ref1.getTestBean2())
        .as("Not referencing same bean twice")
        .isTrue();
    ...
    assertThat(ref2.getTestBean1() != ref2.getTestBean2())
        .as("Not referencing same bean twice")
        .isTrue();
    assertThat(ref1.getTestBean1() != ref2.getTestBean1())
        .as("Not referencing same bean twice")
        .isTrue();
    assertThat(ref1.getTestBean2() != ref2.getTestBean2())
        .as("Not referencing same bean twice")
        .isTrue();
    assertThat(ref1.getTestBean1() != ref2.getTestBean2())
        .as("Not referencing same bean twice")
        .isTrue();
  }
  ...
  public void commentsAndCdataInValue() {
    ...
    assertThat(bean.getName())
        .as("Failed to handle comments and CDATA properly")
