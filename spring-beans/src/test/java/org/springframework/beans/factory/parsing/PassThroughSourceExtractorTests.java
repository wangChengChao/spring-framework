...
public class PassThroughSourceExtractorTests {
  ...
  public void testPassThroughContract() throws Exception {
    ...
    assertThat(extractedSource)
        .as(
            "The contract of PassThroughSourceExtractor states that the supplied "
                + "source object *must* be returned as-is")
        .isSameAs(source);
  }
  ...
  public void testPassThroughContractEvenWithNull() throws Exception {
    ...
    assertThat(extractedSource)
        .as(
            "The contract of PassThroughSourceExtractor states that the supplied "
                + "source object *must* be returned as-is (even if null)")
        .isNull();
  }
}
