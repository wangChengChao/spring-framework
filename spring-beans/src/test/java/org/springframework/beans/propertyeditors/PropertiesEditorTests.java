...
/**
 * Test the conversion of Strings to {@link java.util.Properties} objects, and other property
 * editors.
 *
 * @author Rod Johnson
...
public class PropertiesEditorTests {
  ...
  /**
   * We'll typically align by indenting with tabs or spaces. These should be ignored if at the
   * beginning of a line. We must ensure that comment lines beginning with whitespace are still
   * ignored: The standard syntax doesn't allow this on JDK 1.3.
   */
  @Test
