...
/**
 * Simple factory to allow testing of FactoryBean support in AbstractBeanFactory. Depending on
 * whether its singleton property is set, it will return a singleton or a prototype instance.
 *
 * <p>Implements InitializingBean interface, so we can check that factories get this lifecycle
...
public class DummyFactory
  ...
  /**
   * Was this initialized by invocation of the afterPropertiesSet() method from the InitializingBean
   * interface?
   */
