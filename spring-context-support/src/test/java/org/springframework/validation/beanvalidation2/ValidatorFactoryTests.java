...
public class ValidatorFactoryTests {
  ...
  public void testSimpleValidation() {
    ...
    assertThat(validator.unwrap(ValidatorFactory.class) instanceof HibernateValidatorFactory)
        .isTrue();
    assertThat(
            validator.unwrap(HibernateValidatorFactory.class) instanceof HibernateValidatorFactory)
        .isTrue();
  ...
  public void testSpringValidationWithAutowiredValidator() {
    ConfigurableApplicationContext ctx =
        new AnnotationConfigApplicationContext(LocalValidatorFactoryBean.class);
  ...
  public void testListValidation() {
    ...
    BeanPropertyBindingResult errors =
        new BeanPropertyBindingResult(listContainer, "listContainer");
  ...
  public static class ValidPerson {
    ...
    @Valid private ValidAddress address = new ValidAddress();

    @Valid private List<ValidAddress> addressList = new LinkedList<>();

    @Valid private Set<ValidAddress> addressSet = new LinkedHashSet<>();
  ...
  public static class NameAddressValidator
      implements ConstraintValidator<NameAddressValid, ValidPerson> {
  ...
  public static class MainBean {
    ...
    @InnerValid private InnerBean inner = new InnerBean();
  ...
  public static class InnerValidator implements ConstraintValidator<InnerValid, InnerBean> {
    ...
    public boolean isValid(InnerBean bean, ConstraintValidatorContext context) {
      ...
      if (bean.getValue() == null) {
        context
            .buildConstraintViolationWithTemplate("NULL")
  ...
  public static class ListContainer {
    ...
    @NotXList private List<String> list = new LinkedList<>();
