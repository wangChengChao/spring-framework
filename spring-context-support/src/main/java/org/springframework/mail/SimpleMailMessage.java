 ...
 *
 * <p>Consider {@code JavaMailSender} and JavaMail {@code MimeMessages} for creating more
 * sophisticated messages, for example messages with attachments, special character encodings, or
...
public class SimpleMailMessage implements MailMessage, Serializable {
  ...
  @Nullable private String[] cc;

  @Nullable private String[] bcc;
  ...
  /**
   * Copy constructor for creating a new {@code SimpleMailMessage} from the state of an existing
   * {@code SimpleMailMessage} instance.
   */
