 ...
 * {@link #getCache} request. Also supports a 'static' mode where the set of cache names is
 * pre-defined through {@link #setCacheNames}, with no dynamic creation of further cache regions at
 * runtime.
 *
 * <p>The configuration of the underlying cache can be fine-tuned through a {@link Caffeine} builder
 * or {@link CaffeineSpec}, passed into this CacheManager through {@link #setCaffeine}/{@link
 * #setCaffeineSpec}. A {@link CaffeineSpec}-compliant expression value can also be applied via the
...
public class CaffeineCacheManager implements CacheManager {
  ...
  /**
   * Construct a dynamic CaffeineCacheManager, lazily creating cache instances as they are being
   * requested.
   */
  ...
  /**
   * Set the {@link CaffeineSpec} to use for building each individual {@link CaffeineCache}
   * instance.
   *
   * @see #createNativeCaffeineCache
  ...
  /**
   * Set the Caffeine cache specification String to use for building each individual {@link
   * CaffeineCache} instance. The given value needs to comply with Caffeine's {@link CaffeineSpec}
   * (see its javadoc).
   *
   * @see #createNativeCaffeineCache
  ...
  /**
   * Set the Caffeine CacheLoader to use for building each individual {@link CaffeineCache}
   ...
   *
   * <p>Default is "true", despite Caffeine itself not supporting {@code null} values. An internal
   * holder object will be used to store user-level {@code null}s.
   */
