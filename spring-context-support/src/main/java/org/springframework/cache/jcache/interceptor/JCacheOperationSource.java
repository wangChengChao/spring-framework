...
/**
 * Interface used by {@link JCacheInterceptor}. Implementations know how to source cache operation
 * attributes from standard JSR-107 annotations.
 *
...
public interface JCacheOperationSource {
  ...
  /**
   * Return the cache operations for this method, or {@code null} if the method contains no
   * <em>JSR-107</em> related metadata.
   *
