...
/**
 * {@link org.springframework.cache.CacheManager} implementation backed by a JCache {@link
...
public class JCacheCacheManager extends AbstractTransactionSupportingCacheManager {
  ...
  /**
   * Create a new {@code JCacheCacheManager} without a backing JCache {@link CacheManager
   * javax.cache.CacheManager}.
   *
   * <p>The backing JCache {@code javax.cache.CacheManager} can be set via the {@link
   * #setCacheManager} bean property.
   */
  public JCacheCacheManager() {}

  /**
   * Create a new {@code JCacheCacheManager} for the given backing JCache {@link CacheManager
   * javax.cache.CacheManager}.
   *
   ...
   *
   * <p>Default is "true", despite JSR-107 itself not supporting {@code null} values. An internal
