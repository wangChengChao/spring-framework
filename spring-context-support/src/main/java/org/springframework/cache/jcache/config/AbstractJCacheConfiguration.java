...
/**
 * Abstract JSR-107 specific {@code @Configuration} class providing common structure for enabling
 * JSR-107 annotation-driven cache management capability.
 *
...
public class AbstractJCacheConfiguration extends AbstractCachingConfiguration {
  ...
  @Nullable protected Supplier<CacheResolver> exceptionCacheResolver;
