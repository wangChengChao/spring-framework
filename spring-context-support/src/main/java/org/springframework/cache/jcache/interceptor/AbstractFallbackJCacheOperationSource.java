...
/**
 * Abstract implementation of {@link JCacheOperationSource} that caches attributes for methods and
 * implements a fallback policy: 1. specific target method; 2. declaring method.
 *
...
public abstract class AbstractFallbackJCacheOperationSource implements JCacheOperationSource {
   ...
   */
  @Nullable
  protected abstract JCacheOperation<?> findCacheOperation(
      Method method, @Nullable Class<?> targetType);
