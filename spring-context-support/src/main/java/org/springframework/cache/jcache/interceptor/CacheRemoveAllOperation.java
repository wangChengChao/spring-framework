...
class CacheRemoveAllOperation extends AbstractJCacheOperation<CacheRemoveAll> {
  ...
  public CacheRemoveAllOperation(
      CacheMethodDetails<CacheRemoveAll> methodDetails, CacheResolver cacheResolver) {
  ...
  /**
   * Specify if the cache should be cleared before invoking the method. By default, the cache is
   * cleared after the method invocation.
   *
