...
/**
 * A simple {@link CacheResolver} that resolves the exception cache based on a configurable {@link
 * CacheManager} and the name of the cache: {@link CacheResultOperation#getExceptionCacheName()}.
 *
