 ...
 *
 * <p>A cache operation can be statically cached as it does not contain any runtime operation of a
 * specific cache invocation.
 *
...
public interface JCacheOperation<A extends Annotation>
  ...
  /**
   * Return the {@link CacheResolver} instance to use to resolve the cache to use for this
   * operation.
   */
  CacheResolver getCacheResolver();

  /**
   * Return the {@link CacheInvocationParameter} instances based on the specified method arguments.
   *
