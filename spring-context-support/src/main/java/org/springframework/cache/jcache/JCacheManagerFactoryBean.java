...
/**
 * {@link FactoryBean} for a JCache {@link CacheManager javax.cache.CacheManager}, obtaining a
 * pre-defined {@code CacheManager} by name through the standard JCache {@link Caching
...
public class JCacheManagerFactoryBean
  ...
  @Nullable private URI cacheManagerUri;

  @Nullable private Properties cacheManagerProperties;
