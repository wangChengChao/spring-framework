...
/**
 * Unchecked exception that wraps an exception thrown from a target method. Propagated to the Quartz
 * scheduler from a Job that reflectively invokes an arbitrary target method.
 *
