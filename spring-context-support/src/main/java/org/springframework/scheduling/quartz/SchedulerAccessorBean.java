...
/**
 * Spring bean-style class for accessing a Quartz Scheduler, i.e. for registering jobs, triggers and
 * listeners on a given {@link org.quartz.Scheduler} instance.
 *
...
public class SchedulerAccessorBean extends SchedulerAccessor
   ...
   *
   * <p>Schedulers can be registered in the repository through custom bootstrapping, e.g. via the
   * {@link org.quartz.impl.StdSchedulerFactory} or {@link org.quartz.impl.DirectSchedulerFactory}
   * factory classes. However, in general, it's preferable to use Spring's {@link
   * SchedulerFactoryBean} which includes the job/trigger/listener capabilities of this accessor as
   * well.
   *
   * <p>If not specified, this accessor will try to retrieve a default {@link Scheduler} bean from
  ...
  public void afterPropertiesSet() throws SchedulerException {
    if (this.scheduler == null) {
      this.scheduler =
          (this.schedulerName != null ? findScheduler(this.schedulerName) : findDefaultScheduler());
    }
    registerListeners();
