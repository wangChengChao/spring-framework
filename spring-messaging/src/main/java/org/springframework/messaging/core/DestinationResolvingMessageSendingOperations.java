...
public interface DestinationResolvingMessageSendingOperations<D>
  ...
  /**
   * Resolve the given destination name to a destination, convert the payload Object to serialized
   * form, possibly using a {@link org.springframework.messaging.converter.MessageConverter}, wrap
   * it as a message and send it to the resolved destination.
   *
   * @param destinationName the destination name to resolve
   ...
   * Resolve the given destination name to a destination, convert the payload Object to serialized
   * form, possibly using a {@link org.springframework.messaging.converter.MessageConverter}, wrap
   * it as a message with the given headers and send it to the resolved destination.
   *
   * @param destinationName the destination name to resolve
   * @param payload the Object to use as payload
   ...
   * Resolve the given destination name to a destination, convert the payload Object to serialized
   * form, possibly using a {@link org.springframework.messaging.converter.MessageConverter}, wrap
   * it as a message, apply the given post processor, and send the resulting message to the resolved
   * destination.
   *
   * @param destinationName the destination name to resolve
   * @param payload the Object to use as payload
   ...
   * Resolve the given destination name to a destination, convert the payload Object to serialized
   * form, possibly using a {@link org.springframework.messaging.converter.MessageConverter}, wrap
   * it as a message with the given headers, apply the given post processor, and send the resulting
