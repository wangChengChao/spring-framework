...
/**
 * An implementation of {@link DestinationResolver} that interprets a destination name as the bean
 * name of a {@link MessageChannel} and looks up the bean in the configured {@link BeanFactory}.
 *
 * @author Mark Fisher
 * @since 4.0
 */
public class BeanFactoryMessageChannelDestinationResolver
  ...
  /**
   * A default constructor that can be used when the resolver itself is configured as a Spring bean
   * and will have the {@code BeanFactory} injected as a result of ing having implemented {@link
   * BeanFactoryAware}.
   */
  public BeanFactoryMessageChannelDestinationResolver() {}

  /**
   * A constructor that accepts a {@link BeanFactory} useful if instantiating this resolver manually
   * rather than having it defined as a Spring-managed bean.
   *
