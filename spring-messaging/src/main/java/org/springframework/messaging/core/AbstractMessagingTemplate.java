...
/**
 * An extension of {@link AbstractMessageReceivingTemplate} that adds support for request-reply
 * style operations as defined by {@link MessageRequestReplyOperations}.
 *
 * @author Mark Fisher
...
public abstract class AbstractMessagingTemplate<D> extends AbstractMessageReceivingTemplate<D>
  ...
  public <T> T convertSendAndReceive(
    ...
    return convertSendAndReceive(
        getRequiredDefaultDestination(), request, targetClass, postProcessor);
  }
