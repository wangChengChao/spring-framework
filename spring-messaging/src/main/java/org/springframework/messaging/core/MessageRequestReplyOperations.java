...
public interface MessageRequestReplyOperations<D> {
   ...
   * org.springframework.messaging.converter.MessageConverter}, send it as a {@link Message} to a
   * default destination, receive the reply and convert its body of the specified target class.
   *
   ...
   * send the resulting {@link Message} to a default destination, receive the reply and convert its
