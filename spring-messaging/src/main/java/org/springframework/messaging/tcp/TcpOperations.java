...
public interface TcpOperations<P> {
   ...
   * @return a ListenableFuture that can be used to determine when and if the connection is
   ...
   * @return a ListenableFuture that can be used to determine when and if the initial connection is
   *     successfully established
   */
