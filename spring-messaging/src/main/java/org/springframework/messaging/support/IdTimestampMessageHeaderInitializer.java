...
public class IdTimestampMessageHeaderInitializer implements MessageHeaderInitializer {
  ...
  /**
   * Configure the IdGenerator strategy to initialize {@code MessageHeaderAccessor} instances with.
   *
   * <p>By default this property is set to {@code null} in which case the default IdGenerator of
   * {@link org.springframework.messaging.MessageHeaders} is used.
   *
  ...
  /**
   * A shortcut for calling {@link #setIdGenerator} with an id generation strategy to disable id
  ...
  /**
   * Whether to enable the automatic addition of the {@link
   * org.springframework.messaging.MessageHeaders#TIMESTAMP} header on {@code MessageHeaderAccessor}
