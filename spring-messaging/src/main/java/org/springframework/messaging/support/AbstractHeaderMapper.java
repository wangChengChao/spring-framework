...
public abstract class AbstractHeaderMapper<T> implements HeaderMapper<T> {
  ...
  /**
   * Specify a prefix to be appended to the message header name for any user-defined property that
   * is being mapped into the MessageHeaders. The default is an empty String (no prefix).
   */
  ...
  /**
   * Specify a prefix to be appended to the protocol property name for any user-defined message
   * header that is being mapped into the protocol-specific Message. The default is an empty String
   * (no prefix).
   */
  ...
  /**
   * Generate the name to use to set the header defined by the specified {@code headerName} to the
  ...
  /**
   * Generate the name to use to set the header defined by the specified {@code propertyName} to the
   * {@link MessageHeaders} instance.
   *
  ...
  /**
   * Return the header value, or {@code null} if it does not exist or does not match the requested
   * {@code type}.
   */
  @Nullable
