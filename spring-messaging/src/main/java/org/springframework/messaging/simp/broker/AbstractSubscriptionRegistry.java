...
/**
 * Abstract base class for implementations of {@link SubscriptionRegistry} that looks up information
 * in messages but delegates to abstract methods for the actual storage and retrieval.
 *
