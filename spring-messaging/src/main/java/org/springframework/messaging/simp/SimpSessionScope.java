...
/**
 * A {@link Scope} implementation exposing the attributes of a SiMP session (e.g. WebSocket
 * session).
 *
 * <p>Relies on a thread-bound {@link SimpAttributes} instance exported by {@link
