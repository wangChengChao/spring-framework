...
public class StompBrokerRelayRegistration extends AbstractBrokerRegistration {
  ...
  @Nullable private Long systemHeartbeatSendInterval;

  @Nullable private Long systemHeartbeatReceiveInterval;
  ...
  @Nullable private String userDestinationBroadcast;

  @Nullable private String userRegistryBroadcast;

  public StompBrokerRelayRegistration(
  ...
  /**
   * Set the passcode to use when creating connections to the STOMP broker on behalf of connected
   * clients.
   *
   * <p>By default this is set to "guest".
   */
  ...
  /**
   * Set the interval, in milliseconds, at which the "system" relay session will, in the absence of
   * any other data being sent, send a heartbeat to the STOMP broker. A value of zero will prevent
   * heartbeats from being sent to the broker.
   *
   * <p>The default value is 10000.
   */
  public StompBrokerRelayRegistration setSystemHeartbeatSendInterval(
  ...
  /**
   * Set the maximum interval, in milliseconds, at which the "system" relay session expects, in the
   * absence of any other data, to receive a heartbeat from the STOMP broker. A value of zero will
   * configure the relay session to expect not to receive heartbeats from the broker.
   *
   * <p>The default value is 10000.
   */
  public StompBrokerRelayRegistration setSystemHeartbeatReceiveInterval(
  ...
  /**
   * Configure whether the {@link StompBrokerRelayMessageHandler} should start automatically when
  ...
  /**
   * Set a destination to broadcast messages to user destinations that remain unresolved because the
   * user appears not to be connected. In a multi-application server scenario this gives other
  ...
  /**
   * Set a destination to broadcast the content of the local user registry to and to listen for such
   * broadcasts from other servers. In a multi-application server scenarios this allows each
   * server's user registry to be aware of users connected to other servers.
   *
   * <p>By default this is not set.
   *
  ...
  protected StompBrokerRelayMessageHandler getMessageHandler(SubscribableChannel brokerChannel) {
    ...
    StompBrokerRelayMessageHandler handler =
        new StompBrokerRelayMessageHandler(
