...
/**
 * A {@link java.security.Principal} can also implement this contract when {@link
 * java.security.Principal#getName() getName()} isn't globally unique and therefore not suited for
 * use with "user" destinations.
 *
