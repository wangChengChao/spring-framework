...
public class SimpAttributes {
   ...
   *
   * <p>Also removes the registered destruction callback for the specified attribute, if any.
   * However it <i>does not</i> execute the callback. It is assumed the removed object will continue
   * to be used and destroyed independently at the appropriate time.
   *
   * @param name the name of the attribute
   */
  ...
  /**
   * Register a callback to execute on destruction of the specified attribute. The callback is
  ...
  /**
   * Extract the SiMP session attributes from the given message and wrap them in a {@link
