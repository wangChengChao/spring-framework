...
public class HandlerMethodReturnValueHandlerComposite
  ...
  public static final Log defaultLogger =
      LogFactory.getLog(HandlerMethodReturnValueHandlerComposite.class);
  ...
  public void handleReturnValue(
    ...
    if (handler == null) {
      throw new IllegalStateException(
          "No handler for return value type: " + returnType.getParameterType());
    }
  ...
  public boolean isAsyncReturnValue(Object returnValue, MethodParameter returnType) {
    ...
    return (handler instanceof AsyncHandlerMethodReturnValueHandler
        && ((AsyncHandlerMethodReturnValueHandler) handler)
            .isAsyncReturnValue(returnValue, returnType));
  }
  ...
  public ListenableFuture<?> toListenableFuture(Object returnValue, MethodParameter returnType) {
    ...
    if (handler instanceof AsyncHandlerMethodReturnValueHandler) {
      return ((AsyncHandlerMethodReturnValueHandler) handler)
          .toListenableFuture(returnValue, returnType);
    }
    return null;
  }
}
