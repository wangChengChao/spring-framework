...
/**
 * Handle the return value from the invocation of an annotated {@link Message} handling method.
 *
...
public interface HandlerMethodReturnValueHandler {
   ...
   *     {@link #supportsReturnType(MethodParameter)} and it must have returned {@code true}.
