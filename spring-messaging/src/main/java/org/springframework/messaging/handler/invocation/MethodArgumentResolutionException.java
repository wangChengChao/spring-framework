...
/**
 * Common exception resulting from the invocation of {@link
...
public class MethodArgumentResolutionException extends MessagingException {
  ...
  /**
   * Create a new instance providing the invalid {@code MethodParameter} and a prepared description.
   */
  ...
  /**
   * Create a new instance providing the invalid {@code MethodParameter}, prepared description, and
   * a cause.
   */
  public MethodArgumentResolutionException(
      Message<?> message,
  ...
  private static String getMethodParameterMessage(MethodParameter parameter) {
    return "Could not resolve method parameter at index "
