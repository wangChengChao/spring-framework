...
public class InvocableHandlerMethod extends HandlerMethod {
  ...
  public Mono<Object> invoke(Message<?> message, Object... providedArgs) {
    return getMethodArgumentValues(message, providedArgs)
        .flatMap(
            args -> {
              Object value;
              try {
              ...
              ReactiveAdapter adapter =
                  this.reactiveAdapterRegistry.getAdapter(returnType.getParameterType());
  ...
  private Mono<Object[]> getMethodArgumentValues(Message<?> message, Object... providedArgs) {
    ...
    for (MethodParameter parameter : parameters) {
      ...
      try {
        argMonos.add(
            this.resolvers
                .resolveArgument(parameter, message)
  ...
  private boolean isAsyncVoidReturnType(
      MethodParameter returnType, @Nullable ReactiveAdapter reactiveAdapter) {
