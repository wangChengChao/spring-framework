...
/**
 * Convenient base class for {@link AsyncHandlerMethodReturnValueHandler} implementations that
 * support only asynchronous (Future-like) return values and merely serve as adapters of such types
 * to Spring's {@link org.springframework.util.concurrent.ListenableFuture ListenableFuture}.
 *
