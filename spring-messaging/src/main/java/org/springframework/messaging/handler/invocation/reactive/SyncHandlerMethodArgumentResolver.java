...
/**
 * An extension of {@link HandlerMethodArgumentResolver} for implementations that are synchronous in
 * nature and do not block to resolve values.
 *
...
public interface SyncHandlerMethodArgumentResolver extends HandlerMethodArgumentResolver {
   ...
   * {@inheritDoc}
   *
   * <p>By default this simply delegates to {@link #resolveArgumentValue} for synchronous
   * resolution.
   */
  @Override
