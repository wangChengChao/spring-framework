...
/**
 * Strategy interface to handle the value returned from the invocation of a method handling a {@link
 * Message}.
 *
...
public interface HandlerMethodReturnValueHandler {
   ...
   *     {@link #supportsReturnType(org.springframework.core.MethodParameter)} and it must have
   *     returned {@code true}.
