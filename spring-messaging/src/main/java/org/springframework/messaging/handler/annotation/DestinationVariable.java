...
/**
 * Annotation that indicates a method parameter should be bound to a template variable in a
 * destination template string. Supported on message handling methods such as {@link
