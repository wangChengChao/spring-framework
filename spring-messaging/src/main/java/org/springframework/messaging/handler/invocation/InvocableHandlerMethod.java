...
public class InvocableHandlerMethod extends HandlerMethod {
   ...
   * values to be used directly, i.e. without argument resolution.
   *
  ...
  /**
   * Get the method argument values for the current message, checking the provided argument values
   ...
   * @since 5.1.2
   */
  protected Object[] getMethodArgumentValues(Message<?> message, Object... providedArgs)
      throws Exception {
