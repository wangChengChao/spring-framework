...
public @interface Header {
   ...
   *
   * <p>Default is {@code true}, leading to an exception if the header is missing. Switch this to
   * {@code false} if you prefer a {@code null} value in case of a header missing.
   *
   * @see #defaultValue
   */
