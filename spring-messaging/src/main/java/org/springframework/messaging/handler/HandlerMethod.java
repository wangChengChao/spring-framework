...
public class HandlerMethod {
   ...
   * declared. In some cases the actual endpoint instance at request- processing time may be a JDK
   * dynamic proxy (lazy initialization, prototype beans, and others). Endpoint classes that require
