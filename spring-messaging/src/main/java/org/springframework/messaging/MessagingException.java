...
public class MessagingException extends NestedRuntimeException {
  ...
  @Nullable private final Message<?> failedMessage;
  ...
  public MessagingException(
      Message<?> message, @Nullable String description, @Nullable Throwable cause) {
    super(description, cause);
    this.failedMessage = message;
  }
  ...
  public String toString() {
    return super.toString()
        + (this.failedMessage == null ? "" : (", failedMessage=" + this.failedMessage));
  }
}
