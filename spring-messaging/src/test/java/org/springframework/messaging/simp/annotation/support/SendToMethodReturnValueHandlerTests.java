...
public class SendToMethodReturnValueHandlerTests {
  ...
  private MethodParameter sendToWithPlaceholdersReturnType =
      param("handleAndSendToWithPlaceholders");
  ...
  private MethodParameter sendToUserInSessionDefaultDestReturnType =
      param("handleAndSendToUserDefaultDestInSession");
  ...
  private MethodParameter defaultEmptyAnnotation =
      param(SendToTestBean.class, "handleAndSendToDefaultDest");
  private MethodParameter defaultOverrideAnnotation =
      param(SendToTestBean.class, "handleAndSendToOverride");
  private MethodParameter userDefaultNoAnnotation =
      param(SendToUserTestBean.class, "handleNoAnnotation");
  private MethodParameter userDefaultEmptyAnnotation =
      param(SendToUserTestBean.class, "handleAndSendToDefaultDest");
  private MethodParameter userDefaultOverrideAnnotation =
      param(SendToUserTestBean.class, "handleAndSendToOverride");
  ...
  public void setup() throws Exception {
    ...
    this.handlerAnnotationNotRequired =
        new SendToMethodReturnValueHandler(messagingTemplate, false);
  ...
  public void supportsReturnType() throws Exception {
    ...
    assertThat(this.handlerAnnotationNotRequired.supportsReturnType(this.noAnnotationsReturnType))
        .isTrue();
  ...
  public void testHeadersToSend() throws Exception {
    ...
    assertThat(accessor.getSubscriptionId()).as("Subscription id should not be copied").isNull();
    assertThat(accessor.getHeader(SimpMessagingTemplate.CONVERSION_HINT_HEADER))
        .isEqualTo(this.noAnnotationsReturnType);
  }
  ...
  public void sendToUserSingleSession() throws Exception {
    ...
    assertThat(accessor.getSubscriptionId()).as("Subscription id should not be copied").isNull();
    assertThat(accessor.getHeader(SimpMessagingTemplate.CONVERSION_HINT_HEADER))
        .isEqualTo(this.sendToUserInSessionReturnType);
  ...
  public void sendToUserDefaultDestinationWhenUsingDotPathSeparator() throws Exception {
    ...
    assertThat(accessor.getDestination())
        .isEqualTo(("/user/" + user.getName() + "/queue/dest.foo.bar"));
  }
  ...
  public void jsonView() throws Exception {
    ...
    this.jsonHandler.handleReturnValue(
        handleAndSendToJsonView(), this.jsonViewReturnType, inputMessage);
  ...
  private Message<?> createMessage(
      String sessId, String subsId, String destPrefix, String dest, Principal user) {
