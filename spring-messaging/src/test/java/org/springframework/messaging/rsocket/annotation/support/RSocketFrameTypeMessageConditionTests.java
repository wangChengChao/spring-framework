...
public class RSocketFrameTypeMessageConditionTests {
  ...
  public void getMatchingCondition() {
    ...
    RSocketFrameTypeMessageCondition condition =
        condition(FrameType.REQUEST_FNF, FrameType.REQUEST_RESPONSE);
  ...
  public void compareTo() {
    ...
    assertThat(condition(FrameType.SETUP).compareTo(condition(FrameType.SETUP), message))
        .isEqualTo(0);
    assertThat(condition(FrameType.SETUP).compareTo(condition(FrameType.METADATA_PUSH), message))
        .isEqualTo(0);
  }
