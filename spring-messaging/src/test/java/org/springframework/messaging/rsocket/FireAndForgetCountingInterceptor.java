...
/**
 * Intercept received RSockets and count successfully completed requests seen on the server side.
 * This is useful for verifying fire-and-forget interactions.
 *
  ...
  private static class CountingDecorator extends RSocketProxy {
    ...
    public Mono<Void> fireAndForget(Payload payload) {
      return super.fireAndForget(payload)
          .doOnSuccess(aVoid -> this.fireAndForget.incrementAndGet());
    }
  }
}
