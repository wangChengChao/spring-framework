 ...
 *
 * <p>For example, Spring's @Transactional may be declared at the interface or class level, and
 * whether interface or subclass proxies are used, the @Transactional annotation must be discovered
