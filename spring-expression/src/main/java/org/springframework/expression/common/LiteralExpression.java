...
/**
 * A very simple hardcoded implementation of the Expression interface that represents a string
 * literal. It is used with CompositeStringExpression when representing a template expression which
 * is made up of pieces - some being real expressions to be handled by an EL implementation like
 * SpEL, and some being just textual elements.
 *
 * @author Andy Clement
...
public class LiteralExpression implements Expression {
  ...
  @Override
  public String getValue(EvaluationContext context, @Nullable Object rootObject)
      throws EvaluationException {
    return this.literalValue;
  }
  ...
  public void setValue(@Nullable Object rootObject, @Nullable Object value)
    ...
    throw new EvaluationException(
        this.literalValue, "Cannot call setValue() on a LiteralExpression");
  }
