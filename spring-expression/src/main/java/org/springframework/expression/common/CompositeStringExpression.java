...
/**
 * Represents a template expression broken into pieces. Each piece will be an Expression but pure
 * text parts to the template will be represented as LiteralExpression objects. An example of a
 * template expression might be:
 *
 * <pre class="code">
 * &quot;Hello ${getName()}&quot;
 * </pre>
...
public class CompositeStringExpression implements Expression {
  ...
  public void setValue(@Nullable Object rootObject, @Nullable Object value)
    ...
    throw new EvaluationException(
        this.expressionString, "Cannot call setValue on a composite expression");
  }
