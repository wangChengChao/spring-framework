...
/**
 * An expression capable of evaluating itself against context objects. Encapsulates the details of a
 * previously parsed expression string. Provides a common abstraction for expression evaluation.
 *
 * @author Keith Donald
 * @author Andy Clement
...
public interface Expression {
  ...
  /**
   * Evaluate the expression in the default context. If the result of the evaluation does not match
   * (and cannot be converted to) the expected result type then an exception will be returned.
   *
  ...
  /**
   * Evaluate the expression in the default context against the specified root object. If the result
   * of the evaluation does not match (and cannot be converted to) the expected result type then an
  ...
  /**
   * Evaluate the expression in a specified context which can resolve references to properties,
   * methods, types, etc. The type of the evaluation result is expected to be of a particular class
   * and an exception will be thrown if it is not and cannot be converted to that type.
   *
   * @param context the context in which to evaluate the expression
   * @param desiredResultType the class the caller would like the result to be
   * @return the evaluation result
   ...
   * Evaluate the expression in a specified context which can resolve references to properties,
   * methods, types, etc. The type of the evaluation result is expected to be of a particular class
   * and an exception will be thrown if it is not and cannot be converted to that type. The supplied
   * root object overrides any default specified on the supplied context.
   *
   * @param context the context in which to evaluate the expression
   * @param rootObject the root object against which to evaluate the expression
   * @param desiredResultType the class the caller would like the result to be
  ...
  /**
   * Return the most general type that can be passed to a {@link #setValue} method using the default
   * context.
   *
  ...
  /**
   * Return the most general type that can be passed to the {@link #setValue(Object, Object)} method
  ...
  /**
   * Return the most general type that can be passed to the {@link #setValue(EvaluationContext,
   * Object)} method for the given context.
   *
   * @param context the context in which to evaluate the expression
   * @return the most general type of value that can be set on this context
   * @throws EvaluationException if there is a problem determining the type
  ...
  /**
   * Return the most general type that can be passed to the {@link #setValue(EvaluationContext,
   * Object, Object)} method for the given context. The supplied root object overrides any specified
   * in the context.
   *
   * @param context the context in which to evaluate the expression
   * @param rootObject the root object against which to evaluate the expression
  ...
  /**
   * Determine if an expression can be written to, i.e. setValue() can be called. The supplied root
   * object overrides any specified in the context.
   *
   * @param context the context in which the expression should be checked
   * @param rootObject the root object against which to evaluate the expression
   * @return {@code true} if the expression is writable; {@code false} otherwise
  ...
  /**
   * Set this expression in the provided context to the value provided. The supplied root object
   * overrides any specified in the context.
   *
   * @param context the context in which to set the value of the expression
   * @param rootObject the root object against which to evaluate the expression
   * @param value the new value
