...
/**
 * Encapsulates an object and a {@link TypeDescriptor} that describes it. The type descriptor can
 * contain generic declarations that would not be accessible through a simple {@code getClass()}
 * call on the object.
 *
 * @author Andy Clement
...
public class TypedValue {
  ...
  @Nullable private TypeDescriptor typeDescriptor;

  /**
   * Create a {@link TypedValue} for a simple object. The {@link TypeDescriptor} is inferred from
   * the object, so no generic declarations are preserved.
   *
  ...
  /**
   * Create a {@link TypedValue} for a particular value with a particular {@link TypeDescriptor}
