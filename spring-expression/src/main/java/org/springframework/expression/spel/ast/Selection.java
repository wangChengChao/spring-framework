 ...
 *
 * <p>Basically a subset of the input data is returned based on the evaluation of the expression
 * supplied as selection criteria.
 *
 * @author Andy Clement
 * @author Mark Fisher
 * @author Sam Brannen
...
public class Selection extends SpelNodeImpl {
  ...
  public Selection(
      boolean nullSafe, int variant, int startPos, int endPos, SpelNodeImpl expression) {
  ...
  protected ValueRef getValueRef(ExpressionState state) throws EvaluationException {
        ...
        try {
          ...
          if (val instanceof Boolean) {
            ...
            throw new SpelEvaluationException(
                selectionCriteria.getStartPosition(),
    ...
    if (operand instanceof Iterable || ObjectUtils.isArray(operand)) {
      ...
      if (this.variant == LAST) {
        return new ValueRef.TypedValueHolderValueRef(
            new TypedValue(CollectionUtils.lastElement(result)), this);
      }
    ...
    if (operand == null) {
      ...
      throw new SpelEvaluationException(
          getStartPosition(), SpelMessage.INVALID_TYPE_FOR_SELECTION, "null");
    }

    throw new SpelEvaluationException(
        getStartPosition(), SpelMessage.INVALID_TYPE_FOR_SELECTION, operand.getClass().getName());
  }
