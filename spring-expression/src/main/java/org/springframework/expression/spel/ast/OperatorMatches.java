...
/**
 * Implements the matches operator. Matches takes two operands: The first is a String and the second
 * is a Java regex. It will return {@code true} when {@link #getValue} is called if the first
...
public class OperatorMatches extends Operator {
   ...
   * @return {@code true} if the first operand matches the regex specified as the second operand,
   *     otherwise {@code false}
   * @throws EvaluationException if there is a problem evaluating the expression (e.g. the regex is
   *     invalid)
   */
  @Override
