...
/**
 * A basic {@link TypeComparator} implementation: supports comparison of {@link Number} types as
 * well as types implementing {@link Comparable}.
 *
 * @author Andy Clement
  ...
  public int compare(@Nullable Object left, @Nullable Object right) throws SpelEvaluationException {
    ...
    try {
      ...
      throw new SpelEvaluationException(
          ex, SpelMessage.NOT_COMPARABLE, left.getClass(), right.getClass());
    }

    throw new SpelEvaluationException(
        SpelMessage.NOT_COMPARABLE, left.getClass(), right.getClass());
  }
}
