...
public class Ternary extends SpelNodeImpl {
  ...
  /**
   * Evaluate the condition and if true evaluate the first alternative, otherwise evaluate the
   * second alternative.
   *
  ...
  public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
    ...
    if (value == null) {
      throw new SpelEvaluationException(
          getChild(0).getStartPosition(), SpelMessage.TYPE_CONVERSION_ERROR, "null", "boolean");
    }
