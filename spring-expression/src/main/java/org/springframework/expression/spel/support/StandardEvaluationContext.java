...
/**
 * A powerful and highly configurable {@link EvaluationContext} implementation. This context uses
 * standard implementations of all applicable strategies, based on reflection to resolve properties,
 * methods and fields.
 *
 * <p>For a simpler builder-style context variant for data-binding purposes, consider using {@link
 * SimpleEvaluationContext} instead which allows for opting into several SpEL features as needed by
...
public class StandardEvaluationContext implements EvaluationContext {
  ...
  @Nullable private volatile List<PropertyAccessor> propertyAccessors;

  @Nullable private volatile List<ConstructorResolver> constructorResolvers;

  @Nullable private volatile List<MethodResolver> methodResolvers;

  @Nullable private volatile ReflectiveMethodResolver reflectiveMethodResolver;

  @Nullable private BeanResolver beanResolver;

  @Nullable private TypeLocator typeLocator;
  ...
  /**
   * Register a {@code MethodFilter} which will be called during method resolution for the specified
   * type.
   *
   * <p>The {@code MethodFilter} may remove methods and/or sort the methods which will then be used
   * by SpEL as the candidates to look through for a match.
   *
