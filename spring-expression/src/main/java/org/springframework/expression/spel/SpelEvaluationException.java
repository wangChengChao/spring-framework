...
/**
 * Root exception for Spring EL related exceptions. Rather than holding a hard coded string
 * indicating the problem, it records a message key and the inserts for the message. See {@link
 * SpelMessage} for the list of all possible messages that can occur.
 *
 * @author Andy Clement
...
public class SpelEvaluationException extends EvaluationException {
  ...
  public SpelEvaluationException(
      int position, Throwable cause, SpelMessage message, Object... inserts) {
