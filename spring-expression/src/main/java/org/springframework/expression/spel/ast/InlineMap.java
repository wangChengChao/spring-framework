...
public class InlineMap extends SpelNodeImpl {
  ...
  @Nullable private TypedValue constant;
  ...
  /**
   * If all the components of the map are constants, or lists/maps that themselves contain
   * constants, then a constant list can be built to represent this node. This will speed up later
   * getValue calls and reduce the amount of garbage created.
   */
