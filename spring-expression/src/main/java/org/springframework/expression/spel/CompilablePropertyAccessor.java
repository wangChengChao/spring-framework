...
/**
 * A compilable property accessor is able to generate bytecode that represents the access operation,
 * facilitating compilation to bytecode of expressions that use the accessor.
 *
 * @author Andy Clement
 * @since 4.1
 */
