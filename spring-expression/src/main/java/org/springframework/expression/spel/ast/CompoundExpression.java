...
/**
 * Represents a DOT separated expression sequence, such as {@code
...
public class CompoundExpression extends SpelNodeImpl {
  ...
  public CompoundExpression(int startPos, int endPos, SpelNodeImpl... expressionComponents) {
    ...
    if (expressionComponents.length < 2) {
      throw new IllegalStateException(
          "Do not build compound expressions with less than two entries: "
  ...
  /**
   * Evaluates a compound expression. This involves evaluating each piece in turn and the return
   * value from each piece is the active context object for the subsequent piece.
   *
