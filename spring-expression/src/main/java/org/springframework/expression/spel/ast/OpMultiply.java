 ...
 *
 * <p>Conversions and promotions are handled as defined in <a
 * href="https://java.sun.com/docs/books/jls/third_edition/html/conversions.html">Section 5.6.2 of
 * the Java Language Specification</a>, with the addiction of {@code BigDecimal}/{@code BigInteger}
 * management:
 *
 * <p>If any of the operands is of a reference type, unboxing conversion (Section 5.1.8) is
 * performed. Then:<br>
...
public class OpMultiply extends Operator {
  ...
  /**
   * Implements the {@code multiply} operator directly here for certain types of supported operands
   * and otherwise delegates to any registered overloader for types not supported here.
   *
  ...
  public TypedValue getValueInternal(ExpressionState state) throws EvaluationException {
    ...
    if (leftOperand instanceof Number && rightOperand instanceof Number) {
      ...
      } else if (CodeFlow.isIntegerForNumericOp(leftNumber)
          || CodeFlow.isIntegerForNumericOp(rightNumber)) {
