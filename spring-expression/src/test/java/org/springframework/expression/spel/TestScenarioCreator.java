...
public class TestScenarioCreator {
  ...
  /**
   * Register some Java reflect methods as well known functions that can be called from an
   * expression.
   *
  ...
  private static void populateFunctions(StandardEvaluationContext testContext) {
    try {
      testContext.registerFunction(
          "isEven", TestScenarioCreator.class.getDeclaredMethod("isEven", Integer.TYPE));
      testContext.registerFunction(
          "reverseInt",
          TestScenarioCreator.class.getDeclaredMethod(
              "reverseInt", Integer.TYPE, Integer.TYPE, Integer.TYPE));
      testContext.registerFunction(
          "reverseString",
      ...
      testContext.registerFunction(
          ...
          TestScenarioCreator.class.getDeclaredMethod(
              "varargsFunctionReverseStringsAndMerge", String[].class));
      testContext.registerFunction(
          "varargsFunctionReverseStringsAndMerge2",
          TestScenarioCreator.class.getDeclaredMethod(
              "varargsFunctionReverseStringsAndMerge2", Integer.TYPE, String[].class));
    } catch (Exception ex) {
  ...
  // These methods are registered in the test context and therefore accessible through function
  // calls
  // in test expressions
