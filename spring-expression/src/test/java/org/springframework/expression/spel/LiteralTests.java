...
public class LiteralTests extends AbstractExpressionTests {
  ...
  public void testLongIntInteractions01() {
    ...
    evaluateAndCheckError(
        "0x1220 * 0xffffffffL", Integer.class, SpelMessage.TYPE_CONVERSION_ERROR, 0);
  }
  ...
  public void testConversions() {
    ...
    evaluate(
        ...
        (byte) 37,
        Byte.class); // calling byteValue() on Integer.class
    evaluateAndAskForReturnType(
        "new Integer(37)", (byte) 37, Byte.class); // relying on registered type converters
  }
