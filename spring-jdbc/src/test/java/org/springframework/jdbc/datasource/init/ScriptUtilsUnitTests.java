...
public class ScriptUtilsUnitTests {
  ...
  public void splitSqlScriptDelimitedWithNewLineButDefaultDelimiterSpecified() {
    ...
    assertThat(statements)
        .as("stripped but not split statements")
        .containsExactly(script.replace('\n', ' '));
  }
