...
/**
 * Interface that defines common functionality for objects that can offer parameter values for named
 * SQL parameters, serving as argument for {@link NamedParameterJdbcTemplate} operations.
 *
 * <p>This interface allows for the specification of SQL type in addition to parameter values. All
 * parameter values and types are identified by specifying the name of the parameter.
 *
 * <p>Intended to wrap various implementations like a Map or a JavaBean with a consistent interface.
 *
...
public interface SqlParameterSource {
  ...
  /**
   * Constant that indicates an unknown (or unspecified) SQL type. To be returned from {@code
   ...
   *
   * @param paramName the name of the parameter
   * @return the SQL type of the specified parameter, or {@code TYPE_UNKNOWN} if not known
   * @see #TYPE_UNKNOWN
   */
   ...
   *
   * <p>This is an optional operation, primarily for use with {@link
   * org.springframework.jdbc.core.simple.SimpleJdbcInsert} and {@link
