 ...
 *
 * <p>A {@link ResultSetExtractor}, {@link RowCallbackHandler} or {@link RowMapper} must be provided
 * to handle any returned rows.
 *
 * <p>Returned {@link java.sql.ResultSet ResultSets} - like all stored procedure parameters - must
 * have names.
 *
...
public class SqlReturnResultSet extends ResultSetSupportingSqlParameter {
   ...
   * @param extractor the {@link ResultSetExtractor} to use for parsing the {@link
   *     java.sql.ResultSet}
   */
