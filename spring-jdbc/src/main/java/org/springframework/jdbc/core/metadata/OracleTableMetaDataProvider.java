...
/**
 * Oracle-specific implementation of the {@link
 * org.springframework.jdbc.core.metadata.TableMetaDataProvider}. Supports a feature for including
 * synonyms in the meta-data lookup. Also supports lookup of current schema using the {@code
 * sys_context}.
 *
 * <p>Thanks to Mike Youngstrom and Bruce Campbell for submitting the original suggestion for the
 * Oracle current schema lookup implementation.
 *
...
public class OracleTableMetaDataProvider extends GenericTableMetaDataProvider {
  ...
  @Override
  public void initializeWithTableColumnMetaData(
    ...
    try {
      Class<?> oracleConClass =
          con.getClass().getClassLoader().loadClass("oracle.jdbc.OracleConnection");
