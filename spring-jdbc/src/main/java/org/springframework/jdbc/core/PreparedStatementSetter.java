 ...
 *
 * <p>This interface sets values on a {@link java.sql.PreparedStatement} provided by the
 * JdbcTemplate class, for each of a number of updates in a batch using the same SQL.
 ...
 *
 * <p>It's easier to use this interface than {@link PreparedStatementCreator}: The JdbcTemplate will
 * create the PreparedStatement, with the callback only being responsible for setting parameter
 * values.
 *
