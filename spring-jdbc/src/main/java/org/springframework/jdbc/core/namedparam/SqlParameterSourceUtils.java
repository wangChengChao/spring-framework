...
/**
 * Class that provides helper methods for the use of {@link SqlParameterSource}, in particular with
...
public abstract class SqlParameterSourceUtils {
  ...
  /**
   * Create an array of {@link SqlParameterSource} objects populated with data from the values
   * passed in (either a {@link Map} or a bean object). This will define what is included in a batch
   * operation.
   *
  ...
  /**
   * Create an array of {@link MapSqlParameterSource} objects populated with data from the values
   * passed in. This will define what is included in a batch operation.
   *
   ...
   */
  public static Map<String, String> extractCaseInsensitiveParameterNames(
