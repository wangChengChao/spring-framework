...
/**
 * A SimpleJdbcInsert is a multi-threaded, reusable object providing easy insert capabilities for a
 * table. It provides meta-data processing to simplify the code needed to construct a basic insert
 ...
 * as the JDBC driver can provide the names of the columns for a specified table than we can rely on
 ...
 *
 * <p>Many of the configuration methods return the current instance of the SimpleJdbcInsert to
 * provide the ability to chain multiple ones together in a "fluent" interface style.
 *
