 ...
 *
 * <p>Parameters may be anonymous, in which case "name" is {@code null}. However, all parameters
 * must define an SQL type according to {@link java.sql.Types}.
 *
 * @author Rod Johnson
...
public class SqlParameter {
  ...
  /**
   * Return whether this parameter holds input values that should be set before execution even if
   * they are {@code null}.
   *
  ...
  /**
   * Return whether this parameter is an implicit return parameter used during the results
   * processing of {@code CallableStatement.getMoreResults/getUpdateCount}.
   *
  ...
  /**
   * Convert a list of JDBC types, as defined in {@code java.sql.Types}, to a List of SqlParameter
