...
/**
 * Factory used to create a {@link TableMetaDataProvider} implementation based on the type of
 * database being used.
 *
...
public final class TableMetaDataProviderFactory {
   ...
   */
  public static TableMetaDataProvider createMetaDataProvider(
      DataSource dataSource, TableMetaDataContext context) {
    try {
