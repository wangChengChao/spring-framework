...
/**
 * {@link SqlParameterSource} implementation that obtains parameter values from bean properties of a
...
public class BeanPropertySqlParameterSource extends AbstractSqlParameterSource {
  ...
  @Nullable private String[] propertyNames;
  ...
  /**
   * Provide access to the property names of the wrapped bean. Uses support provided in the {@link
