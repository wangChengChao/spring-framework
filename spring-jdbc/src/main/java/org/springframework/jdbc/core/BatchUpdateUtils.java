...
/**
 * Generic utility methods for working with JDBC batch statements. Mainly for internal use within
 * the framework.
 *
...
public abstract class BatchUpdateUtils {
  ...
  protected static void setStatementParameters(
      Object[] values, PreparedStatement ps, @Nullable int[] columnTypes) throws SQLException {
