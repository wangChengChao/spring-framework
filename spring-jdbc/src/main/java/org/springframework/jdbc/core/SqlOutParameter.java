...
/**
 * Subclass of {@link SqlParameter} to represent an output parameter. No additional properties:
 * instanceof will be used to check for such types.
 *
...
public class SqlOutParameter extends ResultSetSupportingSqlParameter {
  ...
  @Nullable private SqlReturnType sqlReturnType;
   ...
   */
  public SqlOutParameter(
      String name, int sqlType, @Nullable String typeName, @Nullable SqlReturnType sqlReturnType) {
    super(name, sqlType, typeName);
