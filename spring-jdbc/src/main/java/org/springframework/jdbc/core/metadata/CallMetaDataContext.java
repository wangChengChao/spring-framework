...
/**
 * Class to manage context meta-data used for the configuration and execution of a stored procedure
 * call.
 *
...
public class CallMetaDataContext {
  ...
  @Nullable private String procedureName;
  ...
  @Nullable private String actualFunctionReturnName;
  ...
  @Nullable private CallMetaDataProvider metaDataProvider;
  ...
  private CallMetaDataProvider obtainMetaDataProvider() {
    Assert.state(
        this.metaDataProvider != null, "No CallMetaDataProvider - call initializeMetaData first");
    return this.metaDataProvider;
  }

  /**
   * Create a ReturnResultSetParameter/SqlOutParameter depending on the support provided by the JDBC
   * driver used for the database in use.
   *
   * @param parameterName the name of the parameter (also used as the name of the List returned in
   *     the output)
  ...
  /**
   * Get the name of the single out parameter for this call. If there are multiple parameters, the
   * name of the first one will be returned.
   */
  @Nullable
  ...
  /**
   * Process the list of parameters provided, and if procedure column meta-data is used, the
   * parameters will be matched against the meta-data information and any missing ones will be
  ...
  protected List<SqlParameter> reconcileParameters(List<SqlParameter> parameters) {
    ...
    for (String limitedParamName : this.limitedInParameterNames) {
      limitedInParamNamesMap.put(
          lowerCase(provider.parameterNameToUse(limitedParamName)), limitedParamName);
    }
          ...
          if (param == null) {
            throw new InvalidDataAccessApiUsageException(
                "Unable to locate declared parameter for function return value - "
                    + " add an SqlOutParameter with name '"
