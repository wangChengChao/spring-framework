...
/**
 * Interface specifying the API to be implemented by a class providing table meta-data. This is
...
public interface TableMetaDataProvider {
  ...
  /**
   * Initialize using provided database meta-data, table and column information. This initialization
  ...
  /**
   * Get the table name formatted based on meta-data information. This could include altering the
   * case.
   */
  @Nullable
  ...
  /**
   * Get the catalog name formatted based on meta-data information. This could include altering the
   * case.
   */
  @Nullable
  ...
  /**
   * Get the schema name formatted based on meta-data information. This could include altering the
   * case.
   */
  @Nullable
  ...
  /**
   * Does this database support a simple query to retrieve the generated key when the JDBC 3.0
   * feature of retrieving generated keys is not supported?
   *
  ...
  /**
   * Does this database support a column name String array for retrieving generated keys: {@link
