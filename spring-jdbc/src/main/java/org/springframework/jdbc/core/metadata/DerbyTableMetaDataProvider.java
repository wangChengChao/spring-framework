...
/**
 * The Derby specific implementation of {@link TableMetaDataProvider}. Overrides the Derby meta-data
 * info regarding retrieving generated keys.
 *
  ...
  public void initializeWithMetaData(DatabaseMetaData databaseMetaData) throws SQLException {
    ...
    if (!databaseMetaData.supportsGetGeneratedKeys()) {
      if (logger.isInfoEnabled()) {
        logger.info(
            "Overriding supportsGetGeneratedKeys from DatabaseMetaData to 'true'; it was reported as "
                + "'false' by "
