 ...
 *
 * <p>This is intended for internal use by Spring's {@link
...
public interface CallMetaDataProvider {
  ...
  /**
   * Initialize the database specific management of procedure column meta-data. This is only called
   * for databases that are supported. This initialization can be turned off by specifying that
   * column meta-data should not be used.
   *
   * @param databaseMetaData used to retrieve database specific information
  ...
  /**
   * Create a default out parameter based on the provided meta-data. This is used when no explicit
  ...
  /**
   * Create a default inout parameter based on the provided meta-data. This is used when no explicit
   * parameter declaration has been made.
   *
   * @param parameterName the name of the parameter
   * @param meta meta-data used for this call
  ...
  /**
   * Create a default in parameter based on the provided meta-data. This is used when no explicit
   * parameter declaration has been made.
   *
   * @param parameterName the name of the parameter
   * @param meta meta-data used for this call
  ...
  /**
   * Does this database support returning ResultSets as ref cursors to be retrieved with {@link
   * java.sql.CallableStatement#getObject(int)} for the specified column.
   */
  boolean isRefCursorSupported();

  /**
   * Get the {@link java.sql.Types} type for columns that return ResultSets as ref cursors if this
  ...
  /**
   * Should we bypass the return parameter with the specified name. This allows the database
   * specific implementation to skip the processing for specific results returned by the database
   * call.
   */
