...
public class ParsedSql {
  ...
  /**
   * Return all of the parameters (bind variables) in the parsed SQL statement. Repeated occurrences
   * of the same parameter name are included here.
   */
  ...
  /**
   * Set the count of named parameters in the SQL statement. Each parameter name counts once;
   * repeated occurrences do not count here.
   */
  ...
  /**
   * Return the count of named parameters in the SQL statement. Each parameter name counts once;
   * repeated occurrences do not count here.
   */
  ...
  /**
   * Set the total count of all of the parameters in the SQL statement. Repeated occurrences of the
   * same parameter name do count here.
   */
  ...
  /**
   * Return the total count of all of the parameters in the SQL statement. Repeated occurrences of
   * the same parameter name do count here.
   */
