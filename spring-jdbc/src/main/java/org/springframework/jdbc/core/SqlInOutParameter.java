...
/**
 * Subclass of {@link SqlOutParameter} to represent an INOUT parameter. Will return {@code true} for
 * SqlParameter's {@link #isInputValueProvided} test, in contrast to a standard SqlOutParameter.
 *
