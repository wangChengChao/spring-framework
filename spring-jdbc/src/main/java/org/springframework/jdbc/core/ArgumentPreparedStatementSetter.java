...
public class ArgumentPreparedStatementSetter implements PreparedStatementSetter, ParameterDisposer {
  ...
  /**
   * Set the value for prepared statements specified parameter index using the passed in value. This
   * method can be overridden by sub-classes if needed.
   *
  ...
  protected void doSetValue(PreparedStatement ps, int parameterPosition, Object argValue)
    ...
    if (argValue instanceof SqlParameterValue) {
      ...
      StatementCreatorUtils.setParameterValue(
          ps, parameterPosition, paramValue, paramValue.getValue());
    } else {
      StatementCreatorUtils.setParameterValue(
          ps, parameterPosition, SqlTypeValue.TYPE_UNKNOWN, argValue);
    }
  }
