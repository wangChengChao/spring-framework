 ...
 * This interface is not often used directly, but provides the option to enhance testability, as it
...
public interface SimpleJdbcInsertOperations {
   ...
   *
   * <p>Note: This is only necessary to include for Oracle since other databases supporting synonyms
   * seems to include the synonyms automatically.
   *
   * @return the instance of this SimpleJdbcInsert
   */
   ...
   * This method will always return a KeyHolder but the caller must verify that it actually contains
   * the generated keys.
   *
   * @param args a Map containing column names and corresponding value
