...
/**
 * Common base class for ResultSet-supporting SqlParameters like {@link SqlOutParameter} and {@link
 * SqlReturnResultSet}.
 *
...
public class ResultSetSupportingSqlParameter extends SqlParameter {
  ...
  @Nullable private ResultSetExtractor<?> resultSetExtractor;

  @Nullable private RowCallbackHandler rowCallbackHandler;

  @Nullable private RowMapper<?> rowMapper;
