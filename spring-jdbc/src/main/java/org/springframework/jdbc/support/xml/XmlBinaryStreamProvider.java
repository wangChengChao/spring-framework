...
/**
 * Interface defining handling involved with providing {@code OutputStream} data for XML input.
 *
...
public interface XmlBinaryStreamProvider {
  ...
  /**
   * Implementations must implement this method to provide the XML content for the {@code
   * OutputStream}.
   *
