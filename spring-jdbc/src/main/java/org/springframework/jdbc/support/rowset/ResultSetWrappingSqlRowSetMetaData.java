...
/**
 * The default implementation of Spring's {@link SqlRowSetMetaData} interface, wrapping a {@link
 * java.sql.ResultSetMetaData} instance, catching any {@link SQLException SQLExceptions} and
...
public class ResultSetWrappingSqlRowSetMetaData implements SqlRowSetMetaData {
  ...
  /**
   * Create a new ResultSetWrappingSqlRowSetMetaData object for the given ResultSetMetaData
   * instance.
   *
   * @param resultSetMetaData a disconnected ResultSetMetaData instance to wrap (usually a {@code
