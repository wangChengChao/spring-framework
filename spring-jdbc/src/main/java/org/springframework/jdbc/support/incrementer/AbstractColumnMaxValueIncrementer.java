...
/**
 * Abstract base class for {@link DataFieldMaxValueIncrementer} implementations that use a column in
 * a custom sequence table. Subclasses need to provide the specific handling of that table in their
 * {@link #getNextKey()} implementation.
 *
