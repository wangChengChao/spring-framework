...
/**
 * {@link DataFieldMaxValueIncrementer} that increments the maximum value of a given HSQL table with
 * the equivalent of an auto-increment column. Note: If you use this class, your HSQL key column
 * should <i>NOT</i> be auto-increment, as the sequence table does the job.
 *
 ...
 * cacheSize.
 *
 * <p><b>NOTE:</b> HSQL now supports sequences and you should consider using them instead: {@link
