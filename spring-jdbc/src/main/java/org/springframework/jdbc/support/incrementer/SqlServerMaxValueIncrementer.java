...
/**
 * {@link DataFieldMaxValueIncrementer} that increments the maximum value of a given SQL Server
 * table with the equivalent of an auto-increment column. Note: If you use this class, your table
 * key column should <i>NOT</i> be defined as an IDENTITY column, as the sequence table does the
 * job.
 *
 ...
 * cacheSize.
 *
 * <p><b>HINT:</b> Since Microsoft SQL Server supports the JDBC 3.0 {@code getGeneratedKeys} method,
 * it is recommended to use IDENTITY columns directly in the tables and then using a {@link
