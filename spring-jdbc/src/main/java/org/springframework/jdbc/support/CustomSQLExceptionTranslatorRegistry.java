...
/**
 * Registry for custom {@link org.springframework.jdbc.support.SQLExceptionTranslator} instances
 * associated with specific databases allowing for overriding translation based on values contained
 * in the configuration file named "sql-error-codes.xml".
 *
...
public final class CustomSQLExceptionTranslatorRegistry {
  ...
  private static final CustomSQLExceptionTranslatorRegistry instance =
      new CustomSQLExceptionTranslatorRegistry();
  ...
  public void registerTranslator(String dbName, SQLExceptionTranslator translator) {
    ...
    if (logger.isDebugEnabled()) {
      if (replaced != null) {
        ...
        logger.debug(
            "Adding custom translator of type ["
