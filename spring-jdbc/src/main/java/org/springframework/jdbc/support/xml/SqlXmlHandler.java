...
/**
 * Abstraction for handling XML fields in specific databases. Its main purpose is to isolate
 * database-specific handling of XML stored in the database.
 *
 * <p>JDBC 4.0 introduces the new data type {@code java.sql.SQLXML} but most databases and their
 * drivers currently rely on database-specific data types and features.
 *
 * <p>Provides accessor methods for XML fields and acts as factory for {@link SqlXmlValue}
 * instances.
 *
...
public interface SqlXmlHandler {
   ...
   *
   * <p>Might simply invoke {@code ResultSet.getString} or work with {@code SQLXML} or
   * database-specific classes depending on the database and driver.
   *
   ...
   *
   * <p>Might simply invoke {@code ResultSet.getAsciiStream} or work with {@code SQLXML} or
   * database-specific classes depending on the database and driver.
   *
   * @param rs the ResultSet to retrieve the content from
   * @param columnName the column name to use
   ...
   *
   * <p>Might simply invoke {@code ResultSet.getCharacterStream} or work with {@code SQLXML} or
   * database-specific classes depending on the database and driver.
   *
   * @param rs the ResultSet to retrieve the content from
   * @param columnName the column name to use
  ...
  /**
   * Retrieve the given column as Source implemented using the specified source class from the given
   * ResultSet.
   *
   * <p>Might work with {@code SQLXML} or database-specific classes depending on the database and
   * driver.
   *
   * @param rs the ResultSet to retrieve the content from
   * @param columnName the column name to use
  ...
  /**
   * Create a {@code SqlXmlValue} instance for the given XML data, as supported by the underlying
   * JDBC driver.
   *
