...
/**
 * Simple JDBC {@link Blob} adapter that exposes a given byte array or binary stream. Optionally
 * used by {@link DefaultLobHandler}.
 *
...
class PassThroughBlob implements Blob {
  ...
  @Nullable private InputStream binaryStream;
