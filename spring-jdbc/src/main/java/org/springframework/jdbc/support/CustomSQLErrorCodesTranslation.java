 ...
 * "exceptionClass" property defines which exception will be thrown for the list of error codes
 * specified in the errorCodes property.
 *
...
public class CustomSQLErrorCodesTranslation {
  ...
  @Nullable private Class<?> exceptionClass;
