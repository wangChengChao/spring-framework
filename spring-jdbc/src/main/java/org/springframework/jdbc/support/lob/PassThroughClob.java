...
/**
 * Simple JDBC {@link Clob} adapter that exposes a given String or character stream. Optionally used
 * by {@link DefaultLobHandler}.
 *
...
class PassThroughClob implements Clob {
  ...
  @Nullable private Reader characterStream;

  @Nullable private InputStream asciiStream;
