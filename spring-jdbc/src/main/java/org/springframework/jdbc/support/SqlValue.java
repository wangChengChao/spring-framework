 ...
 * callback method {@code setValue} which can throw SQLExceptions that will be caught and translated
 * by the calling code. This callback method has access to the underlying Connection via the given
 * PreparedStatement object, if that should be needed to create any database-specific objects.
 *
