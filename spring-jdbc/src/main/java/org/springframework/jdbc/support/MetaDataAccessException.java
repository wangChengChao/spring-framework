 ...
 *
 * <p>This is a checked exception since we want it to be caught, logged and handled rather than
 * cause the application to fail. Failure to read JDBC meta-data is usually not a fatal problem.
 *
