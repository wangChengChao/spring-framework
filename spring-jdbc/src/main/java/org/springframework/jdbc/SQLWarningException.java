 ...
 *
 * <p>If an SQLWarning is reported, the operation completed, so we will need to explicitly roll it
 * back if we're not happy when looking at the warning. We might choose to ignore (and log) the
 * warning, or to wrap and throw it in the shape of this SQLWarningException instead.
 *
 * @author Rod Johnson
