...
public class GenericSqlQuery<T> extends SqlQuery<T> {
  ...
  @Nullable private RowMapper<T> rowMapper;
  ...
  /**
   * Set a {@link RowMapper} class for this query, creating a fresh {@link RowMapper} instance per
   * execution.
   */
  @SuppressWarnings("rawtypes")
  ...
  public void afterPropertiesSet() {
    ...
    Assert.isTrue(
        this.rowMapper != null || this.rowMapperClass != null,
