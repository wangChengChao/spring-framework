 ...
 * embedded-database} element and creates a {@link BeanDefinition} for an {@link
 * EmbeddedDatabaseFactoryBean}.
 *
 * <p>Picks up nested {@code script} elements and configures a {@link ResourceDatabasePopulator} for
 * each of them.
 *
...
class EmbeddedDatabaseBeanDefinitionParser extends AbstractBeanDefinitionParser {
  ...
  protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
    BeanDefinitionBuilder builder =
        BeanDefinitionBuilder.rootBeanDefinition(EmbeddedDatabaseFactoryBean.class);
