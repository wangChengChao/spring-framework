...
/**
 * {@code EmbeddedDatabaseConfigurer} encapsulates the configuration required to create, connect to,
 * and shut down a specific type of embedded database such as HSQL, H2, or Derby.
 *
 * @author Keith Donald
 * @author Sam Brannen
 * @since 3.0
