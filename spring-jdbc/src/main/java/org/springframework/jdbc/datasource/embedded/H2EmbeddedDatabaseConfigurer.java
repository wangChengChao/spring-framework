...
final class H2EmbeddedDatabaseConfigurer extends AbstractEmbeddedDatabaseConfigurer {
  ...
  @Nullable private static H2EmbeddedDatabaseConfigurer instance;
  ...
  public static synchronized H2EmbeddedDatabaseConfigurer getInstance()
    ...
    if (instance == null) {
      instance =
          new H2EmbeddedDatabaseConfigurer(
              (Class<? extends Driver>)
                  ClassUtils.forName(
                      "org.h2.Driver", H2EmbeddedDatabaseConfigurer.class.getClassLoader()));
    }
    return instance;
  }
