...
/**
 * Abstract base class for JDBC {@link javax.sql.DataSource} implementations that operate on a JDBC
...
public abstract class AbstractDriverBasedDataSource extends AbstractDataSource {
  ...
  @Nullable private Properties connectionProperties;
   ...
   *
   * <p>Can also contain "user" and "password" properties. However, any "username" and "password"
   * bean properties specified on this DataSource will override the corresponding connection
   * properties.
   *
   * @see java.sql.Driver#connect(String, java.util.Properties)
   */
  ...
  /**
   * This implementation delegates to {@code getConnectionFromDriver}, using the default username
  ...
  /**
   * This implementation delegates to {@code getConnectionFromDriver}, using the given username and
   * password.
   *
   * @see #getConnectionFromDriver(String, String)
   */
  ...
  /**
   * Build properties for the Driver, including the given username and password (if any), and obtain
   ...
   * @see java.sql.Driver#connect(String, java.util.Properties)
   */
  protected Connection getConnectionFromDriver(@Nullable String username, @Nullable String password)
      throws SQLException {
