 ...
 *
 * <p>Useful for testing environments or applications that need to match arbitrary {@link String}
 * names to target {@link DataSource} objects.
 *
 * @author Costin Leau
...
public class MapDataSourceLookup implements DataSourceLookup {
   ...
   * Create a new instance of the {@link MapDataSourceLookup} class.
   *
   * @param dataSources the {@link Map} of {@link DataSource DataSources}; the keys are {@link
   *     String Strings}, the values are actual {@link DataSource} instances.
   */
  ...
  /**
   * Set the {@link Map} of {@link DataSource DataSources}; the keys are {@link String Strings}, the
   * values are actual {@link DataSource} instances.
   *
   * <p>If the supplied {@link Map} is {@code null}, then this method call effectively has no
   * effect.
   *
  ...
  /**
   * Add the supplied {@link DataSource} to the map of {@link DataSource DataSources} maintained by
   * this object.
   *
   * @param dataSourceName the name under which the supplied {@link DataSource} is to be added
