...
/**
 * Exception to be thrown by a DataSourceLookup implementation, indicating that the specified
 * DataSource could not be obtained.
 *
...
public class DataSourceLookupFailureException extends NonTransientDataAccessException {
   ...
   *
   * @param msg the detail message
   * @param cause the root cause (usually from using a underlying lookup API such as JNDI)
   */
