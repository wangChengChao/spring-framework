...
/**
 * Provide the list of stereotypes that match an {@link Element}. If an element has one more
 * stereotypes, it is referenced in the index of candidate components and each stereotype can be
