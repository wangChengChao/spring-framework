...
/**
 * A {@link StereotypesProvider} implementation that extracts the stereotypes flagged by the {@value
 * INDEXED_ANNOTATION} annotation. This implementation honors stereotypes defined this way on
 * meta-annotations.
 *
...
class IndexedStereotypesProvider implements StereotypesProvider {
  ...
  private void collectStereotypesOnAnnotations(
  ...
  private Element collectStereotypes(
      Set<Element> seen, Set<String> stereotypes, Element element, AnnotationMirror annotation) {
