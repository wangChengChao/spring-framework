 ...
 *
 * <p>Will lookup Spring managed beans identified by bean name, expecting them to be of type {@code
...
public class BeanFactoryDestinationResolver implements DestinationResolver, BeanFactoryAware {
   ...
   * Create a new instance of the {@link BeanFactoryDestinationResolver} class.
   *
   * <p>Use of this constructor is redundant if this object is being created by a Spring IoC
   * container, as the supplied {@link BeanFactory} will be replaced by the {@link BeanFactory} that
   * creates it (c.f. the {@link BeanFactoryAware} contract). So only use this constructor if you
   * are using this class outside the context of a Spring IoC container.
   *
   * @param beanFactory the bean factory to be used to lookup {@link javax.jms.Destination
   *     Destination}
   */
