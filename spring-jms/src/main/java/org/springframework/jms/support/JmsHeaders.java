...
/**
 * Pre-defined names and prefixes to be used for setting and/or retrieving JMS attributes from/to
...
public interface JmsHeaders {
  ...
  /**
   * Prefix used for JMS API related headers in order to distinguish from user-defined headers and
   * other internal headers (e.g. correlationId).
   *
  ...
  /**
   * Correlation ID for the message. This may be the {@link #MESSAGE_ID} of the message that this
   * message replies to. It may also be an application-specific identifier.
   *
  ...
  /**
   * Specify if the message was resent. This occurs when a message consumer fails to acknowledge the
   * message reception.
   *
   * <p>Read-only value.
   *
