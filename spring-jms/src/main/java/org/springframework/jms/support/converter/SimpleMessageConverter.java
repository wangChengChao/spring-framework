...
/**
 * A simple message converter which is able to handle TextMessages, BytesMessages, MapMessages, and
 * ObjectMessages. Used as default conversion strategy by {@link
 * org.springframework.jms.core.JmsTemplate}, for {@code convertAndSend} and {@code
 * receiveAndConvert} operations.
 *
 * <p>Converts a String to a {@link javax.jms.TextMessage}, a byte array to a {@link
 * javax.jms.BytesMessage}, a Map to a {@link javax.jms.MapMessage}, and a Serializable object to a
 * {@link javax.jms.ObjectMessage} (or vice versa).
 *
...
public class SimpleMessageConverter implements MessageConverter {
   ...
   * MapMessage for a Map, and an ObjectMessage for a Serializable object.
   *
  ...
  /**
   * This implementation converts a TextMessage back to a String, a ByteMessage back to a byte
   * array, a MapMessage back to a Map, and an ObjectMessage back to a Serializable object. Returns
      ...
      if (!(key instanceof String)) {
        throw new MessageConversionException(
            "Cannot convert non-String key of type ["
                + ObjectUtils.nullSafeClassName(key)
