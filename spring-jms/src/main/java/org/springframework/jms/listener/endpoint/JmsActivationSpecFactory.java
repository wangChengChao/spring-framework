...
/**
 * Strategy interface for creating JCA 1.5 ActivationSpec objects based on a configured {@link
 * JmsActivationSpecConfig} object.
 *
 * <p>JCA 1.5 ActivationSpec objects are typically JavaBeans, but unfortunately provider-specific.
 * This strategy interface allows for plugging in any JCA-based JMS provider, creating corresponding
...
public interface JmsActivationSpecFactory {
  ...
  /**
   * Create a JCA 1.5 ActivationSpec object based on the given {@link JmsActivationSpecConfig}
   * object.
   *
   ...
   * @return the provider-specific JCA ActivationSpec object, representing the same settings
   */
