...
public abstract class JmsException extends NestedRuntimeException {
   ...
   *
   * @param msg the detail message
   * @param cause the cause of the exception. This argument is generally expected to be a proper
   *     subclass of {@link javax.jms.JMSException}, but can also be a JNDI NamingException or the
   *     like.
   */
   ...
   * {@code javax.jms} exceptions.
   *
   * @param cause the cause of the exception. This argument is generally expected to be a proper
   *     subclass of {@link javax.jms.JMSException}.
   */
  ...
  /**
   * Convenience method to get the vendor specific error code if the root cause was an instance of
   * JMSException.
   *
   * @return a string specifying the vendor-specific error code if the root cause is an instance of
   *     JMSException, or {@code null}
   */
  @Nullable
    ...
    if (cause instanceof JMSException) {
      ...
      if (linkedEx != null) {
        ...
        if (linkedMessage != null
            && (causeMessage == null || !causeMessage.contains(linkedMessage))) {
