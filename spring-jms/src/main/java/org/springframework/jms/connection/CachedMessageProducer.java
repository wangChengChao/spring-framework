...
/**
 * JMS MessageProducer decorator that adapts calls to a shared MessageProducer instance underneath,
 * managing QoS settings locally within the decorator.
 *
...
class CachedMessageProducer implements MessageProducer, QueueSender, TopicPublisher {
  ...
  @Nullable private Boolean originalDisableMessageID;

  @Nullable private Boolean originalDisableMessageTimestamp;

  @Nullable private Long originalDeliveryDelay;
  ...
  public void send(Message message, CompletionListener completionListener) throws JMSException {
    this.target.send(
        message, this.deliveryMode, this.priority, this.timeToLive, completionListener);
  }
