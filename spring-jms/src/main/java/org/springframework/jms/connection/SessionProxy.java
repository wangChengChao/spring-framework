...
/**
 * Subinterface of {@link javax.jms.Session} to be implemented by Session proxies. Allows access to
 * the underlying target Session.
 *
...
public interface SessionProxy extends Session {
   ...
   *
   * <p>This will typically be the native provider Session or a wrapper from a session pool.
   *
