...
/**
 * A {@link JmsListenerContainerFactory} implementation to build a regular {@link
 * DefaultMessageListenerContainer}.
 *
 * <p>This should be the default for most users and a good transition paths for those that are used
 * to build such container definition manually.
 *
...
public class DefaultJmsListenerContainerFactory
  ...
  @Nullable private Integer cacheLevel;

  @Nullable private String cacheLevelName;

  @Nullable private String concurrency;

  @Nullable private Integer maxMessagesPerTask;

  @Nullable private Long receiveTimeout;

  @Nullable private Long recoveryInterval;

  @Nullable private BackOff backOff;
