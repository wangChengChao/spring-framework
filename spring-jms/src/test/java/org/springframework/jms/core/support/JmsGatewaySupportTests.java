...
public class JmsGatewaySupportTests {
  ...
  public void testJmsGatewaySupportWithConnectionFactory() throws Exception {
    ...
    assertThat(gateway.getConnectionFactory())
        .as("Correct ConnectionFactory")
        .isEqualTo(mockConnectionFactory);
    assertThat(gateway.getJmsTemplate().getConnectionFactory())
        .as("Correct JmsTemplate")
        .isEqualTo(mockConnectionFactory);
