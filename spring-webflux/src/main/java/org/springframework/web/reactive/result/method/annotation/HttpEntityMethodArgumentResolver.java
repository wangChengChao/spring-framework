...
/**
 * Resolves method arguments of type {@link HttpEntity} or {@link RequestEntity} by reading the body
 * of the request through a compatible {@code HttpMessageReader}.
 *
...
public class HttpEntityMethodArgumentResolver extends AbstractMessageReaderArgumentResolver {
  ...
  public HttpEntityMethodArgumentResolver(
  ...
  public boolean supportsParameter(MethodParameter parameter) {
    return checkParameterTypeNoReactiveWrapper(
        parameter, type -> HttpEntity.class.equals(type) || RequestEntity.class.equals(type));
  }
  ...
  private Object createEntity(
      @Nullable Object body, Class<?> entityType, ServerHttpRequest request) {
