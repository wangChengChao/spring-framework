...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
  ...
  /**
   * Returns the URL patterns of this {@link RequestMappingInfo}; or instance with 0 patterns, never
   * {@code null}.
   */
  ...
  /**
   * Returns the HTTP request methods of this {@link RequestMappingInfo}; or instance with 0 request
  ...
  /**
   * Returns the "parameters" condition of this {@link RequestMappingInfo}; or instance with 0
  ...
  /**
   * Returns the "headers" condition of this {@link RequestMappingInfo}; or instance with 0 header
  ...
  /**
   * Returns the "consumes" condition of this {@link RequestMappingInfo}; or instance with 0
   * consumes expressions, never {@code null}.
   */
  ...
  /**
   * Returns the "produces" condition of this {@link RequestMappingInfo}; or instance with 0
   * produces expressions, never {@code null}.
   */
   ...
   * #getMatchingCondition(ServerWebExchange)} to ensure they have conditions with content relevant
   * to current request.
   */
  @Override
  ...
  private static class DefaultBuilder implements Builder {
    ...
    public RequestMappingInfo build() {
      ...
      PathPatternParser parser =
          (this.options.getPatternParser() != null
              ? this.options.getPatternParser()
              : new PathPatternParser());
      PatternsRequestCondition patternsCondition =
          new PatternsRequestCondition(parse(this.paths, parser));
  ...
  public static class BuilderConfiguration {
    ...
    @Nullable private PathPatternParser patternParser;

    @Nullable private RequestedContentTypeResolver contentTypeResolver;
