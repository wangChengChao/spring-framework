...
/**
 * Context holder for request-specific state, like the {@link MessageSource} to use, current locale,
 * binding errors, etc. Provides easy access to localized messages and Errors instances.
 *
 * <p>Suitable for exposition to views, and usage within FreeMarker templates and tag libraries.
 *
 * <p>Can be instantiated manually or automatically exposed to views as a model attribute via
...
public class RequestContext {
  ...
  @Nullable private RequestDataValueProcessor dataValueProcessor;

  public RequestContext(
      ServerWebExchange exchange, Map<String, Object> model, MessageSource messageSource) {
  ...
  /**
   * Return the {@link RequestDataValueProcessor} instance to apply to in form tag libraries and to
   * redirect URLs.
   */
  @Nullable
  ...
  /**
   * Return the context path of the current web application. This is useful for building links to
   * other resources within the application.
   *
   ...
   * @return a URL that points back to the current web application with an absolute path also
  ...
  /**
   * Return a context-aware URl for the given relative URL with placeholders -- named keys with
   * braces {@code {}}. For example, send in a relative URL {@code foo/{bar}?spam={spam}} and a
   * parameter map {@code {bar=baz,spam=nuts}} and the result will be {@code
  ...
  /**
   * Return the request path of the request. This is useful as HTML form action target, also in
   * combination with the original query string.
   */
  ...
  /**
   * Return the query string of the current request. This is useful for building an HTML form action
   * target in combination with the original request path.
   */
