...
public class HandlerResult {
   ...
   * controller method's signature. Also see {@link #getReturnTypeSource()} to obtain the underlying
  ...
  /**
   * Return the {@link MethodParameter} from which {@link #getReturnType() returnType} was created.
   */
