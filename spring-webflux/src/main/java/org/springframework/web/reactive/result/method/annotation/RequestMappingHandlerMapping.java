...
/**
 * An extension of {@link RequestMappingInfoHandlerMapping} that creates {@link RequestMappingInfo}
 * instances from class-level and method-level {@link RequestMapping @RequestMapping} annotations.
 *
...
public class RequestMappingHandlerMapping extends RequestMappingInfoHandlerMapping
   ...
   * controller type is matched by a corresponding {@code Predicate} in the map. The prefix for the
   * first matching predicate is used, assuming the input map has predictable order.
   *
  ...
  /**
   * Set the {@link RequestedContentTypeResolver} to use to determine requested media types. If not
  ...
  /** {@inheritDoc} Expects a handler to have a type-level @{@link Controller} annotation. */
  @Override
   ...
   *
   * <p>Consider extending {@link
   * org.springframework.web.reactive.result.condition.AbstractRequestCondition
   * AbstractRequestCondition} for custom condition types and using {@link
