...
/**
 * Implementation of the {@link org.springframework.web.reactive.HandlerMapping} interface to map
 ...
 *
 * <p>The "urlMap" property is suitable for populating the handler map with bean instances. Mappings
 * to bean names can be set via the "mappings" property, in a form accepted by the {@code
 * java.util.Properties} class, as follows:
 *
 * <pre class="code">
 * /welcome.html=ticketController
 * /show.html=ticketController</pre>
 *
 * <p>The syntax is {@code PATH=HANDLER_BEAN_NAME}. If the path doesn't begin with a slash, one is
 * prepended.
 *
 ...
 * matches all paths under "/test", "/test/**" matches all paths below "/test". For details, see the
...
public class SimpleUrlHandlerMapping extends AbstractUrlHandlerMapping {
   ...
   *
   * @param urlMap map with URL paths as keys and handler beans (or handler bean names) as values
   * @since 5.2
   * @see #setUrlMap(Map)
   */
   ...
   *
   * <p>Useful for specifying entries directly, for example via "urlMap[myKey]". This is
