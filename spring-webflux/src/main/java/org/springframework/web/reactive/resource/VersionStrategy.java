...
/**
 * A strategy to determine the version of a static resource and to apply and/or extract it from the
 * URL path.
 *
...
public interface VersionStrategy {
  ...
  /**
   * Remove the version from the request path. It is assumed that the given version was extracted
   * via {@link #extractVersion(String)}.
   *
