 ...
 *
 * <p>To create an instance, see the static methods {@link #withDefaults()}, {@link #builder()}, and
 * {@link #empty()}.
 *
 * @author Brian Clozel
...
public interface ExchangeStrategies {
  ...
  /**
   * Return an {@code ExchangeStrategies} instance with default configuration provided by {@link
  ...
  /**
   * Return a builder pre-configured with default configuration to start. This is the same as {@link
   * #withDefaults()} but returns a mutable builder for further customizations.
   */
