...
public final class ProducesRequestCondition
  ...
  public ProducesRequestCondition(
      String[] produces, String[] headers, RequestedContentTypeResolver resolver) {
    ...
    if (headers != null) {
      for (String header : headers) {
        HeadersRequestCondition.HeaderExpression expr =
            new HeadersRequestCondition.HeaderExpression(header);
   ...
   * #getMatchingCondition(ServerWebExchange)} and each instance contains the matching producible
  ...
  class ProduceMediaTypeExpression extends AbstractMediaTypeExpression {
    ...
    @Override
    protected boolean matchMediaType(ServerWebExchange exchange)
        throws NotAcceptableStatusException {
      List<MediaType> acceptedMediaTypes = getAcceptedMediaTypes(exchange);
      for (MediaType acceptedMediaType : acceptedMediaTypes) {
