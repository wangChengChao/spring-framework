...
/**
 * Represents a typed, immutable, client-side HTTP request, as executed by the {@link
 * ExchangeFunction}. Instances of this interface can be created via static builder methods.
 *
 * <p>Note that applications are more likely to perform requests through {@link WebClient} rather
...
public interface ClientRequest {
  ...
  /**
   * Name of {@link #attributes() attribute} whose value can be used to correlate log messages for
   * this request. Use {@link #logPrefix()} to obtain a consistently formatted prefix based on this
   * attribute.
   *
   * @since 5.1
   * @see #logPrefix()
  ...
  /**
   * Return a log message prefix to use to correlate messages for this request. The prefix is based
  ...
  interface Builder {
    ...
    /**
     * Manipulate this request's headers with the given consumer. The headers provided to the
     ...
     * @return the built request
     */
    <S, P extends Publisher<S>> Builder body(
