...
public class UnsupportedMediaTypeException extends NestedRuntimeException {
  ...
  public UnsupportedMediaTypeException(
      @Nullable MediaType contentType, List<MediaType> supportedTypes) {
  ...
  private static String initReason(
      @Nullable MediaType contentType, @Nullable ResolvableType bodyType) {
    return "Content type '"
  ...
  /**
   * Return the request Content-Type header if it was parsed successfully, or {@code null}
   * otherwise.
   */
  @Nullable
  ...
  /**
   * Return the list of supported content types in cases when the Content-Type header is parsed but
  ...
  /**
   * Return the body type in the context of which this exception was generated. This is applicable
   * when the exception was raised as a result trying to encode from or decode to a specific Java
   * type.
   *
