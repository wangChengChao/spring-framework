 ...
 *
 * <p>A {@link ConversionService} is invoked to apply type conversion to resolved request header
...
public class RequestHeaderMethodArgumentResolver extends AbstractNamedValueSyncArgumentResolver {
  ...
  protected void handleMissingValue(String name, MethodParameter parameter) {
    ...
    throw new ServerWebInputException(
        "Missing request header '" + name + "' " + "for method parameter of type " + type,
        parameter);
  }
