...
/**
 * A {@link ResourceResolver} that resolves resources from a {@link Cache} or otherwise delegates to
 * the resolver chain and caches the result.
 *
...
public class CachingResourceResolver extends AbstractResourceResolver {
  ...
  protected Mono<String> resolveUrlPathInternal(
    ...
    return chain
        .resolveUrlPath(resourceUrlPath, locations)
