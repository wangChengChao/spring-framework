...
/**
 * A {@link ResourceTransformer} that checks a {@link Cache} to see if a previously transformed
 * resource exists in the cache and returns it if found, or otherwise delegates to the resolver
...
public class CachingResourceTransformer implements ResourceTransformer {
  ...
  public Mono<Resource> transform(
      ServerWebExchange exchange, Resource resource, ResourceTransformerChain transformerChain) {
