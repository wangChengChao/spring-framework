 ...
 * find a variation with the ".gz" extension.
 *
 * <p>The resolver gets involved only if the "Accept-Encoding" request header contains the value
 * "gzip" indicating the client accepts gzipped responses.
 *
...
public class GzipResourceResolver extends AbstractResourceResolver {
  ...
  static final class GzippedResource extends AbstractResource implements HttpResource {
    ...
    public HttpHeaders getResponseHeaders() {
      HttpHeaders headers =
          (this.original instanceof HttpResource
              ? ((HttpResource) this.original).getResponseHeaders()
              : new HttpHeaders());
