...
/**
 * Assist with the configuration of a chain of {@link ViewResolver}'s supporting different template
 * mechanisms.
 *
 * <p>In addition, you can also configure {@link #defaultViews(View...) defaultViews} for rendering
 * according to the requested content type, e.g. JSON, XML, etc.
 *
...
public class ViewResolverRegistry {
   ...
   *
   * <p><strong>Note</strong> that you must also configure script templating by adding a {@link
  ...
  /**
   * Register a {@link ViewResolver} bean instance. This may be useful to configure a 3rd party
   * resolver implementation or as an alternative to other registration methods in this class when
  ...
  /**
   * Set default views associated with any view name and selected based on the best match for the
   * requested content type.
   *
   * <p>Use {@link HttpMessageWriterView HttpMessageWriterView} to adapt and use any existing {@code
   * HttpMessageWriter} (e.g. JSON, XML) as a {@code View}.
   */
  ...
  /**
   * Set the order for the {@link
   * org.springframework.web.reactive.result.view.ViewResolutionResultHandler
   * ViewResolutionResultHandler}.
   *
   * <p>By default this property is not set, which means the result handler is ordered at {@link
