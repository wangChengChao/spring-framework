...
public abstract class ExchangeFunctions {
  ...
  /**
   * Create an {@code ExchangeFunction} with the given {@code ClientHttpConnector}. This is the same
   * as calling {@link #create(ClientHttpConnector, ExchangeStrategies)} and passing {@link
  ...
  /**
   * Create an {@code ExchangeFunction} with the given {@code ClientHttpConnector} and {@code
   * ExchangeStrategies}.
   *
   * @param connector the connector to use for connecting to servers
   ...
   * @return the created {@code ExchangeFunction}
   */
  public static ExchangeFunction create(
      ClientHttpConnector connector, ExchangeStrategies strategies) {
  ...
  private static class DefaultExchangeFunction implements ExchangeFunction {
    ...
    public Mono<ClientResponse> exchange(ClientRequest clientRequest) {
      ...
      return this.connector
          .connect(
              httpMethod, url, httpRequest -> clientRequest.writeTo(httpRequest, this.strategies))
