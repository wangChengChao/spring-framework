...
/**
 * Interface to be implemented by objects that configure and manage a JSR-223 {@link ScriptEngine}
 * for automatic lookup in a web environment. Detected and used by {@link ScriptTemplateView}.
 *
...
public interface ScriptTemplateConfig {
  ...
  /**
   * Return whether to use a shared engine for all threads or whether to create thread-local engine
  ...
  /**
   * Return the render function name (optional). If not specified, the script templates will be
