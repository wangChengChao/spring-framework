...
/**
 * {@link HandlerAdapter} that allows using a {@link WebSocketHandler} with the generic {@link
 * DispatcherHandler} mapping URLs directly to such handlers. Requests are handled by delegating to
 * the configured {@link WebSocketService} which by default is {@link HandshakeWebSocketService}.
 *
