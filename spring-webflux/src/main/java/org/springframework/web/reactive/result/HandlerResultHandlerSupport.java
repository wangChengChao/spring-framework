...
/**
 * Base class for {@link org.springframework.web.reactive.HandlerResultHandler HandlerResultHandler}
 * with support for content negotiation and access to a {@code ReactiveAdapter} registry.
 *
...
public abstract class HandlerResultHandlerSupport implements Ordered {
  ...
  protected HandlerResultHandlerSupport(
   ...
   *
   * <p>By default set to {@link Ordered#LOWEST_PRECEDENCE}, however see Javadoc of sub-classes
   * which may change this default.
   *
  ...
  private List<MediaType> getProducibleTypes(
    ...
    Set<MediaType> mediaTypes =
        exchange.getAttribute(HandlerMapping.PRODUCIBLE_MEDIA_TYPES_ATTRIBUTE);
