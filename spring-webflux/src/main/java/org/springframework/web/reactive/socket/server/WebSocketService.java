 ...
 *
 * <p>For a WebSocket endpoint this means handling the initial WebSocket HTTP handshake request. For
 * a SockJS endpoint it could mean handling all HTTP requests defined in the SockJS protocol.
 *
...
public interface WebSocketService {
   ...
   * @return a {@code Mono<Void>} that completes when application handling of the WebSocket session
   *     completes.
   */
