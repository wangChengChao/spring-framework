...
public class SimpleUrlHandlerMappingTests {
  ...
  public void handlerMappingXmlConfig() throws Exception {
    ...
    testUrl(
        "/administrator/test/pathmatching.html",
        mainController,
        handlerMapping,
        "test/pathmatching.html");
  ...
  private void testUrl(
      String url, Object bean, HandlerMapping handlerMapping, String pathWithinMapping) {
    MockServerHttpRequest request =
        MockServerHttpRequest.method(HttpMethod.GET, URI.create(url)).build();
