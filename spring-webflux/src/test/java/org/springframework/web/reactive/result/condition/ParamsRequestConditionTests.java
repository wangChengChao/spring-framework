...
public class ParamsRequestConditionTests {
  ...
  public void paramEquals() {
    ...
    assertThat(new ParamsRequestCondition("foo").equals(new ParamsRequestCondition("bar")))
        .isFalse();
    assertThat(new ParamsRequestCondition("foo").equals(new ParamsRequestCondition("FOO")))
        .isFalse();
    assertThat(new ParamsRequestCondition("foo=bar"))
        .isEqualTo(new ParamsRequestCondition("foo=bar"));
    assertThat(new ParamsRequestCondition("foo=bar").equals(new ParamsRequestCondition("FOO=bar")))
        .isFalse();
  }
  ...
  public void paramPresent() throws Exception {
    ...
    assertThat(condition.getMatchingCondition(MockServerWebExchange.from(get("/path?foo="))))
        .isNotNull();
  }
  ...
  public void paramPresentNoMatch() throws Exception {
    ParamsRequestCondition condition = new ParamsRequestCondition("foo");
    assertThat(condition.getMatchingCondition(MockServerWebExchange.from(get("/path?bar="))))
        .isNull();
  }
  ...
  public void paramValueMatch() throws Exception {
    ...
    assertThat(condition.getMatchingCondition(MockServerWebExchange.from(get("/path?foo=bar"))))
        .isNotNull();
  }
  ...
  public void paramValueNoMatch() throws Exception {
    ParamsRequestCondition condition = new ParamsRequestCondition("foo=bar");
    assertThat(condition.getMatchingCondition(MockServerWebExchange.from(get("/path?foo=bazz"))))
        .isNull();
  }
  ...
  public void compareToWithNegatedMatch() {
    ...
    assertThat(condition1.compareTo(condition2, exchange))
