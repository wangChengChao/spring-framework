...
public class DefaultEntityResponseBuilderTests {
  ...
  public void fromPublisherClass() {
    ...
    EntityResponse<Flux<String>> response =
        EntityResponse.fromPublisher(body, String.class).build().block();
    assertThat(response.entity()).isSameAs(body);
  }
  ...
  public void fromPublisher() {
    ...
    EntityResponse<Flux<String>> response =
        EntityResponse.fromPublisher(body, typeReference).build().block();
    assertThat(response.entity()).isSameAs(body);
  }
  ...
  public void fromProducer() {
    ...
    ParameterizedTypeReference<String> typeReference = new ParameterizedTypeReference<String>() {};
    EntityResponse<Single<String>> response =
        EntityResponse.fromProducer(body, typeReference).build().block();
    assertThat(response.entity()).isSameAs(body);
  }
  ...
  public void bodyInserter() {
    ...
    Mono<EntityResponse<Publisher<String>>> result =
        EntityResponse.fromPublisher(publisher, String.class).build();

    MockServerWebExchange exchange =
        MockServerWebExchange.from(MockServerHttpRequest.get("http://localhost"));
  ...
  public void notModifiedEtag() {
    ...
    EntityResponse<String> responseMono =
        EntityResponse.fromObject("bar").eTag(etag).build().block();
