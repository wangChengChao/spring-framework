...
public class UrlBasedViewResolverTests {
        ...
        .consumeNextWith(
            view -> {
              ...
              assertThat(((TestView) view).getRequestContextAttribute())
                  .as(
                      "requestContextAttribute when instantiated dynamically by UrlBasedViewResolver")
  ...
  private static class TestView extends AbstractUrlBasedView {
    ...
    protected Mono<Void> renderInternal(
        Map<String, Object> attributes, MediaType contentType, ServerWebExchange exchange) {
