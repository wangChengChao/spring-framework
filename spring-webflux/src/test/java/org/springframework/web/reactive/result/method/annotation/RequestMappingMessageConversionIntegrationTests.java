...
/**
 * {@code @RequestMapping} integration tests focusing on serialization and deserialization of the
 * request and response body.
 *
 * @author Rossen Stoyanchev
 * @author Sebastien Deleuze
 */
public class RequestMappingMessageConversionIntegrationTests
  ...
  public void byteBufferResponseBodyWithPublisher(HttpServer httpServer) throws Exception {
    ...
    assertThat(performGet("/raw-response/publisher", JSON, Person.class).getBody())
        .isEqualTo(expected);
  }
  ...
  public void byteBufferResponseBodyWithFlux(HttpServer httpServer) throws Exception {
    ...
    assertThat(performGet("/raw-response/flux", new HttpHeaders(), String.class).getBody())
        .isEqualTo(expected);
  }
  ...
  public void byteBufferResponseBodyWithMono(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<String> responseEntity =
        performGet("/raw-response/mono", new HttpHeaders(), String.class);
  ...
  public void byteBufferResponseBodyWithObservable(HttpServer httpServer) throws Exception {
    ...
    String expected = "Hello!";
    assertThat(performGet("/raw-response/observable", new HttpHeaders(), String.class).getBody())
        .isEqualTo(expected);
  }
  ...
  public void byteBufferResponseBodyWithRxJava2Observable(HttpServer httpServer) throws Exception {
    ...
    String expected = "Hello!";
    assertThat(
            performGet("/raw-response/rxjava2-observable", new HttpHeaders(), String.class)
                .getBody())
        .isEqualTo(expected);
  }
  ...
  public void byteBufferResponseBodyWithFlowable(HttpServer httpServer) throws Exception {
    ...
    String expected = "Hello!";
    assertThat(performGet("/raw-response/flowable", new HttpHeaders(), String.class).getBody())
        .isEqualTo(expected);
  }
  ...
  public void personResponseBody(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Person> responseEntity =
        performGet("/person-response/person", JSON, Person.class);
  ...
  public void personResponseBodyWithCompletableFuture(HttpServer httpServer) throws Exception {
    ...
    Person expected = new Person("Robert");
    ResponseEntity<Person> responseEntity =
        performGet("/person-response/completable-future", JSON, Person.class);
    assertThat(responseEntity.getHeaders().getContentLength()).isEqualTo(17);
    assertThat(responseEntity.getBody()).isEqualTo(expected);
  }
  ...
  public void personResponseBodyWithEmptyMono(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Person> responseEntity =
        performGet("/person-response/mono-empty", JSON, Person.class);
  ...
  public void personResponseBodyWithMonoDeclaredAsObject(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Person> entity =
        performGet("/person-response/mono-declared-as-object", JSON, Person.class);
  ...
  public void personResponseBodyWithMonoResponseEntity(HttpServer httpServer) throws Exception {
    ...
    Person expected = new Person("Robert");
    ResponseEntity<Person> entity =
        performGet("/person-response/mono-response-entity", JSON, Person.class);
    assertThat(entity.getHeaders().getContentLength()).isEqualTo(17);
    assertThat(entity.getBody()).isEqualTo(expected);
  }
  ...
  public void personResponseBodyWithPublisher(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<List<Person>> entity =
        performGet("/person-response/publisher", JSON, PERSON_LIST);
  ...
  public void personResponseBodyWithFlux(HttpServer httpServer) throws Exception {
    ...
    List<?> expected = asList(new Person("Robert"), new Person("Marie"));
    assertThat(performGet("/person-response/flux", JSON, PERSON_LIST).getBody())
        .isEqualTo(expected);
  }
  ...
  public void personResponseBodyWithObservable(HttpServer httpServer) throws Exception {
    ...
    List<?> expected = asList(new Person("Robert"), new Person("Marie"));
    assertThat(performGet("/person-response/observable", JSON, PERSON_LIST).getBody())
        .isEqualTo(expected);
  }
  ...
  public void personTransform(HttpServer httpServer) throws Exception {
    ...
    assertThat(
            performPost("/person-transform/person", JSON, new Person("Robert"), JSON, Person.class)
                .getBody())
        .isEqualTo(new Person("ROBERT"));
  }
  ...
  public void personTransformWithCompletableFuture(HttpServer httpServer) throws Exception {
    ...
    assertThat(
            performPost(
                    "/person-transform/completable-future",
                    JSON,
                    new Person("Robert"),
                    JSON,
                    Person.class)
  ...
  public void personTransformWithMono(HttpServer httpServer) throws Exception {
    ...
    assertThat(
            performPost("/person-transform/mono", JSON, new Person("Robert"), JSON, Person.class)
                .getBody())
        .isEqualTo(new Person("ROBERT"));
  }
  ...
  public void personTransformWithSingle(HttpServer httpServer) throws Exception {
    ...
    assertThat(
            performPost("/person-transform/single", JSON, new Person("Robert"), JSON, Person.class)
                .getBody())
        .isEqualTo(new Person("ROBERT"));
  }
  ...
  public void personTransformWithRxJava2Single(HttpServer httpServer) throws Exception {
    ...
    assertThat(
            performPost(
                    "/person-transform/rxjava2-single",
                    JSON,
                    new Person("Robert"),
                    JSON,
                    Person.class)
  ...
  public void personTransformWithRxJava2Maybe(HttpServer httpServer) throws Exception {
    ...
    assertThat(
            performPost(
                    "/person-transform/rxjava2-maybe",
                    JSON,
                    new Person("Robert"),
                    JSON,
                    Person.class)
  ...
  public void personTransformWithPublisher(HttpServer httpServer) throws Exception {
    ...
    assertThat(performPost("/person-transform/publisher", JSON, req, JSON, PERSON_LIST).getBody())
        .isEqualTo(res);
  }
  ...
  public void personTransformWithFlux(HttpServer httpServer) throws Exception {
    ...
    List<?> req = asList(new Person("Robert"), new Person("Marie"));
    List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
    assertThat(performPost("/person-transform/flux", JSON, req, JSON, PERSON_LIST).getBody())
        .isEqualTo(res);
  }
  ...
  public void personTransformWithObservable(HttpServer httpServer) throws Exception {
    ...
    List<?> req = asList(new Person("Robert"), new Person("Marie"));
    List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
    assertThat(performPost("/person-transform/observable", JSON, req, JSON, PERSON_LIST).getBody())
        .isEqualTo(res);
  }
  ...
  public void personTransformWithRxJava2Observable(HttpServer httpServer) throws Exception {
    ...
    List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
    assertThat(
            performPost("/person-transform/rxjava2-observable", JSON, req, JSON, PERSON_LIST)
                .getBody())
        .isEqualTo(res);
  }
  ...
  public void personTransformWithFlowable(HttpServer httpServer) throws Exception {
    ...
    List<?> req = asList(new Person("Robert"), new Person("Marie"));
    List<?> res = asList(new Person("ROBERT"), new Person("MARIE"));
    assertThat(performPost("/person-transform/flowable", JSON, req, JSON, PERSON_LIST).getBody())
        .isEqualTo(res);
  }
  ...
  public void personCreateWithPublisherJson(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Void> entity =
        performPost(
            "/person-create/publisher",
            JSON,
            asList(new Person("Robert"), new Person("Marie")),
            null,
            Void.class);

    assertThat(entity.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(getApplicationContext().getBean(PersonCreateController.class).persons.size())
        .isEqualTo(2);
  }
  ...
  public void personCreateWithPublisherXml(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Void> response =
        performPost("/person-create/publisher", APPLICATION_XML, people, null, Void.class);
  ...
  public void personCreateWithMono(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Void> entity =
        performPost("/person-create/mono", JSON, new Person("Robert"), null, Void.class);
  ...
  public void personCreateWithSingle(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Void> entity =
        performPost("/person-create/single", JSON, new Person("Robert"), null, Void.class);
  ...
  public void personCreateWithRxJava2Single(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Void> entity =
        performPost("/person-create/rxjava2-single", JSON, new Person("Robert"), null, Void.class);
  ...
  public void personCreateWithFluxXml(HttpServer httpServer) throws Exception {
    ...
    People people = new People(new Person("Robert"), new Person("Marie"));
    ResponseEntity<Void> response =
        performPost("/person-create/flux", APPLICATION_XML, people, null, Void.class);
  ...
  public void personCreateWithRxJava2ObservableJson(HttpServer httpServer) throws Exception {
    ...
    ResponseEntity<Void> entity =
        performPost(
            "/person-create/rxjava2-observable",
            JSON,
            asList(new Person("Robert"), new Person("Marie")),
            null,
            Void.class);
  ...
  public void personCreateWithObservableXml(HttpServer httpServer) throws Exception {
    ...
    People people = new People(new Person("Robert"), new Person("Marie"));
    ResponseEntity<Void> response =
        performPost("/person-create/observable", APPLICATION_XML, people, null, Void.class);
  ...
  public void personCreateWithFlowableXml(HttpServer httpServer) throws Exception {
    ...
    People people = new People(new Person("Robert"), new Person("Marie"));
    ResponseEntity<Void> response =
        performPost("/person-create/flowable", APPLICATION_XML, people, null, Void.class);
  ...
  private static class RawResponseBodyController {
    ...
    public Publisher<ByteBuffer> getPublisher() {
      ...
      return encoder
          .encode(
              Mono.just(new Person("Robert")),
              dataBufferFactory,
              ResolvableType.forClass(Person.class),
              JSON,
  ...
  private static class PersonTransformationController {
    ...
    public io.reactivex.Single<Person> transformRxJava2Single(
        @RequestBody io.reactivex.Single<Person> personFuture) {
      return personFuture.map(person -> new Person(person.getName().toUpperCase()));
    }
    ...
    public io.reactivex.Observable<Person> transformObservable(
        @RequestBody io.reactivex.Observable<Person> persons) {
      return persons.map(person -> new Person(person.getName().toUpperCase()));
    }
  ...
  private static class PersonCreateController {
    ...
    @PostMapping("/rxjava2-single")
    public io.reactivex.Completable createWithRxJava2Single(
        @RequestBody io.reactivex.Single<Person> single) {
