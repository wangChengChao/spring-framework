...
public class PrincipalMethodArgumentResolverTests {
  ...
  public void supportsParameter() {
    ...
    assertThat(this.resolver.supportsParameter(this.testMethod.arg(Mono.class, Principal.class)))
        .isTrue();
    assertThat(this.resolver.supportsParameter(this.testMethod.arg(Single.class, Principal.class)))
        .isTrue();
  }
