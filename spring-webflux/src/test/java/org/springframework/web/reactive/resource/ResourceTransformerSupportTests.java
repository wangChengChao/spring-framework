...
public class ResourceTransformerSupportTests {
  ...
  public void resolveUrlPath() {
    MockServerWebExchange exchange =
        MockServerWebExchange.from(MockServerHttpRequest.get("/resources/main.css"));
    String resourcePath = "/resources/bar.css";
    Resource resource = getResource("main.css");
    String actual =
        this.transformer
            .resolveUrlPath(resourcePath, exchange, resource, this.chain)
            .block(TIMEOUT);
  ...
  public void resolveUrlPathWithRelativePath() {
    ...
    String actual =
        this.transformer.resolveUrlPath("bar.css", exchange, resource, this.chain).block(TIMEOUT);
  ...
  public void resolveUrlPathWithRelativePathInParentDirectory() {
    ...
    String actual =
        this.transformer
            .resolveUrlPath("../bar.css", exchange, resource, this.chain)
            .block(TIMEOUT);
  ...
  private static class TestResourceTransformerSupport extends ResourceTransformerSupport {
    ...
    public Mono<Resource> transform(
        ServerWebExchange ex, Resource res, ResourceTransformerChain chain) {
