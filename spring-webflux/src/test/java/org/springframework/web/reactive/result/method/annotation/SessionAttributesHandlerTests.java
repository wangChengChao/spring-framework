...
public class SessionAttributesHandlerTests {
  ...
  public void isSessionAttribute() {
    assertThat(this.sessionAttributesHandler.isHandlerSessionAttribute("attr1", String.class))
        .isTrue();
    assertThat(this.sessionAttributesHandler.isHandlerSessionAttribute("attr2", String.class))
        .isTrue();
    assertThat(this.sessionAttributesHandler.isHandlerSessionAttribute("simple", TestBean.class))
        .isTrue();
    assertThat(this.sessionAttributesHandler.isHandlerSessionAttribute("simple", String.class))
        .isFalse();
  }
