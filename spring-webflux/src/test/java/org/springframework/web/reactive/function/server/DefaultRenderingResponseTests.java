...
public class DefaultRenderingResponseTests {
  ...
  public void modelAttribute() {
    Mono<RenderingResponse> result =
        RenderingResponse.create("foo").modelAttribute("foo", "bar").build();
    StepVerifier.create(result)
  ...
  public void render() {
    ...
    Mono<RenderingResponse> result =
        RenderingResponse.create("view").modelAttributes(model).build();
    ...
    StepVerifier.create(result)
        .expectNextMatches(
            response -> "view".equals(response.name()) && model.equals(response.model()))
        .expectComplete()
        .verify();
  }
  ...
  public void notModifiedEtag() {
    String etag = "\"foo\"";
    RenderingResponse responseMono =
        RenderingResponse.create("bar").header(HttpHeaders.ETAG, etag).build().block();
  ...
  public void notModifiedLastModified() {
    ...
    RenderingResponse responseMono =
        RenderingResponse.create("bar")
            .header(
                HttpHeaders.LAST_MODIFIED,
                DateTimeFormatter.RFC_1123_DATE_TIME.format(oneMinuteBeforeNow))
            .build()
            .block();
