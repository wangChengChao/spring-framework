...
public class ResourceRegionHttpMessageConverterTests {
  ...
  private final ResourceRegionHttpMessageConverter converter =
  ...
  public void canWriteResource() {
    assertThat(converter.canWrite(ResourceRegion.class, null, MediaType.APPLICATION_OCTET_STREAM))
        .isTrue();
  ...
  public void canWriteResourceCollection() {
    ...
    assertThat(converter.canWrite(resourceRegionList, null, MediaType.APPLICATION_OCTET_STREAM))
        .isTrue();
  ...
  public void shouldWritePartialContentByteRangeNoEnd() throws Exception {
    ...
    assertThat(outputMessage.getBodyAsString(StandardCharsets.UTF_8))
        .isEqualTo("Framework test resource content.");
  }
  ...
  public void applicationOctetStreamDefaultContentType() throws Exception {
    ...
    BDDMockito.given(body.getInputStream())
        .willReturn(new ByteArrayInputStream("Spring Framework".getBytes()));
