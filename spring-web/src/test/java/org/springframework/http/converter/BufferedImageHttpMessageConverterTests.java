...
public class BufferedImageHttpMessageConverterTests {
  ...
  public void canRead() {
    ...
    assertThat(converter.canRead(BufferedImage.class, new MediaType("image", "png")))
        .as("Image not supported")
        .isTrue();
  }
  ...
  public void canWrite() {
    ...
    assertThat(converter.canWrite(BufferedImage.class, new MediaType("image", "png")))
        .as("Image not supported")
        .isTrue();
    assertThat(converter.canWrite(BufferedImage.class, new MediaType("*", "*")))
        .as("Image not supported")
        .isTrue();
  }
  ...
  public void write() throws IOException {
    ...
    assertThat(outputMessage.getWrittenHeaders().getContentType())
