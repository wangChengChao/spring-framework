...
/**
 * Unit tests for {@link FormHttpMessageConverter} and {@link
...
public class FormHttpMessageConverterTests {
  ...
  public void readForm() throws Exception {
    ...
    MockHttpInputMessage inputMessage =
        new MockHttpInputMessage(body.getBytes(StandardCharsets.ISO_8859_1));
    inputMessage
        .getHeaders()
        .setContentType(
  ...
  public void writeMultipart() throws Exception {
    ...
    this.converter.write(
        parts, new MediaType("multipart", "form-data", StandardCharsets.UTF_8), outputMessage);
  ...
  private void assertCanRead(Class<?> clazz, MediaType mediaType) {
    assertThat(this.converter.canRead(clazz, mediaType))
        .as(clazz.getSimpleName() + " : " + mediaType)
        .isTrue();
  }
  ...
  private void assertCanWrite(MediaType mediaType) {
    ...
    assertThat(this.converter.canWrite(clazz, mediaType))
        .as(clazz.getSimpleName() + " : " + mediaType)
        .isTrue();
  }
