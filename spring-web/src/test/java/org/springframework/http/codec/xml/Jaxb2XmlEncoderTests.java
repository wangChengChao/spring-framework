...
public class Jaxb2XmlEncoderTests extends AbstractEncoderTestCase<Jaxb2XmlEncoder> {
  ...
  public void canEncode() {
    assertThat(
            this.encoder.canEncode(ResolvableType.forClass(Pojo.class), MediaType.APPLICATION_XML))
        .isTrue();
    assertThat(this.encoder.canEncode(ResolvableType.forClass(Pojo.class), MediaType.TEXT_XML))
        .isTrue();
    assertThat(
            this.encoder.canEncode(ResolvableType.forClass(Pojo.class), MediaType.APPLICATION_JSON))
        .isFalse();
    ...
    assertThat(
            this.encoder.canEncode(ResolvableType.forClass(getClass()), MediaType.APPLICATION_XML))
        .isFalse();
