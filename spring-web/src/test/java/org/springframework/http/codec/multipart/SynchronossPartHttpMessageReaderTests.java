...
public class SynchronossPartHttpMessageReaderTests {
  ...
  public void resolveParts() {
    ...
    MultiValueMap<String, Part> parts =
        this.reader.readMono(elementType, request, emptyMap()).block();
  ...
  private ServerHttpRequest generateMultipartRequest() {
    ...
    partsBuilder.part(
        "fooPart", new ClassPathResource("org/springframework/http/codec/multipart/foo.txt"));
