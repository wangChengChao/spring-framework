...
public class CancelWithoutDemandCodecTests {
  ...
  public void cancelWithEncoderHttpMessageWriterAndSingleValue() {
    ...
    writer
        .write(
            Mono.just("foo"),
            ResolvableType.forType(String.class),
  ...
  public void cancelWithJackson() {
    ...
    Flux<DataBuffer> flux =
        encoder.encode(
            Flux.just(new Pojo("foofoo", "barbar"), new Pojo("bar", "baz")),
            this.bufferFactory,
  ...
  public void cancelWithProtobufEncoder() {
    ...
    Flux<DataBuffer> flux =
        encoder.encode(
            Mono.just(msg),
            this.bufferFactory,
            ResolvableType.forClass(Msg.class),
  ...
  public void cancelWithProtobufDecoder() throws InterruptedException {
    ...
    Flux<Message> messages =
        decoder.decode(
            input,
            ResolvableType.forType(Msg.class),
            new MimeType("application", "x-protobuf"),
            Collections.emptyMap());
