...
public class HttpEntityTests {
  ...
  public void testEquals() {
    ...
    assertThat(new HttpEntity<String>(null, null).equals(new HttpEntity<String>(null, null)))
        .isTrue();
  ...
  public void requestEntity() throws Exception {
    ...
    RequestEntity<String> requestEntity =
        new RequestEntity<>(body, headers, HttpMethod.GET, new URI("/"));
    RequestEntity<String> requestEntity2 =
        new RequestEntity<>(body, headers, HttpMethod.GET, new URI("/"));
