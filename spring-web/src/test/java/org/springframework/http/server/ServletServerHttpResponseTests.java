...
public class ServletServerHttpResponseTests {
  ...
  public void getHeaders() throws Exception {
    ...
    assertThat(mockResponse.getHeader("Content-Type"))
  ...
  public void preExistingHeadersFromHttpServletResponse() {
    ...
    assertThat(this.response.getHeaders().get(headerName))
        .isEqualTo(Collections.singletonList(headerValue));
  ...
  public void getBody() throws Exception {
    ...
    assertThat(mockResponse.getContentAsByteArray())
        .as("Invalid content written")
        .isEqualTo(content);
  }
}
