...
public class RequestEntityTests {
  ...
  public void get() {
    RequestEntity<Void> requestEntity =
        RequestEntity.get(URI.create("https://example.com"))
    ...
    assertThat(requestEntity.getHeaders().getFirst("Accept"))
  ...
  public void headers() throws URISyntaxException {
    ...
    RequestEntity<Void> responseEntity =
        RequestEntity.post(new URI("https://example.com"))
            .accept(accept)
    ...
    assertThat(responseHeaders.getFirst("If-Modified-Since"))
        .isEqualTo("Thu, 01 Jan 1970 00:00:12 GMT");
