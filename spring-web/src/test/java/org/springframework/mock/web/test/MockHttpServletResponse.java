...
public class MockHttpServletResponse implements HttpServletResponse {
  ...
  @Nullable private String characterEncoding = WebUtils.DEFAULT_CHARACTER_ENCODING;
  ...
  /**
   * Get the content of the response body as a {@code String}, using the charset specified for the
   * response by the application, either through {@link HttpServletResponse} methods or through a
   * charset parameter on the {@code Content-Type}.
   *
  ...
  /**
   * Get the content of the response body as a {@code String}, using the provided {@code
   * fallbackCharset} if no charset has been explicitly defined and otherwise using the charset
   * specified for the response by the application, either through {@link HttpServletResponse}
   * methods or through a charset parameter on the {@code Content-Type}.
   *
   * @return the content as a {@code String}
   * @throws UnsupportedEncodingException if the character encoding is not supported
   * @since 5.2
  ...
  /**
   * Return the primary value for the given header as a String, if any. Will return the first value
   * in case of multiple values.
   *
   * <p>As of Servlet 3.0, this method is also defined in HttpServletResponse. As of Spring 3.1, it
   * returns a stringified value for Servlet 3.0 compatibility. Consider using {@link
   * #getHeaderValue(String)} for raw Object access.
   *
   ...
   * as-is.
   *
   * <p>Can be overridden in subclasses, appending a session id or the like in a redirect-specific
   * fashion. For general URL encoding rules, override the common {@link #encodeURL} method instead,
   * applying to redirect URLs as well as to general URLs.
   */
  @Override
  ...
  /**
   * Set the {@code Set-Cookie} header to the supplied {@link Cookie}, overwriting any previous
   * cookies.
   *
