 ...
 *
 * <p>A {@link MockFilterChain} can be configured with one or more filters and a Servlet to invoke.
 * The first time the chain is called, it invokes all filters and the Servlet, and saves the request
 * and response. Subsequent invocations raise an {@link IllegalStateException} unless {@link
 * #reset()} is called.
 *
...
public class MockFilterChain implements FilterChain {
  ...
  /**
   * Register a single do-nothing {@link Filter} implementation. The first invocation saves the
   * request and response. Subsequent invocations raise an {@link IllegalStateException} unless
  ...
  /**
   * Invoke registered {@link Filter Filters} and/or {@link Servlet} also saving the request and
   * response.
   */
  @Override
