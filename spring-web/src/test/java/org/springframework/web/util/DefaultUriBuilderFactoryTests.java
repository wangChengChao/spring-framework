...
public class DefaultUriBuilderFactoryTests {
  ...
  public void baseUri() {
    DefaultUriBuilderFactory factory =
        new DefaultUriBuilderFactory("https://foo.example/v1?id=123");
  ...
  public void baseUriWithFullOverride() {
    ...
    assertThat(uri.toString())
        .as("Use of host should case baseUri to be completely ignored")
  ...
  public void defaultUriVarsWithEmptyVarArg() {
    ...
    assertThat(uri.toString())
        .as("Expected delegation to build(Map) method")
