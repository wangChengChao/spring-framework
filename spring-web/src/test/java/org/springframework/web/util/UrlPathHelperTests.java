...
public class UrlPathHelperTests {
  ...
  public void getPathWithinApplicationForRootWithNoLeadingSlash() {
    ...
    assertThat(helper.getPathWithinApplication(request))
        .as("Incorrect root path returned")
        .isEqualTo("/");
  }
  ...
  public void getPathWithinServlet() {
    ...
    assertThat(helper.getPathWithinServletMapping(request))
        .as("Incorrect path returned")
        .isEqualTo("/welcome.html");
  }
  ...
  public void alwaysUseFullPath() {
    ...
    assertThat(helper.getLookupPathForRequest(request))
        .as("Incorrect path returned")
  ...
  public void getRequestUri() {
    request.setRequestURI("/welcome.html");
    assertThat(helper.getRequestUri(request))
        .as("Incorrect path returned")
        .isEqualTo("/welcome.html");
  ...
  public void getRequestKeepSemicolonContent() throws UnsupportedEncodingException {
    ...
    assertThat(helper.getRequestUri(request))
        .as("jsessionid should always be removed")
        .isEqualTo("/foo");

    request.setRequestURI("/foo;a=b;jsessionid=c0o7fszeb1;c=d");
    assertThat(helper.getRequestUri(request))
        .as("jsessionid should always be removed")
        .isEqualTo("/foo;a=b;c=d");
  ...
  //
  // suite of tests root requests for default servlets (SRV 11.2) on Websphere vs Tomcat and other
  // containers
