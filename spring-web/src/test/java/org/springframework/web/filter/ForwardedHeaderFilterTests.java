...
public class ForwardedHeaderFilterTests {
  ...
  private static final String X_FORWARDED_PROTO =
      "x-forwarded-proto"; // SPR-14372 (case insensitive)
  ...
  public void requestUriPreserveEncoding() throws Exception {
    ...
    assertThat(actual.getRequestURL().toString())
        .isEqualTo("http://localhost/app/path%20with%20spaces/");
  }
  ...
  public void requestUriPreserveSemicolonContent() throws Exception {
    ...
    assertThat(actual.getRequestURL().toString())
        .isEqualTo("http://localhost/path;a=b/with/semicolon");
  }
