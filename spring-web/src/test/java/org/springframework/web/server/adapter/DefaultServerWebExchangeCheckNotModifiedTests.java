...
public class DefaultServerWebExchangeCheckNotModifiedTests {
  ...
  @Parameter public HttpMethod method;

  @Parameters(name = "{0}")
  public static Iterable<Object[]> safeMethods() {
    return Arrays.asList(new Object[][] {{HttpMethod.GET}, {HttpMethod.HEAD}});
  }
  ...
  public void checkNotModifiedNon2xxStatus() {
    MockServerHttpRequest request =
        get("/").ifModifiedSince(this.currentDate.toEpochMilli()).build();
  ...
  public void checkNotModifiedInvalidIfNoneMatchHeader() {
    ...
    MockServerWebExchange exchange =
        MockServerWebExchange.from(get("/").ifNoneMatch("missingquotes"));
  ...
  public void checkNotModifiedHeaderAlreadySet() {
    ...
    assertThat(exchange.getResponse().getHeaders().getFirst("Last-Modified"))
  ...
  public void checkNotModifiedTimestamp() throws Exception {
    ...
    assertThat(exchange.getResponse().getHeaders().getLastModified())
        .isEqualTo(currentDate.toEpochMilli());
  }
  ...
  public void checkModifiedUnpaddedETag() {
    ...
    assertThat(exchange.getResponse().getStatusCode()).isNull();
    assertThat(exchange.getResponse().getHeaders().getETag())
        .isEqualTo(String.format("\"%s\"", currentETag));
  }
  ...
  public void checkNotModifiedETagAndModifiedTimestamp() {
    ...
    MockServerWebExchange exchange =
        MockServerWebExchange.from(
            get("/").ifNoneMatch(eTag).ifModifiedSince(oneMinuteAgo.toEpochMilli()));
  ...
  public void checkNotModifiedMultipleETags() {
    ...
    MockServerWebExchange exchange =
        MockServerWebExchange.from(get("/").ifNoneMatch(multipleETags));
  ...
  public void checkNotModifiedTimestampConditionalPut() throws Exception {
    ...
    MockServerHttpRequest request =
        MockServerHttpRequest.put("/").ifUnmodifiedSince(millis).build();
    MockServerWebExchange exchange = MockServerWebExchange.from(request);
