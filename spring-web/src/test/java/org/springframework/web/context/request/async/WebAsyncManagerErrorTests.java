...
/**
 * {@link WebAsyncManager} tests where container-triggered error/completion events are simulated.
 *
...
public class WebAsyncManagerErrorTests {
  ...
  public void startCallableProcessingErrorAndComplete() throws Exception {
    ...
    AsyncEvent event =
        new AsyncEvent(new MockAsyncContext(this.servletRequest, this.servletResponse), e);
  ...
  public void startCallableProcessingErrorAndResumeThroughCallback() throws Exception {
    ...
    assertThat(((MockAsyncContext) this.servletRequest.getAsyncContext()).getDispatchedPath())
        .isEqualTo("/test");
  }
    ...
    DeferredResultProcessingInterceptor interceptor =
        new DeferredResultProcessingInterceptor() {
          ...
          public <T> boolean handleError(
              NativeWebRequest request, DeferredResult<T> result, Throwable t) throws Exception {
