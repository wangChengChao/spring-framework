...
public class SessionAttributesHandlerTests {
  ...
  private final SessionAttributesHandler sessionAttributesHandler =
      new SessionAttributesHandler(SessionAttributeHandler.class, sessionAttributeStore);
  ...
  public void isSessionAttribute() throws Exception {
    ...
    assertThat(sessionAttributesHandler.isHandlerSessionAttribute("simple", TestBean.class))
        .isTrue();
    assertThat(sessionAttributesHandler.isHandlerSessionAttribute("simple", String.class))
        .isFalse();
  }
  ...
  public void storeAttributes() throws Exception {
    ...
    boolean condition =
        sessionAttributeStore.retrieveAttribute(request, "attr3") instanceof TestBean;
