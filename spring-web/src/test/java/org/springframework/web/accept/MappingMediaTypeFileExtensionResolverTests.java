...
public class MappingMediaTypeFileExtensionResolverTests {
  ...
  private final Map<String, MediaType> mapping =
      Collections.singletonMap("json", MediaType.APPLICATION_JSON);
  private final MappingMediaTypeFileExtensionResolver resolver =
      new MappingMediaTypeFileExtensionResolver(this.mapping);
  ...
  /**
   * Unit test for SPR-13747 - ensures that reverse lookup of media type from media type key is
   * case-insensitive.
   */
  @Test
