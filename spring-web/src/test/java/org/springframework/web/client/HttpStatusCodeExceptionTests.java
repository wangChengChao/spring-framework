...
public class HttpStatusCodeExceptionTests {
  ...
  /**
   * Corners bug SPR-9273, which reported the fact that following the changes made in SPR-7591,
   * {@link HttpStatusCodeException} and subtypes became no longer serializable due to the addition
   * of a non-serializable {@code Charset} field.
   */
  @Test
  public void testSerializability() throws IOException, ClassNotFoundException {
    HttpStatusCodeException ex1 =
        new HttpClientErrorException(HttpStatus.BAD_REQUEST, null, null, StandardCharsets.US_ASCII);
