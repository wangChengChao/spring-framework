...
public class DefaultCorsProcessorTests {
  ...
  public void requestWithoutOriginHeader() throws Exception {
    ...
    assertThat(this.response.getHeaders(HttpHeaders.VARY))
        .contains(
            HttpHeaders.ORIGIN,
  ...
  public void actualRequestCredentials() throws Exception {
    ...
    this.processor.processRequest(this.conf, this.request, this.response);
    assertThat(this.response.containsHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN)).isTrue();
    assertThat(this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN))
        .isEqualTo("https://domain2.com");
    assertThat(this.response.containsHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_CREDENTIALS)).isTrue();
    assertThat(this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_CREDENTIALS))
        .isEqualTo("true");
    assertThat(this.response.getHeaders(HttpHeaders.VARY))
        .contains(
            HttpHeaders.ORIGIN,
  ...
  public void actualRequestExposedHeaders() throws Exception {
    ...
    assertThat(
            this.response.getHeader(HttpHeaders.ACCESS_CONTROL_EXPOSE_HEADERS).contains("header1"))
        .isTrue();
    assertThat(
            this.response.getHeader(HttpHeaders.ACCESS_CONTROL_EXPOSE_HEADERS).contains("header2"))
        .isTrue();
    assertThat(this.response.getHeaders(HttpHeaders.VARY))
        .contains(
            HttpHeaders.ORIGIN,
  ...
  public void preflightRequestMatchedAllowedMethod() throws Exception {
    ...
    this.processor.processRequest(this.conf, this.request, this.response);
    assertThat(this.response.getStatus()).isEqualTo(HttpServletResponse.SC_OK);
    assertThat(this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_METHODS))
        .isEqualTo("GET,HEAD");
    assertThat(this.response.getHeaders(HttpHeaders.VARY))
        .contains(
            HttpHeaders.ORIGIN,
  ...
  public void preflightRequestAllowedHeaders() throws Exception {
    ...
    assertThat(
            this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS).contains("Header1"))
        .isTrue();
    assertThat(
            this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS).contains("Header2"))
        .isTrue();
    assertThat(
            this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS).contains("Header3"))
        .isFalse();
    assertThat(this.response.getHeaders(HttpHeaders.VARY))
        .contains(
            HttpHeaders.ORIGIN,
  ...
  public void preflightRequestAllowsAllHeaders() throws Exception {
    ...
    assertThat(
            this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS).contains("Header2"))
        .isTrue();
    assertThat(this.response.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_HEADERS).contains("*"))
        .isFalse();
    assertThat(this.response.getHeaders(HttpHeaders.VARY))
        .contains(
            HttpHeaders.ORIGIN,
