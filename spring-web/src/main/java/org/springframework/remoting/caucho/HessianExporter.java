...
public class HessianExporter extends RemoteExporter implements InitializingBean {
  ...
  @Nullable private HessianRemoteResolver remoteResolver;

  @Nullable private Log debugLogger;

  @Nullable private HessianSkeleton skeleton;
  ...
  protected void doInvoke(
      HessianSkeleton skeleton, InputStream inputStream, OutputStream outputStream)
      throws Throwable {
