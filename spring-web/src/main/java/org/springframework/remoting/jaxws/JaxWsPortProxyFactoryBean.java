...
/**
 * {@link org.springframework.beans.factory.FactoryBean} for a specific port of a JAX-WS service.
 * Exposes a proxy for the port, to be used for bean references. Inherits configuration properties
 * from {@link JaxWsPortClientInterceptor}.
 *
