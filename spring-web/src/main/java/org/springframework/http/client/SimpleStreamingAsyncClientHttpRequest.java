...
/**
 * {@link org.springframework.http.client.ClientHttpRequest} implementation that uses standard Java
 * facilities to execute streaming requests. Created via the {@link
...
final class SimpleStreamingAsyncClientHttpRequest extends AbstractAsyncClientHttpRequest {
  ...
  protected ListenableFuture<ClientHttpResponse> executeInternal(final HttpHeaders headers)
    ...
    return this.taskExecutor.submitListenable(
        new Callable<ClientHttpResponse>() {
          @Override
