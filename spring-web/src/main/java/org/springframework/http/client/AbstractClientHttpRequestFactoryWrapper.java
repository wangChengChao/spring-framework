...
/**
 * Abstract base class for {@link ClientHttpRequestFactory} implementations that decorate another
 * request factory.
 *
...
public abstract class AbstractClientHttpRequestFactoryWrapper implements ClientHttpRequestFactory {
  ...
  /**
   * This implementation simply calls {@link #createRequest(URI, HttpMethod,
   * ClientHttpRequestFactory)} with the wrapped request factory provided to the {@linkplain
   * #AbstractClientHttpRequestFactoryWrapper(ClientHttpRequestFactory) constructor}.
   */
  @Override
