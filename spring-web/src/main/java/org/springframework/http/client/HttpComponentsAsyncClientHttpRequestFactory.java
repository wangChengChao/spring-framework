...
/**
 * Asynchronous extension of the {@link HttpComponentsClientHttpRequestFactory}. Uses <a
 * href="https://hc.apache.org/httpcomponents-asyncclient-dev/">Apache HttpComponents
...
public class HttpComponentsAsyncClientHttpRequestFactory
  ...
  /**
   * Create a new instance of the {@code HttpComponentsAsyncClientHttpRequestFactory} with a default
   * {@link HttpAsyncClient} and {@link HttpClient}.
   */
  ...
  /**
   * Create a new instance of the {@code HttpComponentsAsyncClientHttpRequestFactory} with the given
   * {@link HttpAsyncClient} instance and a default {@link HttpClient}.
   *
  ...
  /**
   * Create a new instance of the {@code HttpComponentsAsyncClientHttpRequestFactory} with the given
   * {@link CloseableHttpAsyncClient} instance and a default {@link HttpClient}.
   *
  ...
  /**
   * Create a new instance of the {@code HttpComponentsAsyncClientHttpRequestFactory} with the given
   * {@link HttpClient} and {@link HttpAsyncClient} instances.
   *
   ...
   */
  public HttpComponentsAsyncClientHttpRequestFactory(
      HttpClient httpClient, HttpAsyncClient asyncClient) {
    super(httpClient);
    this.asyncClient = asyncClient;
  }
  ...
  /**
   * Create a new instance of the {@code HttpComponentsAsyncClientHttpRequestFactory} with the given
   * {@link CloseableHttpClient} and {@link CloseableHttpAsyncClient} instances.
   *
  ...
  /**
   * Set the {@code HttpAsyncClient} used for {@linkplain #createAsyncRequest(URI, HttpMethod)
  ...
  /**
   * Return the {@code HttpAsyncClient} used for {@linkplain #createAsyncRequest(URI, HttpMethod)
   * synchronous execution}.
   *
   * @since 4.3.10
   * @see #getHttpClient()
  ...
  /**
   * Set the {@code CloseableHttpAsyncClient} used for {@linkplain #createAsyncRequest(URI,
   * HttpMethod) asynchronous execution}.
   *
  ...
  /**
   * Return the {@code CloseableHttpAsyncClient} used for {@linkplain #createAsyncRequest(URI,
   * HttpMethod) asynchronous execution}.
   *
  ...
  public CloseableHttpAsyncClient getHttpAsyncClient() {
    Assert.state(
        this.asyncClient instanceof CloseableHttpAsyncClient,
