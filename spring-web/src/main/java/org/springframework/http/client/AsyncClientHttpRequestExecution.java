 ...
 *
 * <p>Used to invoke the next interceptor in the interceptor chain, or - if the calling interceptor
 * is last - execute the request itself.
 *
...
public interface AsyncClientHttpRequestExecution {
  ...
  /**
   * Resume the request execution by invoking the next interceptor in the chain or executing the
