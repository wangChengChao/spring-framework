...
/**
 * The HTTP accessor that extends the base {@link AsyncHttpAccessor} with request intercepting
 * functionality.
 *
...
public abstract class InterceptingAsyncHttpAccessor extends AsyncHttpAccessor {
  ...
  public org.springframework.http.client.AsyncClientHttpRequestFactory getAsyncRequestFactory() {
    org.springframework.http.client.AsyncClientHttpRequestFactory delegate =
        super.getAsyncRequestFactory();
