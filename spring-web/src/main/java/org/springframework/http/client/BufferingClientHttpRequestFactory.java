...
/**
 * Wrapper for a {@link ClientHttpRequestFactory} that buffers all outgoing and incoming streams in
 * memory.
 *
 * <p>Using this wrapper allows for multiple reads of the {@linkplain ClientHttpResponse#getBody()
 * response body}.
 *
...
public class BufferingClientHttpRequestFactory extends AbstractClientHttpRequestFactoryWrapper {
  ...
  /**
   * Indicates whether the request/response exchange for the given URI and method should be buffered
   * in memory.
   *
   * <p>The default implementation returns {@code true} for all URIs and methods. Subclasses can
