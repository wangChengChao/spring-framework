...
/**
 * Represents a client-side asynchronous HTTP request. Created via an implementation of the {@link
 * AsyncClientHttpRequestFactory}.
 *
 * <p>A {@code AsyncHttpRequest} can be {@linkplain #executeAsync() executed}, getting a future
...
public interface AsyncClientHttpRequest extends HttpRequest, HttpOutputMessage {
  ...
  /**
   * Execute this request asynchronously, resulting in a Future handle. {@link ClientHttpResponse}
   * that can be read.
   *
