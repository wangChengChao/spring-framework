...
/**
 * Factory to manage Jetty resources, i.e. {@link Executor}, {@link ByteBufferPool} and {@link
 * Scheduler}, within the lifecycle of a Spring {@code ApplicationContext}.
 *
...
public class JettyResourceFactory implements InitializingBean, DisposableBean {
  ...
  /**
   * Configure the thread prefix to initialize {@link QueuedThreadPool} executor with. This is used
   * only when a {@link Executor} instance isn't {@link #setExecutor(Executor) provided}.
   *
