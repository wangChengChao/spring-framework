...
class ReactorClientHttpResponse implements ClientHttpResponse {
  ...
  public ReactorClientHttpResponse(
      HttpClientResponse response, NettyInbound inbound, ByteBufAllocator alloc) {
    ...
    return this.inbound
        ...
        .doOnCancel(
            () ->
                ...
                // Subsequent subscribers after cancel() will not be rejected, but will hang
                // instead.
