...
/**
 * Base class for {@link org.springframework.web.client.AsyncRestTemplate} and other HTTP accessing
 * gateway helpers, defining common properties such as the {@link
 * org.springframework.http.client.AsyncClientHttpRequestFactory} to operate on.
 *
 * <p>Not intended to be used directly. See {@link
...
public class AsyncHttpAccessor {
   ...
   */
  protected org.springframework.http.client.AsyncClientHttpRequest createAsyncRequest(
