...
public class JettyClientHttpConnector implements ClientHttpConnector {
   ...
   * @deprecated as of 5.2, in favor of {@link
   *     JettyClientHttpConnector#JettyClientHttpConnector(HttpClient, JettyResourceFactory)}
   */
  @Deprecated
  public JettyClientHttpConnector(
  ...
  /**
   * Constructor with an initialized {@link HttpClient} and configures it with the given {@link
   ...
   */
  public JettyClientHttpConnector(
      HttpClient httpClient, @Nullable JettyResourceFactory resourceFactory) {
