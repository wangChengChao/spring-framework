...
public class ServerSentEventHttpMessageWriter implements HttpMessageWriter<Object> {
  ...
  /**
   * Constructor without an {@code Encoder}. In this mode only {@code String} is supported for event
   * data to be encoded.
   */
  ...
  public Mono<Void> write(
    ...
    mediaType =
        (mediaType != null && mediaType.getCharset() != null ? mediaType : DEFAULT_MEDIA_TYPE);
            ...
            element -> {
              ...
              Mono<DataBuffer> bufferMono =
                  Mono.fromCallable(
                      () ->
                          bufferFactory.join(
                              encodeEvent(sb, data, dataType, mediaType, bufferFactory, hints)));
  ...
  private <T> List<DataBuffer> encodeEvent(
      CharSequence markup,
      @Nullable T data,
      ResolvableType dataType,
      MediaType mediaType,
  ...
  public Mono<Void> write(
    ...
    Map<String, Object> allHints =
        Hints.merge(hints, getEncodeHints(actualType, elementType, mediaType, request, response));
