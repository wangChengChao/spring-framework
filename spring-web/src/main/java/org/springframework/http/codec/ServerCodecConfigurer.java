...
public interface ServerCodecConfigurer extends CodecConfigurer {
   ...
   * {@inheritDoc}
   *
   * <p>On the server side, built-in default also include customizations related to the encoder for
   * SSE.
   */
  @Override
  ...
  interface ServerDefaultCodecs extends DefaultCodecs {
     ...
     *
     * <p>By default if this is not set, and Jackson is available, the {@link #jackson2JsonEncoder}
