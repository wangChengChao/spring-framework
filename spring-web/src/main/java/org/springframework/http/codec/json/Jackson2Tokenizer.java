...
/**
 * {@link Function} to transform a JSON stream of arbitrary size, byte array chunks into a {@code
 * Flux<TokenBuffer>} where each token buffer is a well-formed JSON object.
 *
...
final class Jackson2Tokenizer {
   ...
   * @param tokenizeArrayElements if {@code true} and the "top level" JSON object is an array, each
   *     element is returned individually immediately after it is received
