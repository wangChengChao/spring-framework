...
public interface ClientCodecConfigurer extends CodecConfigurer {
  ...
  interface ClientDefaultCodecs extends DefaultCodecs {
     ...
     *
     * <p>By default if this is not set, and Jackson is available, the {@link #jackson2JsonDecoder}
     * override is used instead. Use this property if you want to further customize the SSE decoder.
     *
  ...
  interface MultipartCodecs {
    ...
    /**
     * Add a Part {@link HttpMessageWriter}. For writers of type {@link EncoderHttpMessageWriter}
