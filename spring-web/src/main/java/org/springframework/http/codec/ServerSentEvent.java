...
/**
 * Representation for a Server-Sent Event for use with Spring's reactive Web support. {@code
 * Flux<ServerSentEvent>} or {@code Observable<ServerSentEvent>} is the reactive equivalent to
 * Spring MVC's {@code SseEmitter}.
 *
...
public final class ServerSentEvent<T> {
  ...
  public interface Builder<T> {
    ...
    /**
     * Set SSE comment. If a multi-line comment is provided, it will be turned into multiple SSE
     * comment lines as defined in Server-Sent Events W3C recommendation.
     *
    ...
    /**
     * Set the value of the {@code data} field. If the {@code data} argument is a multi-line {@code
     * String}, it will be turned into multiple {@code data} field lines as defined in the
     * Server-Sent Events W3C recommendation. If {@code data} is not a String, it will be
     * {@linkplain org.springframework.http.codec.json.Jackson2JsonEncoder encoded} into JSON.
     *
  ...
  private static class BuilderImpl<T> implements Builder<T> {
    ...
    @Nullable private Duration retry;
