...
/**
 * Strategy for reading from a {@link ReactiveHttpInputMessage} and decoding the stream of bytes to
...
public interface HttpMessageReader<T> {
   ...
   *     via {@link #canRead(ResolvableType, MediaType)}
  ...
  /**
   * Server-side only alternative to {@link #read(ResolvableType, ReactiveHttpInputMessage, Map)}
   * with additional context available.
   *
   * @param actualType the actual type of the target method parameter; for annotated controllers,
   *     the {@link MethodParameter} can be accessed via {@link ResolvableType#getSource()}.
  ...
  /**
   * Server-side only alternative to {@link #readMono(ResolvableType, ReactiveHttpInputMessage,
   * Map)} with additional, context available.
   *
   * @param actualType the actual type of the target method parameter; for annotated controllers,
   *     the {@link MethodParameter} can be accessed via {@link ResolvableType#getSource()}.
   * @param elementType the type of Objects in the output stream
