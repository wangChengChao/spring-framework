...
/**
 * Extension of {@link HttpEntity} that adds a {@linkplain HttpMethod method} and {@linkplain URI
 * uri}. Used in {@code RestTemplate} and {@code @Controller} methods.
 *
 * <p>In {@code RestTemplate}, this class is used as parameter in {@link
 * org.springframework.web.client.RestTemplate#exchange(RequestEntity, Class) exchange()}:
 *
 * <pre class="code">
 * MyRequest body = ...
 ...
 * </pre>
 *
 * <p>If you would like to provide a URI template with variables, consider using {@link
