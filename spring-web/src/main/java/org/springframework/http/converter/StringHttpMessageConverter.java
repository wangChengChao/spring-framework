 ...
 *
 * <p>By default, this converter supports all media types (<code>&#42;/&#42;</code>), and writes
 * with a {@code Content-Type} of {@code text/plain}. This can be overridden by setting the {@link
...
public class StringHttpMessageConverter extends AbstractHttpMessageConverter<String> {
   ...
   * from the value of {@link Charset#availableCharsets()}. The behavior is suppressed if the header
