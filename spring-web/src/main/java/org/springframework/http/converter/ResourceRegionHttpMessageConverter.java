...
/**
 * Implementation of {@link HttpMessageConverter} that can write a single {@link ResourceRegion}, or
 * Collections of {@link ResourceRegion ResourceRegions}.
 *
 * @author Brian Clozel
...
public class ResourceRegionHttpMessageConverter
  ...
  private void writeResourceRegionCollection(
      Collection<ResourceRegion> resourceRegions, HttpOutputMessage outputMessage)
      throws IOException {
    ...
    responseHeaders.set(
        HttpHeaders.CONTENT_TYPE, "multipart/byteranges; boundary=" + boundaryString);
