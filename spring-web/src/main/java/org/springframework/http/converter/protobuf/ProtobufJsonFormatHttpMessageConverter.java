...
/**
 * Subclass of {@link ProtobufHttpMessageConverter} which enforces the use of Protobuf 3 and its
 * official library {@code "com.google.protobuf:protobuf-java-util"} for JSON processing.
 *
 * <p>Most importantly, this class allows for custom JSON parser and printer configurations through
 * the {@link JsonFormat} utility. If no special parser or printer configuration is given, default
 * variants will be used instead.
 *
 * <p>Requires Protobuf 3.x and {@code "com.google.protobuf:protobuf-java-util"} 3.x, with 3.3 or
 * higher recommended.
 *
...
public class ProtobufJsonFormatHttpMessageConverter extends ProtobufHttpMessageConverter {
  ...
  /**
   * Construct a new {@code ProtobufJsonFormatHttpMessageConverter} with default {@code
   * JsonFormat.Parser} and {@code JsonFormat.Printer} configuration.
   */
  ...
  /**
   * Construct a new {@code ProtobufJsonFormatHttpMessageConverter} with the given {@code
   * JsonFormat.Parser} and {@code JsonFormat.Printer} configuration.
   *
  ...
  /**
   * Construct a new {@code ProtobufJsonFormatHttpMessageConverter} with the given {@code
   * JsonFormat.Parser} and {@code JsonFormat.Printer} configuration, also accepting a registry that
  ...
  /**
   * Construct a new {@code ProtobufJsonFormatHttpMessageConverter} with the given {@code
   * JsonFormat.Parser} and {@code JsonFormat.Printer} configuration, also accepting an initializer
   * that allows the registration of message extensions.
   *
   * @param parser the JSON parser configuration
   * @param printer the JSON printer configuration
   * @param registryInitializer an initializer for message extensions
   * @deprecated as of 5.1, in favor of {@link
