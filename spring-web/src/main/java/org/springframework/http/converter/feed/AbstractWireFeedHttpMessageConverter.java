...
/**
 * Abstract base class for Atom and RSS Feed message converters, using the <a
 * href="https://github.com/rometools/rome">ROME tools</a> project.
 *
 * <p><b>NOTE: As of Spring 4.1, this is based on the {@code com.rometools} variant of ROME, version
 * 1.5. Please upgrade your build dependency.</b>
 *
...
public abstract class AbstractWireFeedHttpMessageConverter<T extends WireFeed>
  ...
  protected T readInternal(Class<? extends T> clazz, HttpInputMessage inputMessage)
    ...
    try {
      ...
      throw new HttpMessageNotReadableException(
          "Could not read WireFeed: " + ex.getMessage(), ex, inputMessage);
    }
  }
  ...
  protected void writeInternal(T wireFeed, HttpOutputMessage outputMessage)
    ...
    Charset charset =
        (StringUtils.hasLength(wireFeed.getEncoding())
            ? Charset.forName(wireFeed.getEncoding())
            : DEFAULT_CHARSET);
