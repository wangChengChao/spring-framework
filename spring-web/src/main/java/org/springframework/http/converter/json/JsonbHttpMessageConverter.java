 ...
 * and write JSON using the <a href="http://json-b.net/">JSON Binding API</a>.
 *
...
public class JsonbHttpMessageConverter extends AbstractJsonHttpMessageConverter {
  ...
  /**
   * Set the {@code Jsonb} instance to use. If not set, a default {@code Jsonb} instance will be
   * created.
   *
   * <p>Setting a custom-configured {@code Jsonb} is one way to take further control of the JSON
