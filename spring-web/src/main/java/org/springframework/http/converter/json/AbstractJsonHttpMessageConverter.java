 ...
 *
 * <p>Note that the Jackson converters have a dedicated class hierarchy due to their multi-format
 * support.
 *
...
public abstract class AbstractJsonHttpMessageConverter
  ...
  public final Object read(
      Type type, @Nullable Class<?> contextClass, HttpInputMessage inputMessage)
