...
/**
 * Google Protocol Messages can contain message extensions that can be parsed if the appropriate
 * configuration has been registered in the {@code ExtensionRegistry}.
 *
 ...
 * @since 4.1
 * @see <a
 *     href="https://developers.google.com/protocol-buffers/docs/reference/java/com/google/protobuf/ExtensionRegistry">
