...
public abstract class AbstractJaxb2HttpMessageConverter<T>
  ...
  /**
   * Customize the {@link Marshaller} created by this message converter before using it to write the
  ...
  /**
   * Customize the {@link Unmarshaller} created by this message converter before using it to read
   * the object from the input.
   *
