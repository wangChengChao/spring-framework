...
/**
 * A simple utility class for obtaining a Google Gson 2.x {@link GsonBuilder} which Base64-encodes
 * {@code byte[]} properties when reading and writing JSON.
 *
...
public abstract class GsonBuilderUtils {
  ...
  /**
   * Obtain a {@link GsonBuilder} which Base64-encodes {@code byte[]} properties when reading and
   * writing JSON.
   *
   * <p>A custom {@link com.google.gson.TypeAdapter} will be registered via {@link
   * GsonBuilder#registerTypeHierarchyAdapter(Class, Object)} which serializes a {@code byte[]}
