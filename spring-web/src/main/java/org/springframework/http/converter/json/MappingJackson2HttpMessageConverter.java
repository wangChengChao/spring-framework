 ...
 * and write JSON using <a href="https://github.com/FasterXML/jackson">Jackson 2.x's</a> {@link
 * ObjectMapper}.
 *
 ...
 * with {@code UTF-8} character set. This can be overridden by setting the {@link
