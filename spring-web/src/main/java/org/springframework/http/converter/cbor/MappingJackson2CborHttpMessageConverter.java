 ...
 * HttpMessageConverter} that can read and write the <a href="https://cbor.io/">CBOR</a> data format
 * using <a href="https://github.com/FasterXML/jackson-dataformats-binary/tree/master/cbor">the
 * dedicated Jackson 2.x extension</a>.
 *
 * <p>By default, this converter supports the {@link MediaType#APPLICATION_CBOR_VALUE} media type.
...
public class MappingJackson2CborHttpMessageConverter extends AbstractJackson2HttpMessageConverter {
  ...
  /**
   * Construct a new {@code MappingJackson2CborHttpMessageConverter} using the default configuration
  ...
  /**
   * Construct a new {@code MappingJackson2CborHttpMessageConverter} with a custom {@link
   * ObjectMapper} (must be configured with a {@code CBORFactory} instance).
   *
  ...
  /**
   * {@inheritDoc} The {@code ObjectMapper} must be configured with a {@code CBORFactory} instance.
   */
  @Override
