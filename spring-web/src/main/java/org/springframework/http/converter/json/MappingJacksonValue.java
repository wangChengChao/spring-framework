 ...
 *
 * <p>On the server side this wrapper is added with a {@code ResponseBodyInterceptor} after content
 * negotiation selects the converter to use but before the write.
 *
 * <p>On the client side, simply wrap the POJO and pass it in to the {@code RestTemplate}.
 *
...
public class MappingJacksonValue {
  ...
  @Nullable private Class<?> serializationView;
