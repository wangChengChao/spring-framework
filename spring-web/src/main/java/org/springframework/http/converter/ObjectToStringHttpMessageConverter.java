...
/**
 * An {@code HttpMessageConverter} that uses {@link StringHttpMessageConverter} for reading and
 * writing content and a {@link ConversionService} for converting the String content to and from the
 * target object type.
 *
 * <p>By default, this converter supports the media type {@code text/plain} only. This can be
...
public class ObjectToStringHttpMessageConverter extends AbstractHttpMessageConverter<Object> {
  ...
  /**
   * A constructor accepting a {@code ConversionService} to use to convert the (String) message body
   * to/from the target class type. This constructor uses {@link
   * StringHttpMessageConverter#DEFAULT_CHARSET} as the default charset.
   *
   ...
   */
  public ObjectToStringHttpMessageConverter(
      ConversionService conversionService, Charset defaultCharset) {
