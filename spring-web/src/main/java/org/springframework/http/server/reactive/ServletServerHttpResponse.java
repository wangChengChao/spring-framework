...
class ServletServerHttpResponse extends AbstractListenerServerHttpResponse {
  ...
  @Nullable private volatile ResponseBodyFlushProcessor bodyFlushProcessor;

  @Nullable private volatile ResponseBodyProcessor bodyProcessor;
   ...
   * ServletOutputStream#isReady()} returns "true" and the readable bytes in the DataBuffer is
   * greater than 0.
   *
