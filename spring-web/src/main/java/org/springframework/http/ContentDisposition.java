...
public final class ContentDisposition {
  ...
  private ContentDisposition(
      ...
      @Nullable ZonedDateTime readDate) {
  ...
  /**
   * Return the value of the {@literal filename} parameter (or the value of the {@literal filename*}
   * one decoded as defined in the RFC 5987), or {@code null} if not defined.
   */
  @Nullable
  ...
  private static class BuilderImpl implements Builder {
    ...
    @Nullable private ZonedDateTime creationDate;

    @Nullable private ZonedDateTime modificationDate;

    @Nullable private ZonedDateTime readDate;
