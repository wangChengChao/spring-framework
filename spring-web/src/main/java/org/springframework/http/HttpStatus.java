...
public enum HttpStatus {
   ...
   * org.springframework.http.HttpStatus.Series#INFORMATIONAL}. This is a shortcut for checking the
   * value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
   */
  ...
  /**
   * Whether this status code is in the HTTP series {@link
   * org.springframework.http.HttpStatus.Series#SUCCESSFUL}. This is a shortcut for checking the
   * value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link
   * org.springframework.http.HttpStatus.Series#REDIRECTION}. This is a shortcut for checking the
   * value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link
   * org.springframework.http.HttpStatus.Series#CLIENT_ERROR}. This is a shortcut for checking the
   * value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link
   * org.springframework.http.HttpStatus.Series#SERVER_ERROR}. This is a shortcut for checking the
   * value of {@link #series()}.
   *
   * @since 4.0
   * @see #series()
  ...
  /**
   * Whether this status code is in the HTTP series {@link
   * org.springframework.http.HttpStatus.Series#CLIENT_ERROR} or {@link
   * org.springframework.http.HttpStatus.Series#SERVER_ERROR}. This is a shortcut for checking the
   * value of {@link #series()}.
   *
   * @since 5.0
