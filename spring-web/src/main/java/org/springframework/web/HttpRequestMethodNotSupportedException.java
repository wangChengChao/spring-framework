...
public class HttpRequestMethodNotSupportedException extends ServletException {
  ...
  public HttpRequestMethodNotSupportedException(
      String method, @Nullable Collection<String> supportedMethods) {
   ...
   */
  public HttpRequestMethodNotSupportedException(
      String method, @Nullable String[] supportedMethods) {
   ...
   */
  public HttpRequestMethodNotSupportedException(
      String method, @Nullable String[] supportedMethods, String msg) {
    super(msg);
    this.method = method;
  ...
  /**
   * Return the actually supported HTTP methods as {@link HttpMethod} instances, or {@code null} if
   * not known.
   *
   * @since 3.2
   */
