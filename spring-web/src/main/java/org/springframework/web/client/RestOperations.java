...
/**
 * Interface specifying a basic set of RESTful operations. Implemented by {@link RestTemplate}. Not
...
public interface RestOperations {
  ...
  /**
   * Retrieve a representation by doing a GET on the URI template. The response (if any) is
   * converted and returned.
   *
  ...
  /**
   * Retrieve a representation by doing a GET on the URL . The response (if any) is converted and
   * returned.
   *
   * @param url the URL
   * @param responseType the type of the return value
  ...
  /**
   * Retrieve a representation by doing a GET on the URI template. The response is converted and
  ...
  /**
   * Retrieve a representation by doing a GET on the URL . The response is converted and stored in
   * an {@link ResponseEntity}.
   *
   * @param url the URL
   * @param responseType the type of the return value
   ...
   * <p>URI Template variables are expanded using the given URI variables, if any.
   *
   * <p>The {@code request} parameter can be a {@link HttpEntity} in order to add additional HTTP
   * headers to the request.
   *
   * <p>The body of the entity, or {@code request} itself, can be a {@link
   * org.springframework.util.MultiValueMap MultiValueMap} to create a multipart request. The values
   * in the {@code MultiValueMap} can be any Object representing the body of the part, or an {@link
   * org.springframework.http.HttpEntity HttpEntity} representing a part with body and headers.
   *
   * @param url the URL
   ...
   * headers to the request.
   *
   * <p><b>NOTE: The standard JDK HTTP library does not support HTTP PATCH. You need to use the
   * Apache HttpComponents or OkHttp request factory.</b>
   *
   * @param url the URL
  ...
  /**
   * Update a resource by PATCHing the given object to the URL, and return the representation found
   * in the response.
   *
   * <p>The {@code request} parameter can be a {@link HttpEntity} in order to add additional HTTP
   * headers to the request.
  ...
  /**
   * Execute the HTTP method to the given URI template, writing the given request entity to the
   * request, and returns the response as {@link ResponseEntity}. The given {@link
  ...
  /**
   * Execute the request specified in the given {@link RequestEntity} and return the response as
   * {@link ResponseEntity}. Typically used in combination with the static builder methods on {@code
  ...
  /**
   * Execute the request specified in the given {@link RequestEntity} and return the response as
   * {@link ResponseEntity}. The given {@link ParameterizedTypeReference} is used to pass generic
   * type information:
   *
   * <pre class="code">
   * MyRequest body = ...
  ...
  /**
   * Execute the HTTP method to the given URI template, preparing the request with the {@link
   * RequestCallback}, and reading the response with a {@link ResponseExtractor}.
   *
   * <p>URI Template variables are expanded using the given URI variables, if any.
   *
   * @param url the URL
  ...
  /**
   * Execute the HTTP method to the given URL, preparing the request with the {@link
   * RequestCallback}, and reading the response with a {@link ResponseExtractor}.
   *
   * @param url the URL
   * @param method the HTTP method (GET, POST, etc)
