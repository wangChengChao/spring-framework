...
/**
 * Interface specifying a basic set of asynchronous RESTful operations. Implemented by {@link
 * AsyncRestTemplate}. Not often used directly, but a useful option to enhance testability, as it
...
public interface AsyncRestOperations {
   ...
   */
  <T> ListenableFuture<ResponseEntity<T>> getForEntity(
      String url, Class<T> responseType, Object... uriVariables) throws RestClientException;

  /**
   * Asynchronously retrieve a representation by doing a GET on the URI template. The response is
   * converted and stored in an {@link ResponseEntity}.
   *
  ...
  /**
   * Asynchronously retrieve a representation by doing a GET on the URL. The response is converted
  ...
  /**
   * Create a new resource by POSTing the given object to the URI template, and asynchronously
   * returns the value of the {@code Location} header. This header typically indicates where the new
   * resource is stored.
   *
   * <p>URI Template variables are expanded using the given URI variables, if any.
   *
   ...
   */
  ListenableFuture<URI> postForLocation(
      String url, @Nullable HttpEntity<?> request, Object... uriVariables)
      throws RestClientException;
   ...
   */
  ListenableFuture<URI> postForLocation(
      String url, @Nullable HttpEntity<?> request, Map<String, ?> uriVariables)
      throws RestClientException;

  /**
   * Create a new resource by POSTing the given object to the URL, and asynchronously returns the
   * value of the {@code Location} header. This header typically indicates where the new resource is
   * stored.
   *
   * @param url the URL
   * @param request the Object to be POSTed (may be {@code null})
   ...
   * @see org.springframework.http.HttpEntity
   */
  ListenableFuture<URI> postForLocation(URI url, @Nullable HttpEntity<?> request)
      throws RestClientException;
   ...
   * @see org.springframework.http.HttpEntity
   */
  <T> ListenableFuture<ResponseEntity<T>> postForEntity(
  ...
  /**
   * Asynchronously execute the HTTP method to the given URI template, writing the given request
   ...
   * @param requestEntity the entity (headers and/or body) to write to the request (may be {@code
   *     null})
   * @param responseType the type of the return value
   * @param uriVariables the variables to expand in the template
   * @return the response as entity wrapped in a {@link Future}
   */
  <T> ListenableFuture<ResponseEntity<T>> exchange(
      String url,
      HttpMethod method,
  ...
  /**
   * Asynchronously execute the HTTP method to the given URI template, writing the given request
   * entity to the request, and returns the response as {@link ResponseEntity}. The given {@link
  ...
  /**
   * Asynchronously execute the HTTP method to the given URI template, preparing the request with
   * the {@link AsyncRequestCallback}, and reading the response with a {@link ResponseExtractor}.
   *
   * <p>URI Template variables are expanded using the given URI variables, if any.
   *
   * @param url the URL
  ...
  /**
   * Asynchronously execute the HTTP method to the given URL, preparing the request with the {@link
   * AsyncRequestCallback}, and reading the response with a {@link ResponseExtractor}.
   *
   * @param url the URL
   * @param method the HTTP method (GET, POST, etc)
   * @param requestCallback object that prepares the request
