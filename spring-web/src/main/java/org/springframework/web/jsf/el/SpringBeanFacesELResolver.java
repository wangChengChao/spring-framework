...
/**
 * JSF {@code ELResolver} that delegates to the Spring root {@code WebApplicationContext}, resolving
 * name references to Spring-defined beans.
 *
 ...
 * &lt;/application></pre>
 *
 * All your JSF expressions can then implicitly refer to the names of Spring-managed service layer
 * beans, for example in property values of JSF-managed beans:
 *
 * <pre class="code">
 * &lt;managed-bean>
...
public class SpringBeanFacesELResolver extends ELResolver {
  ...
  public Iterator<FeatureDescriptor> getFeatureDescriptors(
      ELContext elContext, @Nullable Object base) {
    return null;
  }
