...
public class ServerWebExchangeContextFilter implements WebFilter {
  ...
  /**
   * Access the {@link ServerWebExchange} from the Reactor Context, if available, which is if {@link
   * ServerWebExchangeContextFilter} is configured for use and the give context was obtained from a
