 ...
 * @deprecated as of 5.1 this filter is deprecated in favor of using {@link
 *     ForwardedHeaderTransformer} which can be declared as a bean with the name
 *     "forwardedHeaderTransformer" or registered explicitly in {@link
