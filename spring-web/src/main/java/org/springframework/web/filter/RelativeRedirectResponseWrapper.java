...
/**
 * A response wrapper used for the implementation of {@link RelativeRedirectFilter} also shared with
 * {@link ForwardedHeaderFilter}.
 *
...
final class RelativeRedirectResponseWrapper extends HttpServletResponseWrapper {
  ...
  public static HttpServletResponse wrapIfNecessary(
      HttpServletResponse response, HttpStatus redirectStatus) {
