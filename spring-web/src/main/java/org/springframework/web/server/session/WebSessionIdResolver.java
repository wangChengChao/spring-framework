...
/**
 * Contract for session id resolution strategies. Allows for session id resolution through the
 * request and for sending the session id or expiring the session through the response.
 *
