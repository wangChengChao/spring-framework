...
class DefaultServerWebExchangeBuilder implements ServerWebExchange.Builder {
  ...
  @Nullable private ServerHttpRequest request;

  @Nullable private ServerHttpResponse response;

  @Nullable private Mono<Principal> principalMono;
  ...
  /**
   * An immutable wrapper of an exchange returning property overrides -- given to the constructor --
   * or original values otherwise.
   */
  private static class MutativeDecorator extends ServerWebExchangeDecorator {
    ...
    @Nullable private final Mono<Principal> principalMono;

    public MutativeDecorator(
        ServerWebExchange delegate,
        @Nullable ServerHttpRequest request,
        @Nullable ServerHttpResponse response,
        @Nullable Mono<Principal> principalMono) {
