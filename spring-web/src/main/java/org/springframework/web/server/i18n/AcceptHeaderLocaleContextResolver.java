...
/**
 * {@link LocaleContextResolver} implementation that simply uses the primary locale specified in the
 * "Accept-Language" header of the HTTP request (that is, the locale sent by the client browser,
 * normally that of the client's OS).
 *
 * <p>Note: Does not support {@link #setLocaleContext}, since the accept header can only be changed
