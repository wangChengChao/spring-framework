...
/**
 * Exception for an {@link HttpStatus#INTERNAL_SERVER_ERROR} that exposes extra information about a
 * controller method that failed, or a controller method argument that could not be resolved.
 *
...
public class ServerErrorException extends ResponseStatusException {
  ...
  @Nullable private final Method handlerMethod;

  @Nullable private final MethodParameter parameter;
