...
/**
 * {@link LocaleContextResolver} implementation that always returns a fixed locale and optionally
 * time zone. Default is the current JVM's default locale.
 *
 * <p>Note: Does not support {@link #setLocaleContext}, as the fixed locale and time zone cannot be
 * changed.
 *
