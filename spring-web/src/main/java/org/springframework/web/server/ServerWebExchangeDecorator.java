...
/**
 * A convenient base class for classes that need to wrap another {@link ServerWebExchange}.
 * Pre-implements all methods by delegating to the wrapped instance.
 *
 * <p><strong>Note:</strong> if the purpose for using a decorator is to override properties like
 * {@link #getPrincipal()}, consider using {@link ServerWebExchange#mutate()} instead.
 *
