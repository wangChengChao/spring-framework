 ...
 * applications. The exception provides additional fields (e.g. an optional {@link MethodParameter}
 * if related to the error).
 *
...
public class ServerWebInputException extends ResponseStatusException {
  ...
  public ServerWebInputException(
      String reason, @Nullable MethodParameter parameter, @Nullable Throwable cause) {
