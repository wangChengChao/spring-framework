...
/**
 * Extends {@code PathExtensionContentNegotiationStrategy} that also uses {@link
...
public class ServletPathExtensionContentNegotiationStrategy
  ...
  /**
   * Create an instance without any mappings to start with. Mappings may be added later when
   * extensions are resolved through {@link ServletContext#getMimeType(String)} or via {@link
   ...
   * class for a potential {@link org.springframework.http.MediaTypeFactory} lookup.
   */
  @Override
  @Nullable
