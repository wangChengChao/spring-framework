...
/**
 * Adapter that implements the Servlet HttpSessionBindingListener interface, wrapping a session
...
public class DestructionCallbackBindingListener
   ...
   *
   * @param destructionCallback the Runnable to execute when this listener object gets unbound from
   *     the session
   */
