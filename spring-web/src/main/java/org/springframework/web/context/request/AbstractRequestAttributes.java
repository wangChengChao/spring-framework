...
/**
 * Abstract support class for RequestAttributes implementations, offering a request completion
 * mechanism for request-specific destruction callbacks and for updating accessed session
 * attributes.
 *
...
public abstract class AbstractRequestAttributes implements RequestAttributes {
   ...
   *
   * <p>Executes all request destruction callbacks and updates the session attributes that have been
   * accessed during request processing.
   */
  ...
  /**
   * Update all session attributes that have been accessed during request processing, to expose
   * their potentially updated state to the underlying session manager.
   */
