...
public abstract class WebAsyncUtils {
  ...
  /**
   * Obtain the {@link WebAsyncManager} for the current request, or if not found, create and
  ...
  /**
   * Create an AsyncWebRequest instance. By default, an instance of {@link
   * StandardServletAsyncWebRequest} gets created.
   *
   * @param request the current request
   * @param response the current response
   * @return an AsyncWebRequest instance (never {@code null})
   */
  public static AsyncWebRequest createAsyncWebRequest(
