 ...
 *
 * <p>Implements {@link org.springframework.web.context.ConfigurableWebApplicationContext}, but is
 * not intended for declarative setup in {@code web.xml}. Instead, it is designed for programmatic
 * setup, for example for building nested contexts or for use within {@link
 * org.springframework.web.WebApplicationInitializer WebApplicationInitializers}.
 *
 * <p><b>If you intend to implement a WebApplicationContext that reads bean definitions from
 * configuration files, consider deriving from AbstractRefreshableWebApplicationContext, reading the
 * bean definitions in an implementation of the {@code loadBeanDefinitions} method.</b>
 *
 ...
 * "file:" URLs, as implemented by AbstractApplicationContext.
 *
 * <p>In addition to the special beans detected by {@link
 * org.springframework.context.support.AbstractApplicationContext}, this class detects a ThemeSource
...
public class GenericWebApplicationContext extends GenericApplicationContext
   ...
   */
  public GenericWebApplicationContext(
      DefaultListableBeanFactory beanFactory, ServletContext servletContext) {
    super(beanFactory);
    this.servletContext = servletContext;
  }
