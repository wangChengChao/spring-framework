...
/**
 * Static {@link org.springframework.web.context.WebApplicationContext} implementation for testing.
 ...
 * interface to allow for direct replacement of an {@link XmlWebApplicationContext}, despite not
...
public class StaticWebApplicationContext extends StaticApplicationContext
  ...
  protected void initPropertySources() {
    WebApplicationContextUtils.initServletPropertySources(
        getEnvironment().getPropertySources(), this.servletContext, this.servletConfig);
  }
