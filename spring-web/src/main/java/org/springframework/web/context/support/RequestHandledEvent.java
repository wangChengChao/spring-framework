 ...
 *
 * <p>Supported by Spring's own FrameworkServlet (through a specific ServletRequestHandledEvent
 * subclass), but can also be raised by any other web component.
 *
 * @author Rod Johnson
...
public class RequestHandledEvent extends ApplicationEvent {
   ...
   * @param userName the name of the user that was associated with the request, if any (usually the
   *     UserPrincipal)
