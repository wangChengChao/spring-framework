...
/**
 * Abstract adapter class for the {@link DeferredResultProcessingInterceptor} interface for
...
public abstract class DeferredResultProcessingInterceptorAdapter
  ...
  /**
   * This implementation returns {@code true} by default allowing other interceptors to be given a
   * chance to handle the timeout.
   */
  @Override
