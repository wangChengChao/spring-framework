...
class DeferredResultInterceptorChain {
  ...
  public void applyBeforeConcurrentHandling(
  ...
  public Object applyPostProcess(
      NativeWebRequest request, DeferredResult<?> deferredResult, Object concurrentResult) {
   ...
   *
   * @return {@code true} to continue error handling, or false to bypass any further error handling
   */
  public boolean triggerAfterError(
      NativeWebRequest request, DeferredResult<?> deferredResult, Throwable ex) throws Exception {
