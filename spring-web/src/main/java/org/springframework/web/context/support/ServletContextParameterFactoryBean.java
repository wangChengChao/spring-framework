 ...
 * "context-param" defined in {@code web.xml}). Exposes that ServletContext init parameter when used
 * as bean reference, effectively making it available as named Spring bean instance.
 *
 * <p><b>NOTE:</b> As of Spring 3.0, you may also use the "contextParameters" default bean which is
 * of type Map, and dereference it using an "#{contextParameters.myKey}" expression to access a
  ...
  public void setServletContext(ServletContext servletContext) {
    ...
    if (this.paramValue == null) {
      throw new IllegalStateException(
          "No ServletContext init parameter '" + this.initParamName + "' found");
    }
  }
