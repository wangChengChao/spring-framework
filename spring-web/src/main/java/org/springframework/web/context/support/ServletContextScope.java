 ...
 * ServletContext. Those attributes will get destroyed whenever the entire application shuts down,
 * which might be earlier or later than the shutdown of the containing Spring ApplicationContext.
 *
 * <p>The associated destruction mechanism relies on a {@link
 * org.springframework.web.context.ContextCleanupListener} being registered in {@code web.xml}. Note
 * that {@link org.springframework.web.context.ContextLoaderListener} includes
 * ContextCleanupListener's functionality.
 *
 * <p>This scope is registered as default scope with key {@link
