 ...
 * org.springframework.web.multipart.MultipartHttpServletRequest} interface. Provides management of
 * pre-generated parameter values.
 *
...
public class DefaultMultipartHttpServletRequest extends AbstractMultipartHttpServletRequest {
  ...
  @Nullable private Map<String, String[]> multipartParameters;

  @Nullable private Map<String, String> multipartParameterContentTypes;
   ...
   * @param mpParams a map of the parameters to expose, with Strings as keys and String arrays as
   *     values
   */
  ...
  /**
   * Set a Map with parameter names as keys and String array objects as values. To be invoked by
   * subclasses on initialization.
   */
  ...
  /**
   * Set a Map with parameter names as keys and content type Strings as values. To be invoked by
   * subclasses on initialization.
   */
  protected final void setMultipartParameterContentTypes(
      Map<String, String> multipartParameterContentTypes) {
    this.multipartParameterContentTypes = multipartParameterContentTypes;
  }

  /**
   * Obtain the multipart parameter content type Map for retrieval, lazily initializing it if
   * necessary.
   *
   * @see #initializeMultipart()
   */
