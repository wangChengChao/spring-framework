 ...
 *
 * <p>Provides common configuration properties and parsing functionality for multipart requests,
 * using a Map of Spring CommonsMultipartFile instances as representation of uploaded files and a
 * String-based parameter Map as representation of uploaded form fields.
 *
...
public abstract class CommonsFileUploadSupport {
  ...
  /**
   * Instantiate a new CommonsFileUploadSupport with its corresponding FileItemFactory and
  ...
  /**
   * Return the underlying {@code org.apache.commons.fileupload.disk.DiskFileItemFactory} instance.
  ...
  /**
   * Return the underlying {@code org.apache.commons.fileupload.FileUpload} instance. There is
  ...
  /**
   * Set the maximum allowed size (in bytes) before an upload gets rejected. -1 indicates no limit
   * (the default).
   *
  ...
  /**
   * Set the maximum allowed size (in bytes) for each individual file before an upload gets
   * rejected. -1 indicates no limit (the default).
   *
  ...
  /**
   * Set the default character encoding to use for parsing requests, to be applied to headers of
   * individual parts and to form fields. Default is ISO-8859-1, according to the Servlet spec.
   *
   ...
   *
   * <p>Default is "false", stripping off path information that may prefix the actual filename e.g.
   * from Opera. Switch this to "true" for preserving the client-specified filename as-is, including
   * potential path separators.
   *
   * @since 4.3.5
   ...
   *
   * <p>Default implementation returns a standard DiskFileItemFactory. Can be overridden to use a
   * custom subclass, e.g. for testing purposes.
   *
