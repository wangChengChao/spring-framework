...
/**
 * Adapt {@link MultipartFile} to {@link org.springframework.core.io.Resource}, exposing the content
 * as {@code InputStream} and also overriding {@link #contentLength()} as well as {@link
 * #getFilename()}.
 *
...
class MultipartFileResource extends AbstractResource {
  ...
  public boolean equals(@Nullable Object other) {
    return (this == other
        || (other instanceof MultipartFileResource
