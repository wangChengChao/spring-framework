...
/**
 * A common delegate for {@code HandlerMethodArgumentResolver} implementations which need to resolve
 * {@link MultipartFile} and {@link Part} arguments.
 *
...
public final class MultipartResolutionDelegate {
  ...
  static MultipartHttpServletRequest asMultipartHttpServletRequest(HttpServletRequest request) {
    MultipartHttpServletRequest unwrapped =
  ...
  public static Object resolveMultipartArgument(
      String name, MethodParameter parameter, HttpServletRequest request) throws Exception {
  ...
  private static List<Part> resolvePartList(HttpServletRequest request, String name)
      throws Exception {
