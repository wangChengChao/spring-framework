...
/**
 * Provide a per request {@link CorsConfiguration} instance based on a collection of {@link
 * CorsConfiguration} mapped on path patterns.
 *
...
public class UrlBasedCorsConfigurationSource implements CorsConfigurationSource {
  ...
  /**
   * Optionally configure the name of the attribute that caches the lookupPath. This is used to make
   * the call to {@link UrlPathHelper#getLookupPathForRequest(HttpServletRequest, String)}
   *
