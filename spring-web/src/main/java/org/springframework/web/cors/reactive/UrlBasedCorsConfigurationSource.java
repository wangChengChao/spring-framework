...
/**
 * Provide a per reactive request {@link CorsConfiguration} instance based on a collection of {@link
...
public class UrlBasedCorsConfigurationSource implements CorsConfigurationSource {
  ...
  /**
   * Construct a new {@code UrlBasedCorsConfigurationSource} instance with default {@code
   * PathPatternParser}.
   *
   * @since 5.0.6
   */
  ...
  /**
   * Construct a new {@code UrlBasedCorsConfigurationSource} instance from the supplied {@code
   * PathPatternParser}.
   */
