...
/**
 * {@link javax.servlet.http.HttpServletResponse} wrapper that caches all content written to the
 * {@linkplain #getOutputStream() output stream} and {@linkplain #getWriter() writer}, and allows
 * this content to be retrieved via a {@link #getContentAsByteArray() byte array}.
 *
 * <p>Used e.g. by {@link org.springframework.web.filter.ShallowEtagHeaderFilter}. Note: As of
...
public class ContentCachingResponseWrapper extends HttpServletResponseWrapper {
  ...
  @Nullable private Integer contentLength;
   ...
   *
   * @param complete whether to set a corresponding content length for the complete cached body
   *     content
   * @since 4.2
   */
