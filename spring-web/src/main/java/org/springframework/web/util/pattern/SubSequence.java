...
/**
 * Used to represent a subsection of an array, useful when wanting to pass that subset of data to
 * another method (e.g. a java regex matcher) but not wanting to create a new string object to hold
 * all that data.
 *
 * @author Andy Clement
 * @since 5.0
