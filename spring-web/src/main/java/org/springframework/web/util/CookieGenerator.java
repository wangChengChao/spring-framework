...
/**
 * Helper class for cookie generation, carrying cookie descriptor settings as bean properties and
 * being able to add and remove cookie to/from a given response.
 *
 * <p>Can serve as base class for components that generate specific cookies, such as
...
public class CookieGenerator {
  ...
  @Nullable private Integer cookieMaxAge;
  ...
  /**
   * Use the given domain for cookies created by this generator. The cookie is only visible to
  ...
  /**
   * Use the given path for cookies created by this generator. The cookie is only visible to URLs in
   * this path and below.
   *
  ...
  /**
   * Use the given maximum age (in seconds) for cookies created by this generator. Useful special
   * value: -1 ... not persistent, deleted when client shuts down.
   *
   * <p>Default is no specific maximum age at all, using the Servlet container's default.
   *
  ...
  /**
   * Set whether the cookie should only be sent using a secure protocol, such as HTTPS (SSL). This
   * is an indication to the receiving browser, not processed by the HTTP server itself.
   *
   * <p>Default is "false".
   *
  ...
  /**
   * Add a cookie with the given value to the response, using the cookie descriptor settings of this
   * generator.
   *
  ...
  /**
   * Remove the cookie that this generator describes from the response. Will generate a cookie with
  ...
  /**
   * Create a cookie with the given value, using the cookie descriptor settings of this generator
   * (except for "cookieMaxAge").
   *
