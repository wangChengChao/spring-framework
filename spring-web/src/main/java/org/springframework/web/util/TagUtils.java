...
/**
 * Utility class for tag library related code, exposing functionality such as translating {@link
 ...
 *   <li>{@code request} will be transformed to {@link javax.servlet.jsp.PageContext#REQUEST_SCOPE
 *       PageContext.REQUEST_SCOPE}
 *   <li>{@code session} will be transformed to {@link javax.servlet.jsp.PageContext#SESSION_SCOPE
 *       PageContext.SESSION_SCOPE}
 *   <li>{@code application} will be transformed to {@link
 *       javax.servlet.jsp.PageContext#APPLICATION_SCOPE PageContext.APPLICATION_SCOPE}
 * </ul>
 *
...
public abstract class TagUtils {
   ...
   *
   * <p>If the {@code String} does not match 'request', 'session', 'page' or 'application', the
   * method will return {@link PageContext#PAGE_SCOPE}.
   *
   ...
   * @throws IllegalArgumentException if either of the supplied arguments is {@code null}; or if the
   *     supplied {@code ancestorTagClass} is not type-assignable to the {@link Tag} class
   */
  ...
  /**
   * Determine whether the supplied {@link Tag} has any ancestor tag of the supplied type, throwing
   ...
   * @throws IllegalStateException if the supplied {@code tag} does not have a tag of the supplied
   *     {@code parentTagClass} as an ancestor
   * @throws IllegalArgumentException if any of the supplied arguments is {@code null}, or in the
   *     case of the {@link String}-typed arguments, is composed wholly of whitespace; or if the
   *     supplied {@code ancestorTagClass} is not type-assignable to the {@link Tag} class
  ...
  public static void assertHasAncestorOfType(
    ...
    if (!TagUtils.hasAncestorOfType(tag, ancestorTagClass)) {
      throw new IllegalStateException(
          "The '"
              + tagName
              + "' tag can only be used inside a valid '"
              + ancestorTagName
              + "' tag.");
    }
  }
