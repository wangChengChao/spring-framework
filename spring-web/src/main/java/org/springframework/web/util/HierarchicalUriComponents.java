...
final class HierarchicalUriComponents extends UriComponents {
  ...
  @Nullable private UnaryOperator<String> variableEncoder;
  ...
  HierarchicalUriComponents(
      ...
      @Nullable PathComponent path,
      @Nullable MultiValueMap<String, String> query,
      boolean encoded) {
    ...
    this.queryParams =
        query != null ? CollectionUtils.unmodifiableMultiValueMap(query) : EMPTY_QUERY_PARAMS;
  ...
  /**
   * Identical to {@link #encode()} but skipping over URI variable placeholders. Also {@link
   * #variableEncoder} is initialized with the given charset for use later when URI variables are
   * expanded.
   */
  HierarchicalUriComponents encodeTemplate(Charset charset) {
    ...
    String fragmentTo =
        (getFragment() != null ? encoder.apply(getFragment(), Type.FRAGMENT) : null);
    String userInfoTo =
        (getUserInfo() != null ? encoder.apply(getUserInfo(), Type.USER_INFO) : null);
  ...
  public HierarchicalUriComponents encode(Charset charset) {
    ...
    String fragmentTo =
        (fragment != null ? encodeUriComponent(fragment, charset, Type.FRAGMENT) : null);
    String userInfoTo =
        (this.userInfo != null ? encodeUriComponent(this.userInfo, charset, Type.USER_INFO) : null);
    String hostTo =
        (this.host != null ? encodeUriComponent(this.host, charset, getHostType()) : null);
    ...
    return new HierarchicalUriComponents(
        ...
        pathTo,
        queryParamsTo,
        EncodeState.FULLY_ENCODED,
        null);
  }

  private MultiValueMap<String, String> encodeQueryParams(
  ...
  /**
   * Encode the given source into an encoded String using the rules specified by the given component
  ...
  public URI toUri() {
    try {
      if (this.encodeState.isEncoded()) {
        ...
        return new URI(
            getScheme(), getUserInfo(), getHost(), getPort(), path, getQuery(), getFragment());
      }
  ...
  private enum EncodeState {
    ...
    /**
     * URI vars expanded first and then each URI component encoded by quoting only illegal
     * characters within that URI component.
     */
    FULLY_ENCODED,

    /**
     * URI template encoded first by quoting illegal characters only, and then URI vars encoded more
     * strictly when expanded, by quoting both illegal chars and chars with reserved meaning.
     */
    TEMPLATE_ENCODED;
  ...
  static final class FullPathComponent implements PathComponent {
    ...
    public boolean equals(@Nullable Object other) {
      return (this == other
          || (other instanceof FullPathComponent
  ...
  static final class PathSegmentComponent implements PathComponent {
    ...
    public boolean equals(@Nullable Object other) {
      return (this == other
          || (other instanceof PathSegmentComponent
