 ...
 *
 * <p>A text may contain {@code ${...}} placeholders, to be resolved as servlet context init
 * parameters or system properties: e.g. {@code ${user.dir}}. Default values can be supplied using
...
public abstract class ServletContextPropertyUtils {
  ...
  /**
   * Resolve ${...} placeholders in the given text, replacing them with corresponding servlet
   * context init parameter or system property values.
   *
  ...
  /**
   * Resolve ${...} placeholders in the given text, replacing them with corresponding servlet
   * context init parameter or system property values. Unresolvable placeholders with no default
  ...
  public static String resolvePlaceholders(
    ...
    PropertyPlaceholderHelper helper =
        (ignoreUnresolvablePlaceholders ? nonStrictHelper : strictHelper);
    return helper.replacePlaceholders(
        text, new ServletContextPlaceholderResolver(text, servletContext));
  }
      ...
      try {
        ...
        System.err.println(
            "Could not resolve placeholder '"
                ...
                + "' in ["
                + this.text
                + "] as ServletContext init-parameter or system property: "
                + ex);
        return null;
      }
    }
