...
/**
 * Default implementation of the {@link SessionAttributeStore} interface, storing the attributes in
 * the WebRequest session (i.e. HttpSession).
 *
...
public class DefaultSessionAttributeStore implements SessionAttributeStore {
   ...
   *
   * <p>Default is to use no prefix, storing the session attributes with the same name as in the
   * model.
   */
   ...
   *
   * <p>The default implementation simply prepends the configured {@link #setAttributeNamePrefix
