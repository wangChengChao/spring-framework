...
/**
 * Create a {@link WebRequestDataBinder} instance and initialize it with a {@link
...
public class DefaultDataBinderFactory implements WebDataBinderFactory {
   ...
   *
   * @param initializer for global data binder initialization (or {@code null} if none)
   */
  ...
  /**
   * Create a new {@link WebDataBinder} for the given target object and initialize it through a
  ...
  /**
   * Extension point to further initialize the created data binder instance (e.g. with
   * {@code @InitBinder} methods) after "global" initialization via {@link WebBindingInitializer}.
   *
