...
/**
 * Convenient {@link WebBindingInitializer} for declarative configuration in a Spring application
 * context. Allows for reusing pre-configured initializers with multiple controller/handlers.
 *
...
public class ConfigurableWebBindingInitializer implements WebBindingInitializer {
   ...
   *
   * <p>Default is "true" on a standard DataBinder. Note that this feature is only supported for
   * bean property access (DataBinder's default mode), not for field access.
   *
   ...
   *
   * <p>Default is {@code false}, using bean property access. Switch this to {@code true} in order
   * to enforce direct field access.
   *
   ...
   *
   * <p>Default is {@code null}, that is, using the default strategy of the data binder.
   *
   * @see org.springframework.validation.DataBinder#setBindingErrorProcessor
   */
  public final void setBindingErrorProcessor(
      @Nullable BindingErrorProcessor bindingErrorProcessor) {
  ...
  public final void setPropertyEditorRegistrars(
      @Nullable PropertyEditorRegistrar[] propertyEditorRegistrars) {
