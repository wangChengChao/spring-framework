...
/**
 * Parameter extraction methods, for an approach distinct from data binding, in which parameters of
 * specific types are required.
 *
 * <p>This approach is very useful for simple submissions, where binding request parameters to a
 * command object would be overkill.
 *
...
public abstract class ServletRequestUtils {
  ...
  /**
   * Get an Integer parameter, or {@code null} if not present. Throws an exception if it the
   * parameter value isn't a number.
   *
   * @param request current HTTP request
   * @param name the name of the parameter
   * @return the Integer value, or {@code null} if not present
   * @throws ServletRequestBindingException a subclass of ServletException, so it doesn't need to be
   *     caught
   */
  @Nullable
  ...
  /**
   * Get a Long parameter, or {@code null} if not present. Throws an exception if it the parameter
  ...
  /**
   * Get a Float parameter, or {@code null} if not present. Throws an exception if it the parameter
   * value isn't a number.
   *
   * @param request current HTTP request
   * @param name the name of the parameter
  ...
  /**
   * Get a Double parameter, or {@code null} if not present. Throws an exception if it the parameter
   * value isn't a number.
   *
   * @param request current HTTP request
   * @param name the name of the parameter
  ...
  /**
   * Get a double parameter, with a fallback value. Never throws an exception. Can pass a
   * distinguished value as default to enable checks of whether it was supplied.
   *
   * @param request current HTTP request
   * @param name the name of the parameter
  ...
  /**
   * Get a Boolean parameter, or {@code null} if not present. Throws an exception if it the
   * parameter value isn't a boolean.
   *
   * <p>Accepts "true", "on", "yes" (any case) and "1" as values for true; treats every other
  ...
  /**
   * Get a boolean parameter, with a fallback value. Never throws an exception. Can pass a
   * distinguished value as default to enable checks of whether it was supplied.
   *
   * <p>Accepts "true", "on", "yes" (any case) and "1" as values for true; treats every other
   * non-empty value as false (i.e. parses leniently).
  ...
  public static boolean getBooleanParameter(
      ServletRequest request, String name, boolean defaultVal) {
    if (request.getParameter(name) == null) {
      return defaultVal;
    }
    try {
  ...
  /**
   * Get a String parameter, with a fallback value. Never throws an exception. Can pass a
   * distinguished value to default to enable checks of whether it was supplied.
   *
   * @param request current HTTP request
   * @param name the name of the parameter
   * @param defaultVal the default value to use as fallback
