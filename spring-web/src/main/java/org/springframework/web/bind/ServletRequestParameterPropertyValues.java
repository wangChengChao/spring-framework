...
/**
 * PropertyValues implementation created from parameters in a ServletRequest. Can look for all
 * property values beginning with a certain prefix and prefix separator (default is "_").
 *
 * <p>For example, with a prefix of "spring", "spring_param1" and "spring_param2" result in a Map
 * with "param1" and "param2" as keys.
 *
 * <p>This class is not immutable to be able to efficiently remove property values that should be
 * ignored for binding.
 *
 * @author Rod Johnson
...
public class ServletRequestParameterPropertyValues extends MutablePropertyValues {
  ...
  /**
   * Create new ServletRequestPropertyValues using the given prefix and the default prefix separator
   * (the underscore character "_").
   *
   * @param request the HTTP request
   * @param prefix the prefix for parameters (the full prefix will consist of this plus the
   *     separator)
   ...
   * @param prefix the prefix for parameters (the full prefix will consist of this plus the
   *     separator)
   * @param prefixSeparator separator delimiting prefix (e.g. "spring") and the rest of the
