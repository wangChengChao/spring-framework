...
/**
 * Errors wrapper that adds automatic HTML escaping to the wrapped instance, for convenient usage in
 * HTML views. Can be retrieved easily via RequestContext's {@code getErrors} method.
 *
 * <p>Note that BindTag does <i>not</i> use this class to avoid unnecessary creation of ObjectError
 * instances. It just escapes the messages and values that get copied into the respective BindStatus
 * instance.
 *
