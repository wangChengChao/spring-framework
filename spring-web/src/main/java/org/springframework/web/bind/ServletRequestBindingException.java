 ...
 *
 * <p>Extends ServletException for convenient throwing in any Servlet resource (such as a Filter),
 * and NestedServletException for proper root cause handling (as the plain ServletException doesn't
 * expose its root cause at all).
 *
 * @author Rod Johnson
