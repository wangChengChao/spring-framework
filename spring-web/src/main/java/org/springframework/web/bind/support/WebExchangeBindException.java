...
/**
 * A specialization of {@link ServerWebInputException} thrown when after data binding and validation
 * failure. Implements {@link BindingResult} (and its super-interface {@link Errors}) to allow for
 * direct analysis of binding and validation errors.
 *
...
public class WebExchangeBindException extends ServerWebInputException implements BindingResult {
  ...
  public String getMessage() {
    ...
    StringBuilder sb =
        new StringBuilder("Validation failed for argument at index ")
