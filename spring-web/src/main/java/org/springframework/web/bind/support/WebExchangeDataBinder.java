...
/**
 * Specialized {@link org.springframework.validation.DataBinder} to perform data binding from URL
 * query params or form data in the request data to Java objects.
 *
...
public class WebExchangeDataBinder extends WebDataBinder {
  ...
  /**
   * Protected method to obtain the values for data binding. By default this method delegates to
   ...
   * {@code Map<String, Object>} of values to use for data binding purposes.
   *
   * @param exchange the current exchange
