 ...
 * constructor.
 *
 * <p>A {@link WebDataBinder} is created to apply type conversion to the resolved argument value if
 * it doesn't match the method parameter type.
 *
...
public abstract class AbstractNamedValueMethodArgumentResolver
   ...
   */
  @Nullable
  protected abstract Object resolveName(
