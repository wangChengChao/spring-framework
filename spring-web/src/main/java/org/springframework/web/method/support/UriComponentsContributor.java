...
/**
 * Strategy for contributing to the building of a {@link UriComponents} by looking at a method
 * parameter and an argument value and deciding what part of the target URL should be updated.
 *
...
public interface UriComponentsContributor {
  ...
  /**
   * Process the given method argument and either update the {@link UriComponentsBuilder} or add to
   * the map with URI variables to use to expand the URI after all arguments are processed.
   *
