...
/**
 * Resolves a {@link SessionStatus} argument by obtaining it from the {@link ModelAndViewContainer}.
 *
...
public class SessionStatusMethodArgumentResolver implements HandlerMethodArgumentResolver {
  ...
  public Object resolveArgument(
    ...
    Assert.state(
        mavContainer != null, "ModelAndViewContainer is required for session status exposure");
