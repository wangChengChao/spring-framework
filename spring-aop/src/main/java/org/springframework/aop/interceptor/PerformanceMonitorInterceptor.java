...
/**
 * Simple AOP Alliance {@code MethodInterceptor} for performance monitoring. This interceptor has no
 * effect on the intercepted method call.
 *
...
public class PerformanceMonitorInterceptor extends AbstractMonitoringInterceptor {
  ...
  /**
   * Create a new PerformanceMonitorInterceptor with a dynamic or static logger, according to the
   * given flag.
   *
