...
/**
 * Simple AOP Alliance {@code MethodInterceptor} that can be introduced in a chain to display
 * verbose trace information about intercepted method invocations, with method entry and method exit
 * info.
 *
