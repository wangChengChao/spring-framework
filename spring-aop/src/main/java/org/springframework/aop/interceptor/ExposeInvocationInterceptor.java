 ...
 *
 * <p>Don't use this interceptor unless this is really necessary. Target objects should not normally
 * know about Spring AOP, as this creates a dependency on Spring API. Target objects should be plain
 * POJOs as far as possible.
 *
...
public final class ExposeInvocationInterceptor
  ...
  /**
   * Singleton advisor for this class. Use in preference to INSTANCE when using Spring AOP, as it
   * prevents the need to create a new Advisor to wrap the instance.
   */
  public static final Advisor ADVISOR =
      new DefaultPointcutAdvisor(INSTANCE) {
        @Override
  ...
  /**
   * Required to support serialization. Replaces with canonical instance on deserialization,
