...
/**
 * Extension of AopConfigException thrown when trying to perform an advisor generation operation on
 * a class that is not an AspectJ annotation-style aspect.
 *
 * @author Rod Johnson
 * @since 2.0
 */
