 ...
 * expect. Use a {@link LazySingletonAspectInstanceFactoryDecorator} to wrap this to ensure only one
 * new aspect comes back.
 *
 * @author Rod Johnson
...
public class PrototypeAspectInstanceFactory extends BeanFactoryAspectInstanceFactory
  ...
  /**
   * Create a PrototypeAspectInstanceFactory. AspectJ will be called to introspect to create AJType
   * metadata using the type returned for the given bean name from the BeanFactory.
   *
