...
public abstract class AspectJAopUtils {
  ...
  /**
   * Return the AspectJPrecedenceInformation provided by this advisor or its advice. If neither the
   * advisor nor the advice have precedence information, this method will return {@code null}.
   */
  @Nullable
