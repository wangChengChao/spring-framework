...
/**
 * Factory that can create Spring AOP Advisors given AspectJ classes from classes honoring the
 * AspectJ 5 annotation syntax, using reflection to invoke the corresponding advice methods.
 *
 * @author Rod Johnson
...
public class ReflectiveAspectJAdvisorFactory extends AbstractAspectJAdvisorFactory
  ...
  static {
    Comparator<Method> adviceKindComparator =
        new ConvertingComparator<>(
            new InstanceComparator<>(
                Around.class, Before.class, After.class, AfterReturning.class, AfterThrowing.class),
            (Converter<Method, Annotation>)
                method -> {
   ...
   * to the created {@link AspectJExpressionPointcut} instances, for bean pointcut handling as well
   * as consistent {@link ClassLoader} resolution.
   *
  ...
  protected static class SyntheticInstantiationAdvisor extends DefaultPointcutAdvisor {
    ...
    public SyntheticInstantiationAdvisor(final MetadataAwareAspectInstanceFactory aif) {
      super(
          aif.getAspectMetadata().getPerClausePointcut(),
