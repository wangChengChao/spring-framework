...
public class TypePatternClassFilter implements ClassFilter {
  ...
  @Nullable private TypePatternMatcher aspectJTypePatternMatcher;

  /**
   * Creates a new instance of the {@link TypePatternClassFilter} class.
   *
   * <p>This is the JavaBean constructor; be sure to set the {@link #setTypePattern(String)
   * typePattern} property, else a no doubt fatal {@link IllegalStateException} will be thrown when
   * the {@link #matches(Class)} method is first invoked.
   */
  public TypePatternClassFilter() {}

  /**
   * Create a fully configured {@link TypePatternClassFilter} using the given type pattern.
   *
   ...
   *
   * <p>Examples include: <code class="code">
   * org.springframework.beans.*
   * </code> This will match any class or interface in the given package. <code class="code">
   * org.springframework.beans.ITestBean+
   * </code> This will match the {@code ITestBean} interface and any class that implements it.
   *
  ...
  /**
   * If a type pattern has been specified in XML, the user cannot write {@code and} as "&&" (though
   * &amp;&amp; will work). We also allow {@code and} between two sub-expressions.
   *
