...
/**
 * Implementation of {@link AspectInstanceFactory} that creates a new instance of the specified
 * aspect class for every {@link #getAspectInstance()} call.
 *
...
public class SimpleAspectInstanceFactory implements AspectInstanceFactory {
  ...
  public final Object getAspectInstance() {
    try {
      ...
      throw new AopConfigException(
          "Failed to invoke aspect constructor: " + this.aspectClass.getName(),
  ...
  /**
   * Determine the order for this factory's aspect instance, either an instance-specific order
   * expressed through implementing the {@link org.springframework.core.Ordered} interface, or a
   * fallback order.
   *
  ...
  /**
   * Determine a fallback order for the case that the aspect instance does not express an
   * instance-specific order through implementing the {@link org.springframework.core.Ordered}
   * interface.
   *
