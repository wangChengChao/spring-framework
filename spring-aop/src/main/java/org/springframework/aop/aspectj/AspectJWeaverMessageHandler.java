...
/**
 * Implementation of AspectJ's {@link IMessageHandler} interface that routes AspectJ weaving
 * messages through the same logging system as the regular Spring messages.
 *
 * <p>Pass the option...
 *
 * <p><code class="code">
 * -XmessageHandlerClass:org.springframework.aop.aspectj.AspectJWeaverMessageHandler</code>
 *
 * <p>to the weaver; for example, specifying the following in a "{@code META-INF/aop.xml} file:
 *
