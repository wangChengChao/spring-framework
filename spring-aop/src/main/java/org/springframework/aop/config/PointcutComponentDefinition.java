...
/**
 * {@link org.springframework.beans.factory.parsing.ComponentDefinition} implementation that holds a
 * pointcut definition.
 *
 * @author Rob Harrop
 * @since 2.0
...
public class PointcutComponentDefinition extends AbstractComponentDefinition {
  ...
  public PointcutComponentDefinition(
    ...
    this.description =
        "Pointcut <name='" + pointcutBeanName + "', expression=[" + expression + "]>";
  }
