...
/**
 * Base implementation for {@link org.springframework.beans.factory.xml.BeanDefinitionDecorator
 * BeanDefinitionDecorators} wishing to add an {@link org.aopalliance.intercept.MethodInterceptor
 * interceptor} to the resulting bean.
 *
 * <p>This base class controls the creation of the {@link ProxyFactoryBean} bean definition and
 * wraps the original as an inner-bean definition for the {@code target} property of {@link
 * ProxyFactoryBean}.
 *
 * <p>Chaining is correctly handled, ensuring that only one {@link ProxyFactoryBean} definition is
 * created. If a previous {@link org.springframework.beans.factory.xml.BeanDefinitionDecorator}
 ...
 *
 * <p>Subclasses have only to create the {@code BeanDefinition} to the interceptor that they wish to
 * add.
 *
 * @author Rob Harrop
...
public abstract class AbstractInterceptorDrivenBeanDefinitionDecorator
  ...
  public final BeanDefinitionHolder decorate(
    ...
    BeanDefinitionHolder targetHolder =
        new BeanDefinitionHolder(targetDefinition, existingBeanName + ".TARGET");
    ...
    String interceptorName =
        existingBeanName + '.' + getInterceptorNameSuffix(interceptorDefinition);
  ...
  /**
   * Subclasses should implement this method to return the {@code BeanDefinition} for the
   * interceptor they wish to apply to the bean being decorated.
   */
