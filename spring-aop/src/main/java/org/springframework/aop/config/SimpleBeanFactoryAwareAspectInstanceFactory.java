...
/**
 * Implementation of {@link AspectInstanceFactory} that locates the aspect from the {@link
 * org.springframework.beans.factory.BeanFactory} using a configured bean name.
 *
 * @author Rob Harrop
...
public class SimpleBeanFactoryAwareAspectInstanceFactory
  ...
  /**
   * Set the name of the aspect bean. This is the bean that is returned when calling {@link
   * #getAspectInstance()}.
   */
