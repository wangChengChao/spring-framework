...
/**
 * Pointcut and method matcher for use in simple <b>cflow</b>-style pointcut. Note that evaluating
 * such pointcuts is 10-15 times slower than evaluating normal pointcuts, but they are useful in
 * some cases.
 *
 * @author Rod Johnson
 * @author Rob Harrop
...
public class ControlFlowPointcut implements Pointcut, ClassFilter, MethodMatcher, Serializable {
  ...
  /**
   * Construct a new pointcut that matches all calls below the given method in the given class. If
   * no method name is given, matches all control flows below the given class.
   *
   * @param clazz the clazz
