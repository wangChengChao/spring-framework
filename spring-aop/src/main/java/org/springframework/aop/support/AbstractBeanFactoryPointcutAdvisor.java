...
/**
 * Abstract BeanFactory-based PointcutAdvisor that allows for any Advice to be configured as
...
public abstract class AbstractBeanFactoryPointcutAdvisor extends AbstractPointcutAdvisor
   ...
   *
   * <p>An instance of the specified bean will be obtained on first access of this advisor's advice.
   * This advisor will only ever obtain at most one single instance of the advice bean, caching the
   * instance for the lifetime of the advisor.
   *
   * @see #getAdvice()
   */
  ...
  /**
   * Specify a particular instance of the target advice directly, avoiding lazy resolution in {@link
   * #getAdvice()}.
   *
   * @since 3.1
   */
