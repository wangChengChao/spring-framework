...
/**
 * Simple Pointcut that looks for a specific Java 5 annotation being present on a {@link
 * #forClassAnnotation class} or {@link #forMethodAnnotation method}.
 *
...
public class AnnotationMatchingPointcut implements Pointcut {
   ...
   *
   * @param classAnnotationType the annotation type to look for at the class level
   * @param checkInherited whether to also check the superclasses and interfaces as well as
   *     meta-annotations for the annotation type
   * @see AnnotationClassFilter#AnnotationClassFilter(Class, boolean)
   */
  public AnnotationMatchingPointcut(
      Class<? extends Annotation> classAnnotationType, boolean checkInherited) {
   ...
   * Create a new AnnotationMatchingPointcut for the given annotation type.
   *
   * @param classAnnotationType the annotation type to look for at the class level (can be {@code
   *     null})
   * @param methodAnnotationType the annotation type to look for at the method level (can be {@code
   *     null})
   */
  public AnnotationMatchingPointcut(
      @Nullable Class<? extends Annotation> classAnnotationType,
  ...
  public AnnotationMatchingPointcut(
    ...
    Assert.isTrue(
        (classAnnotationType != null || methodAnnotationType != null),
  ...
  /**
   * Factory method for an AnnotationMatchingPointcut that matches for the specified annotation at
   * the class level.
   *
   ...
   */
  public static AnnotationMatchingPointcut forClassAnnotation(
   ...
   * @return the corresponding AnnotationMatchingPointcut
   */
  public static AnnotationMatchingPointcut forMethodAnnotation(
      Class<? extends Annotation> annotationType) {
    Assert.notNull(annotationType, "Annotation type must not be null");
  ...
  /**
   * {@link ClassFilter} that delegates to {@link AnnotationUtils#isCandidateClass} for filtering
   * classes whose methods are not worth searching to begin with.
   */
