...
public abstract class ClassFilters {
   ...
   * @return a distinct ClassFilter that matches all classes that either of the given ClassFilter
   *     matches
   */
   ...
   * @param cf1 the first ClassFilter
   * @param cf2 the second ClassFilter
   * @return a distinct ClassFilter that matches all classes that both of the given ClassFilter
   *     match
   */
  ...
  private static class UnionClassFilter implements ClassFilter, Serializable {
    ...
    public boolean equals(@Nullable Object other) {
      return (this == other
          || (other instanceof UnionClassFilter
  ...
  private static class IntersectionClassFilter implements ClassFilter, Serializable {
    ...
    public boolean equals(@Nullable Object other) {
      return (this == other
          || (other instanceof IntersectionClassFilter
              && ObjectUtils.nullSafeEquals(
                  this.filters, ((IntersectionClassFilter) other).filters)));
    }
