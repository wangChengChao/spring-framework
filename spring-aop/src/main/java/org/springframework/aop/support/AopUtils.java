 ...
 *
 * <p>See {@link org.springframework.aop.framework.AopProxyUtils} for a collection of
 * framework-specific AOP utility methods which depend on internals of Spring's AOP framework
 * implementation.
 *
 * @author Rod Johnson
...
public abstract class AopUtils {
   ...
   *
   * <p>This method goes beyond the implementation of {@link Proxy#isProxyClass(Class)} by
   * additionally checking if the given object is an instance of {@link SpringProxy}.
   *
   * @param object the object to check
   ...
   *
   * <p>This method goes beyond the implementation of {@link ClassUtils#isCglibProxy(Object)} by
   * additionally checking if the given object is an instance of {@link SpringProxy}.
   *
   * @param object the object to check
   ...
   * invocation, find the corresponding target method if there is one. E.g. the method may be {@code
   * IFoo.bar()} and the target class may be {@code DefaultFoo}. In this case, the method may be
   * {@code DefaultFoo.bar()}. This enables attributes on that method to be found.
   *
   * <p><b>NOTE:</b> In contrast to {@link
   * org.springframework.util.ClassUtils#getMostSpecificMethod}, this method resolves Java 5 bridge
   * methods in order to retrieve attributes from the <i>original</i> method definition.
   *
   ...
   *
   * <p>This is an important test as it can be used to optimize out a advisor for a class. This
   * version also takes into account introductions (for IntroductionAwareMethodMatchers).
   *
   * @param advisor the advisor to check
   * @param targetClass class we're testing
   * @param hasIntroductions whether or not the advisor chain for this bean includes any
   ...
   * @return sublist of Advisors that can apply to an object of the given class (may be the incoming
   *     List as-is)
   */
