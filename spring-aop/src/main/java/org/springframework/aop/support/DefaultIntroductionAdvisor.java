...
/**
 * Simple {@link org.springframework.aop.IntroductionAdvisor} implementation that by default applies
 * to any class.
 *
 * @author Rod Johnson
...
public class DefaultIntroductionAdvisor
   ...
   *
   * @param advice the Advice to apply (may implement the {@link
   *     org.springframework.aop.IntroductionInfo} interface)
   * @see #addInterface
   */
   ...
   * @param introductionInfo the IntroductionInfo that describes the interface to introduce (may be
   *     {@code null})
   */
  ...
  public void addInterface(Class<?> intf) {
    ...
    if (!intf.isInterface()) {
      throw new IllegalArgumentException(
          "Specified class [" + intf.getName() + "] must be an interface");
    }
