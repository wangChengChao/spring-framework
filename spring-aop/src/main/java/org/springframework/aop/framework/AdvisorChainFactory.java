...
public interface AdvisorChainFactory {
   ...
   * @param targetClass the target class (may be {@code null} to indicate a proxy without target
   *     object, in which case the method's declaring class is the next best option)
