...
public abstract class AutoProxyUtils {
   ...
   *
   * <p>Proxy factories can set this attribute if they built a target class proxy for a specific
   * bean, and want to enforce that bean can always be cast to its target class (even if AOP advices
   * get applied through auto-proxying).
   *
  ...
  /**
   * Determine whether the given bean name indicates an "original instance" according to {@link
   * AutowireCapableBeanFactory#ORIGINAL_INSTANCE_SUFFIX}, skipping any proxy attempts for it.
   *
   * @param beanName the name of the bean
