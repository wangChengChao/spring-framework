 ...
 *
 * <p>Creates a dynamic proxy, implementing the interfaces exposed by the AopProxy. Dynamic proxies
 * <i>cannot</i> be used to proxy methods defined in classes, rather than interfaces.
 *
 * <p>Objects of this type should be obtained through proxy factories, configured by an {@link
 * AdvisedSupport} class. This class is internal to Spring's AOP framework and need not be used
 * directly by client code.
 *
 * <p>Proxies created using this class will be thread-safe if the underlying (target) class is
 * thread-safe.
 *
 * <p>Proxies are serializable so long as all Advisors (including Advices and Pointcuts) and the
 * TargetSource are serializable.
 *
 * @author Rod Johnson
