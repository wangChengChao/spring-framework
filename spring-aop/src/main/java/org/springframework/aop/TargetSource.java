 ...
 * etc.
 *
 * <p>Application developers don't usually need to work with {@code TargetSources} directly: this is
 * an AOP framework interface.
 *
 * @author Rod Johnson
...
public interface TargetSource extends TargetClassAware {
   ...
   *
   * <p>Can return {@code null}, although certain usages of a {@code TargetSource} might just work
   * with a predetermined target class.
   *
   * @return the type of targets returned by this {@link TargetSource}
   */
  @Override
   ...
   *
   * <p>In that case, there will be no need to invoke {@link #releaseTarget(Object)}, and the AOP
   * framework can cache the return value of {@link #getTarget()}.
   *
   ...
   *
   * @return the target object which contains the joinpoint, or {@code null} if there is no actual
   *     target instance
