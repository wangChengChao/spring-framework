...
/**
 * Unit tests relating to the abstract {@link AbstractPrototypeBasedTargetSource} and not
 * subclasses.
 *
 * @author Rod Johnson
 * @author Chris Beams
...
public class PrototypeBasedTargetSourceTests {
  ...
  private static class TestTargetSource extends AbstractPrototypeBasedTargetSource {
    ...
    /**
     * Nonserializable test field to check that subclass state can't prevent serialization from
     * working
     */
