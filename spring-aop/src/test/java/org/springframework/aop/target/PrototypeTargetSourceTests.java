...
public class PrototypeTargetSourceTests {
  ...
  public void setup() {
    ...
    new XmlBeanDefinitionReader(this.beanFactory)
        .loadBeanDefinitions(qualifiedResource(PrototypeTargetSourceTests.class, "context.xml"));
  }

  /**
   * Test that multiple invocations of the prototype bean will result in no change to visible state,
   * as a new instance is used. With the singleton, there will be change.
   */
  @Test
