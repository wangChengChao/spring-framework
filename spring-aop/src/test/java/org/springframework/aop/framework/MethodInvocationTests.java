...
class MethodInvocationTests {
  ...
  void testValidInvocation() throws Throwable {
    ...
    List<Object> interceptors =
        Collections.singletonList((MethodInterceptor) invocation -> returnValue);
    ReflectiveMethodInvocation invocation =
        new ReflectiveMethodInvocation(proxy, null, method, null, null, interceptors);
  ...
  void testToStringDoesntHitTarget() throws Throwable {
    ...
    Object proxy = new Object();
    ReflectiveMethodInvocation invocation =
        new ReflectiveMethodInvocation(proxy, target, m, null, null, interceptors);
