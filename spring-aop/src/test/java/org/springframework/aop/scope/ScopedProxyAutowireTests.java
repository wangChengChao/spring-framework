...
public class ScopedProxyAutowireTests {
  ...
  public void testScopedProxyInheritsAutowireCandidateFalse() {
    ...
    assertThat(
            Arrays.asList(bf.getBeanNamesForType(TestBean.class, false, false)).contains("scoped"))
        .isTrue();
    assertThat(
            Arrays.asList(bf.getBeanNamesForType(TestBean.class, true, false)).contains("scoped"))
        .isTrue();
