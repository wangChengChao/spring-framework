...
public class AspectJNamespaceHandlerTests {
  ...
  public void testRegisterAutoProxyCreator() throws Exception {
    ...
    assertThat(registry.getBeanDefinitionCount())
        .as("Incorrect number of definitions registered")
        .isEqualTo(1);
  ...
  public void testRegisterAspectJAutoProxyCreator() throws Exception {
    ...
    assertThat(definition.getBeanClassName())
        .as("Incorrect APC class")
        .isEqualTo(AspectJAwareAdvisorAutoProxyCreator.class.getName());
  }
