...
/**
 * Tests just the annotation binding part of {@link AspectJAdviceParameterNameDiscoverer}; see
 * supertype for remaining tests.
 *
...
public class TigerAspectJAdviceParameterNameDiscovererTests
  ...
  public void testAnnotationMedley() {
    assertParameterNames(
        getMethod("annotationMedley"),
        "@annotation(a) && args(count) && this(foo)",
        null,
        "ex",
