...
/**
 * Additional parameter name discover tests that need Java 5. Yes this will re-run the tests from
 * the superclass, but that doesn't matter in the grand scheme of things...
 *
