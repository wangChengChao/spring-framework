...
public class CustomizableTraceInterceptorTests {
  ...
  public void testSetEmptyEnterMessage() {
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(() -> new CustomizableTraceInterceptor().setEnterMessage(""));
  }
        ...
        .isThrownBy(
            () ->
                new CustomizableTraceInterceptor()
                    .setEnterMessage(CustomizableTraceInterceptor.PLACEHOLDER_RETURN_VALUE));
  }
  ...
  public void testSetEnterMessageWithExceptionPlaceholder() {
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
                new CustomizableTraceInterceptor()
                    .setEnterMessage(CustomizableTraceInterceptor.PLACEHOLDER_EXCEPTION));
  }
  ...
  public void testSetEmptyExitMessage() {
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(() -> new CustomizableTraceInterceptor().setExitMessage(""));
  }
  ...
  public void testSetExitMessageWithExceptionPlaceholder() {
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(
            () ->
                new CustomizableTraceInterceptor()
                    .setExitMessage(CustomizableTraceInterceptor.PLACEHOLDER_EXCEPTION));
  }
  ...
  public void testSetEmptyExceptionMessage() {
    ...
    assertThatIllegalArgumentException()
        .isThrownBy(() -> new CustomizableTraceInterceptor().setExceptionMessage(""));
  }
  ...
  @Test
  public void testSunnyDayPathLogsCorrectlyWithPrettyMuchAllPlaceholdersMatching()
      throws Throwable {

    MethodInvocation methodInvocation = mock(MethodInvocation.class);

    given(methodInvocation.getMethod())
        .willReturn(String.class.getMethod("toString", new Class[0]));
    given(methodInvocation.getThis()).willReturn(this);
    ...
    interceptor.setEnterMessage(
        new StringBuffer()
            .append("Entering the '")
            .append(CustomizableTraceInterceptor.PLACEHOLDER_METHOD_NAME)
            ...
            .append(CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENTS)
            .append(") and arg types (")
            .append(CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENT_TYPES)
            .append(").")
            .toString());
    interceptor.setExitMessage(
        new StringBuffer()
            ...
            .append(CustomizableTraceInterceptor.PLACEHOLDER_ARGUMENT_TYPES)
            .append("), returning '")
            .append(CustomizableTraceInterceptor.PLACEHOLDER_RETURN_VALUE)
            .append("' and taking '")
            .append(CustomizableTraceInterceptor.PLACEHOLDER_INVOCATION_TIME)
            .append("' this long.")
            .toString());
    interceptor.invoke(methodInvocation);
