...
/**
 * Represents a container for MIME attachments Concrete implementations might adapt a SOAPMessage or
 * an email message.
 *
...
public interface MimeContainer {
   ...
   *
   * @return {@code true} when the constraints specified in <a
   *     href="https://www.w3.org/TR/2005/REC-xop10-20050125/#identifying_xop_documents">Identifying
