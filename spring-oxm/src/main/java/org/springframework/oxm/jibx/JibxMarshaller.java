 ...
 *
 * <p>The typical usage will be to set the {@code targetClass} and optionally the {@code
...
public class JibxMarshaller extends AbstractMarshaller implements InitializingBean {
  ...
  @Nullable private Class<?> targetClass;

  @Nullable private String targetPackage;

  @Nullable private String bindingName;
  ...
  @Nullable private String docTypeRootElementName;

  @Nullable private String docTypeSystemId;

  @Nullable private String docTypePublicId;

  @Nullable private String docTypeInternalSubset;

  @Nullable private IBindingFactory bindingFactory;

  private final TransformerFactory transformerFactory = TransformerFactory.newInstance();

  /**
   * Set the target class for this instance. Setting either this property or the {@link
   * #setTargetPackage(String) targetPackage} property is required.
   *
  ...
  /**
   * Set the target package for this instance. Setting either this property or the {@link
   * #setTargetClass(Class) targetClass} property is required.
   *
  ...
  /**
   * Set the root element name for the DTD declaration written when marshalling. By default, this is
   * {@code null} (i.e. no DTD declaration is written).
   *
  ...
  /**
   * Set the system id for the DTD declaration written when marshalling. By default, this is {@code
   * null}. Only used when the root element also has been set.
   *
  ...
  /**
   * Set the public id for the DTD declaration written when marshalling. By default, this is {@code
   * null}. Only used when the root element also has been set.
   *
  ...
  /**
   * Set the internal subset Id for the DTD declaration written when marshalling. By default, this
   * is {@code null}. Only used when the root element also has been set.
   *
   * @see #setDocTypeRootElementName(String)
   */
  ...
  protected void marshalDomNode(Object graph, Node node) throws XmlMappingException {
    try {
      // JiBX does not support DOM natively, so we write to a buffer first, and transform that to
      // the Node
  ...
  private Object transformAndUnmarshal(Source source, @Nullable String encoding)
      throws IOException {
    try {
      Transformer transformer = this.transformerFactory.newTransformer();
      if (encoding != null) {
  ...
  /**
   * Convert the given {@code JiBXException} to an appropriate exception from the {@code
