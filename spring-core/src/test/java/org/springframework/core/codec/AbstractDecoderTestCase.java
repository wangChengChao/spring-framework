...
/**
 * Abstract base class for {@link Decoder} unit tests. Subclasses need to implement {@link
 * #canDecode()}, {@link #decode()} and {@link #decodeToMono()}, possibly using the wide variety of
 * helper methods like {@link #testDecodeAll} or {@link #testDecodeToMonoAll}.
 *
...
public abstract class AbstractDecoderTestCase<D extends Decoder<?>>
  ...
  /**
   * Subclasses should implement this method to test {@link Decoder#decode}, possibly using {@link
   * #testDecodeAll} or other helper methods.
   */
  @Test
   ...
   *
   * <ul>
   *   <li>{@link #testDecode(Publisher, ResolvableType, Consumer, MimeType, Map)}
   *   <li>{@link #testDecodeError(Publisher, ResolvableType, MimeType, Map)}
   *   <li>{@link #testDecodeCancel(Publisher, ResolvableType, MimeType, Map)}
   *   <li>{@link #testDecodeEmpty(ResolvableType, MimeType, Map)}
   * </ul>
   *
   ...
   */
  protected <T> void testDecodeAll(
  ...
  /**
   * Test a {@link Decoder#decode decode} scenario where the input stream contains an error. This
   * test method will feed the first element of the {@code input} stream to the decoder, followed by
   ...
   * @see InputException
   */
  protected void testDecodeError(
      Publisher<DataBuffer> input,
      ResolvableType outputType,
      @Nullable MimeType mimeType,
      @Nullable Map<String, Object> hints) {
    ...
    assertThatExceptionOfType(InputException.class)
        .isThrownBy(
            () ->
                this.decoder
                    .decode(buffer, outputType, mimeType, hints)
   ...
   * @param hints the hints used for decoding. May be {@code null}.
   */
  protected void testDecodeCancel(
      Publisher<DataBuffer> input,
      ResolvableType outputType,
      @Nullable MimeType mimeType,
      @Nullable Map<String, Object> hints) {
  ...
  /**
   * Test a {@link Decoder#decode decode} scenario where the input stream is empty. The output is
   ...
   * @param hints the hints used for decoding. May be {@code null}.
   */
  protected void testDecodeEmpty(
      ResolvableType outputType, @Nullable MimeType mimeType, @Nullable Map<String, Object> hints) {
   ...
   *
   * <ul>
   *   <li>{@link #testDecodeToMono(Publisher, ResolvableType, Consumer, MimeType, Map)}
   *   <li>{@link #testDecodeToMonoError(Publisher, ResolvableType, MimeType, Map)}
   *   <li>{@link #testDecodeToMonoCancel(Publisher, ResolvableType, MimeType, Map)}
   *   <li>{@link #testDecodeToMonoEmpty(ResolvableType, MimeType, Map)}
   * </ul>
   *
   * @param input the input to be provided to the decoder
   * @param outputClass the desired output class
   ...
   * @param <T> the output type
   */
  protected <T> void testDecodeToMonoAll(
      Publisher<DataBuffer> input,
      Class<? extends T> outputClass,
      Consumer<StepVerifier.FirstStep<T>> stepConsumer) {
   ...
   * @param <T> the output type
   */
  protected <T> void testDecodeToMono(
      Publisher<DataBuffer> input,
      Class<? extends T> outputClass,
      Consumer<StepVerifier.FirstStep<T>> stepConsumer) {
   ...
   * followed by an {@link InputException}. The result is expected to contain the error.
   *
   * @param input the input to be provided to the decoder
   * @param outputType the desired output type
   * @param mimeType the mime type to use for decoding. May be {@code null}.
   ...
   * @see InputException
   */
  protected void testDecodeToMonoError(
      Publisher<DataBuffer> input,
      ResolvableType outputType,
      @Nullable MimeType mimeType,
      @Nullable Map<String, Object> hints) {
  ...
  /**
   * Test a {@link Decoder#decodeToMono decode} scenario where the input stream is canceled. This
   * test method will immediately cancel the output stream.
   *
   * @param input the input to be provided to the decoder
   * @param outputType the desired output type
   * @param mimeType the mime type to use for decoding. May be {@code null}.
   * @param hints the hints used for decoding. May be {@code null}.
   */
  protected void testDecodeToMonoCancel(
      Publisher<DataBuffer> input,
      ResolvableType outputType,
      @Nullable MimeType mimeType,
      @Nullable Map<String, Object> hints) {
  ...
  /**
   * Test a {@link Decoder#decodeToMono decode} scenario where the input stream is empty. The output
   * is expected to be empty as well.
   *
   * @param outputType the desired output type
   * @param mimeType the mime type to use for decoding. May be {@code null}.
   * @param hints the hints used for decoding. May be {@code null}.
   */
  protected void testDecodeToMonoEmpty(
      ResolvableType outputType, @Nullable MimeType mimeType, @Nullable Map<String, Object> hints) {
