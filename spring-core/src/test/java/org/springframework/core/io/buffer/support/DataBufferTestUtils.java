 ...
 *
 * <p>Note that this class is in the {@code test} tree of the project: the methods contained herein
 * are not suitable for production code bases.
 *
...
public abstract class DataBufferTestUtils {
   ...
   *
   * <p>Note that this method reads the entire buffer into the heap, which might consume a lot of
   * memory.
   *
