...
class MergedAnnotationClassLoaderTests {
  ...
  void synthesizedUsesCorrectClassLoader() throws Exception {
    ...
    Annotation metaAnnotation =
        getDeclaredAnnotation(annotation.annotationType(), TEST_META_ANNOTATION);
    ...
    Annotation utilsMeta =
        AnnotatedElementUtils.getMergedAnnotation(source, TestMetaAnnotation.class);
