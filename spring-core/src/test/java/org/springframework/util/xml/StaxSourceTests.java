...
class StaxSourceTests {
  ...
  void streamReaderSourceToStreamResult() throws Exception {
    ...
    assertThat(source.getXMLStreamReader())
        .as("Invalid streamReader returned")
        .isEqualTo(streamReader);
  ...
  void eventReaderSourceToStreamResult() throws Exception {
    ...
    assertThat((Object) source.getXMLEventReader())
        .as("Invalid eventReader returned")
        .isEqualTo(eventReader);
