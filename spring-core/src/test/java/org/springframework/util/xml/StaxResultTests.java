...
class StaxResultTests {
  ...
  void streamWriterSource() throws Exception {
    ...
    assertThat(result.getXMLStreamWriter())
        .as("Invalid streamWriter returned")
        .isEqualTo(streamWriter);
  ...
  void eventWriterSource() throws Exception {
    ...
    assertThat(result.getXMLEventWriter())
        .as("Invalid eventWriter returned")
        .isEqualTo(eventWriter);
