...
public abstract class StreamUtils {
  ...
  /**
   * Copy the contents of the given InputStream into a new byte array. Leaves the stream open when
   * done.
   *
  ...
  /**
   * Copy the contents of the given byte array to the given OutputStream. Leaves the stream open
   * when done.
   *
  ...
  /**
   * Copy the contents of the given String to the given output OutputStream. Leaves the stream open
   * when done.
   *
  ...
  /**
   * Copy the contents of the given InputStream to the given OutputStream. Leaves both streams open
   * when done.
   *
   ...
   *
   * <p>If the specified range exceeds the length of the InputStream, this copies up to the end of
   * the stream and returns the actual number of copied bytes.
   *
  ...
  /**
   * Return a variant of the given {@link OutputStream} where calling {@link OutputStream#close()
   * close()} has no effect.
   *
