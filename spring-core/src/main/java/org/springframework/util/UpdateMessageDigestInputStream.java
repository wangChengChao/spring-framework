...
/**
 * Extension of {@link java.io.InputStream} that allows for optimized implementations of message
 * digesting.
 *
...
abstract class UpdateMessageDigestInputStream extends InputStream {
   ...
   *
   * <p>Using this method is more optimized since it avoids creating new byte arrays for each call.
   *
