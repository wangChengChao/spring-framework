...
public interface StringValueResolver {
   ...
   * @return the resolved String value (may be {@code null} when resolved to a null value), possibly
   *     the original String value itself (in case of no placeholders to resolve or when ignoring
