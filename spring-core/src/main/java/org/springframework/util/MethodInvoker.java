...
/**
 * Helper class that allows for specifying a method to invoke in a declarative fashion, be it static
 * or non-static.
 *
 * <p>Usage: Specify "targetClass"/"targetMethod" or "targetObject"/"targetMethod", optionally
 * specify arguments, prepare the invoker. Afterwards, you may invoke the method any number of
 * times, obtaining the invocation result.
 *
...
public class MethodInvoker {
  ...
  @Nullable protected Class<?> targetClass;

  @Nullable private Object targetObject;

  @Nullable private String targetMethod;

  @Nullable private String staticMethod;

  @Nullable private Object[] arguments;

  /** The method we will call. */
  @Nullable private Method methodObject;

  /**
   * Set the target class on which to call the target method. Only necessary when the target method
   * is static; else, a target object needs to be specified anyway.
   *
   * @see #setTargetObject
   * @see #setTargetMethod
   */
  ...
  /**
   * Set the target object on which to call the target method. Only necessary when the target method
   * is not static; else, a target class is sufficient.
   *
   * @see #setTargetClass
   * @see #setTargetMethod
   */
  ...
  /**
   * Set the name of the method to be invoked. Refers to either a static method or a non-static
   * method, depending on a target object being set.
   *
   * @see #setTargetClass
   * @see #setTargetObject
   */
   ...
   * "example.MyExampleClass.myExampleMethod". Convenient alternative to specifying targetClass and
   * targetMethod.
   *
   * @see #setTargetClass
   * @see #setTargetMethod
  ...
  /**
   * Set arguments for the method invocation. If this property is not set, or the Object array is of
   * length 0, a method with no arguments is assumed.
   */
   ...
   *
   * <p>The default implementations uses {@code ClassUtils.forName}, using the thread context class
   * loader.
   *
  ...
  /**
   * Return whether this invoker has been prepared already, i.e. whether it allows access to {@link
   * #getPreparedMethod()} already.
   */
   ...
   *
   * @return the object (possibly null) returned by the method invocation, or {@code null} if the
