 ...
 *
 * <p>A compound comparator calls each Comparator in sequence until a single Comparator returns a
 * non-zero result, or the comparators are exhausted and zero is returned.
 *
 * <p>This facilitates in-memory sorting similar to multi-column sorting in SQL. The order of any
 * single Comparator in the list can also be reversed.
 *
 * @author Keith Donald
 * @author Juergen Hoeller
 * @since 1.2.2
 * @param <T> the type of objects that may be compared by this comparator
 * @deprecated as of Spring Framework 5.0, in favor of the standard JDK 8 {@link
...
public class CompoundComparator<T> implements Comparator<T>, Serializable {
  ...
  /**
   * Construct a CompoundComparator with initially no Comparators. Clients must add at least one
   * Comparator before calling the compare method or an IllegalStateException is thrown.
   */
  ...
  public boolean equals(@Nullable Object other) {
    return (this == other
        || (other instanceof CompoundComparator
