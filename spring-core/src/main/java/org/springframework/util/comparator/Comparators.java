...
/**
 * Convenient entry point with generically typed factory methods for common Spring {@link
 * Comparator} variants.
 *
...
public abstract class Comparators {
  ...
  /**
   * Return a {@link Comparable} adapter which accepts null values and sorts them lower than
   * non-null values.
   *
  ...
  /**
   * Return a decorator for the given comparator which accepts null values and sorts them lower than
   * non-null values.
   *
  ...
  /**
   * Return a {@link Comparable} adapter which accepts null values and sorts them higher than
   * non-null values.
   *
  ...
  /**
   * Return a decorator for the given comparator which accepts null values and sorts them higher
