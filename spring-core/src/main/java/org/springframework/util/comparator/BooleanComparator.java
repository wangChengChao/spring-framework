...
/**
 * A {@link Comparator} for {@link Boolean} objects that can sort either {@code true} or {@code
 * false} first.
 *
 * @author Keith Donald
 * @since 1.2.2
...
public class BooleanComparator implements Comparator<Boolean>, Serializable {
  ...
  /**
   * A shared default instance of this comparator, treating {@code true} lower than {@code false}.
   */
  public static final BooleanComparator TRUE_LOW = new BooleanComparator(true);

  /**
   * A shared default instance of this comparator, treating {@code true} higher than {@code false}.
   */
   ...
   *
   * <p>Alternatively, you can use the default shared instances: {@code BooleanComparator.TRUE_LOW}
   * and {@code BooleanComparator.TRUE_HIGH}.
   *
