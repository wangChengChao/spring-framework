...
/**
 * Composite iterator that combines multiple other iterators, as registered via {@link
 * #add(Iterator)}.
 *
 * <p>This implementation maintains a linked set of iterators which are invoked in sequence until
