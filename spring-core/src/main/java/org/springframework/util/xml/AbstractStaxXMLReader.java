...
abstract class AbstractStaxXMLReader extends AbstractXMLReader {
  ...
  private static final String NAMESPACE_PREFIXES_FEATURE_NAME =
      "http://xml.org/sax/features/namespace-prefixes";

  private static final String IS_STANDALONE_FEATURE_NAME =
  ...
  @Nullable private Boolean isStandalone;
  ...
  /**
   * Indicates whether the SAX feature {@code http://xml.org/sax/features/namespaces-prefixes} is
   * turned on.
   */
  ...
  /**
   * Convert a {@code QName} to a qualified name, as used by DOM and SAX. The returned string has a
   * format of {@code prefix:localName} if the prefix is set, or just {@code localName} if not.
   *
