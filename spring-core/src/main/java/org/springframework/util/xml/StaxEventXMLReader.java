...
/**
 * SAX {@code XMLReader} that reads from a StAX {@code XMLEventReader}. Consumes {@code XMLEvents}
...
class StaxEventXMLReader extends AbstractStaxXMLReader {
  ...
  /**
   * Constructs a new instance of the {@code StaxEventXmlReader} that reads from the given {@code
   * XMLEventReader}. The supplied event reader must be in {@code XMLStreamConstants.START_DOCUMENT}
  ...
  private void handleStartElement(StartElement startElement) throws SAXException {
    if (getContentHandler() != null) {
      ...
      if (hasNamespacesFeature()) {
        ...
        getContentHandler()
            .startElement("", "", toQualifiedName(qName), getAttributes(startElement));
      }
    }
  }
  ...
  private void handleEndElement(EndElement endElement) throws SAXException {
    if (getContentHandler() != null) {
      ...
      if (hasNamespacesFeature()) {
        getContentHandler()
            .endElement(qName.getNamespaceURI(), qName.getLocalPart(), toQualifiedName(qName));
  ...
  private void handleNotationDeclaration(NotationDeclaration declaration) throws SAXException {
    if (getDTDHandler() != null) {
      getDTDHandler()
          .notationDecl(
              declaration.getName(), declaration.getPublicId(), declaration.getSystemId());
    }
  }
  ...
  private Attributes getAttributes(StartElement event) {
    ...
    for (Iterator i = event.getAttributes(); i.hasNext(); ) {
      ...
      attributes.addAttribute(
          namespace, qName.getLocalPart(), toQualifiedName(qName), type, attribute.getValue());
    }
