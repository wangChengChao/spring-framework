...
/**
 * Abstract base class for SAX {@code ContentHandler} and {@code LexicalHandler} implementations
 * that use StAX as a basis. All methods delegate to internal template methods, capable of throwing
 * a {@code XMLStreamException}. Additionally, an namespace context stack is used to keep track of
 * declared namespaces.
 *
...
abstract class AbstractStaxHandler implements ContentHandler, LexicalHandler {
  ...
  @Override
  public final void startDTD(String name, @Nullable String publicId, String systemId)
      throws SAXException {
    try {
  ...
  /**
   * Convert a namespace URI and DOM or SAX qualified name to a {@code QName}. The qualified name
   * can have the form {@code prefix:localname} or {@code localName}.
   *
  ...
  protected abstract void startElementInternal(
      QName name, Attributes attributes, Map<String, String> namespaceMapping)
