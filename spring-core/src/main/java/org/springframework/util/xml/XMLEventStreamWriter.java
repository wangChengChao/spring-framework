...
/**
 * Implementation of the {@link javax.xml.stream.XMLStreamWriter} interface that wraps an {@link
 * XMLEventWriter}.
 *
...
class XMLEventStreamWriter implements XMLStreamWriter {
  ...
  public void writeStartElement(String namespaceURI, String localName) throws XMLStreamException {
    closeEmptyElementIfNecessary();
    doWriteStartElement(
        this.eventFactory.createStartElement(new QName(namespaceURI, localName), null, null));
  }
  ...
  public void writeStartElement(String prefix, String localName, String namespaceURI)
    ...
    doWriteStartElement(
        this.eventFactory.createStartElement(
            new QName(namespaceURI, localName, prefix), null, null));
  }

  private void doWriteStartElement(StartElement startElement) throws XMLStreamException {
    this.eventWriter.add(startElement);
    this.endElements.add(
        this.eventFactory.createEndElement(startElement.getName(), startElement.getNamespaces()));
  }
  ...
  public void writeAttribute(String namespaceURI, String localName, String value)
    ...
    this.eventWriter.add(
        this.eventFactory.createAttribute(new QName(namespaceURI, localName), value));
  }
  ...
  private void doWriteNamespace(Namespace namespace) throws XMLStreamException {
    ...
    EndElement newEndElement =
        this.eventFactory.createEndElement(oldEndElement.getName(), newNamespaces.iterator());
