...
/**
 * Implementation of the {@link javax.xml.stream.XMLStreamReader} interface that wraps a {@link
 * XMLEventReader}. Useful because the StAX {@link javax.xml.stream.XMLInputFactory} allows one to
