...
/**
 * Simple {@code javax.xml.namespace.NamespaceContext} implementation. Follows the standard {@code
 * NamespaceContext} contract, and is loadable via a {@code java.util.Map} or {@code
...
public class SimpleNamespaceContext implements NamespaceContext {
  ...
  /**
   * Set the bindings for this namespace context. The supplied map must consist of string key value
   * pairs.
   */
