...
/**
 * Simple {@code javax.xml.transform.ErrorListener} implementation: logs warnings using the given
 * Commons Logging logger instance, and rethrows errors to discontinue the XML transformation.
 *
