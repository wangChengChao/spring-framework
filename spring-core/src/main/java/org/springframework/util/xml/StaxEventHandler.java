...
class StaxEventHandler extends AbstractStaxHandler {
  ...
  /**
   * Construct a new instance of the {@code StaxEventContentHandler} that writes to the given {@code
   * XMLEventWriter}. A default {@code XMLEventFactory} will be created.
   *
  ...
  protected void startElementInternal(
      QName name, Attributes atts, Map<String, String> namespaceMapping) throws XMLStreamException {
