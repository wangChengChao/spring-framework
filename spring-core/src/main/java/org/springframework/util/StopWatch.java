...
/**
 * Simple stop watch, allowing for timing of a number of tasks, exposing total running time and
 * running time for each named task.
 *
 * <p>Conceals use of {@link System#nanoTime()}, improving the readability of application code and
 ...
 *
 * <p>This class is normally used to verify performance during proof-of-concept work and in
 * development, rather than as part of production applications.
 *
 * <p>As of Spring Framework 5.2, running time is tracked and reported in nanoseconds.
 *
 * @author Rod Johnson
...
public class StopWatch {
   ...
   *
   * <p>Handy when we have output from multiple stop watches and need to distinguish between them in
   ...
   *
   * <p>The ID is handy when we have output from multiple stop watches and need to distinguish
   * between them.
   *
   * <p>Does not start any task.
   *
   ...
   *
   * <p>Set this to {@code false} when using a {@code StopWatch} for millions of intervals;
