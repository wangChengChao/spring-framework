...
/**
 * A simple {@link BackOff} implementation that provides a fixed interval between two attempts and a
...
public class FixedBackOff implements BackOff {
  ...
  /**
   * Create an instance with an interval of {@value #DEFAULT_INTERVAL} ms and an unlimited number of
   * attempts.
   */
  public FixedBackOff() {}
  ...
  private class FixedBackOffExecution implements BackOffExecution {
    ...
    public String toString() {
      String attemptValue =
          (FixedBackOff.this.maxAttempts == Long.MAX_VALUE
              ? "unlimited"
              : String.valueOf(FixedBackOff.this.maxAttempts));
      return "FixedBackOff{interval="
          + FixedBackOff.this.interval
          + ", currentAttempts="
          + this.currentAttempts
          + ", maxAttempts="
          + attemptValue
