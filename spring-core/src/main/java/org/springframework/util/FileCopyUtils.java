...
/**
 * Simple utility methods for file and stream copying. All copy methods use a block size of 4096
 * bytes, and close all affected streams when done. A variation of the copy methods from this class
 * that leave streams open can be found in {@link StreamUtils}.
 *
...
public abstract class FileCopyUtils {
  ...
  /**
   * Copy the contents of the given InputStream to the given OutputStream. Closes both streams when
   * done.
   *
