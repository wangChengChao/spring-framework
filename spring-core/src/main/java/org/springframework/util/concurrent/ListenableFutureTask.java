...
public class ListenableFutureTask<T> extends FutureTask<T> implements ListenableFuture<T> {
  ...
  /**
   * Create a new {@code ListenableFutureTask} that will, upon running, execute the given {@link
   * Callable}.
   *
  ...
  /**
   * Create a {@code ListenableFutureTask} that will, upon running, execute the given {@link
   * Runnable}, and arrange that {@link #get()} will return the given result on successful
   * completion.
   *
