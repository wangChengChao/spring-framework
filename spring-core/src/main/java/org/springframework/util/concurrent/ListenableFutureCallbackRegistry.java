...
/**
 * Helper class for {@link ListenableFuture} implementations that maintains a of success and failure
 * callbacks and helps to notify them.
 *
...
public class ListenableFutureCallbackRegistry<T> {
  ...
  /**
   * Trigger a {@link ListenableFutureCallback#onSuccess(Object)} call on all added callbacks with
   * the given result.
   *
  ...
  /**
   * Trigger a {@link ListenableFutureCallback#onFailure(Throwable)} call on all added callbacks
   * with the given {@code Throwable}.
   *
