 ...
 * href="https://commons.apache.org/codec/">Apache Commons Codec</a> for a more comprehensive suite
 * of digest utilities.
 *
...
public abstract class DigestUtils {
  ...
  /**
   * Append a hexadecimal string representation of the MD5 digest of the given inputStream to the
  ...
  /**
   * Create a new {@link MessageDigest} with the given algorithm. Necessary because {@code
