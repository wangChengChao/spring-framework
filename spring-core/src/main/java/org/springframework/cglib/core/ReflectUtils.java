...
public class ReflectUtils {
  ...
  public static Signature getSignature(Member member) {
    if (member instanceof Method) {
      ...
      return new Signature(
          Constants.CONSTRUCTOR_NAME, Type.getMethodDescriptor(Type.VOID_TYPE, types));
  ...
  public static List addAllMethods(final Class type, final List list) {
    ...
    } else list.addAll(java.util.Arrays.asList(type.getDeclaredMethods()));
  ...
  public static Class defineClass(
      String className, byte[] b, ClassLoader loader, ProtectionDomain protectionDomain)
      throws Exception {
  ...
  public static Class defineClass(
    ...
    if (contextClass != null
        && contextClass.getClassLoader() == loader
      ...
      try {
        ...
        if (target.getClass() != LinkageError.class
            && target.getClass() != IllegalArgumentException.class) {
