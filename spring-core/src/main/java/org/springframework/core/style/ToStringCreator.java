...
/**
 * Utility class that builds pretty-printing {@code toString()} methods with pluggable styling
 * conventions. By default, ToStringCreator adheres to Spring's {@code toString()} styling
 * conventions.
 *
 * @author Keith Donald
...
public class ToStringCreator {
  ...
  public ToStringCreator(Object obj, @Nullable ValueStyler styler) {
    this(
        obj, new DefaultToStringStyler(styler != null ? styler : StylerUtils.DEFAULT_VALUE_STYLER));
  }
