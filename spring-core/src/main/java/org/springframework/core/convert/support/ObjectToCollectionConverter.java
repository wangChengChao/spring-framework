...
/**
 * Converts an Object to a single-element Collection containing the Object. Will convert the Object
 * to the target Collection's parameterized type if necessary.
 *
 * @author Keith Donald
...
final class ObjectToCollectionConverter implements ConditionalGenericConverter {
  ...
  public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
    return ConversionUtils.canConvertElements(
        sourceType, targetType.getElementTypeDescriptor(), this.conversionService);
  }
  ...
  public Object convert(
    ...
    Collection<Object> target =
        CollectionFactory.createCollection(
            targetType.getType(), (elementDesc != null ? elementDesc.getType() : null), 1);
