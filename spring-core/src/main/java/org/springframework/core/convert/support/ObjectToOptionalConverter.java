...
/**
 * Convert an Object to {@code java.util.Optional<T>} if necessary using the {@code
 * ConversionService} to convert the source Object to the generic type of Optional when known.
 *
...
final class ObjectToOptionalConverter implements ConditionalGenericConverter {
  ...
  public Object convert(
    ...
    if (source == null) {
      ...
      Object target =
          this.conversionService.convert(source, sourceType, new GenericTypeDescriptor(targetType));
      if (target == null
