...
/**
 * Converts a comma-delimited String to a Collection. If the target collection element type is
 * declared, only matches if {@code String.class} can be converted to it.
 *
 * @author Keith Donald
