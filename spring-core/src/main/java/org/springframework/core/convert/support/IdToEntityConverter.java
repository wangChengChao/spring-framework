...
/**
 * Converts an entity identifier to a entity reference by calling a static finder method on the
 * target entity type.
 *
 * <p>For this converter to match, the finder method must be static, have the signature {@code
  ...
  public boolean matches(TypeDescriptor sourceType, TypeDescriptor targetType) {
    ...
    return (finder != null
        && this.conversionService.canConvert(
            sourceType, TypeDescriptor.valueOf(finder.getParameterTypes()[0])));
  }
