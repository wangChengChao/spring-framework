 ...
 * String field to a Date field, an implementation might return {@code true} if the target field has
 * also been annotated with {@code @DateTimeFormat}.
 *
 * <p>As another example, when converting from a String field to an {@code Account} field, an
 * implementation might return {@code true} if the target Account class defines a {@code public
 * static findAccount(String)} method.
 *
 * @author Phillip Webb
 * @author Keith Donald
 * @since 3.2
