...
/**
 * Exception thrown when a {@link AsyncTaskExecutor} rejects to accept a given task for execution
 * because of the specified timeout.
 *
...
public class TaskTimeoutException extends TaskRejectedException {
  ...
  /**
   * Create a new {@code TaskTimeoutException} with the specified detail message and the given root
   * cause.
   *
   * @param msg the detail message
   * @param cause the root cause (usually from using an underlying API such as the {@code
