...
public final class Conventions {
  ...
  /**
   * Determine the conventional variable name for the supplied {@code Object} based on its concrete
   * type. The convention used is to return the un-capitalized short name of the {@code Class},
   ...
   *
   * <p>For arrays the pluralized version of the array component type is used. For {@code
   * Collection}s an attempt is made to 'peek ahead' to determine the component type and return its
   * pluralized version.
   *
  ...
  /**
   * Determine the conventional variable name for the given parameter taking the generic collection
   * type, if any, into account.
   *
  ...
  /**
   * Determine the conventional variable name for the return type of the given method, taking the
   * generic collection type, if any, into account.
   *
  ...
  /**
   * Determine the conventional variable name for the return type of the given method, taking the
   * generic collection type, if any, into account, falling back on the given actual return value if
   * the method declaration is not specific enough, e.g. {@code Object} return type or untyped
   * collection.
   *
   * @param method the method to generate a variable name for
  ...
  /**
   * Determine the conventional variable name for the return type of the given method, taking the
   * generic collection type, if any, into account, falling back on the given return value if the
   * method declaration is not specific enough, e.g. {@code Object} return type or untyped
   * collection.
   *
   * <p>As of 5.0 this method supports reactive types:<br>
   * {@code Mono<com.myapp.Product>} becomes {@code "productMono"}<br>
  ...
  /**
   * Convert {@code String}s in attribute name format (e.g. lowercase, hyphens separating words)
   * into property name format (camel-case). For example {@code transaction-manager} becomes {@code
   * "transactionManager"}.
   */
  ...
  /**
   * Return an attribute name qualified by the given enclosing {@link Class}. For example the
   * attribute name '{@code foo}' qualified by {@link Class} '{@code com.myapp.SomeClass}' would be
   * '{@code com.myapp.SomeClass.foo}'
   */
  ...
  /**
   * Retrieve the {@code Class} of an element in the {@code Collection}. The exact element for which
   * the {@code Class} is retrieved will depend on the concrete {@code Collection} implementation.
   */
