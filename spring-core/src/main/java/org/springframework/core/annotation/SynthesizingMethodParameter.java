...
/**
 * A {@link MethodParameter} variant which synthesizes annotations that declare attribute aliases
...
public class SynthesizingMethodParameter extends MethodParameter {
  ...
  /**
   * Create a new {@code SynthesizingMethodParameter} for the given method, with nesting level 1.
   *
  ...
  /**
   * Create a new {@code SynthesizingMethodParameter} for the given constructor, with nesting level
   * 1.
   *
   ...
   *     nested List)
   */
  public SynthesizingMethodParameter(
      Constructor<?> constructor, int parameterIndex, int nestingLevel) {
    super(constructor, parameterIndex, nestingLevel);
  }

  /**
   * Copy constructor, resulting in an independent {@code SynthesizingMethodParameter} based on the
   * same metadata and cache state that the original object was in.
   *
   ...
   * @since 5.0
   */
  public static SynthesizingMethodParameter forExecutable(
