...
public interface MergedAnnotationSelector<A extends Annotation> {
  ...
  /**
   * Determine if the existing annotation is known to be the best candidate and any subsequent
   * selections may be skipped.
   *
   ...
   * @return the most appropriate annotation from the {@code existing} or {@code candidate}
   */
