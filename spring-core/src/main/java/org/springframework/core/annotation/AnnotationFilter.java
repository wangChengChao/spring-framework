...
public interface AnnotationFilter {
  ...
  /**
   * {@link AnnotationFilter} that matches annotations in the {@code java.lang} and {@code
   * org.springframework.lang} packages and their subpackages.
   */
  AnnotationFilter PLAIN = packages("java.lang", "org.springframework.lang");

  /**
   * {@link AnnotationFilter} that matches annotations in the {@code java} and {@code javax}
   * packages and their subpackages.
   */
  AnnotationFilter JAVA = packages("java", "javax");

  /**
   * {@link AnnotationFilter} that always matches and can be used when no relevant annotation types
   * are expected to be present at all.
   */
  ...
  /**
   * {@link AnnotationFilter} that never matches and can be used when no filtering is needed
   * (allowing for any annotation types to be present).
   */
