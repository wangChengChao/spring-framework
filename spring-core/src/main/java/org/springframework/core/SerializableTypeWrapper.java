...
/**
 * Internal utility class that can be used to obtain wrapped {@link Serializable} variants of {@link
 * java.lang.reflect.Type java.lang.reflect.Types}.
 *
 * <p>{@link #forField(Field) Fields} or {@link #forMethodParameter(MethodParameter)
 * MethodParameters} can be used as the root source for a serializable type. Alternatively, a
 * regular {@link Class} can also be used as source.
 *
 * <p>The returned type will either be a {@link Class} or a serializable proxy of {@link
 * GenericArrayType}, {@link ParameterizedType}, {@link TypeVariable} or {@link WildcardType}. With
 * the exception of {@link Class} (which is final) calls to methods that return further {@link Type
 * Types} (for example {@link GenericArrayType#getGenericComponentType()}) will be automatically
 * wrapped.
 *
 * @author Phillip Webb
...
final class SerializableTypeWrapper {
   ...
   *
   * <p>If type artifacts are generally not serializable in the current runtime environment, this
   * delegate will simply return the original {@code Type} as-is.
   */
  @Nullable
  ...
  /**
   * {@link Serializable} {@link InvocationHandler} used by the proxied {@link Type}. Provides
   * serialization support and enhances any methods that return {@code Type} or {@code Type[]}.
   */
  @SuppressWarnings("serial")
  ...
  static class MethodParameterTypeProvider implements TypeProvider {
    ...
    public MethodParameterTypeProvider(MethodParameter methodParameter) {
      this.methodName =
          (methodParameter.getMethod() != null ? methodParameter.getMethod().getName() : null);
  ...
  static class MethodInvokeTypeProvider implements TypeProvider {
    ...
    @Nullable private transient volatile Object result;
