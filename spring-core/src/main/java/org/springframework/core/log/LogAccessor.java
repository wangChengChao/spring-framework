...
/**
 * A convenient accessor for Commons Logging, providing not only {@code CharSequence} based log
 * methods but also {@code Supplier} based variants for use with Java 8 lambda expressions.
 *
