...
/**
 * Region of a {@link Resource} implementation, materialized by a {@code position} within the {@link
 * Resource} and a byte {@code count} for the length of that region.
 *
...
public class ResourceRegion {
  ...
  /**
   * Create a new {@code ResourceRegion} from a given {@link Resource}. This region of a resource is
   * represented by a start {@code position} and a byte {@code count} within the given {@code
   * Resource}.
   *
