...
/**
 * Default implementation of the {@link ResourceLoader} interface. Used by {@link ResourceEditor},
 * and serves as base class for {@link
 * org.springframework.context.support.AbstractApplicationContext}. Can also be used standalone.
 *
...
public class DefaultResourceLoader implements ResourceLoader {
   ...
   *
   * <p>ClassLoader access will happen using the thread context class loader at the time of this
   ...
   * Create a new DefaultResourceLoader.
   *
   * @param classLoader the ClassLoader to load class path resources with, or {@code null} for using
  ...
  /**
   * Specify the ClassLoader to load class path resources with, or {@code null} for using the thread
   * context class loader at the time of actual resource access.
   *
   * <p>The default is that ClassLoader access will happen using the thread context class loader at
   ...
   *
   * <p>Will get passed to ClassPathResource's constructor for all ClassPathResource objects created
   * by this resource loader.
   *
  ...
  /**
   * Register the given resolver with this resource loader, allowing for additional protocols to be
   * handled.
   *
  ...
  /**
   * Return the collection of currently registered protocol resolvers, allowing for introspection as
