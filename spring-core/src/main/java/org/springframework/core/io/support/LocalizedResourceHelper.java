...
/**
 * Helper class for loading a localized resource, specified through name, extension and current
 * locale.
 *
...
public class LocalizedResourceHelper {
   ...
   *
   * <p>The file will be searched with locations in the following order, similar to {@code
   ...
   * </ul>
   *
   * <p>If none of the specific files can be found, a resource descriptor for the default location
   * will be returned.
   *
