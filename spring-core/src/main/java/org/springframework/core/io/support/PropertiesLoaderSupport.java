...
public abstract class PropertiesLoaderSupport {
  ...
  @Nullable private Resource[] locations;
   ...
   *
   * <p>Can point to a classic properties file or to an XML file that follows JDK 1.5's properties
   * XML format.
   */
   ...
   *
   * <p>Can point to classic properties files or to XML files that follow JDK 1.5's properties XML
   * format.
   *
   * <p>Note: Properties defined in later files will override properties defined earlier files, in
   * case of overlapping keys. Hence, make sure that the most specific files are the last ones in
   ...
   *
   * <p>Default is "false": Properties from files override local defaults. Can be switched to "true"
   * to let local properties override defaults from files.
   */
   ...
   *
   * <p>"true" is appropriate if the properties file is completely optional. Default is "false".
   */
