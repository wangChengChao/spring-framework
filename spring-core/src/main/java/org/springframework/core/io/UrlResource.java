...
/**
 * {@link Resource} implementation for {@code java.net.URL} locators. Supports resolution as a
 * {@code URL} and also as a {@code File} in case of the {@code "file:"} protocol.
 *
...
public class UrlResource extends AbstractFileResolvingResource {
   ...
   * @see java.net.URI#URI(String, String, String)
   */
  public UrlResource(String protocol, String location, @Nullable String fragment)
  ...
  /**
   * This implementation creates a {@code UrlResource}, applying the given path relative to the path
   * of the underlying URL of this resource descriptor.
   *
