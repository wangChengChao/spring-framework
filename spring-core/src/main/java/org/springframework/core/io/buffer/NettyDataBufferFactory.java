...
/**
 * Implementation of the {@code DataBufferFactory} interface based on a Netty {@link
 * ByteBufAllocator}.
 *
...
public class NettyDataBufferFactory implements DataBufferFactory {
   ...
   *
   * <p>Returns the {@linkplain NettyDataBuffer#getNativeBuffer() native buffer} if {@code buffer}
   * is a {@link NettyDataBuffer}; returns {@link Unpooled#wrappedBuffer(ByteBuffer)} otherwise.
   *
