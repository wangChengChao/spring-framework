 ...
 *
 * <p>Note: As of Spring Framework 5.0, this {@link Resource} implementation uses NIO.2 API for
 * read/write interactions. As of 5.1, it may be constructed with a {@link java.nio.file.Path}
 * handle in which case it will perform all file system interactions via NIO.2, only resorting to
 * {@link File} on {@link #getFile()}.
 *
...
public class FileSystemResource extends AbstractResource implements WritableResource {
  ...
  /**
   * Create a new {@code FileSystemResource} from a {@link Path} handle, performing all file system
   * interactions via NIO.2 instead of {@link File}.
   *
   * <p>In contrast to {@link PathResource}, this variant strictly follows the general {@link
   * FileSystemResource} conventions, in particular in terms of path cleaning and {@link
   * #createRelative(String)} handling.
   *
  ...
  public boolean equals(@Nullable Object other) {
    return (this == other
        || (other instanceof FileSystemResource
