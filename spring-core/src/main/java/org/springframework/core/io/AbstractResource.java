 ...
 *
 * <p>The "exists" method will check whether a File or InputStream can be opened; "isOpen" will
 * always return false; "getURL" and "getFile" throw an exception; and "toString" will return the
 * description.
 *
...
public abstract class AbstractResource implements Resource {
  ...
  public boolean exists() {
    ...
    try {
      ...
      try {
        ...
        logAccessor.debug(
            ex, () -> "Could not close InputStream for resource: " + getDescription());
        return false;
      }
    }
  }
  ...
  /**
   * This implementation always returns {@code true} for a resource that {@link #exists() exists}
   * (revised as of 5.1).
   */
  @Override
  ...
  /**
   * This implementation returns {@link Channels#newChannel(InputStream)} with the result of {@link
   * #getInputStream()}.
   *
   * <p>This is the same as in {@link Resource}'s corresponding default method but mirrored here for
   * efficient JVM-level dispatching in a class hierarchy.
   */
  @Override
   ...
   * @throws FileNotFoundException if the resource cannot be resolved as an absolute file path, i.e.
   *     is not available in a file system
