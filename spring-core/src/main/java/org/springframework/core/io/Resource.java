...
public interface Resource extends InputStreamSource {
   ...
   *
   * <p>Will be {@code true} for typical resource descriptors that exist since it strictly implies
   ...
   * InputStream cannot be read multiple times, and must be read and closed to avoid resource leaks.
   *
   ...
   *
   * @throws java.io.FileNotFoundException if the resource cannot be resolved as absolute file path,
   ...
   *
   * <p>The default implementation returns {@link Channels#newChannel(InputStream)} with the result
  ...
  /**
   * Determine a filename for this resource, i.e. typically the last part of the path: for example,
   * "myfile.txt".
   *
