...
/**
 * {@link Resource} implementation for {@link java.nio.file.Path} handles, performing all operations
 * and transformations via the {@code Path} API. Supports resolution as a {@link File} and also as a
 * {@link URL}. Implements the extended {@link WritableResource} interface.
 *
 * <p>Note: As of 5.1, {@link java.nio.file.Path} support is also available in {@link
 * FileSystemResource#FileSystemResource(Path) FileSystemResource}, applying Spring's standard
 * String-based path transformations but performing all operations via the {@link
...
public class PathResource extends AbstractResource implements WritableResource {
   ...
   * Paths.get("C:/dir1/"), relative path "dir2" -> "C:/dir1/dir2"!
   *
  ...
  /**
   * This implementation creates a PathResource, applying the given path relative to the path of the
   * underlying file of this resource descriptor.
   *
