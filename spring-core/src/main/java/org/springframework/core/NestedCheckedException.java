 ...
 *
 * <p>This class is {@code abstract} to force the programmer to extend the class. {@code getMessage}
 * will include nested exception information; {@code printStackTrace} and other like methods will
 * delegate to the wrapped exception, if any.
 *
 * <p>The similarity between this class and the {@link NestedRuntimeException} class is unavoidable,
 * as Java forces these two classes to have different superclasses (ah, the inflexibility of
...
public abstract class NestedCheckedException extends Exception {
  ...
  /**
   * Construct a {@code NestedCheckedException} with the specified detail message and nested
   * exception.
   *
   * @param msg the detail message
