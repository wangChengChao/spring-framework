...
/**
 * {@link AnnotationMetadata} created from a {@link SimpleAnnotationMetadataReadingVisitor}.
 *
 * @author Phillip Webb
 * @since 5.2
 */
final class SimpleAnnotationMetadata implements AnnotationMetadata {
  ...
  @Nullable private final String enclosingClassName;
  ...
  SimpleAnnotationMetadata(
      ...
      MethodMetadata[] annotatedMethods,
