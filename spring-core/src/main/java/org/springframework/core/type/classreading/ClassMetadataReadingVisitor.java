...
/**
 * ASM class visitor which looks only for the class name and implemented types, exposing them
 * through the {@link org.springframework.core.type.ClassMetadata} interface.
 *
 * @author Rod Johnson
 * @author Costin Leau
 * @author Mark Fisher
