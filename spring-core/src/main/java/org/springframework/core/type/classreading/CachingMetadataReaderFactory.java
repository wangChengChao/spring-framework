...
/**
 * Caching implementation of the {@link MetadataReaderFactory} interface, caching a {@link
 * MetadataReader} instance per Spring {@link Resource} handle (i.e. per ".class" file).
 *
...
public class CachingMetadataReaderFactory extends SimpleMetadataReaderFactory {
  ...
  /**
   * Create a new CachingMetadataReaderFactory for the default class loader, using a local resource
   * cache.
   */
  ...
  /**
   * Create a new CachingMetadataReaderFactory for the given {@link ClassLoader}, using a local
   * resource cache.
   *
  ...
  /**
   * Create a new CachingMetadataReaderFactory for the given {@link ResourceLoader}, using a shared
   * resource cache if supported or a local resource cache otherwise.
   *
   ...
   *
   * <p>Default is 256 for a local cache, whereas a shared cache is typically unbounded. This method
   * enforces a local resource cache, even if the {@link ResourceLoader} supports a shared resource
   * cache.
   */
