 ...
 * Serves as base class for {@link org.springframework.remoting.rmi.CodebaseAwareObjectInputStream}.
 *
...
public class ConfigurableObjectInputStream extends ObjectInputStream {
   ...
   */
  public ConfigurableObjectInputStream(InputStream in, @Nullable ClassLoader classLoader)
      throws IOException {
   ...
   *
   * <p>The default implementation simply rethrows the original exception, since there is no
   * fallback available.
   *
   ...
   *
   * <p>The default implementation simply returns {@code null}, indicating that no specific fallback
   * is available.
   */
  @Nullable
