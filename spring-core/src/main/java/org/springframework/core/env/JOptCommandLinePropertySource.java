 ...
 * <h2>Typical usage</h2>
 *
 * Configure and execute an {@code OptionParser} against the {@code String[]} of arguments supplied
 * to the {@code main} method, and create a {@link JOptCommandLinePropertySource} using the
 * resulting {@code OptionSet} object:
 *
 * <pre class="code">
...
public class JOptCommandLinePropertySource extends CommandLinePropertySource<OptionSet> {
  ...
  /**
   * Create a new {@code JOptCommandLinePropertySource} having the default name and backed by the
   * given {@code OptionSet}.
   *
  ...
  /**
   * Create a new {@code JOptCommandLinePropertySource} having the given name and backed by the
   * given {@code OptionSet}.
   */
  ...
  protected List<String> getNonOptionArgs() {
    ...
    return (stringArgValues.isEmpty()
