...
public class SystemEnvironmentPropertySource extends MapPropertySource {
  ...
  /**
   * Create a new {@code SystemEnvironmentPropertySource} with the given name and delegating to the
   * given {@code MapPropertySource}.
   */
  ...
  /**
   * Check to see if this property source contains a property with the given name, or any underscore
   * / uppercase variation thereof. Return the resolved name if one is found or otherwise the
   * original name. Never returns {@code null}.
   */
