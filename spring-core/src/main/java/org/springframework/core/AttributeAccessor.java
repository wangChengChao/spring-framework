...
public interface AttributeAccessor {
  ...
  /**
   * Get the value of the attribute identified by {@code name}. Return {@code null} if the attribute
   * doesn't exist.
   *
   * @param name the unique attribute key
  ...
  /**
   * Remove the attribute identified by {@code name} and return its value. Return {@code null} if no
   * attribute under {@code name} is found.
   *
   * @param name the unique attribute key
  ...
  /**
   * Return {@code true} if the attribute identified by {@code name} exists. Otherwise return {@code
   * false}.
   *
   * @param name the unique attribute key
   */
