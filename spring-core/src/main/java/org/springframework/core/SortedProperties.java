...
/**
 * Specialization of {@link Properties} that sorts properties alphanumerically based on their keys.
 *
 * <p>This can be useful when storing the {@link Properties} instance in a properties file, since it
 * allows such files to be generated in a repeatable manner with consistent ordering of properties.
 *
...
class SortedProperties extends Properties {
  ...
  /**
   * Construct a new {@code SortedProperties} instance that honors the supplied {@code omitComments}
   * flag.
   *
  ...
  /**
   * Construct a new {@code SortedProperties} instance with properties populated from the supplied
   * {@link Properties} object and honoring the supplied {@code omitComments} flag.
   *
   * <p>Default properties from the supplied {@code Properties} object will not be copied.
   *
  ...
  @Override
  public void storeToXML(OutputStream out, @Nullable String comments, String encoding)
      throws IOException {
   ...
   *
   * <p>The keys will be converted to strings if necessary using {@link String#valueOf(Object)} and
   * sorted alphanumerically according to the natural order of strings.
   */
  @Override
   ...
   *
   * <p>The entries will be sorted based on their keys, and the keys will be converted to strings if
   * necessary using {@link String#valueOf(Object)} and compared alphanumerically according to the
