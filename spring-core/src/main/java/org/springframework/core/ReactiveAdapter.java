...
/**
 * Adapter for a Reactive Streams {@link Publisher} to and from an async/reactive type such as
 * {@code CompletableFuture}, RxJava {@code Observable}, and others.
 *
...
public class ReactiveAdapter {
  ...
  /**
   * Constructor for an adapter with functions to convert the target reactive or async type to and
   ...
   *
   * @param source the source object to adapt from; if the given object is {@code null}, {@link
   *     ReactiveTypeDescriptor#getEmptyValue()} is used.
