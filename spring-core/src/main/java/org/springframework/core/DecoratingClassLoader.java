...
/**
 * Base class for decorating ClassLoaders such as {@link OverridingClassLoader} and {@link
 * org.springframework.instrument.classloading.ShadowingClassLoader}, providing common handling of
...
public abstract class DecoratingClassLoader extends ClassLoader {
   ...
   *
   * <p>Any class whose fully-qualified name starts with the name registered here will be handled by
   ...
   *
   * <p>Any class name registered here will be handled by the parent ClassLoader in the usual
   * fashion.
   *
