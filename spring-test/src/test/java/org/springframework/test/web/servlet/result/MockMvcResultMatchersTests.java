...
public class MockMvcResultMatchersTests {
  ...
  public void redirectWithUrlTemplate() throws Exception {
    assertThatCode(
            () ->
                redirectedUrlTemplate("/orders/{orderId}/items/{itemId}", 1, 2)
                    .match(redirectedUrlStub("/orders/1/items/2")))
        .doesNotThrowAnyException();
  }
  ...
  public void redirectWithMatchingPattern() throws Exception {
    assertThatCode(
            () -> redirectedUrlPattern("/resource/*").match(redirectedUrlStub("/resource/1")))
        .doesNotThrowAnyException();
  }
  ...
  public void redirectWithNonMatchingPatternBecauseNotRedirect() {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(
            () -> redirectedUrlPattern("/resource/*").match(forwardedUrlStub("/resource/1")))
  ...
  public void forwardNonMatching() {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(
            () -> forwardedUrlPattern("api/resource/2").match(forwardedUrlStub("api/resource/1")))
  ...
  public void forwardNonMatchingBecauseNotForward() {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(
            () -> forwardedUrlPattern("/resource/*").match(redirectedUrlStub("/resource/1")))
  ...
  public void forwardWithQueryString() throws Exception {
    assertThatCode(
            () ->
                forwardedUrl("/api/resource/1?arg=value")
                    .match(forwardedUrlStub("/api/resource/1?arg=value")))
        .doesNotThrowAnyException();
  }
  ...
  public void forwardWithUrlTemplate() throws Exception {
    assertThatCode(
            () ->
                forwardedUrlTemplate("/orders/{orderId}/items/{itemId}", 1, 2)
                    .match(forwardedUrlStub("/orders/1/items/2")))
        .doesNotThrowAnyException();
  }
  ...
  public void forwardWithMatchingPattern() throws Exception {
    assertThatCode(
            () -> forwardedUrlPattern("/api/**/?").match(forwardedUrlStub("/api/resource/1")))
        .doesNotThrowAnyException();
  }
