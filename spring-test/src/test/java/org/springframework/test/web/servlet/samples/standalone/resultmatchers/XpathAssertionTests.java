...
public class XpathAssertionTests {
  ...
  public void setup() throws Exception {
    this.mockMvc =
        standaloneSetup(new MusicController())
            ...
            .alwaysExpect(
                content().contentType(MediaType.parseMediaType("application/xml;charset=UTF-8")))
            .build();
  }
  ...
  public void testString() throws Exception {
    ...
    this.mockMvc
        ...
        .andExpect(
            xpath(composerName, musicNamespace, 1)
                .string(equalTo("Johann Sebastian Bach"))) // Hamcrest..
  ...
  public void testNodeCount() throws Exception {
    ...
    this.mockMvc
        ...
        .andExpect(
            xpath("/ns:people/composers/composer", musicNamespace)
                .nodeCount(equalTo(4))) // Hamcrest..
  ...
  public void testFeedWithLinefeedChars() throws Exception {
    ...
    standaloneSetup(new BlogFeedController())
        .build()
