...
public class StatusAssertionTests {
  ...
  public void reasonEquals() {
    ...
    // Wrong reason
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> assertions.reasonEquals("Request Timeout"));
  }
  ...
  public void matches() {
    ...
    // Wrong status
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> assertions.value(equalTo(200)));
  }
  ...
  private StatusAssertions statusAssertions(HttpStatus status) {
    ...
    ExchangeResult result =
        new ExchangeResult(request, response, emptyContent, emptyContent, Duration.ZERO, null);
