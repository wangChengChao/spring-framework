...
public class MultipartControllerTests {
  ...
  public void multipartRequestWrapped() throws Exception {
    ...
    mockMvc
        .perform(multipart("/json").file(jsonPart))
        .andExpect(model().attribute("json", jsonMap));
  }
  ...
  private static class MultipartController {
    ...
    public String processOptionalFileList(
        @RequestParam Optional<List<MultipartFile>> file,
        @RequestPart Map<String, String> json,
        Model model)
        throws IOException {
    ...
    public String processPart(
        @RequestParam Part part, @RequestPart Map<String, String> json, Model model)
        throws IOException {
