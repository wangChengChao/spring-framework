...
/**
 * Examples of defining expectations on the response content, content type, and the character
 * encoding.
 *
...
public class ContentAssertionTests {
  ...
  public void testContentType() throws Exception {
    this.mockMvc
        .perform(get("/handle").accept(MediaType.TEXT_PLAIN))
  ...
  public void testContentAsString() throws Exception {
    ...
    this.mockMvc
        .perform(get("/handleUtf8"))
        .andExpect(content().string(equalTo("\u3053\u3093\u306b\u3061\u306f\u4e16\u754c\uff01")));
  }
  ...
  public void testContentAsBytes() throws Exception {
    ...
    this.mockMvc
        .perform(get("/handleUtf8"))
        .andExpect(
            content().bytes("\u3053\u3093\u306b\u3061\u306f\u4e16\u754c\uff01".getBytes("UTF-8")));
  }
