...
public class JsonPathRequestMatchersTests {
  ...
  public void valueWithMismatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.str").value("bogus").match(request));
  }
  ...
  public void existsNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.bogus").exists().match(request));
  }
  ...
  public void doesNotExistNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.str").doesNotExist().match(request));
  }
  ...
  public void doesNotExistForAnEmptyMap() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.emptyMap").doesNotExist().match(request));
  }
  ...
  public void isNotEmptyForAnEmptyString() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.emptyString").isNotEmpty().match(request));
  }

  @Test
  public void isNotEmptyForAnEmptyArray() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.emptyArray").isNotEmpty().match(request));
  }

  @Test
  public void isNotEmptyForAnEmptyMap() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.emptyMap").isNotEmpty().match(request));
  }
  ...
  public void isArrayNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.str").isArray().match(request));
  }
  ...
  public void isMapNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.str").isMap().match(request));
  }
  ...
  public void isBooleanNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.str").isBoolean().match(request));
  }
  ...
  public void isNumberNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.str").isNumber().match(request));
  }
  ...
  public void isStringNoMatch() throws Exception {
    assertThatExceptionOfType(AssertionError.class)
        .isThrownBy(() -> new JsonPathRequestMatchers("$.arr").isString().match(request));
  }
}
