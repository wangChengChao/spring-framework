...
/**
 * Extension of {@link CommitForRequiredEjbTxDaoTestNGTests} which sets the default rollback
...
public class RollbackForRequiredEjbTxDaoTestNGTests extends CommitForRequiredEjbTxDaoTestNGTests {
  ...
  /**
   * Overrides parent implementation in order to change expectations to align with behavior
   * associated with "required" transactions on repositories/DAOs and default rollback semantics for
   * transactions managed by the TestContext framework.
   */
