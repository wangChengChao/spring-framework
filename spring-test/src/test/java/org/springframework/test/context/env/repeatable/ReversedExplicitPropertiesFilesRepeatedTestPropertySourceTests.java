...
/**
 * Same as {@link ExplicitPropertiesFilesRepeatedTestPropertySourceTests}, but with the order of the
 * properties files reversed.
 *
 * @author Sam Brannen
 * @since 5.2
 */
...
class ReversedExplicitPropertiesFilesRepeatedTestPropertySourceTests
