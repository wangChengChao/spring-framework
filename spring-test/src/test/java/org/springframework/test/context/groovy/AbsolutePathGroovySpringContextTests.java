...
/**
 * Extension of {@link GroovySpringContextTests} that declares a Groovy script using an absolute
 * path.
 *
 * @author Sam Brannen
 * @since 4.1
...
@ContextConfiguration(
    locations = "/org/springframework/test/context/groovy/context.groovy",
