...
class BootstrapTestUtilsContextInitializerTests extends AbstractContextConfigurationUtilsTests {
  ...
  void buildMergedConfigWithSingleLocalInitializer() {
    ...
    assertMergedConfig(
        ...
        EMPTY_STRING_ARRAY,
        EMPTY_CLASS_ARRAY,
        initializers(FooInitializer.class),
  ...
  void buildMergedConfigWithLocalAndInheritedInitializer() {
    ...
    assertMergedConfig(
        ...
        testClass,
        EMPTY_STRING_ARRAY,
        classes(FooConfig.class, BarConfig.class),
        initializers(FooInitializer.class, BarInitializer.class),
        DelegatingSmartContextLoader.class);
  }
  ...
  void buildMergedConfigWithOverriddenInitializers() {
    ...
    assertMergedConfig(
        ...
        EMPTY_STRING_ARRAY,
        classes(FooConfig.class, BarConfig.class),
        initializers(BarInitializer.class),
        DelegatingSmartContextLoader.class);
  }
