...
/**
 * Parameterized test class for integration tests that demonstrate support for Java generics in
 * JUnit Jupiter test classes when used with the Spring TestContext Framework and the {@link
 * SpringExtension}.
 *
