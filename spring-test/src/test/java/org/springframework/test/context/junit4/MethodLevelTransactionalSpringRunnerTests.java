 ...
 * &#64;Transactional}, {@link TestExecutionListeners &#64;TestExecutionListeners}, and {@link
 * ContextConfiguration &#64;ContextConfiguration} annotations in conjunction with the {@link
 * SpringRunner} and the following {@link TestExecutionListener TestExecutionListeners}:
 *
 * <ul>
 ...
 * </ul>
 *
 * <p>This class specifically tests usage of {@code @Transactional} defined at the <strong>method
 * level</strong>.
 *
 * @author Sam Brannen
 * @since 2.5
...
public class MethodLevelTransactionalSpringRunnerTests
