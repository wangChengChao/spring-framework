...
/**
 * Combined integration test for {@link AbstractJUnit4SpringContextTests} and {@link
...
public class ConcreteTransactionalJUnit4SpringContextTests
  ...
  public void verifyAnnotationAutowiredFields() {
    ...
    assertThat(this.nonrequiredLong)
        .as("The nonrequiredLong property should NOT have been autowired.")
        .isNull();
  ...
  public void modifyTestDataWithinTransaction() {
    ...
    assertThat(countRowsInPersonTable())
        .as(
            "Verifying the number of rows in the person table in modifyTestDataWithinTransaction().")
        .isEqualTo(4);
  }
