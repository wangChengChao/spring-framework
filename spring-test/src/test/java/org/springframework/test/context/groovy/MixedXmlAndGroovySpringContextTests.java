...
/**
 * Integration test class that verifies proper support for mixing XML configuration files and Groovy
 * scripts to load an {@code ApplicationContext} using the TestContext framework.
 *
 * @author Sam Brannen
 * @since 4.1
 */
