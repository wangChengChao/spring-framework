...
/**
 * Exact copy of {@link MultipleDataSourcesAndTransactionManagersSqlScriptsTests}, except that the
 * test methods are transactional.
 *
 * @author Sam Brannen
 * @since 4.1
 */
...
class MultipleDataSourcesAndTransactionManagersTransactionalSqlScriptsTests {
  ...
  @Sql(
      scripts = "data-add-catbert.sql",
      config = @SqlConfig(dataSource = "dataSource2", transactionManager = "txMgr2"))
  void database2() {
