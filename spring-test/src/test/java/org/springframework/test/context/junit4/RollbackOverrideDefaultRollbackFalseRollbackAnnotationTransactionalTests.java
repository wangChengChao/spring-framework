...
/**
 * Extension of {@link DefaultRollbackFalseRollbackAnnotationTransactionalTests} which tests
 * method-level <em>rollback override</em> behavior via the {@link Rollback @Rollback} annotation.
 *
 * @author Sam Brannen
 * @since 4.2
 * @see Rollback
 */
public class RollbackOverrideDefaultRollbackFalseRollbackAnnotationTransactionalTests
