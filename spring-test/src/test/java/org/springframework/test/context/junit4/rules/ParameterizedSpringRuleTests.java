...
/**
 * Integration test which demonstrates how to use JUnit's {@link Parameterized} runner in
 * conjunction with {@link SpringClassRule} and {@link SpringMethodRule} to provide dependency
...
@ContextConfiguration(
    "/org/springframework/test/context/junit4/ParameterizedDependencyInjectionTests-context.xml")
