...
/**
 * Integration tests which verify that '<i>before</i>' and '<i>after</i>' methods of {@link
 * TestExecutionListener TestExecutionListeners} as well as {@code @BeforeTransaction} and
 * {@code @AfterTransaction} methods can fail tests run via the {@link SpringRunner} in a JUnit 4
 * environment.
 *
 * <p>See: <a href="https://jira.spring.io/browse/SPR-3960" target="_blank">SPR-3960</a>.
 *
 * <p>Indirectly, this class also verifies that all {@code TestExecutionListener} lifecycle
...
public class FailingBeforeAndAfterMethodsSpringRunnerTests {
  ...
  public void runTestAndAssertCounters() throws Exception {
    int expectedStartedCount =
        this.clazz.getSimpleName().startsWith("AlwaysFailingBeforeTestClass") ? 0 : 1;
    int expectedFinishedCount =
        this.clazz.getSimpleName().startsWith("AlwaysFailingBeforeTestClass") ? 0 : 1;

    runTestsAndAssertCounters(
        getRunnerClass(), this.clazz, expectedStartedCount, 1, expectedFinishedCount, 0, 0);
  }

  // -------------------------------------------------------------------

  protected static class AlwaysFailingBeforeTestClassTestExecutionListener
  ...
  protected static class AlwaysFailingAfterTestClassTestExecutionListener
      implements TestExecutionListener {
  ...
  protected static class AlwaysFailingPrepareTestInstanceTestExecutionListener
      implements TestExecutionListener {
  ...
  protected static class AlwaysFailingBeforeTestMethodTestExecutionListener
      implements TestExecutionListener {
  ...
  protected static class AlwaysFailingBeforeTestExecutionTestExecutionListener
      implements TestExecutionListener {
  ...
  protected static class AlwaysFailingAfterTestMethodTestExecutionListener
      implements TestExecutionListener {
  ...
  protected static class AlwaysFailingAfterTestExecutionTestExecutionListener
      implements TestExecutionListener {
