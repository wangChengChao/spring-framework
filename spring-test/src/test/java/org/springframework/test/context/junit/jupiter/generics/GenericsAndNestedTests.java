...
/**
 * Integration tests that verify support for Java generics combined with {@code @Nested} test
 * classes when used with the Spring TestContext Framework and the {@link SpringExtension}.
 *
