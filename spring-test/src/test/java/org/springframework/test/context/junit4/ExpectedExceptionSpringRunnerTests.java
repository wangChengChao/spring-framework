...
/**
 * Verifies proper handling of JUnit's {@link Test#expected() &#064;Test(expected = ...)} support in
...
public class ExpectedExceptionSpringRunnerTests {
  ...
  public void expectedExceptions() throws Exception {
    runTestsAndAssertCounters(
        SpringRunner.class, ExpectedExceptionSpringRunnerTestCase.class, 1, 0, 1, 0, 0);
  }
