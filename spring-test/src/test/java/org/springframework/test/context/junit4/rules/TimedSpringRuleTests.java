...
/**
 * This class is an extension of {@link TimedSpringRunnerTests} that has been modified to use {@link
 * SpringClassRule} and {@link SpringMethodRule}.
 *
 * @author Sam Brannen
 * @since 4.2
 */
public class TimedSpringRuleTests extends TimedSpringRunnerTests {
  ...
  public static final class TimedSpringRuleTestCase extends TimedSpringRunnerTestCase {
    ...
    /**
     * Overridden to always throw an exception, since Spring's Rule-based JUnit integration does not
     * fail a test for duplicate configuration of timeouts.
     */
    @Override
