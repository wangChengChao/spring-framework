 ...
 *
 * <p>These tests primarily exist to ensure that {@code MergedContextConfiguration} can safely be
 * used as the cache key for {@link org.springframework.test.context.cache.ContextCache
 * ContextCache}.
 *
 * @author Sam Brannen
 * @author Phillip Webb
...
class MergedContextConfigurationTests {
  ...
  void hashCodeWithNulls() {
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(null, null, null, null, null);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(null, null, null, null, null);
  ...
  void hashCodeWithNullArrays() {
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(getClass(), null, null, null, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(getClass(), null, null, null, loader);
    assertThat(mergedConfig2.hashCode()).isEqualTo(mergedConfig1.hashCode());
  }
  ...
  void hashCodeWithSameLocations() {
    ...
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(
            getClass(), locations, EMPTY_CLASS_ARRAY, EMPTY_STRING_ARRAY, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(
            getClass(), locations, EMPTY_CLASS_ARRAY, EMPTY_STRING_ARRAY, loader);
    assertThat(mergedConfig2.hashCode()).isEqualTo(mergedConfig1.hashCode());
  ...
  void hashCodeWithDifferentLocations() {
    ...
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(
            getClass(), locations1, EMPTY_CLASS_ARRAY, EMPTY_STRING_ARRAY, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(
            getClass(), locations2, EMPTY_CLASS_ARRAY, EMPTY_STRING_ARRAY, loader);
    assertThat(mergedConfig2.hashCode()).isNotEqualTo((long) mergedConfig1.hashCode());
  }
  ...
  void hashCodeWithSameConfigClasses() {
    ...
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, classes, EMPTY_STRING_ARRAY, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, classes, EMPTY_STRING_ARRAY, loader);
    assertThat(mergedConfig2.hashCode()).isEqualTo(mergedConfig1.hashCode());
  ...
  void hashCodeWithDifferentConfigClasses() {
    ...
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, classes1, EMPTY_STRING_ARRAY, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, classes2, EMPTY_STRING_ARRAY, loader);
    assertThat(mergedConfig2.hashCode()).isNotEqualTo((long) mergedConfig1.hashCode());
  }
  ...
  void hashCodeWithSameProfiles() {
    ...
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, EMPTY_CLASS_ARRAY, activeProfiles, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, EMPTY_CLASS_ARRAY, activeProfiles, loader);
    assertThat(mergedConfig2.hashCode()).isEqualTo(mergedConfig1.hashCode());
  ...
  void hashCodeWithSameProfilesReversed() {
    ...
    MergedContextConfiguration mergedConfig1 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, EMPTY_CLASS_ARRAY, activeProfiles1, loader);
    MergedContextConfiguration mergedConfig2 =
        new MergedContextConfiguration(
            getClass(), EMPTY_STRING_ARRAY, EMPTY_CLASS_ARRAY, activeProfiles2, loader);
    assertThat(mergedConfig2.hashCode()).isNotEqualTo((long) mergedConfig1.hashCode());
  }
  ...
  void hashCodeWithDifferentParents() {
    MergedContextConfiguration parent1 =
        new MergedContextConfiguration(
            getClass(),
            new String[] {"foo", "bar}"},
            EMPTY_CLASS_ARRAY,
            EMPTY_STRING_ARRAY,
            loader);
    MergedContextConfiguration parent2 =
        new MergedContextConfiguration(
            getClass(),
            new String[] {"baz", "quux"},
            EMPTY_CLASS_ARRAY,
  ...
  private static class FooInitializer
