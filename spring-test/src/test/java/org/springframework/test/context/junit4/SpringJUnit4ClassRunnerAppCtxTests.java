...
public class SpringJUnit4ClassRunnerAppCtxTests
  ...
  public void verifyAnnotationAutowiredMethods() {
    assertThat(this.employee)
        .as("The employee setter method should have been autowired.")
        .isNotNull();
  ...
  public void verifyAutowiredAtValueFields() {
    assertThat(this.literalFieldValue)
        .as("Literal @Value field should have been autowired")
        .isNotNull();
  ...
  public void verifyAutowiredAtValueMethods() {
    assertThat(this.literalParameterValue)
        .as("Literal @Value method parameter should have been autowired.")
        .isNotNull();
    assertThat(this.spelParameterValue)
        .as("SpEL @Value method parameter should have been autowired.")
        .isNotNull();
  ...
  public void verifyResourceAnnotationInjectedFields() {
    assertThat(this.foo)
        .as("The foo field should have been injected via @Resource.")
        .isEqualTo("Foo");
  }
  ...
  public void verifyResourceAnnotationInjectedMethods() {
    assertThat(this.bar)
        .as("The bar method should have been wired via @Resource.")
        .isEqualTo("Bar");
  }
}
