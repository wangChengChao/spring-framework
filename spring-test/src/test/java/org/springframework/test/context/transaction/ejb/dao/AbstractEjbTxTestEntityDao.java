...
/**
 * Abstract base class for EJB implementations of {@link TestEntityDao} which declare transaction
 * semantics for {@link #incrementCount(String)} via {@link TransactionAttribute}.
 *
 * @author Sam Brannen
