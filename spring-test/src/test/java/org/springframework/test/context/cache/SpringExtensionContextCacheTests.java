...
/**
 * Unit tests which verify correct {@link ContextCache application context caching} in conjunction
 * with the {@link SpringExtension} and the {@link DirtiesContext &#064;DirtiesContext} annotation
 * at the method level.
 *
 * @author Sam Brannen
...
class SpringExtensionContextCacheTests {
  ...
  void verifyContextDirty() {
    ...
    assertThat(this.applicationContext)
        ...
        .isNotSameAs(SpringExtensionContextCacheTests.dirtiedApplicationContext);
    SpringExtensionContextCacheTests.dirtiedApplicationContext = this.applicationContext;
  }
  ...
  void verifyContextNotDirty() {
    ...
    assertThat(this.applicationContext)
        ...
        .isSameAs(SpringExtensionContextCacheTests.dirtiedApplicationContext);
  }
}
