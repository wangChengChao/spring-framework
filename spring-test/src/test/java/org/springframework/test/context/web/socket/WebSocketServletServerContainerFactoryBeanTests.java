...
/**
 * Integration tests that validate support for {@link ServletServerContainerFactoryBean} in
 * conjunction with {@link WebAppConfiguration @WebAppConfiguration} and the Spring TestContext
 * Framework.
 *
 * @author Sam Brannen
 * @since 4.3.1
