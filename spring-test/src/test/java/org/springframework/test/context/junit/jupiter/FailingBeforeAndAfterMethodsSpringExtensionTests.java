 ...
 * {@code @AfterTransaction} methods can fail tests run via the {@link SpringExtension} in a JUnit
 * Jupiter environment.
 *
 * <p>See: <a href="https://jira.spring.io/browse/SPR-3960" target="_blank">SPR-3960</a> and <a
 * href="https://jira.spring.io/browse/SPR-4365" target="_blank">SPR-4365</a>.
 *
...
class FailingBeforeAndAfterMethodsSpringExtensionTests {
  ...
  private static class AlwaysFailingBeforeTestClassTestExecutionListener
  ...
  private static class AlwaysFailingAfterTestClassTestExecutionListener
      implements TestExecutionListener {
  ...
  private static class AlwaysFailingPrepareTestInstanceTestExecutionListener
      implements TestExecutionListener {
  ...
  private static class AlwaysFailingBeforeTestMethodTestExecutionListener
      implements TestExecutionListener {
  ...
  private static class AlwaysFailingBeforeTestExecutionTestExecutionListener
      implements TestExecutionListener {
  ...
  private static class AlwaysFailingAfterTestMethodTestExecutionListener
      implements TestExecutionListener {
  ...
  private static class AlwaysFailingAfterTestExecutionTestExecutionListener
      implements TestExecutionListener {
