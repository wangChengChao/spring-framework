...
/**
 * Integration tests which demonstrate use of the Spring MVC Test Framework and the Spring
 * TestContext Framework with JUnit Jupiter and the {@link SpringExtension} (via a custom {@link
 * SpringJUnitWebConfig @SpringJUnitWebConfig} composed annotation).
 *
 * <p>Note how the {@link #springMvcTest(WebApplicationContext)} test method has the {@link
 * WebApplicationContext} injected as a method parameter. This allows the {@link MockMvc} instance
