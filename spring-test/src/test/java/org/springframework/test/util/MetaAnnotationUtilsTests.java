...
class MetaAnnotationUtilsTests {
  ...
  private void assertAtComponentOnComposedAnnotation(
    ...
    assertAtComponentOnComposedAnnotation(
        rootDeclaringClass, rootDeclaringClass, name, composedAnnotationType);
  }
  ...
  private void assertAtComponentOnComposedAnnotation(
    ...
    assertThat(descriptor.getRootDeclaringClass())
        .as("rootDeclaringClass")
        .isEqualTo(rootDeclaringClass);
    ...
    assertThat(descriptor.getComposedAnnotation())
        .as("composedAnnotation should not be null")
        .isNotNull();
    assertThat(descriptor.getComposedAnnotationType())
        .as("composedAnnotationType")
        .isEqualTo(composedAnnotationType);
  }
  ...
  private void assertAtComponentOnComposedAnnotationForMultipleCandidateTypes(
    ...
    assertThat(((Component) descriptor.getAnnotation()).value())
        .as("component name")
        .isEqualTo(name);
    assertThat(descriptor.getComposedAnnotation())
        .as("composedAnnotation should not be null")
  ...
  void findAnnotationDescriptorWithInheritedAnnotationOnClass() {
    ...
    assertThat(
            findAnnotationDescriptor(InheritedAnnotationClass.class, Transactional.class)
                .getRootDeclaringClass())
        .isEqualTo(InheritedAnnotationClass.class);
    assertThat(
            findAnnotationDescriptor(SubInheritedAnnotationClass.class, Transactional.class)
                .getRootDeclaringClass())
        .isEqualTo(InheritedAnnotationClass.class);
  }
  ...
  void findAnnotationDescriptorWithInheritedAnnotationOnInterface() {
    // Note: @Transactional is inherited
    Transactional rawAnnotation =
        InheritedAnnotationInterface.class.getAnnotation(Transactional.class);
    ...
    descriptor =
        findAnnotationDescriptor(SubInheritedAnnotationInterface.class, Transactional.class);
    assertThat(descriptor).isNotNull();
    ...
    descriptor =
        findAnnotationDescriptor(SubSubInheritedAnnotationInterface.class, Transactional.class);
    assertThat(descriptor).isNotNull();
    assertThat(descriptor.getRootDeclaringClass())
        .isEqualTo(SubSubInheritedAnnotationInterface.class);
    assertThat(descriptor.getDeclaringClass()).isEqualTo(InheritedAnnotationInterface.class);
    assertThat(descriptor.getAnnotation()).isEqualTo(rawAnnotation);
  }
  ...
  void findAnnotationDescriptorForNonInheritedAnnotationOnClass() {
    ...
    assertThat(
            findAnnotationDescriptor(NonInheritedAnnotationClass.class, Order.class)
                .getRootDeclaringClass())
        .isEqualTo(NonInheritedAnnotationClass.class);
    assertThat(
            findAnnotationDescriptor(SubNonInheritedAnnotationClass.class, Order.class)
                .getRootDeclaringClass())
        .isEqualTo(NonInheritedAnnotationClass.class);
  }
  ...
  void findAnnotationDescriptorForNonInheritedAnnotationOnInterface() {
    ...
    assertThat(descriptor).isNotNull();
    assertThat(descriptor.getRootDeclaringClass())
        .isEqualTo(SubNonInheritedAnnotationInterface.class);
    assertThat(descriptor.getDeclaringClass()).isEqualTo(NonInheritedAnnotationInterface.class);
    assertThat(descriptor.getAnnotation()).isEqualTo(rawAnnotation);
  }
  ...
  void findAnnotationDescriptorWithLocalAndMetaComponentAnnotation() {
    ...
    assertThat(descriptor.getRootDeclaringClass())
        .isEqualTo(HasLocalAndMetaComponentAnnotation.class);
  ...
  void findAnnotationDescriptorForClassWithMetaAnnotatedInterface() {
    Component rawAnnotation =
        AnnotationUtils.findAnnotation(ClassWithMetaAnnotatedInterface.class, Component.class);
    AnnotationDescriptor<Component> descriptor =
  ...
  void findAnnotationDescriptorForClassWithLocalMetaAnnotationAndAnnotatedSuperclass() {
    ...
    assertThat(descriptor.getRootDeclaringClass())
        .as("rootDeclaringClass")
        .isEqualTo(MetaAnnotatedAndSuperAnnotatedContextConfigClass.class);
    assertThat(descriptor.getDeclaringClass()).as("declaringClass").isEqualTo(MetaConfig.class);
    assertThat(descriptor.getAnnotationType())
        .as("annotationType")
        .isEqualTo(ContextConfiguration.class);
    assertThat(descriptor.getComposedAnnotation())
        .as("composedAnnotation should not be null")
        .isNotNull();
    assertThat(descriptor.getComposedAnnotationType())
        .as("composedAnnotationType")
        .isEqualTo(MetaConfig.class);

    assertThat(descriptor.getAnnotationAttributes().getClassArray("classes"))
        .as("configured classes")
  ...
  void findAnnotationDescriptorOnAnnotatedClassWithMissingTargetMetaAnnotation() {
    ...
    AnnotationDescriptor<Component> descriptor =
        findAnnotationDescriptor(InheritedAnnotationClass.class, Component.class);
  ...
  void findAnnotationDescriptorOnMetaCycleAnnotatedClassWithMissingTargetMetaAnnotation() {
    AnnotationDescriptor<Component> descriptor =
        findAnnotationDescriptor(MetaCycleAnnotatedClass.class, Component.class);
  ...
  void findAnnotationDescriptorForTypesWithNoAnnotationPresent() {
    assertThat(
            findAnnotationDescriptorForTypes(
                NonAnnotatedInterface.class, Transactional.class, Component.class))
        .isNull();
    assertThat(
            findAnnotationDescriptorForTypes(
                NonAnnotatedClass.class, Transactional.class, Order.class))
        .isNull();
  }
  ...
  void findAnnotationDescriptorForTypesWithInheritedAnnotationOnClass() {
    // Note: @Transactional is inherited
    assertThat(
            findAnnotationDescriptorForTypes(InheritedAnnotationClass.class, Transactional.class)
                .getRootDeclaringClass())
        .isEqualTo(InheritedAnnotationClass.class);
    assertThat(
            findAnnotationDescriptorForTypes(SubInheritedAnnotationClass.class, Transactional.class)
                .getRootDeclaringClass())
        .isEqualTo(InheritedAnnotationClass.class);
  }
  ...
  void findAnnotationDescriptorForTypesForNonInheritedAnnotationOnClass() {
    // Note: @Order is not inherited.
    assertThat(
            findAnnotationDescriptorForTypes(NonInheritedAnnotationClass.class, Order.class)
                .getRootDeclaringClass())
        .isEqualTo(NonInheritedAnnotationClass.class);
    assertThat(
            findAnnotationDescriptorForTypes(SubNonInheritedAnnotationClass.class, Order.class)
                .getRootDeclaringClass())
        .isEqualTo(NonInheritedAnnotationClass.class);
  }
  ...
  void findAnnotationDescriptorForTypesForNonInheritedAnnotationOnInterface() {
    ...
    descriptor =
        findAnnotationDescriptorForTypes(SubNonInheritedAnnotationInterface.class, Order.class);
    assertThat(descriptor).isNotNull();
    assertThat(descriptor.getRootDeclaringClass())
        .isEqualTo(SubNonInheritedAnnotationInterface.class);
    assertThat(descriptor.getDeclaringClass()).isEqualTo(NonInheritedAnnotationInterface.class);
  ...
  void findAnnotationDescriptorForTypesWithMetaAnnotationWithDefaultAttributes() {
    ...
    assertThat(descriptor.getAnnotationType()).isEqualTo(annotationType);
    assertThat(((ContextConfiguration) descriptor.getAnnotation()).value())
        .isEqualTo(new Class<?>[] {});
    assertThat(descriptor.getAnnotationAttributes().getClassArray("classes"))
        .isEqualTo(new Class<?>[] {MetaConfig.DevConfig.class, MetaConfig.ProductionConfig.class});
  ...
  void findAnnotationDescriptorForTypesWithMetaAnnotationWithOverriddenAttributes() {
    ...
    assertThat(((ContextConfiguration) descriptor.getAnnotation()).value())
        .isEqualTo(new Class<?>[] {});
    assertThat(descriptor.getAnnotationAttributes().getClassArray("classes"))
        .isEqualTo(new Class<?>[] {MetaAnnotationUtilsTests.class});
    assertThat(descriptor.getComposedAnnotation()).isNotNull();
    assertThat(descriptor.getComposedAnnotationType()).isEqualTo(MetaConfig.class);
  }
  ...
  void findAnnotationDescriptorForTypesForClassWithMetaAnnotatedInterface() {
    ...
    UntypedAnnotationDescriptor descriptor =
        findAnnotationDescriptorForTypes(
            ClassWithMetaAnnotatedInterface.class,
            Service.class,
            Component.class,
            Order.class,
            Transactional.class);
  ...
  void findAnnotationDescriptorForTypesForClassWithLocalMetaAnnotationAndMetaAnnotatedInterface() {
    Class<ClassWithLocalMetaAnnotationAndMetaAnnotatedInterface> startClass =
        ClassWithLocalMetaAnnotationAndMetaAnnotatedInterface.class;
    assertAtComponentOnComposedAnnotationForMultipleCandidateTypes(
  ...
  @Test
  void
      findAnnotationDescriptorForTypesForSubClassWithLocalMetaAnnotationAndMetaAnnotatedInterface() {
    assertAtComponentOnComposedAnnotationForMultipleCandidateTypes(
        SubClassWithLocalMetaAnnotationAndMetaAnnotatedInterface.class,
        ClassWithLocalMetaAnnotationAndMetaAnnotatedInterface.class,
        "meta2",
  ...
  static class SubClassWithLocalMetaAnnotationAndMetaAnnotatedInterface
      extends ClassWithLocalMetaAnnotationAndMetaAnnotatedInterface {}
  ...
  static class MetaAnnotatedAndSuperAnnotatedContextConfigClass
      extends AnnotatedContextConfigClass {}
}
