...
/**
 * Static factory methods for {@link RequestMatcher} classes. Typically used to provide input for
...
public abstract class MockRestRequestMatchers {
  ...
  /**
   * Variant of {@link #requestTo(URI)} that prepares the URI from a URI template plus optional
   * variables via {@link UriComponentsBuilder} including encoding.
   *
  ...
  public static RequestMatcher requestToUriTemplate(String expectedUri, Object... uriVars) {
    Assert.notNull(expectedUri, "'uri' must not be null");
    URI uri =
        UriComponentsBuilder.fromUriString(expectedUri).buildAndExpand(uriVars).encode().toUri();
   ...
   * of the body. The JSON path expression can be a parameterized string using formatting specifiers
   * as defined in {@link String#format(String, Object...)}.
   *
   ...
   * Access to request body matchers using a <a
   * href="https://github.com/jayway/JsonPath">JsonPath</a> expression to inspect a specific subset
   * of the body and a Hamcrest match for asserting the value found at the JSON path.
   *
  ...
  /**
   * Access to request body matchers using an XPath to inspect a specific subset of the body. The
   * XPath expression can be a parameterized string using formatting specifiers as defined in {@link
   * String#format(String, Object...)}.
   *
   * @param expression the XPath optionally parameterized with arguments
   * @param args arguments to parameterize the XPath expression with
   */
  public static XpathRequestMatchers xpath(String expression, Object... args)
      throws XPathExpressionException {
    return new XpathRequestMatchers(expression, null, args);
  }

  /**
   * Access to response body matchers using an XPath to inspect a specific subset of the body. The
   * XPath expression can be a parameterized string using formatting specifiers as defined in {@link
   * String#format(String, Object...)}.
   *
   * @param expression the XPath optionally parameterized with arguments
   ...
   * @param args arguments to parameterize the XPath expression with
   */
  public static XpathRequestMatchers xpath(
