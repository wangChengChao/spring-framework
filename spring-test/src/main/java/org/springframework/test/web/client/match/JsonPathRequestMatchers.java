...
/**
 * Factory for assertions on the request content using <a
 * href="https://github.com/jayway/JsonPath">JsonPath</a> expressions.
 *
 * <p>An instance of this class is typically accessed via {@link
 * MockRestRequestMatchers#jsonPath(String, Matcher)} or {@link
...
public class JsonPathRequestMatchers {
   ...
   *
   * <p>Use {@link MockRestRequestMatchers#jsonPath(String, Matcher)} or {@link
   * MockRestRequestMatchers#jsonPath(String, Object...)}.
   *
  ...
  /**
   * Evaluate the JSON path expression against the request content and assert the resulting value
  ...
  /**
   * An overloaded variant of {@link #value(Matcher)} that also accepts a target type for the
   * resulting value that the matcher can work reliably against.
   *
   * <p>This can be useful for matching numbers reliably &mdash; for example, to coerce an integer
   * into a double.
   *
   * @since 4.3.3
   */
  ...
  /**
   * Evaluate the JSON path expression against the request content and assert that the result is
  ...
  public RequestMatcher value(Object expectedValue) {
    return new AbstractJsonPathRequestMatcher() {
      ...
      protected void matchInternal(MockClientHttpRequest request)
          throws IOException, ParseException {
        JsonPathRequestMatchers.this.jsonPathHelper.assertValue(
            request.getBodyAsString(), expectedValue);
      }
    };
  }

  /**
   * Evaluate the JSON path expression against the request content and assert that a non-null value
   * exists at the given path.
   *
   * <p>If the JSON path expression is not {@linkplain JsonPath#isDefinite definite}, this method
   * asserts that the value at the given path is not <em>empty</em>.
   */
  ...
  /**
   * Evaluate the JSON path expression against the request content and assert that a value does not
   * exist at the given path.
   *
   * <p>If the JSON path expression is not {@linkplain JsonPath#isDefinite definite}, this method
   * asserts that the value at the given path is <em>empty</em>.
   */
  ...
  /**
   * Evaluate the JSON path expression against the response content and assert that a value,
  ...
  /**
   * Evaluate the JSON path expression against the request content and assert that an empty value
   * exists at the given path.
   *
   * <p>For the semantics of <em>empty</em>, consult the Javadoc for {@link
   * org.springframework.util.ObjectUtils#isEmpty(Object)}.
   *
   * @since 4.2.1
   * @see #isNotEmpty()
   * @see #exists()
  ...
  /**
   * Evaluate the JSON path expression against the request content and assert that a non-empty value
   * exists at the given path.
   *
   * <p>For the semantics of <em>empty</em>, consult the Javadoc for {@link
   * org.springframework.util.ObjectUtils#isEmpty(Object)}.
  ...
  public RequestMatcher isNotEmpty() {
    return new AbstractJsonPathRequestMatcher() {
      @Override
      public void matchInternal(MockClientHttpRequest request) throws IOException, ParseException {
        JsonPathRequestMatchers.this.jsonPathHelper.assertValueIsNotEmpty(
  ...
  /**
   * Evaluate the JSON path expression against the request content and assert that the result is an
   * array.
   */
