...
abstract class AbstractMockServerSpec<B extends WebTestClient.MockServerSpec<B>>
  ...
  @Nullable private List<WebFilter> filters;

  @Nullable private WebSessionManager sessionManager;

  @Nullable private List<MockServerConfigurer> configurers;
  ...
  /**
   * Sub-classes must create an {@code WebHttpHandlerBuilder} that will then be used to create the
   * HttpHandler for the mock server.
   */
