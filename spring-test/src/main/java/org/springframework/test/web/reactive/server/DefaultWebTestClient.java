...
class DefaultWebTestClient implements WebTestClient {
  ...
  private class DefaultRequestBodyUriSpec implements RequestBodyUriSpec {
    ...
    @Nullable private String uriTemplate;
    ...
    @Override
    public <T, S extends Publisher<T>> RequestHeadersSpec<?> body(
  ...
  private static class DefaultResponseSpec implements ResponseSpec {
    ...
    DefaultResponseSpec(
        WiretapConnector.Info wiretapInfo,
    ...
    private <E> ListBodySpec<E> getListBodySpec(Flux<E> flux) {
      ...
      EntityExchangeResult<List<E>> entityResult =
          new EntityExchangeResult<>(this.exchangeResult, body);
    ...
    public BodyContentSpec expectBody() {
      ByteArrayResource resource =
          this.response.bodyToMono(ByteArrayResource.class).block(this.timeout);
      byte[] body = (resource != null ? resource.getByteArray() : null);
      EntityExchangeResult<byte[]> entityResult =
          new EntityExchangeResult<>(this.exchangeResult, body);
      ...
      this.result.assertWithDiagnostics(
          () ->
              AssertionErrors.assertEquals(
                  "Response body", expected, this.result.getResponseBody()));
      return self();
    }
    ...
    public ListBodySpec<E> hasSize(int size) {
      ...
      getResult()
          .assertWithDiagnostics(
              () ->
                  AssertionErrors.assertEquals(
                      message, size, (actual != null ? actual.size() : 0)));
      return this;
    }
          ...
          .assertWithDiagnostics(
              () ->
                  AssertionErrors.assertTrue(
                      message, (actual != null && actual.containsAll(expected))));
      return this;
    }
  ...
  private static class DefaultBodyContentSpec implements BodyContentSpec {
    ...
    private String getBodyAsString() {
      ...
      Charset charset =
          Optional.ofNullable(this.result.getResponseHeaders().getContentType())
