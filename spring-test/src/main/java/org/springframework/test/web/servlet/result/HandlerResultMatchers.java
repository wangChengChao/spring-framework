 ...
 *
 * <p>An instance of this class is typically accessed via {@link MockMvcResultMatchers#handler}.
 *
 * <p><strong>Note:</strong> Expectations that assert the controller method used to process the
 * request work only for requests processed with {@link RequestMappingHandlerMapping} and {@link
 * RequestMappingHandlerAdapter} which is used by default with the Spring MVC Java config and XML
 * namespace.
 *
...
public class HandlerResultMatchers {
  ...
  /** Protected constructor. Use {@link MockMvcResultMatchers#handler()}. */
   ...
   *
   * <p>The expected method is specified through a "mock" controller method invocation similar to
   * {@link MvcUriComponentsBuilder#fromMethodCall(Object)}.
   *
   ...
   * </pre>
   *
   * <p>A test that has statically imported {@link MvcUriComponentsBuilder#on} can be performed as
   * follows:
   *
   * <pre class="code">
   * mockMvc.perform(get("/"))
   ...
   * </pre>
   *
   * @param obj either the value returned from a "mock" controller invocation or the "mock"
