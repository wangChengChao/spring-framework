...
/**
 * Result handler that prints {@link MvcResult} details to a given output stream &mdash; for
 * example: {@code System.out}, {@code System.err}, a custom {@code java.io.PrintWriter}, etc.
 *
 * <p>An instance of this class is typically accessed via one of the {@link
 * MockMvcResultHandlers#print print} or {@link MockMvcResultHandlers#log log} methods in {@link
...
public class PrintingResultHandler implements ResultHandler {
  ...
  protected final MultiValueMap<String, String> getParamsMultiValueMap(
  ...
  /**
   * Print the supplied cookies in a human-readable form, assuming the {@link Cookie} implementation
   * does not provide its own {@code toString()}.
   *
   * @since 4.2
   */
