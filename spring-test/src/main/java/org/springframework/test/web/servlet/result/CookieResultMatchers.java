 ...
 *
 * <p>An instance of this class is typically accessed via {@link MockMvcResultMatchers#cookie}.
 *
...
public class CookieResultMatchers {
  ...
  /** Protected constructor. Use {@link MockMvcResultMatchers#cookie()}. */
  ...
  /**
   * Assert a cookie exists. The existence check is irrespective of whether max age is 0 (i.e.
   * expired).
   */
  ...
  /**
   * Assert a cookie does not exist. Note that the existence check is irrespective of whether max
   * age is 0, i.e. expired.
   */
