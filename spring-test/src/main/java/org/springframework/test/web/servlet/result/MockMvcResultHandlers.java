...
public abstract class MockMvcResultHandlers {
  ...
  private static final Log logger =
      LogFactory.getLog("org.springframework.test.web.servlet.result");

  /**
   * Log {@link MvcResult} details as a {@code DEBUG} log message via Apache Commons Logging using
   * the log category {@code org.springframework.test.web.servlet.result}.
   *
   * @since 4.2
   * @see #print()
  ...
  /**
   * A {@link ResultHandler} that logs {@link MvcResult} details at {@code DEBUG} level via Apache
   * Commons Logging.
   *
   * <p>Delegates to a {@link PrintWriterPrintingResultHandler} for building the log message.
   *
   * @since 4.2
   */
