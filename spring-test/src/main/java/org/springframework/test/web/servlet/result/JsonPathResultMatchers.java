...
public class JsonPathResultMatchers {
   ...
   *
   * <p>Use {@link MockMvcResultMatchers#jsonPath(String, Object...)} or {@link
  ...
  /**
   * Configures the current {@code JsonPathResultMatchers} instance to verify that the JSON payload
   * is prepended with the given prefix.
   *
   * <p>Use this method if the JSON payloads are prefixed to avoid Cross Site Script Inclusion
   * (XSSI) attacks.
   *
  ...
  /**
   * Evaluate the JSON path expression against the response content and assert that the result is
  ...
  /**
   * Evaluate the JSON path expression against the response content and assert that a non-null
   * value, possibly an empty array or map, exists at the given path.
   *
  ...
  /**
   * Evaluate the JSON path expression against the response content and assert that an empty value
  ...
  /**
   * Evaluate the JSON path expression against the response content and assert that a non-empty
  ...
  /**
   * Evaluate the JSON path expression against the response content and assert that the result is an
   * array.
   */
  ...
  private String getContent(MvcResult result) throws UnsupportedEncodingException {
    ...
    if (StringUtils.hasLength(this.prefix)) {
      try {
        String reason =
            String.format(
                "Expected a JSON payload prefixed with \"%s\" but found: %s",
