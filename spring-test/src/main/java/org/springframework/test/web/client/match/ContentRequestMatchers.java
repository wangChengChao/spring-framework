...
/**
 * Factory for request content {@code RequestMatcher}'s. An instance of this class is typically
 * accessed via {@link MockRestRequestMatchers#content()}.
 *
...
public class ContentRequestMatchers {
  ...
  /**
   * Assert the request content type is compatible with the given content type as defined by {@link
  ...
  public RequestMatcher contentTypeCompatibleWith(MediaType contentType) {
    return request -> {
      ...
      if (actualContentType != null) {
        assertTrue(
            "Content type [" + actualContentType + "] is not compatible with [" + contentType + "]",
   ...
   *
   * <p>Use of this matcher assumes the <a href="http://xmlunit.sourceforge.net/">XMLUnit</a>
   ...
   *
   * @see <a
   *     href="https://code.google.com/p/xml-matchers/">https://code.google.com/p/xml-matchers/</a>
   */
