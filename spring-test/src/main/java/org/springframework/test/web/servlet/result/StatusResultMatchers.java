 ...
 *
 * <p>An instance of this class is typically accessed via {@link MockMvcResultMatchers#status}.
 *
 * @author Keesun Baik
...
public class StatusResultMatchers {
  ...
  /** Protected constructor. Use {@link MockMvcResultMatchers#status()}. */
  protected StatusResultMatchers() {}

  /**
   * Assert the response status code with the given Hamcrest {@link Matcher}. Use the {@code
   * StatusResultMatchers.isEqualTo} extension in Kotlin.
   */
  ...
  /**
   * Assert the response status code is equal to an integer value. Use the {@code
   * StatusResultMatchers.isEqualTo} extension in Kotlin.
   */
