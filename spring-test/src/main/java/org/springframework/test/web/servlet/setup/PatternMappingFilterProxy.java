...
/**
 * A Filter that invokes a delegate {@link Filter} only if the request URL matches the pattern it is
 * mapped to using pattern matching as defined in the Servlet spec.
 *
 * @author Rob Winch
 * @since 3.2
 */
