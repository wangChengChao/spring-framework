...
/**
 * Factory methods for request content {@code RequestMatcher}'s using an XPath expression. An
 * instance of this class is typically accessed via {@code RequestMatchers.xpath(..)}.
 *
...
public class XpathRequestMatchers {
  ...
  /**
   * Class constructor, not for direct instantiation. Use {@link
   * MockRestRequestMatchers#xpath(String, Object...)} or {@link
   ...
   */
  protected XpathRequestMatchers(
