...
/**
 * A contract for setting up request expectations and defining a response. Implementations can be
 * obtained through {@link MockRestServiceServer#expect(RequestMatcher)}.
 *
 * @author Craig Walls
 * @since 3.2
 */
