...
public class XmlExpectationsHelper {
   ...
   * i.e. they contain the same elements and attributes regardless of order.
   *
   * <p>Use of this method assumes the <a href="https://github.com/xmlunit/xmlunit">XMLUnit</a>
   ...
   * @see org.springframework.test.web.servlet.result.MockMvcResultMatchers#xpath(String, Map,
   *     Object...)
   */
