 ...
 *
 * <p>Use of this class requires the <a href="https://jsonassert.skyscreamer.org/">JSONassert</a>
 * library.
 *
...
public class JsonExpectationsHelper {
  ...
  /**
   * Parse the expected and actual strings as JSON and assert the two are "not similar" - i.e. they
   * contain different attribute-value pairs regardless of formatting with a lenient checking
   * (extensible, and non-strict array ordering).
   *
   * @param expected the expected JSON content
   * @param actual the actual JSON content
