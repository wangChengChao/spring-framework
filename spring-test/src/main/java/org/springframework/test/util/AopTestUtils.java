...
/**
 * {@code AopTestUtils} is a collection of AOP-related utility methods for use in unit and
 * integration testing scenarios.
 *
 * <p>For Spring's core AOP utilities, see {@link org.springframework.aop.support.AopUtils AopUtils}
 * and {@link org.springframework.aop.framework.AopProxyUtils AopProxyUtils}.
 *
 * @author Sam Brannen
...
public abstract class AopTestUtils {
   ...
   *
   * <p>If the supplied {@code candidate} is a Spring {@linkplain AopUtils#isAopProxy proxy}, the
   * target of the proxy will be returned; otherwise, the {@code candidate} will be returned <em>as
   * is</em>.
   *
