...
/**
 * {@code ProfileValueSourceConfiguration} is a class-level annotation for use with JUnit 4 which is
 * used to specify what type of {@link ProfileValueSource} to use when retrieving <em>profile
 * values</em> configured via {@link IfProfileValue @IfProfileValue}.
 *
