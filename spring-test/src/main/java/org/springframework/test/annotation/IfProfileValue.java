...
/**
 * Test annotation for use with JUnit 4 to indicate whether a test is enabled or disabled for a
...
public @interface IfProfileValue {
  ...
  /**
   * A single, permissible {@code value} of the <em>profile value</em> for the given {@link #name}.
   *
