...
/**
 * {@link EventListener @EventListener} annotation used to consume a {@link BeforeTestExecution}
 ...
 * org.springframework.test.context.TestExecutionListener#beforeTestExecution} lifecycle.
 *
 * <p>Event processing can optionally be made {@linkplain #value conditional} via a SpEL expression
 * &mdash; for example, {@code @BeforeTestExecution("event.testContext.testMethod.name matches
 * 'test.*'")}.
 *
