 ...
 * from XML resources.
 *
 * <p>Default resource locations are detected using the suffix {@code "-context.xml"}.
 *
 * @author Sam Brannen
 * @since 3.2
...
public class GenericXmlWebContextLoader extends AbstractGenericWebContextLoader {
   ...
   * locations in the supplied {@code WebMergedContextConfiguration}, using an {@link
    ...
    if (webMergedConfig.hasClasses()) {
      String msg =
          String.format(
              ...
              ObjectUtils.nullSafeToString(webMergedConfig.getClasses()),
