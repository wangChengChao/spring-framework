...
/**
 * Default implementation of the {@link ActiveProfilesResolver} strategy that resolves <em>active
 * bean definition profiles</em> based solely on profiles configured declaratively via {@link
 * ActiveProfiles#profiles} or {@link ActiveProfiles#value}.
 *
 * @author Sam Brannen
 * @since 4.1
 * @see ActiveProfiles
...
public class DefaultActiveProfilesResolver implements ActiveProfilesResolver {
   ...
   * on profiles configured declaratively via {@link ActiveProfiles#profiles} or {@link
