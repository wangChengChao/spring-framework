...
/**
 * {@link EventListener @EventListener} annotation used to consume a {@link BeforeTestMethodEvent}
 ...
 * org.springframework.test.context.TestExecutionListener#beforeTestMethod} lifecycle.
 *
 * <p>Event processing can optionally be made {@linkplain #value conditional} via a SpEL expression
 * &mdash; for example, {@code @BeforeTestMethod("event.testContext.testMethod.name matches
 * 'test.*'")}.
 *
