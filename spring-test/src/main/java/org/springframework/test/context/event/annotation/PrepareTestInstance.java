...
/**
 * {@link EventListener @EventListener} annotation used to consume a {@link
 * PrepareTestInstanceEvent} published by the {@link
 ...
 * org.springframework.test.context.TestExecutionListener#prepareTestInstance} lifecycle.
 *
 * <p>Event processing can optionally be made {@linkplain #value conditional} via a SpEL expression
 * &mdash; for example, {@code @PrepareTestInstance("event.testContext.testClass.name matches
 * '.+IntegrationTests'")}.
 *
