...
public class SpringExtension
   ...
   *
   * <p>A parameter is considered to be autowirable if one of the following conditions is {@code
   * true}.
   *
   * <ol>
   *   <li>The {@linkplain ParameterContext#getDeclaringExecutable() declaring executable} is a
   *       {@link Constructor} and {@link TestConstructorUtils#isAutowirableConstructor(Constructor,
   *       Class)} returns {@code true}.
   *   <li>The parameter is of type {@link ApplicationContext} or a sub-type thereof.
   *   <li>{@link ParameterResolutionDelegate#isAutowirable} returns {@code true}.
   * </ol>
   *
   * <p><strong>WARNING</strong>: If a test class {@code Constructor} is annotated with
   * {@code @Autowired} or automatically autowirable (see {@link TestConstructor}), Spring will
   * assume the responsibility for resolving all parameters in the constructor. Consequently, no
   * other registered {@link ParameterResolver} will be able to resolve parameters.
   *
