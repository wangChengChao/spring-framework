...
/**
 * {@link EventListener @EventListener} annotation used to consume a {@link BeforeTestClassEvent}
 ...
 * org.springframework.test.context.TestExecutionListener#beforeTestClass} lifecycle.
 *
 * <p>Event processing can optionally be made {@linkplain #value conditional} via a SpEL expression
 * &mdash; for example, {@code @BeforeTestClass("event.testContext.testClass.name matches
 * '.+IntegrationTests'")}.
 *
