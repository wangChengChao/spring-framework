...
/**
 * {@code ContextConfigurationAttributes} encapsulates the context configuration attributes declared
...
public class ContextConfigurationAttributes {
   ...
   *
   * @param declaringClass the test class that declared {@code @ContextConfiguration}, either
  ...
  /**
   * Construct a new {@link ContextConfigurationAttributes} instance for the supplied {@link
   * ContextConfiguration @ContextConfiguration} annotation and the {@linkplain Class test class}
   * that declared it.
   *
  ...
  public ContextConfigurationAttributes(
      Class<?> declaringClass, ContextConfiguration contextConfiguration) {
    this(
        declaringClass,
  ...
  /**
   * Construct a new {@link ContextConfigurationAttributes} instance for the supplied {@link
   * AnnotationAttributes} (parsed from a {@link ContextConfiguration @ContextConfiguration}
   * annotation) and the {@linkplain Class test class} that declared them.
   *
   * @param declaringClass the test class that declared {@code @ContextConfiguration}
  ...
  /**
   * Construct a new {@link ContextConfigurationAttributes} instance for the {@linkplain Class test
   * class} that declared the {@link ContextConfiguration @ContextConfiguration} annotation and its
   * corresponding attributes.
   *
   * @param declaringClass the test class that declared {@code @ContextConfiguration}
   * @param locations the resource locations declared via {@code @ContextConfiguration}
   * @param classes the annotated classes declared via {@code @ContextConfiguration}
   * @param inheritLocations the {@code inheritLocations} flag declared via
   *     {@code @ContextConfiguration}
   * @param initializers the context initializers declared via {@code @ContextConfiguration}
   * @param inheritInitializers the {@code inheritInitializers} flag declared via
   *     {@code @ContextConfiguration}
   * @param contextLoaderClass the {@code ContextLoader} class declared via
   *     {@code @ContextConfiguration}
  ...
  /**
   * Get the {@linkplain Class class} that declared the {@link
   * ContextConfiguration @ContextConfiguration} annotation, either explicitly or implicitly.
   *
  ...
  /**
   * Set the <em>processed</em> annotated classes, effectively overriding the original value
  ...
  /**
   * Get the annotated classes that were declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
   * <p>Note: this is a mutable property. The returned value may therefore represent a
   * <em>processed</em> value that does not match the original value declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
  ...
  /**
   * Set the <em>processed</em> resource locations, effectively overriding the original value
   * declared via {@link ContextConfiguration @ContextConfiguration}.
   *
   * @see #getLocations()
   */
  ...
  /**
   * Get the resource locations that were declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
   * <p>Note: this is a mutable property. The returned value may therefore represent a
   * <em>processed</em> value that does not match the original value declared via {@link
  ...
  /**
   * Determine if this {@code ContextConfigurationAttributes} instance has path-based resource
   * locations.
   *
  ...
  /**
   * Determine if this {@code ContextConfigurationAttributes} instance has either path-based
  ...
  /**
   * Get the {@code inheritLocations} flag that was declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
  ...
  /**
   * Get the {@code ApplicationContextInitializer} classes that were declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
  ...
  /**
   * Get the {@code inheritInitializers} flag that was declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
  ...
  /**
   * Get the name of the context hierarchy level that was declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
  ...
  /**
   * Get the {@code ContextLoader} class that was declared via {@link
   * ContextConfiguration @ContextConfiguration}.
   *
  ...
  /**
   * Determine if the supplied object is equal to this {@code ContextConfigurationAttributes}
   * instance by comparing both object's {@linkplain #getDeclaringClass() declaring class},
   * {@linkplain #getLocations() locations}, {@linkplain #getClasses() annotated classes},
   * {@linkplain #isInheritLocations() inheritLocations flag}, {@linkplain #getInitializers()
   * context initializer classes}, {@linkplain #isInheritInitializers() inheritInitializers flag},
   * and the {@link #getContextLoaderClass() ContextLoader class}.
   */
  @Override
  ...
  /**
   * Generate a unique hash code for all properties of this {@code ContextConfigurationAttributes}
   * instance excluding the {@linkplain #getName() name}.
   */
  @Override
  public int hashCode() {
