...
public class DefaultBootstrapContext implements BootstrapContext {
   ...
   * @param cacheAwareContextLoaderDelegate the context loader delegate to use for transparent
   *     interaction with the {@code ContextCache}; never {@code null}
   */
  ...
  public String toString() {
    return new ToStringCreator(this) //
        ...
        .append(
            ...
            this.cacheAwareContextLoaderDelegate.getClass().getName()) //
        .toString();
  }
}
