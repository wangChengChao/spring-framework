...
/**
 * {@code DelegatingSmartContextLoader} is a concrete implementation of {@link
 * AbstractDelegatingSmartContextLoader} that delegates to a {@link GenericXmlContextLoader} (or a
 * {@link GenericGroovyXmlContextLoader} if Groovy is present in the classpath) and an {@link
...
public class DelegatingSmartContextLoader extends AbstractDelegatingSmartContextLoader {
  ...
  private static final boolean groovyPresent =
      ClassUtils.isPresent(
              "groovy.lang.Closure", DelegatingSmartContextLoader.class.getClassLoader())
          && ClassUtils.isPresent(
