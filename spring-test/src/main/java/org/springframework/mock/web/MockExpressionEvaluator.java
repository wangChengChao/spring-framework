...
/**
 * Mock implementation of the JSP 2.0 {@link javax.servlet.jsp.el.ExpressionEvaluator} interface,
 * delegating to the Apache JSTL {@link ExpressionEvaluatorManager}. Only necessary for testing
 * applications when testing custom JSP tags.
 *
 * <p>Note that the Apache JSTL implementation (jstl.jar, standard.jar) has to be available on the
 * classpath to use this expression evaluator.
 *
...
public class MockExpressionEvaluator extends javax.servlet.jsp.el.ExpressionEvaluator {
  ...
  public javax.servlet.jsp.el.Expression parseExpression(
      final String expression,
      final Class expectedType,
      final javax.servlet.jsp.el.FunctionMapper functionMapper)
  ...
  protected Object doEvaluate(
      String expression, Class expectedType, javax.servlet.jsp.el.FunctionMapper functionMapper)
      throws javax.servlet.jsp.el.ELException {
