...
public class MockHttpSession implements HttpSession {
  ...
  public void clearAttributes() {
    for (Iterator<Map.Entry<String, Object>> it = this.attributes.entrySet().iterator();
        it.hasNext(); ) {
  ...
  /**
   * Convenience method for asserting that this session has not been {@linkplain #invalidate()
   * invalidated}.
   *
  ...
  /**
   * Deserialize the attributes of this session from a state object created by {@link
   * #serializeState()}.
   *
