 ...
 * names. Mainly for test environments, but also usable for standalone applications.
 *
 * <p>This class is not intended for direct usage by applications, although it can be used for
 * example to override JndiTemplate's {@code createInitialContext} method in unit tests. Typically,
...
public class SimpleNamingContext implements Context {
  ...
  /**
   * Create a new naming context with the given naming root, the given name/object map, and the JNDI
   * environment entries.
   */
  public SimpleNamingContext(
      String root,
   ...
   *
   * <p>Note: Not intended for direct use by applications. Will be used by any standard
   * InitialContext JNDI lookups.
   *
  ...
  /**
   * Bind the given object to the given name. Note: Not intended for direct use by applications if
   * setting up a JVM-level JNDI environment. Use SimpleNamingContextBuilder to set up JNDI bindings
   * then.
   *
