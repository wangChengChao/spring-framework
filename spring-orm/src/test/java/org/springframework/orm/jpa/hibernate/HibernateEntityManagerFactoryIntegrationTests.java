...
public class HibernateEntityManagerFactoryIntegrationTests
  ...
  protected String[] getConfigLocations() {
    return new String[] {
      "/org/springframework/orm/jpa/hibernate/hibernate-manager.xml",
  ...
  public void testCanCastNativeEntityManagerFactoryToHibernateEntityManagerFactoryImpl() {
    ...
    boolean condition1 =
        emfi.getNativeEntityManagerFactory()
            instanceof org.hibernate.jpa.HibernateEntityManagerFactory;
  ...
  public void testCanCastSharedEntityManagerProxyToHibernateEntityManager() {
    ...
    // as of Hibernate 5.2
    boolean condition =
        ((EntityManagerProxy) sharedEntityManager).getTargetEntityManager() instanceof Session;
    assertThat(condition).isTrue();
  }
