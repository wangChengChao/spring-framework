...
/**
 * Simple synchronization adapter that propagates a {@code flush()} call to the underlying Hibernate
 * Session. Used in combination with JTA.
 *
...
public class SpringFlushSynchronization extends TransactionSynchronizationAdapter {
  ...
  public boolean equals(@Nullable Object other) {
    return (this == other
        || (other instanceof SpringFlushSynchronization
