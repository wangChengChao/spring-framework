...
/**
 * Helper class featuring methods for Hibernate Session handling. Also provides support for
 * exception translation.
 *
 * <p>Used internally by {@link HibernateTransactionManager}. Can also be used directly in
 * application code.
 *
...
public abstract class SessionFactoryUtils {
  ...
  /**
   * Order value for TransactionSynchronization objects that clean up Hibernate Sessions. Returns
   * {@code DataSourceUtils.CONNECTION_SYNCHRONIZATION_ORDER - 100} to execute Session cleanup
   * before JDBC Connection cleanup, if any.
   *
  ...
  /**
   * Trigger a flush on the given Hibernate Session, converting regular {@link HibernateException}
   * instances as well as Hibernate 5.2's {@link PersistenceException} wrappers accordingly.
   *
  ...
  /**
   * Perform actual closing of the Hibernate Session, catching and logging any cleanup exceptions
   * thrown.
   *
  ...
  public static DataSource getDataSource(SessionFactory sessionFactory) {
    Method getProperties =
        ClassUtils.getMethodIfAvailable(sessionFactory.getClass(), "getProperties");
