...
/**
 * Spring's base implementation of the JPA {@link javax.persistence.spi.PersistenceUnitInfo}
 * interface, used to bootstrap an {@code EntityManagerFactory} in a container.
 *
 * <p>This implementation is largely a JavaBean, offering mutators for all standard {@code
...
public class MutablePersistenceUnitInfo implements SmartPersistenceUnitInfo {
  ...
  @Nullable private String persistenceProviderClassName;

  @Nullable private PersistenceUnitTransactionType transactionType;

  @Nullable private DataSource nonJtaDataSource;

  @Nullable private DataSource jtaDataSource;

  private final List<String> mappingFileNames = new LinkedList<>();

  private List<URL> jarFileUrls = new LinkedList<>();

  @Nullable private URL persistenceUnitRootUrl;
  ...
  @Nullable private String persistenceProviderPackageName;
   ...
   *
   * <p>Note: This refers to annotated {@code package-info.java} files. It does <i>not</i> trigger
   * entity scanning in the specified package; this is rather the job of {@link
   * DefaultPersistenceUnitManager#setPackagesToScan}.
   *
   * @since 4.1
  ...
  public String toString() {
    return "PersistenceUnitInfo: name '"
