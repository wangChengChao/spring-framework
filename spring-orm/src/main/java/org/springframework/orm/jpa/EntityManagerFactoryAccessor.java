...
/**
 * Base class for any class that needs to access a JPA {@link EntityManagerFactory}, usually in
 * order to obtain a JPA {@link EntityManager}. Defines common properties.
 *
...
public abstract class EntityManagerFactoryAccessor implements BeanFactoryAware {
   ...
   * name have been specified, a default EntityManagerFactory will be retrieved through finding a
   * single unique bean of type EntityManagerFactory.
   *
