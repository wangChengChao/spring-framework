...
/**
 * Exception thrown on an optimistic locking violation for a mapped object. Provides information
 * about the persistent class and the identifier.
 *
...
public class ObjectOptimisticLockingFailureException extends OptimisticLockingFailureException {
  ...
  @Nullable private final Object persistentClass;

  @Nullable private final Object identifier;

  /**
   * Create a general ObjectOptimisticLockingFailureException with the given message, without any
   * information on the affected object.
   *
  ...
  /**
   * Create a new ObjectOptimisticLockingFailureException for the given object, with the default
   * "optimistic locking failed" message.
   *
  ...
  /**
   * Create a new ObjectOptimisticLockingFailureException for the given object, with the given
   * explicit message.
   *
   * @param persistentClass the persistent class
   * @param identifier the ID of the object for which the locking failed
  ...
  /**
   * Return the persistent class of the object for which the locking failed. If no Class was
  ...
  /**
   * Return the name of the persistent class of the object for which the locking failed. Will work
