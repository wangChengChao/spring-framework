...
public class ObjectRetrievalFailureException extends DataRetrievalFailureException {
  ...
  /**
   * Create a general ObjectRetrievalFailureException with the given message, without any
  ...
  /**
   * Create a new ObjectRetrievalFailureException for the given object, with the default "not found"
   * message.
   *
  ...
  /**
   * Create a new ObjectRetrievalFailureException for the given object, with the given explicit
  ...
  /**
   * Return the persistent class of the object that was not found. If no Class was specified, this
   * method returns null.
   */
  @Nullable
  ...
  /**
   * Return the name of the persistent class of the object that was not found. Will work for both
   * Class objects and String names.
   */
  @Nullable
