...
public interface StompEndpointRegistry {
  ...
  /**
   * Set the order of the {@link org.springframework.web.servlet.HandlerMapping} used for STOMP
   * endpoints relative to other Spring MVC handler mappings.
   *
  ...
  /**
   * Configure a customized {@link UrlPathHelper} for the STOMP endpoint {@link
