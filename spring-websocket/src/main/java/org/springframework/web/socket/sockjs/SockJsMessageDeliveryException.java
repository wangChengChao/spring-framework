 ...
 * but one or more of the messages it contained could not be delivered to the WebSocketHandler
 * either because the handler failed or because the connection got closed.
 *
...
public class SockJsMessageDeliveryException extends SockJsException {
  ...
  public SockJsMessageDeliveryException(
      String sessionId, List<String> undeliveredMessages, Throwable cause) {
    super(
        "Failed to deliver message(s) " + undeliveredMessages + " for session " + sessionId,
        sessionId,
        cause);
  ...
  public SockJsMessageDeliveryException(
      String sessionId, List<String> undeliveredMessages, String message) {
    super(
