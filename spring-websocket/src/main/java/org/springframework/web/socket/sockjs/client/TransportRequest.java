...
public interface TransportRequest {
  ...
  /**
   * Return the headers to add to all other HTTP requests besides the handshake request such as XHR
  ...
  /**
   * Register a timeout cleanup task to invoke if the SockJS session is not fully established within
   * the calculated retransmission timeout period.
   */
