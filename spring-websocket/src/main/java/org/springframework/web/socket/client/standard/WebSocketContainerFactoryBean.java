...
/**
 * A FactoryBean for creating and configuring a {@link javax.websocket.WebSocketContainer} through
 * Spring XML configuration. In Java configuration, ignore this class and use {@code
 * ContainerProvider.getWebSocketContainer()} instead.
 *
