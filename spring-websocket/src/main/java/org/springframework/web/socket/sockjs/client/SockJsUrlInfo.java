...
/**
 * Container for the base URL of a SockJS endpoint with additional helper methods to derive related
 * SockJS URLs: specifically, the {@link #getInfoUrl() info} and {@link
 * #getTransportUrl(TransportType) transport} URLs.
 *
