...
/**
 * A default implementation of {@link org.springframework.web.socket.sockjs.SockJsService} with all
 * default {@link TransportHandler} implementations pre-registered.
 *
...
public class DefaultSockJsService extends TransportHandlingSockJsService
   ...
   *     provided TaskScheduler should be declared as a Spring bean to ensure it is initialized at
   *     start up and shut down when the application stops.
   */
  ...
  /**
   * Create a DefaultSockJsService with overridden {@link TransportHandler handler} types replacing
  ...
  public DefaultSockJsService(
      TaskScheduler scheduler, Collection<TransportHandler> handlerOverrides) {
