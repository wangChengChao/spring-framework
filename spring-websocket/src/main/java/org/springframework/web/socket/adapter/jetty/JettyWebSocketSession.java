...
public class JettyWebSocketSession extends AbstractWebSocketSession<Session> {
  ...
  @Nullable private String acceptedProtocol;

  @Nullable private List<WebSocketExtension> extensions;
  ...
  public void initializeNativeSession(Session session) {
    ...
    if (!CollectionUtils.isEmpty(jettyExtensions)) {
      ...
      for (ExtensionConfig jettyExtension : jettyExtensions) {
        extensions.add(
            new WebSocketExtension(jettyExtension.getName(), jettyExtension.getParameters()));
      }
