...
/**
 * An implementation of {@link javax.websocket.server.ServerEndpointConfig} for use in Spring-based
 * applications. A {@link ServerEndpointRegistration} bean is detected by {@link
 * ServerEndpointExporter} and registered with a Java WebSocket runtime at startup.
 *
 * <p>Class constructors accept a singleton {@link javax.websocket.Endpoint} instance or an Endpoint
 * specified by type {@link Class}. When specified by type, the endpoint will be instantiated and
 * initialized through the Spring ApplicationContext before each client WebSocket connection.
 *
 * <p>This class also extends {@link javax.websocket.server.ServerEndpointConfig.Configurator} to
 * make it easier to override methods for customizing the handshake process.
 *
...
public class ServerEndpointRegistration extends ServerEndpointConfig.Configurator
  ...
  /**
   * Create a new {@link ServerEndpointRegistration} instance from an {@code
