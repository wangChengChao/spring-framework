...
public interface RequestUpgradeStrategy {
  ...
  /**
   * Perform runtime specific steps to complete the upgrade. Invoked after successful negotiation of
   ...
   * @param attributes handshake request specific attributes to be set on the WebSocket session via
   *     {@link org.springframework.web.socket.server.HandshakeInterceptor} and thus made available
   *     to the {@link org.springframework.web.socket.WebSocketHandler}
   ...
   *     negotiate the requirements of the handshake request.
   */
  void upgrade(
