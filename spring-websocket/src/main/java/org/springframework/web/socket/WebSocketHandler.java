 ...
 * exception handling strategy is provided by {@link
 * org.springframework.web.socket.handler.ExceptionWebSocketHandlerDecorator
 * ExceptionWebSocketHandlerDecorator} and it can be customized or replaced by decorating the {@link
 * WebSocketHandler} with a different decorator.
 *
...
public interface WebSocketHandler {
   ...
   * #handleMessage(WebSocketSession, WebSocketMessage)}. The flag {@link
   * org.springframework.web.socket.WebSocketMessage#isLast()} indicates if the message is partial
   * and whether it is the last part.
   */
