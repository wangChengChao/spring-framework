 ...
 *
 * <p>Note that this event may be raised more than once for a single session and therefore event
 * consumers should be idempotent and ignore a duplicate event.
 *
...
public class SessionDisconnectEvent extends AbstractSubProtocolEvent {
  ...
  public SessionDisconnectEvent(
      Object source, Message<byte[]> message, String sessionId, CloseStatus closeStatus) {
  ...
  public String toString() {
    return "SessionDisconnectEvent[sessionId="
        + this.sessionId
        + ", "
