...
/**
 * An extension of {@link AbstractClientSockJsSession} wrapping and delegating to an actual
 * WebSocket session.
 *
...
public class WebSocketClientSockJsSession extends AbstractClientSockJsSession
  ...
  public WebSocketClientSockJsSession(
  ...
  public <T> T getNativeSession(@Nullable Class<T> requiredType) {
    return (requiredType == null || requiredType.isInstance(this.webSocketSession)
        ? (T) this.webSocketSession
        : null);
  }
