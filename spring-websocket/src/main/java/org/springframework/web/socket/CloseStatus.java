...
public final class CloseStatus {
   ...
   * timed out while sending a message) and extra care should be exercised, e.g. avoid sending any
   * further data to the client that may be done during normal shutdown.
   *
   * @since 4.0.3
   */
