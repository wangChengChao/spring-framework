...
/**
 * A {@link WebSocketSession} that exposes the underlying, native WebSocketSession through a getter.
 *
...
public interface NativeWebSocketSession extends WebSocketSession {
   ...
   * @return the native session of the required type, or {@code null} if not available
   */
  @Nullable
