...
public final class TextMessage extends AbstractWebSocketMessage<String> {
  ...
  /**
   * Create a new text WebSocket message from the given byte[]. It is assumed the byte array can be
   * encoded into an UTF-8 String.
   *
   * @param payload the non-null payload
   */
  ...
  /**
   * Create a new text WebSocket message with the given payload representing the full or partial
