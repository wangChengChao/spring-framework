...
public class StandardWebSocketHandlerAdapter extends Endpoint {
  ...
  public void onOpen(final javax.websocket.Session session, EndpointConfig config) {
    ...
    if (this.handler.supportsPartialMessages()) {
      session.addMessageHandler(
          new MessageHandler.Partial<String>() {
            @Override
    ...
    session.addMessageHandler(
        new MessageHandler.Whole<javax.websocket.PongMessage>() {
          @Override
  ...
  private void handleBinaryMessage(
      javax.websocket.Session session, ByteBuffer payload, boolean isLast) {
