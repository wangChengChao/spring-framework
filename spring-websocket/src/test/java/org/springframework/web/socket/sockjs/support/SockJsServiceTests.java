...
public class SockJsServiceTests extends AbstractHttpRequestTests {
  ...
  public void validateRequest() {
    ...
    resetResponseAndHandleRequest(
        "GET", "/echo/server/session/jsonp;Setup.pl", HttpStatus.NOT_FOUND);
  }
  ...
  public void handleInfoGet() throws IOException {
    ...
    assertThat(this.servletResponse.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_CREDENTIALS))
        .isNull();
    ...
    assertThat(body.substring(body.indexOf(',')))
        .isEqualTo(",\"origins\":[\"*:*\"],\"cookie_needed\":true,\"websocket\":true}");
    ...
    assertThat(body.substring(body.indexOf(',')))
        .isEqualTo(",\"origins\":[\"*:*\"],\"cookie_needed\":false,\"websocket\":false}");
  ...
  public void handleInfoGetWithOrigin() throws IOException {
    ...
    this.service.setAllowedOrigins(
        Arrays.asList(
            "http://mydomain1.example", "http://mydomain2.example", "http://mydomain3.example"));
    resetResponseAndHandleRequest("GET", "/echo/info", HttpStatus.OK);
  ...
  public void handleInfoGetCorsFilter() {
    ...
    assertThat(this.servletResponse.getHeader(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN))
        .isEqualTo("foobar:123");
  }
  ...
  public void handleInfoGetWildflyNPE() throws IOException {
    ...
    given(mockResponse.getHeaders(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN))
  ...
  public void handleInfoOptionsWithForbiddenOrigin() {
    ...
    assertThat(corsConfiguration.getAllowedOrigins())
        .isEqualTo(Collections.singletonList("https://mydomain1.example"));
  }
  ...
  public void handleInfoOptionsWithOriginAndCorsHeadersDisabled() {
    ...
    this.service.setAllowedOrigins(
        Arrays.asList(
            "https://mydomain1.example", "https://mydomain2.example", "http://mydomain3.example"));
    resetResponseAndHandleRequest("OPTIONS", "/echo/info", HttpStatus.NO_CONTENT);
    assertThat(this.service.getCorsConfiguration(this.servletRequest)).isNull();
  }
  ...
  public void handleIframeRequest() throws IOException {
    ...
    assertThat(this.response.getHeaders().getETag())
        .isEqualTo("\"0096cbd37f2a5218c33bb0826a7c74cbf\"");
  }
  ...
  public void handleRawWebSocketRequest() throws IOException {
    ...
    assertThat(this.service.sessionId)
        .as("Raw WebSocket should not open a SockJS session")
        .isNull();
  ...
  public void handleEmptyContentType() {
    ...
    assertThat(this.servletResponse.getStatus())
        .as("Invalid/empty content should have been ignored")
        .isEqualTo(200);
  }
  ...
  private static class TestSockJsService extends AbstractSockJsService {
    ...
    protected void handleRawWebSocketRequest(
        ServerHttpRequest req, ServerHttpResponse res, WebSocketHandler handler)
        throws IOException {
