...
public class DefaultSimpUserRegistryTests {
  ...
  public void removeSessionIds() {
    ...
    SessionDisconnectEvent disconnectEvent =
        new SessionDisconnectEvent(this, message, "456", status, user);
  ...
  public void findSubscriptions() throws Exception {
    ...
    Set<SimpSubscription> matches =
        registry.findSubscriptions(
            new SimpSubscriptionMatcher() {
              @Override
  ...
  private Message<byte[]> createMessage(
      SimpMessageType type, String sessionId, String subscriptionId, String destination) {
