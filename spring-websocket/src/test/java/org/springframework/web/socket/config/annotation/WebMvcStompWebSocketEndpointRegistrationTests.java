...
public class WebMvcStompWebSocketEndpointRegistrationTests {
  ...
  public void setup() {
    this.handler =
        new SubProtocolWebSocketHandler(
            mock(MessageChannel.class), mock(SubscribableChannel.class));
  ...
  public void minimalRegistration() {
    WebMvcStompWebSocketEndpointRegistration registration =
        new WebMvcStompWebSocketEndpointRegistration(
    ...
    assertThat(((WebSocketHttpRequestHandler) entry.getKey()).getHandshakeInterceptors().size())
        .isEqualTo(1);
  ...
  public void allowedOrigins() {
    ...
    assertThat(wsHandler.getHandshakeInterceptors().get(0).getClass())
        .isEqualTo(OriginHandshakeInterceptor.class);
  }
  ...
  public void allowedOriginsWithSockJsService() {
    ...
    MultiValueMap<HttpRequestHandler, String> mappings = registration.getMappings();
    assertThat(mappings.size()).isEqualTo(1);
    SockJsHttpRequestHandler requestHandler =
        (SockJsHttpRequestHandler) mappings.entrySet().iterator().next().getKey();
  ...
  public void handshakeHandlerAndInterceptor() {
    ...
    assertThat(requestHandler.getHandshakeInterceptors().get(1).getClass())
        .isEqualTo(OriginHandshakeInterceptor.class);
  }
  ...
  public void handshakeHandlerInterceptorWithSockJsService() {
    ...
    WebSocketTransportHandler transportHandler =
        (WebSocketTransportHandler) handlers.get(TransportType.WEBSOCKET);
    ...
    assertThat(sockJsService.getHandshakeInterceptors().get(1).getClass())
        .isEqualTo(OriginHandshakeInterceptor.class);
  }
