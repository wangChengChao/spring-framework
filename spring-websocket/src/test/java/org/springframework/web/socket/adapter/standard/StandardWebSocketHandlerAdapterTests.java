...
public class StandardWebSocketHandlerAdapterTests {
  ...
  public void setup() {
    ...
    this.adapter =
        new StandardWebSocketHandlerAdapter(this.webSocketHandler, this.webSocketSession);
  }
  ...
  public void onClose() throws Throwable {
    ...
    verify(this.webSocketHandler)
        .afterConnectionClosed(this.webSocketSession, CloseStatus.NORMAL.withReason("reason"));
  }
