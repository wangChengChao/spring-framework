...
public class WebSocketMessageBrokerConfigurationSupportTests {
  ...
  public void clientInboundChannelSendMessage() throws Exception {
    ...
    SubProtocolWebSocketHandler webSocketHandler =
        config.getBean(SubProtocolWebSocketHandler.class);
  ...
  public void webSocketHandlerDecorator() throws Exception {
    ...
    SimpleUrlHandlerMapping mapping =
        (SimpleUrlHandlerMapping) config.getBean("stompWebSocketHandlerMapping");
    WebSocketHttpRequestHandler httpHandler =
        (WebSocketHttpRequestHandler) mapping.getHandlerMap().get("/test");
