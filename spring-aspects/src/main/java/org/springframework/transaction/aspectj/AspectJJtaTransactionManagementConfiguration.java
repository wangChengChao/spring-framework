 ...
 * AspectJ-based annotation-driven transaction management for the JTA 1.2 {@link
 * javax.transaction.Transactional} annotation in addition to Spring's own {@link
 ...
 */
@Configuration
public class AspectJJtaTransactionManagementConfiguration
    extends AspectJTransactionManagementConfiguration {
