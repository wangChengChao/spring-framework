...
public class AnnotationAsyncExecutionAspectTests {
  ...
  private final AsyncUncaughtExceptionHandler defaultExceptionHandler =
  ...
  */
  ...
  @Test
  public void qualifiedAsyncMethodsAreRoutedToCorrectExecutor()
      throws InterruptedException, ExecutionException {
  ...
  static class ClassWithoutAsyncAnnotation {
    ...
    /**
     * It should raise an error to attach @Async to a method that returns a non-void or non-Future.
     * This method must remain commented-out, otherwise there will be a compile-time error.
     * Uncomment to manually verify that the compiler produces an error message due to the 'declare
     * error' statement in {@link AnnotationAsyncExecutionAspect}.
     */
