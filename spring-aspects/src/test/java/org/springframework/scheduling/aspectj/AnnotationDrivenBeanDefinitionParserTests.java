...
public class AnnotationDrivenBeanDefinitionParserTests {
  ...
  public void asyncAspectRegistered() {
    assertThat(context.containsBean(TaskManagementConfigUtils.ASYNC_EXECUTION_ASPECT_BEAN_NAME))
        .isTrue();
  }
  ...
  public void asyncPostProcessorExecutorReference() {
    ...
    assertThat(
            ((Supplier) new DirectFieldAccessor(aspect).getPropertyValue("defaultExecutor")).get())
        .isSameAs(executor);
  }
  ...
  public void asyncPostProcessorExceptionHandlerReference() {
    ...
    Object aspect = context.getBean(TaskManagementConfigUtils.ASYNC_EXECUTION_ASPECT_BEAN_NAME);
    assertThat(
            ((Supplier) new DirectFieldAccessor(aspect).getPropertyValue("exceptionHandler")).get())
