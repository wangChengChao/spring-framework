...
public abstract class FooServiceImpl implements FooService {
  ...
  private static final Comparator<MessageBean> COMPARATOR_BY_MESSAGE =
      Comparator.comparing(MessageBean::getMessage);
  ...
  public Future<String> asyncFoo(int id) {
    ...
    Assert.state(
        ServiceInvocationCounter.getThreadLocalCount() != null, "Thread-local counter not exposed");
