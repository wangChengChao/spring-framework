...
/**
 * Tests the interaction between {@link ApplicationContext} implementations and any registered
 * {@link BeanFactoryPostProcessor} implementations. Specifically {@link StaticApplicationContext}
 * is used for the tests, but what's represented here is any {@link AbstractApplicationContext}
 * implementation.
 *
...
public class BeanFactoryPostProcessorTests {
  ...
  public void testBeanDefinitionRegistryPostProcessorRegisteringAnother() {
    ...
    ac.registerBeanDefinition(
        "bdrpp2", new RootBeanDefinition(OuterBeanDefinitionRegistryPostProcessor.class));
    ac.refresh();
    assertThat(ac.getBean("bfpp1", TestBeanFactoryPostProcessor.class).wasCalled).isTrue();
    assertThat(ac.getBean("bfpp2", TestBeanFactoryPostProcessor.class).wasCalled).isTrue();
  }
  ...
  public void testBeanFactoryPostProcessorAsApplicationListener() {
    StaticApplicationContext ac = new StaticApplicationContext();
    ac.registerBeanDefinition(
        "bfpp", new RootBeanDefinition(ListeningBeanFactoryPostProcessor.class));
    ac.refresh();
    boolean condition =
        ac.getBean(ListeningBeanFactoryPostProcessor.class).received
  ...
  public void testBeanFactoryPostProcessorWithInnerBeanAsApplicationListener() {
    ...
    ac.refresh();
    boolean condition =
        ac.getBean(NestingBeanFactoryPostProcessor.class).getListeningBean().received
            instanceof ContextRefreshedEvent;
    assertThat(condition).isTrue();
  }
  ...
  public static class PrioritizedBeanDefinitionRegistryPostProcessor
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
      ...
      registry.registerBeanDefinition(
          "bfpp1", new RootBeanDefinition(TestBeanFactoryPostProcessor.class));
    }
  ...
  public static class TestBeanDefinitionRegistryPostProcessor
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
      ...
      registry.registerBeanDefinition(
          "bfpp2", new RootBeanDefinition(TestBeanFactoryPostProcessor.class));
    }
  ...
  public static class OuterBeanDefinitionRegistryPostProcessor
      implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
        throws BeansException {
      registry.registerBeanDefinition(
          "anotherpp", new RootBeanDefinition(TestBeanDefinitionRegistryPostProcessor.class));
      registry.registerBeanDefinition(
          "ppp", new RootBeanDefinition(PrioritizedBeanDefinitionRegistryPostProcessor.class));
    }
