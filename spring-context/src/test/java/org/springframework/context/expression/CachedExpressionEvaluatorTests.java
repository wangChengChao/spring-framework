...
public class CachedExpressionEvaluatorTests {
  ...
  public void parseNewExpression() {
    ...
    assertThat(expressionEvaluator.testCache.size())
        .as("Expression should be in cache")
        .isEqualTo(1);
  }
  ...
  public void cacheExpression() {
    ...
    hasParsedExpression("true");
    assertThat(expressionEvaluator.testCache.size())
        .as("Only one expression should be in cache")
        .isEqualTo(1);
  }
  ...
  public void cacheExpressionBasedOnConcreteType() {
    ...
    assertThat(expressionEvaluator.testCache.size())
        .as("Cached expression should be based on type")
        .isEqualTo(2);
  }
