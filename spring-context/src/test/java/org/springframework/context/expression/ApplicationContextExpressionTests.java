...
public class ApplicationContextExpressionTests {
  ...
  public void prototypeCreationReevaluatesExpressions() {
    ...
    ac.getBeanFactory()
        .registerSingleton(GenericApplicationContext.CONVERSION_SERVICE_BEAN_NAME, cs);
  ...
  public void prototypeCreationIsFastEnough() {
    ...
    assertThat(sw.getTotalTimeMillis() < 6000)
  ...
  public void resourceInjection() throws IOException {
    ...
    try (AnnotationConfigApplicationContext ac =
        new AnnotationConfigApplicationContext(ResourceInjectionBean.class)) {
