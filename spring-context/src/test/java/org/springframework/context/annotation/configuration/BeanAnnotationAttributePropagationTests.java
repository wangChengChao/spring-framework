...
/**
 * Unit tests proving that the various attributes available via the {@link Bean} annotation are
 * correctly reflected in the {@link BeanDefinition} created when processing the {@link
 * Configuration} class.
 *
 * <p>Also includes tests proving that using {@link Lazy} and {@link Primary} annotations in
 * conjunction with Bean propagate their respective metadata correctly into the resulting
 * BeanDefinition
 *
 * @author Chris Beams
...
public class BeanAnnotationAttributePropagationTests {
  ...
  public void autowireMetadataIsPropagated() {
    ...
    assertThat(beanDef(Config.class).getAutowireMode())
        .as("autowire mode was not propagated")
        .isEqualTo(AbstractBeanDefinition.AUTOWIRE_BY_TYPE);
  }
  ...
  public void autowireCandidateMetadataIsPropagated() {
    ...
    assertThat(beanDef(Config.class).isAutowireCandidate())
        .as("autowire candidate flag was not propagated")
        .isFalse();
  }
  ...
  public void initMethodMetadataIsPropagated() {
    ...
    assertThat(beanDef(Config.class).getInitMethodName())
        .as("init method name was not propagated")
        .isEqualTo("start");
  }
  ...
  public void destroyMethodMetadataIsPropagated() {
    ...
    assertThat(beanDef(Config.class).getDestroyMethodName())
        .as("destroy method name was not propagated")
        .isEqualTo("destroy");
  }
  ...
  public void dependsOnMetadataIsPropagated() {
    ...
    assertThat(beanDef(Config.class).getDependsOn())
        .as("dependsOn metadata was not propagated")
        .isEqualTo(new String[] {"bar", "baz"});
  }
  ...
  public void primaryMetadataIsPropagated() {
    ...
    assertThat(beanDef(Config.class).isPrimary())
        .as("primary metadata was not propagated")
        .isTrue();
  }
  ...
  public void primaryMetadataIsFalseByDefault() {
    ...
    assertThat(beanDef(Config.class).isPrimary())
        .as("@Bean methods should be non-primary by default")
        .isFalse();
  }
  ...
  public void lazyMetadataIsFalseByDefault() {
    ...
    assertThat(beanDef(Config.class).isLazyInit())
        .as("@Bean methods should be non-lazy by default")
        .isFalse();
  }
  ...
  public void eagerConfigurationProducesEagerBeanDefinitions() {
    ...
    assertThat(beanDef(Config.class).isLazyInit())
        .as("@Lazy(false) @Configuration should produce eager bean definitions")
        .isFalse();
  }
