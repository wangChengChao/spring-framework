...
/**
 * Note the name of {@link AEnclosingConfig} is chosen to help ensure scanning picks up the
 * enclosing configuration prior to {@link ChildConfig} to demonstrate this can happen with
 * classpath scanning.
 *
 * @author Rob Winch
 */
