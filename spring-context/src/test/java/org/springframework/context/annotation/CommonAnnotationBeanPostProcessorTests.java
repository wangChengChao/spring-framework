...
public class CommonAnnotationBeanPostProcessorTests {
  ...
  public void testPostConstructAndPreDestroy() {
    ...
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(AnnotatedInitDestroyBean.class));
  ...
  public void testPostConstructAndPreDestroyWithApplicationContextAndPostProcessor() {
    ...
    ctx.registerBeanDefinition(
        "bpp2", new RootBeanDefinition(CommonAnnotationBeanPostProcessor.class));
    ctx.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(AnnotatedInitDestroyBean.class));
    ctx.refresh();
  ...
  public void testSerialization() throws Exception {
    ...
    CommonAnnotationBeanPostProcessor bpp2 =
        (CommonAnnotationBeanPostProcessor) SerializationTestUtils.serializeAndDeserialize(bpp);
  ...
  public void testSerializationWithManualConfiguration() throws Exception {
    ...
    bpp.setInitAnnotationType(PostConstruct.class);
    bpp.setDestroyAnnotationType(PreDestroy.class);
    InitDestroyAnnotationBeanPostProcessor bpp2 =
  ...
  public void testResourceInjectionWithResolvableDependencyType() {
    ...
    bf.registerResolvableDependency(
    ...
    ExtendedResourceInjectionBean bean =
        (ExtendedResourceInjectionBean) bf.getBean("annotatedBean");
    INestedTestBean tb = bean.getTestBean6();
    assertThat(tb).isNotNull();

    ExtendedResourceInjectionBean anotherBean =
        (ExtendedResourceInjectionBean) bf.getBean("annotatedBean");
    assertThat(bean).isNotSameAs(anotherBean);
  ...
  public void testResourceInjectionWithDefaultMethod() {
    ...
    bf.addBeanPostProcessor(bpp);
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(DefaultMethodResourceInjectionBean.class));
    TestBean tb2 = new TestBean();
    bf.registerSingleton("testBean2", tb2);
  ...
  public void testExtendedResourceInjection() {
    ...
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(ExtendedResourceInjectionBean.class));
    bf.registerBeanDefinition(
        "annotatedBean2", new RootBeanDefinition(NamedResourceInjectionBean.class));
    bf.registerBeanDefinition(
        "annotatedBean3", new RootBeanDefinition(ConvertedResourceInjectionBean.class));
    TestBean tb = new TestBean();
    bf.registerSingleton("testBean", tb);
    TestBean tb2 = new TestBean();
    bf.registerSingleton("testBean2", tb2);
    ...
    ConvertedResourceInjectionBean bean3 =
        (ConvertedResourceInjectionBean) bf.getBean("annotatedBean3");
  ...
  public void testExtendedEjbInjection() {
    ...
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(ExtendedEjbInjectionBean.class));
    TestBean tb = new TestBean();
    bf.registerSingleton("testBean", tb);
    TestBean tb2 = new TestBean();
    bf.registerSingleton("testBean2", tb2);
  ...
  public void testLazyResolutionWithResourceField() {
    ...
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(LazyResourceFieldInjectionBean.class));
    bf.registerBeanDefinition("testBean", new RootBeanDefinition(TestBean.class));

    LazyResourceFieldInjectionBean bean =
        (LazyResourceFieldInjectionBean) bf.getBean("annotatedBean");
  ...
  public void testLazyResolutionWithResourceMethod() {
    ...
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(LazyResourceMethodInjectionBean.class));
    bf.registerBeanDefinition("testBean", new RootBeanDefinition(TestBean.class));

    LazyResourceMethodInjectionBean bean =
        (LazyResourceMethodInjectionBean) bf.getBean("annotatedBean");
    assertThat(bf.containsSingleton("testBean")).isFalse();
    bean.testBean.setName("notLazyAnymore");
    assertThat(bf.containsSingleton("testBean")).isTrue();
    TestBean tb = (TestBean) bf.getBean("testBean");
  ...
  public void testLazyResolutionWithCglibProxy() {
    ...
    bf.registerBeanDefinition(
        "annotatedBean", new RootBeanDefinition(LazyResourceCglibInjectionBean.class));
    bf.registerBeanDefinition("testBean", new RootBeanDefinition(TestBean.class));

    LazyResourceCglibInjectionBean bean =
        (LazyResourceCglibInjectionBean) bf.getBean("annotatedBean");
    assertThat(bf.containsSingleton("testBean")).isFalse();
    bean.testBean.setName("notLazyAnymore");
    assertThat(bf.containsSingleton("testBean")).isTrue();
    TestBean tb = (TestBean) bf.getBean("testBean");
  ...
  public static class ResourceInjectionBean extends AnnotatedInitDestroyBean {
    ...
    @Resource private TestBean testBean;
  ...
  static class NonPublicResourceInjectionBean<B> extends ResourceInjectionBean {
    ...
    @Resource INestedTestBean testBean5;

    INestedTestBean testBean6;

    @Resource BeanFactory beanFactory;
  ...
  public static class ExtendedResourceInjectionBean
      extends NonPublicResourceInjectionBean<ITestBean> {}
  ...
  public static class ExtendedEjbInjectionBean extends ResourceInjectionBean {
    ...
    @EJB private INestedTestBean testBean5;
  ...
  private static class LazyResourceFieldInjectionBean {
    ...
    @Resource @Lazy private ITestBean testBean;
  }
