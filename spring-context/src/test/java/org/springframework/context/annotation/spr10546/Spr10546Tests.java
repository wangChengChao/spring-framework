...
public class Spr10546Tests {
  ...
  /**
   * Prior to fixing SPR-10546 this might have succeeded depending on the ordering the classes were
   * picked up. If they are picked up in the same order as {@link
   * #enclosingConfigFirstParentDefinesBean()} then it would fail. This test is mostly for
   * illustration purposes, but doesn't hurt to continue using it.
   *
   * <p>We purposely use the {@link AEnclosingConfig} to make it alphabetically prior to the {@link
   * AEnclosingConfig.ChildConfig} which encourages this to occur with the classpath scanning
  ...
  public void enclosingConfigFirstParentDefinesBeanWithImportResource() {
    assertLoadsMyBean(
        AEnclosingWithImportResourceConfig.class,
        AEnclosingWithImportResourceConfig.ChildConfig.class);
  }
  ...
  public void enclosingConfigFirstParentDefinesBeanWithComponentScan() {
    assertLoadsMyBean(
        AEnclosingWithComponentScanConfig.class,
        AEnclosingWithComponentScanConfig.ChildConfig.class);
  }
  ...
  public void enclosingConfigFirstParentWithParentDefinesBean() {
    assertLoadsMyBean(
        AEnclosingWithGrandparentConfig.class, AEnclosingWithGrandparentConfig.ChildConfig.class);
  }
  ...
  public void enclosingConfigFirstParentDefinesBeanWithImport() {
    assertLoadsMyBean(
        AEnclosingWithImportConfig.class, AEnclosingWithImportConfig.ChildConfig.class);
  }
