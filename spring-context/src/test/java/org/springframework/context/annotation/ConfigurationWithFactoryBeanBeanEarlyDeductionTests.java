...
/**
 * Test for {@link AbstractBeanFactory} type inference from {@link FactoryBean FactoryBeans} defined
...
public class ConfigurationWithFactoryBeanBeanEarlyDeductionTests {
  ...
  public void preFreezeUnresolvedGenericFactoryBean() {
    ...
    try {
      ...
      NameCollectingBeanFactoryPostProcessor postProcessor =
          new NameCollectingBeanFactoryPostProcessor();
  ...
  private void assertPreFreeze(
      Class<?> configurationClass, BeanFactoryPostProcessor... postProcessors) {
    NameCollectingBeanFactoryPostProcessor postProcessor =
        new NameCollectingBeanFactoryPostProcessor();
  ...
  static class AttributeClassRegistrar implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(
      ...
      BeanDefinition definition =
          BeanDefinitionBuilder.genericBeanDefinition(RawWithAbstractObjectTypeFactoryBean.class)
              .getBeanDefinition();
