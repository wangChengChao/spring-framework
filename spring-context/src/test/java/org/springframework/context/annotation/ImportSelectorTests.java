...
public class ImportSelectorTests {
  ...
  public void invokeAwareMethodsInImportSelector() {
    ...
    assertThat(SampleImportSelector.classLoader)
  ...
  public void importSelectorsWithNestedGroup() {
    ...
    assertThat(TestImportGroup.allImports())
        .containsOnlyKeys(
            ParentConfiguration1.class.getName(), ChildConfiguration1.class.getName());
    assertThat(TestImportGroup.allImports().get(ParentConfiguration1.class.getName()))
        .containsExactly(
            DeferredImportSelector1.class.getName(), ChildConfiguration1.class.getName());
  ...
  public void importSelectorsWithNestedGroupSameDeferredImport() {
    ...
    assertThat(TestImportGroup.allImports())
        .containsOnlyKeys(
            ParentConfiguration2.class.getName(), ChildConfiguration2.class.getName());
    assertThat(TestImportGroup.allImports().get(ParentConfiguration2.class.getName()))
        .containsExactly(
            DeferredImportSelector2.class.getName(), ChildConfiguration2.class.getName());
  ...
  public void invokeAwareMethodsInImportGroup() {
    AnnotationConfigApplicationContext context =
        new AnnotationConfigApplicationContext(GroupedConfig1.class);
    assertThat(TestImportGroup.beanFactory).isEqualTo(context.getBeanFactory());
    assertThat(TestImportGroup.classLoader)
        .isEqualTo(context.getBeanFactory().getBeanClassLoader());
  ...
  @Retention(RetentionPolicy.RUNTIME)
  @Import({
    GroupedDeferredImportSelector1.class,
    GroupedDeferredImportSelector2.class,
    ImportSelector1.class,
    ImportSelector2.class
  })
