 ...
 * or @Component 'value' attributes are indeed respected, and that customization of bean naming
 * through a BeanNameGenerator strategy works as expected.
 *
 * @author Chris Beams
 * @since 3.1.1
 */
