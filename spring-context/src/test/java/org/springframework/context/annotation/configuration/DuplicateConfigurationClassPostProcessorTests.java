...
/**
 * Corners the bug originally reported by SPR-8824, where the presence of two {@link
 * ConfigurationClassPostProcessor} beans in combination with a @Configuration class having at least
 * one @Bean method causes a "Singleton 'foo' isn't currently in creation" exception.
 *
 * @author Chris Beams
 * @since 3.1
 */
