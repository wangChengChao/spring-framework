...
/**
 * Reproduces SPR-8756, which has been marked as "won't fix" for reasons described in the issue.
 * Also demonstrates the suggested workaround.
 *
 * @author Chris Beams
 */
public class PackagePrivateBeanMethodInheritanceTests {
  ...
  @Configuration
  public static class ReproConfig
      extends org.springframework.context.annotation.configuration.a.BaseConfig {
    @Bean
    public Foo foo1() {
  ...
  @Configuration
  public static class WorkaroundConfig
      extends org.springframework.context.annotation.configuration.a.BaseConfig {
    @Bean
    public Foo foo1() {
