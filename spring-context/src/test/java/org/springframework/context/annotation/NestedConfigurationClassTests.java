...
public class NestedConfigurationClassTests {
  ...
  public void twoLevelsDeep() {
    ...
    assertThat(ctx.getBeanFactory().containsSingleton("nestedConfigurationClassTests.L0Config"))
        .isFalse();
    ...
    assertThat(ctx.getBeanFactory().containsSingleton(L0Config.L1Config.L2Config.class.getName()))
        .isFalse();
    ctx.getBean(L0Config.L1Config.L2Config.class);
    ctx.getBean("l2Bean");
  ...
  public void twoLevelsInLiteMode() {
    ...
    assertThat(
            ctx.getBeanFactory().containsSingleton("nestedConfigurationClassTests.L0ConfigLight"))
        .isFalse();
    ctx.getBean(L0ConfigLight.class);
    ctx.getBean("l0Bean");

    assertThat(ctx.getBeanFactory().containsSingleton(L0ConfigLight.L1ConfigLight.class.getName()))
        .isTrue();
    ...
    assertThat(
            ctx.getBeanFactory()
                .containsSingleton(L0ConfigLight.L1ConfigLight.L2ConfigLight.class.getName()))
        .isFalse();
