...
public class AnnotationDrivenBeanDefinitionParserTests {
  ...
  public void asyncPostProcessorRegistered() {
    assertThat(context.containsBean(TaskManagementConfigUtils.ASYNC_ANNOTATION_PROCESSOR_BEAN_NAME))
        .isTrue();
  }
  ...
  public void asyncPostProcessorExecutorReference() {
    ...
    Object postProcessor =
        context.getBean(TaskManagementConfigUtils.ASYNC_ANNOTATION_PROCESSOR_BEAN_NAME);
    assertThat(
            ((Supplier<?>) new DirectFieldAccessor(postProcessor).getPropertyValue("executor"))
                .get())
        .isSameAs(executor);
  }
  ...
  public void scheduledPostProcessorSchedulerReference() {
    ...
    Object postProcessor =
        context.getBean(TaskManagementConfigUtils.SCHEDULED_ANNOTATION_PROCESSOR_BEAN_NAME);
    assertThat(new DirectFieldAccessor(postProcessor).getPropertyValue("scheduler"))
        .isSameAs(scheduler);
  }
  ...
  public void asyncPostProcessorExceptionHandlerReference() {
    ...
    assertThat(
            ((Supplier<?>)
                    new DirectFieldAccessor(postProcessor).getPropertyValue("exceptionHandler"))
                .get())
