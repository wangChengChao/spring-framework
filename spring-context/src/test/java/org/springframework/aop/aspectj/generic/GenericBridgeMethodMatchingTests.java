 ...
 * gets called as the way into the proxy. Therefore, we need tests for calling a bean with static
 * type set to type with generic method and to type with specific non-generic implementation.
 *
 * <p>This class focuses on JDK proxy, while a subclass, GenericBridgeMethodMatchingClassProxyTests,
 * focuses on class proxying.
 *
 * <p>See SPR-3556 for more details.
 *
