  ...
  public void testExceptionOnConfigParsingWithMismatchedAdviceMethod() {
    try {
      ...
      assertThat(cause.getMessage().contains("invalidAbsoluteTypeName"))
          .as("invalidAbsoluteTypeName should be detected by AJ")
          .isTrue();
    }
  }
  ...
  public void testExceptionOnConfigParsingWithAmbiguousAdviceMethod() {
    try {
      ...
      assertThat(
              cause
                  .getMessage()
                  .contains("Cannot resolve method 'myBeforeAdvice' to a unique method"))
          .as("Cannot resolve method 'myBeforeAdvice' to a unique method")
          .isTrue();
    }
  }
}
