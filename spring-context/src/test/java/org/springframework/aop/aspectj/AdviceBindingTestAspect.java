...
/**
 * Aspect used as part of before advice binding tests and serves as base class for a number of more
 * specialized test aspects.
 *
...
class AdviceBindingTestAspect {
  ...
  /**
   * Collaborator interface that makes it easy to test this aspect is working as expected through
   * mocking.
   */
