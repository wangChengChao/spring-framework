...
/**
 * Tests corner case of using {@link Cacheable} and {@link CachePut} on the same operation.
 *
...
public class CachePutEvaluationTests {
  ...
  public void getAndPut() {
    ...
    assertThat(this.cache.get(value + 100).get())
        .as("Wrong value for @CachePut key")
        .isEqualTo(value);
    ...
    assertThat(this.cache.get(anotherValue + 100).get())
        .as("Wrong value for @CachePut key")
  ...
  public static class SimpleService {
    ...
    /**
     * Represent an invalid use case. If the result of the operation is non null, then we put the
     * value with a different key. This forces the method to be executed every time.
     */
    @Cacheable
