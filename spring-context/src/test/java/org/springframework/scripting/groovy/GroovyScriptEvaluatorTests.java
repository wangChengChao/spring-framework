...
public class GroovyScriptEvaluatorTests {
  ...
  public void testGroovyScriptFromFile() {
    ...
    Object result =
        evaluator.evaluate(
            new ResourceScriptSource(new ClassPathResource("simple.groovy", getClass())));
    assertThat(result).isEqualTo(6);
  }
  ...
  public void testGroovyScriptWithImportCustomizer() {
    ...
    Object result =
        evaluator.evaluate(new StaticScriptSource("return ResourceUtils.CLASSPATH_URL_PREFIX"));
