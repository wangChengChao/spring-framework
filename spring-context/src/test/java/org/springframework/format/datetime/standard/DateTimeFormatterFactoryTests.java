...
public class DateTimeFormatterFactoryTests {
  ...
  private static final TimeZone TEST_TIMEZONE =
      ZURICH.equals(TimeZone.getDefault()) ? NEW_YORK : ZURICH;
  ...
  public void createDateTimeFormatterInOrderOfPropertyPriority() {
    ...
    assertThat(applyLocale(factory.createDateTimeFormatter()).format(dateTime))
        .isEqualTo("2009-10-21");
  ...
  public void createDateTimeFormatterWithTimeZone() {
    ...
    assertThat(factory.createDateTimeFormatter().format(dateTime))
        .isEqualTo("20091021121000 " + offset);
  }
