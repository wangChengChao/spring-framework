...
public class JodaTimeFormattingTests {
  ...
  public void testJodaTimePatternsForStyle() {
    System.out.println(
        org.joda.time.format.DateTimeFormat.patternForStyle("SS", LocaleContextHolder.getLocale()));
    System.out.println(
        org.joda.time.format.DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
    System.out.println(
        org.joda.time.format.DateTimeFormat.patternForStyle("LL", LocaleContextHolder.getLocale()));
    System.out.println(
        org.joda.time.format.DateTimeFormat.patternForStyle("FF", LocaleContextHolder.getLocale()));
  }
  ...
  public void testBindLocalDateAnnotated() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("localDateAnnotated"))
        .isEqualTo("Oct 31, 2009");
  }
  ...
  public void testBindNestedLocalDateAnnotated() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("children[0].localDateAnnotated"))
        .isEqualTo("Oct 31, 2009");
  }
  ...
  public void testBindLocalTimeAnnotated() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("localTimeAnnotated"))
        .isEqualTo("12:00:00 PM");
  }
  ...
  public void testBindDateTime() {
    MutablePropertyValues propertyValues = new MutablePropertyValues();
    propertyValues.add(
        "dateTime", new DateTime(2009, 10, 31, 12, 0, ISOChronology.getInstanceUTC()));
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
  ...
  public void testBindDateTimeISO() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("dateTime"))
  ...
  public void testBindDateTimeAnnotated() {
    MutablePropertyValues propertyValues = new MutablePropertyValues();
    propertyValues.add(
        "dateTimeAnnotated", new DateTime(2009, 10, 31, 12, 0, ISOChronology.getInstanceUTC()));
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
  ...
  public void testBindDateTimeAnnotatedPattern() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("dateTimeAnnotatedPattern"))
        .isEqualTo("10/31/09 12:00 PM");
  }
  ...
  public void testBindDateWithErrorAvoidingDateConstructor() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(1);
    assertThat(binder.getBindingResult().getFieldValue("date"))
        .isEqualTo("Sat, 12 Aug 1995 13:30:00 GMT");
  }
  ...
  public void testBindISODateTime() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("isoDateTime"))
        .isEqualTo("2009-10-31T07:00:00.000-05:00");
  }
  ...
  public void dateToStringWithFormat() {
    ...
    Object actual =
        this.conversionService.convert(
            date, TypeDescriptor.valueOf(Date.class), TypeDescriptor.valueOf(String.class));
    String expected =
        JodaTimeContextHolder.getFormatter(
                org.joda.time.format.DateTimeFormat.shortDateTime(), Locale.US)
  ...
  public void testBindPeriod() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("period").toString().equals("P6Y3M1D"))
        .isTrue();
  }
  ...
  public void testBindDuration() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("duration").toString().equals("PT72.345S"))
        .isTrue();
  }
  ...
  public void testBindYearMonth() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("yearMonth").toString().equals("2007-12"))
        .isTrue();
  }
  ...
  public void testBindMonthDay() {
    ...
    binder.bind(propertyValues);
    assertThat(binder.getBindingResult().getErrorCount()).isEqualTo(0);
    assertThat(binder.getBindingResult().getFieldValue("monthDay").toString().equals("--12-03"))
        .isTrue();
  }
  ...
  private static class JodaTimeBean {
    ...
    @DateTimeFormat private Date date;
    ...
    @DateTimeFormat private DateTime dateTimeAnnotatedDefault;
