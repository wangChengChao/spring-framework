...
public abstract class AbstractMetadataAssemblerTests extends AbstractJmxAssemblerTests {
  ...
  public void testDescription() throws Exception {
    ...
    assertThat(info.getDescription())
        .as("The descriptions are not the same")
        .isEqualTo("My Managed Bean");
  }
  ...
  public void testAttributeDescriptionOnSetter() throws Exception {
    ...
    assertThat(attr.getDescription())
        .as("The description for the age attribute is incorrect")
  ...
  public void testAttributeDescriptionOnGetter() throws Exception {
    ...
    assertThat(attr.getDescription())
        .as("The description for the name attribute is incorrect")
  ...
  public void testManagedResourceDescriptor() throws Exception {
    ...
    assertThat(desc.getFieldValue("currencyTimeLimit"))
        .as("Currency Time Limit should be 15")
        .isEqualTo("15");
    assertThat(desc.getFieldValue("persistPolicy"))
        .as("Persist Policy should be OnUpdate")
        .isEqualTo("OnUpdate");
    assertThat(desc.getFieldValue("persistPeriod"))
        .as("Persist Period should be 200")
        .isEqualTo("200");
    assertThat(desc.getFieldValue("persistLocation"))
        .as("Persist Location should be foo")
        .isEqualTo("./foo");
    assertThat(desc.getFieldValue("persistName"))
        .as("Persist Name should be bar")
        .isEqualTo("bar.jmx");
  }
  ...
  public void testAttributeDescriptor() throws Exception {
    ...
    assertThat(desc.getFieldValue("currencyTimeLimit"))
        .as("Currency Time Limit should be 20")
        .isEqualTo("20");
    assertThat(desc.getFieldValue("persistPolicy"))
        .as("Persist Policy should be OnUpdate")
        .isEqualTo("OnUpdate");
    assertThat(desc.getFieldValue("persistPeriod"))
        .as("Persist Period should be 300")
        .isEqualTo("300");
  }
  ...
  public void testOperationDescriptor() throws Exception {
    ...
    assertThat(desc.getFieldValue("currencyTimeLimit"))
        .as("Currency Time Limit should be 30")
        .isEqualTo("30");
    assertThat(desc.getFieldValue("role"))
        .as("Role should be \"operation\"")
        .isEqualTo("operation");
  }
  ...
  public void testWithCglibProxy() throws Exception {
    ...
    assertThat(inf.getOperations().length)
        .as("Incorrect number of operations")
        .isEqualTo(getExpectedOperationCount());
    assertThat(inf.getAttributes().length)
        .as("Incorrect number of attributes")
        .isEqualTo(getExpectedAttributeCount());

    assertThat(assembler.includeBean(proxy.getClass(), "some bean name"))
        .as("Not included in autodetection")
        .isTrue();
  }
  ...
  public void testMetricDescription() throws Exception {
    ...
    assertThat(metric.getDescription())
        .as("The description for the queue size metric is incorrect")
  ...
  public void testMetricDescriptor() throws Exception {
    ...
    assertThat(desc.getFieldValue("displayName"))
        .as("Display Name should be Queue Size")
        .isEqualTo("Queue Size");
    assertThat(desc.getFieldValue("metricType"))
        .as("Metric Type should be COUNTER")
        .isEqualTo("COUNTER");
    assertThat(desc.getFieldValue("metricCategory"))
        .as("Metric Category should be utilization")
  ...
  public void testMetricDescriptorDefaults() throws Exception {
    ...
    assertThat(desc.getFieldValue("currencyTimeLimit"))
        .as("Currency Time Limit should not be populated")
        .isNull();
    assertThat(desc.getFieldValue("persistPolicy"))
        .as("Persist Policy should not be populated")
        .isNull();
    assertThat(desc.getFieldValue("persistPeriod"))
        .as("Persist Period should not be populated")
        .isNull();
    assertThat(desc.getFieldValue("units")).as("Unit should not be populated").isNull();
    assertThat(desc.getFieldValue("displayName"))
        .as("Display Name should be populated by default via JMX")
        .isEqualTo(CACHE_ENTRIES_METRIC);
    assertThat(desc.getFieldValue("metricType"))
        .as("Metric Type should be GAUGE")
        .isEqualTo("GAUGE");
    assertThat(desc.getFieldValue("metricCategory"))
        .as("Metric Category should not be populated")
        .isNull();
  }
