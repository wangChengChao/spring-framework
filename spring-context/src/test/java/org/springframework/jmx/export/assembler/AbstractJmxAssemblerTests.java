...
public abstract class AbstractJmxAssemblerTests extends AbstractJmxTests {
  ...
  public void testRegisterOperations() throws Exception {
    ...
    assertThat(inf.getOperations().length)
        .as("Incorrect number of operations registered")
  ...
  public void testRegisterAttributes() throws Exception {
    ...
    assertThat(inf.getAttributes().length)
        .as("Incorrect number of attributes registered")
  ...
  public void testGetMBeanAttributeInfo() throws Exception {
    ...
    assertThat(inf.length)
        .as("Invalid number of Attributes returned")
        .isEqualTo(getExpectedAttributeCount());

    for (int x = 0; x < inf.length; x++) {
      assertThat(inf[x]).as("MBeanAttributeInfo should not be null").isNotNull();
      assertThat(inf[x].getDescription())
          .as("Description for MBeanAttributeInfo should not be null")
          .isNotNull();
    }
  }
  ...
  public void testGetMBeanOperationInfo() throws Exception {
    ...
    assertThat(inf.length)
        .as("Invalid number of Operations returned")
        .isEqualTo(getExpectedOperationCount());

    for (int x = 0; x < inf.length; x++) {
      assertThat(inf[x]).as("MBeanOperationInfo should not be null").isNotNull();
      assertThat(inf[x].getDescription())
          .as("Description for MBeanOperationInfo should not be null")
          .isNotNull();
    }
  }
  ...
  public void testAttributeInfoHasDescriptors() throws Exception {
    ...
    assertThat(desc.getFieldValue("getMethod"))
        .as("getMethod field should not be null")
        .isNotNull();
    assertThat(desc.getFieldValue("setMethod"))
        .as("setMethod field should not be null")
        .isNotNull();
    assertThat(desc.getFieldValue("getMethod"))
        .as("getMethod field has incorrect value")
        .isEqualTo("getName");
    assertThat(desc.getFieldValue("setMethod"))
        .as("setMethod field has incorrect value")
        .isEqualTo("setName");
  }
  ...
  public void testAttributeHasCorrespondingOperations() throws Exception {
    ...
    assertThat(new Integer(4))
        .as("get operation should have visibility of four")
        .isEqualTo(get.getDescriptor().getFieldValue("visibility"));
    assertThat(get.getDescriptor().getFieldValue("role"))
        .as("get operation should have role \"getter\"")
        .isEqualTo("getter");

    ModelMBeanOperationInfo set = info.getOperation("setName");
    assertThat(set).as("set operation should not be null").isNotNull();
    assertThat(new Integer(4))
        .as("set operation should have visibility of four")
        .isEqualTo(set.getDescriptor().getFieldValue("visibility"));
    assertThat(set.getDescriptor().getFieldValue("role"))
        .as("set operation should have role \"setter\"")
        .isEqualTo("setter");
  }
  ...
  public void testNotificationMetadata() throws Exception {
    ...
    assertThat(notifications[0].getName())
        .as("Incorrect notification name")
        .isEqualTo("My Notification");
