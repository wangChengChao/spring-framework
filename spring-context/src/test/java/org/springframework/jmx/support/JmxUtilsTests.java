...
public class JmxUtilsTests {
  ...
  public void testIsMBeanWithDynamicMBean() throws Exception {
    ...
    assertThat(JmxUtils.isMBean(mbean.getClass()))
        .as("Dynamic MBean not detected correctly")
        .isTrue();
  }
  ...
  public void testIsMBeanWithStandardMBeanWrapper() throws Exception {
    ...
    assertThat(JmxUtils.isMBean(mbean.getClass()))
        .as("Standard MBean not detected correctly")
        .isTrue();
  }
  ...
  public void testNotAnMBean() throws Exception {
    assertThat(JmxUtils.isMBean(Object.class))
        .as("Object incorrectly identified as an MBean")
        .isFalse();
  }
  ...
  public void testSimpleMXBean() throws Exception {
    FooX foo = new FooX();
    assertThat(JmxUtils.isMBean(foo.getClass()))
        .as("Simple MXBean not detected correctly")
        .isTrue();
  }
  ...
  public void testSimpleMBeanThroughInheritance() throws Exception {
    Bar bar = new Bar();
    Abc abc = new Abc();
    assertThat(JmxUtils.isMBean(bar.getClass()))
        .as("Simple MBean (through inheritance) not detected correctly")
        .isTrue();
    assertThat(JmxUtils.isMBean(abc.getClass()))
        .as("Simple MBean (through 2 levels of inheritance) not detected correctly")
        .isTrue();
  }
  ...
  public void testGetAttributeNameWithStrictCasing() {
    PropertyDescriptor pd =
        new BeanWrapperImpl(AttributeTestBean.class).getPropertyDescriptor("name");
  ...
  public void testAppendIdentityToObjectName() throws MalformedObjectNameException {
    ...
    assertThat(uniqueName.getDomain())
        .as("Domain of transformed name is incorrect")
        .isEqualTo(objectName.getDomain());
    assertThat(uniqueName.getKeyProperty("type"))
        .as("Type key is incorrect")
        .isEqualTo(objectName.getKeyProperty(typeProperty));
    assertThat(uniqueName.getKeyProperty(JmxUtils.IDENTITY_OBJECT_NAME_KEY))
        .as("Identity key is incorrect")
