...
public class FieldError extends ObjectError {
   ...
   * @param bindingFailure whether this error represents a binding failure (like a type mismatch);
  ...
  /**
   * Return whether this error represents a binding failure (like a type mismatch); otherwise it is
