...
/**
 * Abstract implementation of the {@link Errors} interface. Provides common access to evaluated
 * errors; however, does not define concrete management of {@link ObjectError ObjectErrors} and
