...
/**
 * Abstract base class for {@link BindingResult} implementations that work with Spring's {@link
 * org.springframework.beans.PropertyAccessor} mechanism. Pre-implements field access through
 * delegation to the corresponding PropertyAccessor methods.
 *
...
public abstract class AbstractPropertyBindingResult extends AbstractBindingResult {
  ...
  @Nullable private transient ConversionService conversionService;
   ...
   *
   * <p>Note that a PropertyAccessor used by a BindingResult should always have its
   * "extractOldValueForEditor" flag set to "true" by default, since this is typically possible
   * without side effects for model objects that serve as data binding target.
   *
