...
/**
 * {@link LocalValidatorFactoryBean} subclass that simply turns {@link
 * org.springframework.validation.Validator} calls into no-ops in case of no Bean Validation
 * provider being available.
 *
 * <p>This is the actual class used by Spring's MVC configuration namespace, in case of the {@code
