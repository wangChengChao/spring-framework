 ...
 *
 * <p>Can be used e.g. with Spring MVC handler methods arguments. Supported through {@link
 * org.springframework.validation.SmartValidator}'s validation hint concept, with validation group
 * classes acting as hint objects.
 *
 ...
 * @see org.springframework.validation.SmartValidator#validate(Object,
...
public @interface Validated {
  ...
  /**
   * Specify one or more validation groups to apply to the validation step kicked off by this
   * annotation.
   *
   * <p>JSR-303 defines validation groups as custom annotations which an application declares for
   * the sole purpose of using them as type-safe group arguments, as implemented in {@link
   * org.springframework.validation.beanvalidation.SpringValidatorAdapter}.
   *
   * <p>Other {@link org.springframework.validation.SmartValidator} implementations may support
   * class arguments in other ways as well.
   */
  Class<?>[] value() default {};
}
