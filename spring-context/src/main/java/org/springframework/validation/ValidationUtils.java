...
/**
 * Utility class offering convenient methods for invoking a {@link Validator} and for rejecting
 * empty fields.
 *
 * <p>Checks for an empty field in {@code Validator} implementations can become one-liners when
 * using {@link #rejectIfEmpty} or {@link #rejectIfEmptyOrWhitespace}.
 *
...
public abstract class ValidationUtils {
  ...
  /**
   * Invoke the given {@link Validator} for the supplied object and {@link Errors} instance.
   *
   ...
   * @throws IllegalArgumentException if either of the {@code Validator} or {@code Errors} arguments
   *     is {@code null}, or if the supplied {@code Validator} does not {@link
   *     Validator#supports(Class) support} the validation of the supplied object's type
   */
  ...
  /**
   * Invoke the given {@link Validator}/{@link SmartValidator} for the supplied object and {@link
   * Errors} instance.
   *
   * @param validator the {@code Validator} to be invoked
   * @param target the object to bind the parameters to
   ...
   *
   * <p>An 'empty' value in this context means either {@code null} or the empty string "".
   *
   * <p>The object whose field is being validated does not need to be passed in because the {@link
   * Errors} instance can resolve field values by itself (it will usually hold an internal reference
   ...
   * @param field the field name to check
   * @param errorCode the error code, interpretable as message key
   * @param errorArgs the error arguments, for argument binding via MessageFormat (can be {@code
   *     null})
   */
  public static void rejectIfEmpty(
  ...
  /**
   * Reject the given field with the given error code, error arguments and default message if the
   * value is empty.
   *
   * <p>An 'empty' value in this context means either {@code null} or the empty string "".
   *
  ...
  /**
   * Reject the given field with the given error code if the value is empty or just contains
   * whitespace.
   *
   * <p>An 'empty' value in this context means either {@code null}, the empty string "", or
   * consisting wholly of whitespace.
   *
   * <p>The object whose field is being validated does not need to be passed in because the {@link
   * Errors} instance can resolve field values by itself (it will usually hold an internal reference
   * to the target object).
  ...
  /**
   * Reject the given field with the given error code and default message if the value is empty or
  ...
  /**
   * Reject the given field with the given error code and error arguments if the value is empty or
   * just contains whitespace.
   *
   * <p>An 'empty' value in this context means either {@code null}, the empty string "", or
   * consisting wholly of whitespace.
  ...
  /**
   * Reject the given field with the given error code, error arguments and default message if the
   * value is empty or just contains whitespace.
   *
   * <p>An 'empty' value in this context means either {@code null}, the empty string "", or
   * consisting wholly of whitespace.
   *
