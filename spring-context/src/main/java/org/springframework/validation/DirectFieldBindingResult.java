...
/**
 * Special implementation of the Errors and BindingResult interfaces, supporting registration and
 * evaluation of binding errors on value objects. Performs direct field access instead of going
 * through JavaBean getters.
 *
...
public class DirectFieldBindingResult extends AbstractPropertyBindingResult {
  ...
  @Nullable private transient ConfigurablePropertyAccessor directFieldAccessor;
   ...
   */
  public DirectFieldBindingResult(
      @Nullable Object target, String objectName, boolean autoGrowNestedPaths) {
    super(objectName);
    this.target = target;
  ...
  protected ConfigurablePropertyAccessor createDirectFieldAccessor() {
    if (this.target == null) {
      throw new IllegalStateException(
          "Cannot access fields on null target instance '" + getObjectName() + "'");
    }
