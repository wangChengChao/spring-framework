...
public class JndiTemplate {
  ...
  @Nullable private Properties environment;
  ...
  /**
   * Obtain a JNDI context corresponding to this template's configuration. Called by {@link
   * #execute}; may also be called directly.
   *
   ...
   *
   * <p>The default implementation use this template's environment settings. Can be subclassed for
   ...
   * @return object found (cannot be {@code null}; if a not so well-behaved JNDI implementations
   *     returns null, a NamingException gets thrown)
   ...
   *
   * @param name the JNDI name of the object
   * @param requiredType type the JNDI object must match. Can be an interface or superclass of the
   *     actual class, or {@code null} for any match. For example, if the value is {@code
  ...
  /**
   * Rebind the given object to the current JNDI context, using the given name. Overwrites any
   * existing binding.
   *
   * @param name the JNDI name of the object
