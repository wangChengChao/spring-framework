...
/**
 * General exception to be thrown on scheduling failures, such as the scheduler already having shut
 * down. Unchecked since scheduling failures are usually fatal.
 *
