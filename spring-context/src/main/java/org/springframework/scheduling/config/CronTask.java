...
/**
 * {@link TriggerTask} implementation defining a {@code Runnable} to be executed according to a
 * {@linkplain org.springframework.scheduling.support.CronSequenceGenerator standard cron
 * expression}.
 *
 * @author Chris Beams
 * @since 3.2
