...
public interface SchedulingTaskExecutor extends AsyncTaskExecutor {
   ...
   *
   * <p>This should be considered a hint. Of course {@code TaskExecutor} clients are free to ignore
   * this flag and hence the {@code SchedulingTaskExecutor} interface overall. However, thread pools
   * will usually indicated a preference for short-lived tasks, allowing for more fine-grained
   * scheduling.
   *
