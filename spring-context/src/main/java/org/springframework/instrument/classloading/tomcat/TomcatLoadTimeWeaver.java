 ...
 * new {@code org.apache.tomcat.InstrumentableClassLoader}. Also capable of handling Spring's
 * TomcatInstrumentableClassLoader when encountered.
 *
...
public class TomcatLoadTimeWeaver implements LoadTimeWeaver {
  ...
  /**
   * Create a new instance of the {@link TomcatLoadTimeWeaver} class using the default {@link
  ...
  /**
   * Create a new instance of the {@link TomcatLoadTimeWeaver} class using the supplied {@link
   * ClassLoader}.
   *
  ...
  public TomcatLoadTimeWeaver(@Nullable ClassLoader classLoader) {
    ...
    try {
      ...
      Method copyMethod =
          ClassUtils.getMethodIfAvailable(instrumentableLoaderClass, "copyWithoutTransformers");
      if (copyMethod == null) {
      ...
      throw new IllegalStateException(
          "Could not initialize TomcatLoadTimeWeaver because Tomcat API classes are not available",
          ex);
    }
  }
  ...
  public void addTransformer(ClassFileTransformer transformer) {
    try {
      ...
      throw new IllegalStateException(
          "Tomcat addTransformer method threw exception", ex.getCause());
    } catch (Throwable ex) {
  ...
  public ClassLoader getThrowawayClassLoader() {
    try {
      return new OverridingClassLoader(
          this.classLoader, (ClassLoader) this.copyMethod.invoke(this.classLoader));
    } catch (InvocationTargetException ex) {
