...
/**
 * {@link LoadTimeWeaver} implementation for GlassFish's {@code
...
public class GlassFishLoadTimeWeaver implements LoadTimeWeaver {
  ...
  /**
   * Create a new instance of the {@link GlassFishLoadTimeWeaver} class using the default {@link
  ...
  /**
   * Create a new instance of the {@link GlassFishLoadTimeWeaver} class using the supplied {@link
   * ClassLoader}.
   *
  ...
  public GlassFishLoadTimeWeaver(@Nullable ClassLoader classLoader) {
    ...
    try {
      ...
      throw new IllegalStateException(
          "Could not initialize GlassFishLoadTimeWeaver because GlassFish API classes are not available",
          ex);
    }
    ...
    if (clazzLoader == null) {
      throw new IllegalArgumentException(
          classLoader
              + " and its parents are not suitable ClassLoaders: A ["
              + instrumentableLoaderClass.getName()
  ...
  public void addTransformer(ClassFileTransformer transformer) {
    try {
      ...
      throw new IllegalStateException(
          "GlassFish addTransformer method threw exception", ex.getCause());
    } catch (Throwable ex) {
