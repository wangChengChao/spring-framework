...
/**
 * {@link LoadTimeWeaver} implementation for WebSphere's instrumentable ClassLoader. Compatible with
 * WebSphere 7 as well as 8 and 9.
 *
 * @author Costin Leau
 * @since 3.1
 */
public class WebSphereLoadTimeWeaver implements LoadTimeWeaver {
  ...
  /**
   * Create a new instance of the {@link WebSphereLoadTimeWeaver} class using the default {@link
  ...
  /**
   * Create a new instance of the {@link WebSphereLoadTimeWeaver} class using the supplied {@link
   * ClassLoader}.
   *
