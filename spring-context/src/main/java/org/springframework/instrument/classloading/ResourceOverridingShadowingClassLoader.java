...
public class ResourceOverridingShadowingClassLoader extends ShadowingClassLoader {
  ...
  /**
   * Return the resource (if any) at the new path on an attempt to locate a resource at the old
   * path.
   *
   ...
   *
   * @param oldPath the path of the resource to hide even if it exists in the parent ClassLoader
   */
