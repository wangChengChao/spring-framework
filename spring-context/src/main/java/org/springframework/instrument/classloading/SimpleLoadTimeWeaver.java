...
/**
 * {@code LoadTimeWeaver} that builds and exposes a {@link SimpleInstrumentableClassLoader}.
 *
 * <p>Mainly intended for testing environments, where it is sufficient to perform all class
...
public class SimpleLoadTimeWeaver implements LoadTimeWeaver {
   ...
   *
   * @param classLoader the {@code ClassLoader} to build a simple instrumentable {@code ClassLoader}
   *     on top of
   */
