...
/**
 * Simple {@link CacheOperationSource} implementation that allows attributes to be matched by
 * registered name.
 *
 * @author Costin Leau
 * @since 3.1
...
public class NameMatchCacheOperationSource implements CacheOperationSource, Serializable {
  ...
  /**
   * Set a name/attribute map, consisting of method names (e.g. "myMethod") and CacheOperation
   * instances (or Strings to be converted to CacheOperation instances).
   *
   * @see CacheOperation
   */
   ...
   *
   * <p>Method names can be exact matches, or of the pattern "xxx*", "*xxx" or "*xxx*" for matching
   * multiple methods.
   *
