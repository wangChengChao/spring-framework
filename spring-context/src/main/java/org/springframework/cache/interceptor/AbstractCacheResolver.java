...
/**
 * A base {@link CacheResolver} implementation that requires the concrete implementation to provide
 * the collection of cache name(s) based on the invocation context.
 *
...
public abstract class AbstractCacheResolver implements CacheResolver, InitializingBean {
   ...
   *
   * <p>It is acceptable to return {@code null} to indicate that no cache could be resolved for this
   * invocation.
   *
