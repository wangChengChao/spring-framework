...
abstract class CacheOperationSourcePointcut extends StaticMethodMatcherPointcut
  ...
  /**
   * Obtain the underlying {@link CacheOperationSource} (may be {@code null}). To be implemented by
   * subclasses.
   */
  @Nullable
  ...
  /**
   * {@link ClassFilter} that delegates to {@link CacheOperationSource#isCandidateClass} for
