...
/**
 * A {@link CacheResolver} that forces the resolution to a configurable collection of name(s)
 * against a given {@link CacheManager}.
 *
...
public class NamedCacheResolver extends AbstractCacheResolver {
  ...
  @Nullable private Collection<String> cacheNames;
