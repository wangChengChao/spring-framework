...
class CacheOperationExpressionEvaluator extends CachedExpressionEvaluator {
   ...
   * @param result the return value (can be {@code null}) or {@link #NO_RESULT} if there is no
   *     return at this time
  ...
  public EvaluationContext createEvaluationContext(
    ...
    CacheEvaluationContext evaluationContext =
        new CacheEvaluationContext(rootObject, targetMethod, args, getParameterNameDiscoverer());
  ...
  @Nullable
  public Object key(
      String keyExpression, AnnotatedElementKey methodKey, EvaluationContext evalContext) {
  ...
  public boolean unless(
      String unlessExpression, AnnotatedElementKey methodKey, EvaluationContext evalContext) {
    return (Boolean.TRUE.equals(
        getExpression(this.unlessCache, methodKey, unlessExpression)
            .getValue(evalContext, Boolean.class)));
  }
