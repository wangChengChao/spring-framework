...
/**
 * A simple {@link CacheResolver} that resolves the {@link Cache} instance(s) based on a
 * configurable {@link CacheManager} and the name of the cache(s) as provided by {@link
