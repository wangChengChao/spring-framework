...
/**
 * {@code NamespaceHandler} allowing for the configuration of declarative cache management using
 * either XML or using annotations.
 *
 * <p>This namespace handler is the central piece of functionality in the Spring cache management
 * facilities.
 *
 * @author Costin Leau
 * @since 3.1
...
public class CacheNamespaceHandler extends NamespaceHandlerSupport {
  ...
  public void init() {
    registerBeanDefinitionParser(
        "annotation-driven", new AnnotationDrivenCacheBeanDefinitionParser());
