...
/**
 * Subclass of {@link ModelMap} that implements the {@link Model} interface. Java 5 specific like
 * the {@code Model} interface itself.
 *
 * <p>This is an implementation class exposed to handler methods by Spring MVC, typically via a
