...
/**
 * Subclass of {@link BeanFactoryRefreshableTargetSource} that determines whether a refresh is
 * required through the given {@link ScriptFactory}.
 *
 * @author Rob Harrop
...
public class RefreshableScriptTargetSource extends BeanFactoryRefreshableTargetSource {
   ...
   * @param scriptFactory the ScriptFactory to delegate to for determining whether a refresh is
   *     required
  ...
  /**
   * Determine whether a refresh is required through calling ScriptFactory's {@code
  ...
  protected Object obtainFreshBean(BeanFactory beanFactory, String beanName) {
    return super.obtainFreshBean(
        beanFactory, (this.isFactoryBean ? BeanFactory.FACTORY_BEAN_PREFIX + beanName : beanName));
  }
}
