...
/**
 * {@code NamespaceHandler} that supports the wiring of objects backed by dynamic languages such as
 * Groovy, JRuby and BeanShell. The following is an example (from the reference documentation) that
 * details the wiring of a Groovy backed bean:
 *
 * <pre class="code">
...
public class LangNamespaceHandler extends NamespaceHandlerSupport {
  ...
  @Override
  public void init() {
    registerScriptBeanDefinitionParser(
        "groovy", "org.springframework.scripting.groovy.GroovyScriptFactory");
    registerScriptBeanDefinitionParser("bsh", "org.springframework.scripting.bsh.BshScriptFactory");
    registerScriptBeanDefinitionParser(
        "std", "org.springframework.scripting.support.StandardScriptFactory");
