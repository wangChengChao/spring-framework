...
public abstract class LangNamespaceUtils {
  ...
  /**
   * Register a {@link ScriptFactoryPostProcessor} bean definition in the supplied {@link
   * BeanDefinitionRegistry} if the {@link ScriptFactoryPostProcessor} hasn't already been
   * registered.
   *
   ...
   */
  public static BeanDefinition registerScriptFactoryPostProcessorIfNecessary(
