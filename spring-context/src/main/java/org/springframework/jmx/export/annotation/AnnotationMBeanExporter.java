...
/**
 * Convenient subclass of Spring's standard {@link MBeanExporter}, activating Java 5 annotation
 * usage for JMX exposure of Spring beans: {@link ManagedResource}, {@link ManagedAttribute}, {@link
 * ManagedOperation}, etc.
 *
 * <p>Sets a {@link MetadataNamingStrategy} and a {@link MetadataMBeanInfoAssembler} with an {@link
 * AnnotationJmxAttributeSource}, and activates the {@link #AUTODETECT_ALL} mode by default.
 *
