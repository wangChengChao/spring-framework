...
/**
 * Interface used by the {@code MetadataMBeanInfoAssembler} to read source-level metadata from a
 * managed resource's class.
 *
 * @author Rob Harrop
...
public interface JmxAttributeSource {
  ...
  /**
   * Implementations should return an instance of {@code ManagedResource} if the supplied {@code
   * Class} has the appropriate metadata. Otherwise should return {@code null}.
   *
  ...
  /**
   * Implementations should return an instance of {@code ManagedAttribute} if the supplied {@code
   * Method} has the corresponding metadata. Otherwise should return {@code null}.
   *
  ...
  /**
   * Implementations should return an instance of {@code ManagedMetric} if the supplied {@code
   * Method} has the corresponding metadata. Otherwise should return {@code null}.
   *
   * @param method the method to read the attribute data from
  ...
  /**
   * Implementations should return an instance of {@code ManagedOperation} if the supplied {@code
   * Method} has the corresponding metadata. Otherwise should return {@code null}.
   *
   * @param method the method to read the attribute data from
   * @return the attribute, or {@code null} if not found
  ...
  /**
   * Implementations should return an array of {@code ManagedOperationParameter} if the supplied
   * {@code Method} has the corresponding metadata. Otherwise should return an empty array if no
   * metadata is found.
   *
  ...
  /**
   * Implementations should return an array of {@link ManagedNotification ManagedNotifications} if
   * the supplied the {@code Class} has the corresponding metadata. Otherwise should return an empty
   * array.
   *
