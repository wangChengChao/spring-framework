...
/**
 * Extension of the {@link RequiredModelMBean} class that ensures the {@link
 * Thread#getContextClassLoader() thread context ClassLoader} is switched for the managed resource's
 * {@link ClassLoader} before any invocations occur.
 *
 * @author Rob Harrop
 * @since 2.0
...
public class SpringModelMBean extends RequiredModelMBean {
  ...
  /**
   * Stores the {@link ClassLoader} to use for invocations. Defaults to the current thread {@link
   * ClassLoader}.
   */
  ...
  /**
   * Switches the {@link Thread#getContextClassLoader() context ClassLoader} for the managed
   * resources {@link ClassLoader} before allowing the invocation to occur.
   *
