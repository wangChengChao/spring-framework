...
public interface MBeanExporterListener {
  ...
  /**
   * Called by {@link MBeanExporter} after an MBean has been <i>successfully</i> registered with an
  ...
  /**
   * Called by {@link MBeanExporter} after an MBean has been <i>successfully</i> unregistered from
   * an {@link javax.management.MBeanServer}.
   *
