...
public class UnableToSendNotificationException extends JmxException {
  ...
  /**
   * Create a new instance of the {@link UnableToSendNotificationException} class with the specified
   * error message.
   *
  ...
  /**
   * Create a new instance of the {@link UnableToSendNotificationException} with the specified error
