...
/**
 * Exception thrown when we are unable to register an MBean, for example because of a naming
 * conflict.
 *
 * @author Rob Harrop
 * @since 2.0
...
public class UnableToRegisterMBeanException extends MBeanExportException {
  ...
  /**
   * Create a new {@code UnableToRegisterMBeanException} with the specified error message and root
   * cause.
   *
   * @param msg the detail message
