...
/**
 * Abstract implementation of the {@code MBeanInfoAssembler} interface that encapsulates the
 * creation of a {@code ModelMBeanInfo} instance but delegates the creation of metadata to
 * subclasses.
 *
 * <p>This class offers two flavors of Class extraction from a managed bean instance: {@link
 * #getTargetClass}, extracting the target class behind any kind of AOP proxy, and {@link
 * #getClassToExpose}, returning the class or interface that will be searched for annotations and
 * exposed to the JMX runtime.
 *
 * @author Rob Harrop
...
public abstract class AbstractMBeanInfoAssembler implements MBeanInfoAssembler {
  ...
  /**
   * Create an instance of the {@code ModelMBeanInfoSupport} class supplied with all JMX
   * implementations and populates the metadata through calls to the subclass.
   *
  ...
  /**
   * Check the given bean instance, throwing an IllegalArgumentException if it is not eligible for
   * exposure with this assembler.
   *
  ...
  /**
   * Return the actual bean class of the given bean instance. This is the class exposed to
   * description-style JMX properties.
   *
   * <p>Default implementation returns the target class for an AOP proxy, and the plain bean class
   * else.
   *
   ...
   * be searched for attributes and operations
   *
   ...
   *
   * <p>Default implementation returns a simple description for the MBean based on the class name.
   *
   * @param managedBean the bean instance (might be an AOP proxy)
  ...
  /**
   * Called after the {@code ModelMBeanInfo} instance has been constructed but before it is passed
   * to the {@code MBeanExporter}.
   *
   * <p>Subclasses can implement this method to add additional descriptors to the MBean metadata.
  ...
  /**
   * Get the constructor metadata for the MBean resource. Subclasses should implement this method to
  ...
  /**
   * Get the notification metadata for the MBean resource. Subclasses should implement this method
   * to return the appropriate metadata for all notifications that should be exposed in the
  ...
  /**
   * Get the attribute metadata for the MBean resource. Subclasses should implement this method to
   * return the appropriate metadata for all the attributes that should be exposed in the management
   * interface for the managed resource.
   *
   * @param managedBean the bean instance (might be an AOP proxy)
   * @param beanKey the key associated with the MBean in the beans map of the {@code MBeanExporter}
  ...
  /**
   * Get the operation metadata for the MBean resource. Subclasses should implement this method to
