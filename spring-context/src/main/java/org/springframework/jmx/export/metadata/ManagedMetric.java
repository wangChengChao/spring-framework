...
/**
 * Metadata that indicates to expose a given bean property as a JMX attribute, with additional
 * descriptor properties that indicate that the attribute is a metric. Only valid when used on a
 * JavaBean getter.
 *
