...
/**
 * Exception thrown when we cannot locate an instance of an {@code MBeanServer}, or when more than
...
public class MBeanServerNotFoundException extends JmxException {
  ...
  /**
   * Create a new {@code MBeanServerNotFoundException} with the specified error message and root
   * cause.
   *
   * @param msg the error message
