...
/**
 * Thrown when an invocation on an MBean resource failed with an exception (either a reflection
 * exception or an exception thrown by the target method itself).
 *
...
public class InvocationFailureException extends JmxException {
  ...
  /**
   * Create a new {@code InvocationFailureException} with the specified error message and root
   * cause.
   *
   * @param msg the detail message
