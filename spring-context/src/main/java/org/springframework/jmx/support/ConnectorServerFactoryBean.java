...
public class ConnectorServerFactoryBean extends MBeanRegistrationSupport
  ...
  /**
   * Set whether any threads started for the {@code JMXConnectorServer} should be started as daemon
   * threads.
   */
   ...
   * JMXConnectorServer} will be started in a separate thread. If the {@code daemon} flag is set to
   * {@code true}, that thread will be started as a daemon thread.
   *
   * @throws JMException if a problem occurred when registering the connector server with the {@code
   *     MBeanServer}
  ...
  /**
   * Stop the {@code JMXConnectorServer} managed by an instance of this class. Automatically called
   * on {@code ApplicationContext} shutdown.
   *
