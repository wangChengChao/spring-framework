...
public final class ObjectNameManager {
   ...
   *
   * @param objectName the {@code ObjectName} in {@code ObjectName} or {@code String} format
  ...
  /**
   * Retrieve an {@code ObjectName} instance for the specified domain and a single property with the
  ...
  /**
   * Retrieve an {@code ObjectName} instance with the specified domain name and the supplied
   * key/name properties.
   *
   * @param domainName the domain name for the {@code ObjectName}
