...
/**
 * Helper class that aggregates a {@link javax.management.NotificationListener}, a {@link
 * javax.management.NotificationFilter}, and an arbitrary handback object, as well as the names of
 * MBeans from which the listener wishes to receive {@link javax.management.Notification
 * Notifications}.
 *
...
public class NotificationListenerHolder {
  ...
  @Nullable private NotificationFilter notificationFilter;

  @Nullable private Object handback;
  ...
  /**
   * Set the {@link javax.management.NotificationFilter} associated with the encapsulated {@link
  ...
  /**
   * Return the {@link javax.management.NotificationFilter} associated with the encapsulated {@link
  ...
  /**
   * Set the (arbitrary) object that will be 'handed back' as-is by an {@link
   * javax.management.NotificationBroadcaster} when notifying any {@link
  ...
  /**
   * Return the (arbitrary) object that will be 'handed back' as-is by an {@link
   * javax.management.NotificationBroadcaster} when notifying any {@link
   * javax.management.NotificationListener}.
   *
   ...
   * encapsulated {@link #getNotificationFilter() NotificationFilter} will be registered with to
   * listen for {@link javax.management.Notification Notifications}. Can be specified as {@code
   * ObjectName} instance or as {@code String}.
   *
  ...
  public void setMappedObjectName(@Nullable Object mappedObjectName) {
    this.mappedObjectNames =
        (mappedObjectName != null
            ? new LinkedHashSet<>(Collections.singleton(mappedObjectName))
            : null);
  }

  /**
   * Set an array of {@link javax.management.ObjectName}-style names of the MBeans that the
   * encapsulated {@link #getNotificationFilter() NotificationFilter} will be registered with to
   * listen for {@link javax.management.Notification Notifications}. Can be specified as {@code
   * ObjectName} instances or as {@code String}s.
   *
  ...
  /**
   * Return the list of {@link javax.management.ObjectName} String representations for which the
   * encapsulated {@link #getNotificationFilter() NotificationFilter} will be registered as a
   * listener for {@link javax.management.Notification Notifications}.
   *
