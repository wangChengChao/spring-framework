...
/**
 * Abstract base class for BeanDefinitionParsers which build JNDI-locating beans, supporting an
 * optional "jndiEnvironment" bean property, populated from an "environment" XML sub-element.
 *
 * @author Rob Harrop
