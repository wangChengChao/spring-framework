...
public interface MessageSourceResolvable {
   ...
   *
   * @return an array of objects to be used as parameters to replace placeholders within the message
   *     text
   ...
   *
   * <p>The default implementation simply returns {@code null}. Note that the default message may be
   * identical to the primary message code ({@link #getCodes()}), which effectively enforces {@link
   * org.springframework.context.support.AbstractMessageSource#setUseCodeAsDefaultMessage} for this
   * particular message.
   *
