...
/**
 * Represent an {@link AnnotatedElement} on a particular {@link Class} and is suitable as a key.
 *
 * @author Costin Leau
...
public final class AnnotatedElementKey implements Comparable<AnnotatedElementKey> {
  ...
  /**
   * Create a new instance with the specified {@link AnnotatedElement} and optional target {@link
   * Class}.
   */
