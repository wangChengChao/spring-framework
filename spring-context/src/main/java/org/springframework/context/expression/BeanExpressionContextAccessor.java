 ...
 * {@link org.springframework.beans.factory.config.BeanExpressionContext}.
 *
...
public class BeanExpressionContextAccessor implements PropertyAccessor {
  ...
  public boolean canRead(EvaluationContext context, @Nullable Object target, String name)
    ...
    return (target instanceof BeanExpressionContext
        && ((BeanExpressionContext) target).containsObject(name));
  }
  ...
  public TypedValue read(EvaluationContext context, @Nullable Object target, String name)
      throws AccessException {
    Assert.state(
        target instanceof BeanExpressionContext, "Target must be of type BeanExpressionContext");
