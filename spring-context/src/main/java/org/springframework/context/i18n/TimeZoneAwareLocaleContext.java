 ...
 *
 * <p>Having this variant of LocaleContext set to {@link LocaleContextHolder} means that some
 * TimeZone-aware infrastructure has been configured, even if it may not be able to produce a
 * non-null TimeZone at the moment.
 *
