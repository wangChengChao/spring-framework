 ...
 * org.springframework.context.ApplicationContext}, can use an {@code ApplicationEventMulticaster}
...
public interface ApplicationEventMulticaster {
   ...
   *
   * <p>After a remove call, the multicaster will perform no action on event notification until new
   ...
   * Multicast the given application event to appropriate listeners.
   *
   * <p>If the {@code eventType} is {@code null}, a default type is built based on the {@code event}
   * instance.
   *
   * @param event the event to multicast
