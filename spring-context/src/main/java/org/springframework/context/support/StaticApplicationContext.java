...
/**
 * {@link org.springframework.context.ApplicationContext} implementation which supports programmatic
 * registration of beans and messages, rather than reading bean definitions from external
 * configuration sources. Mainly useful for testing.
 *
 * @author Rod Johnson
...
public class StaticApplicationContext extends GenericApplicationContext {
  ...
  /**
   * Return the internal StaticMessageSource used by this context. Can be used to register messages
   * on it.
   *
   * @see #addMessage
   */
