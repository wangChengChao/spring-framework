...
/**
 * Convenient base class for components with a need for embedded value resolution (i.e. {@link
 * org.springframework.context.EmbeddedValueResolverAware} consumers).
 *
