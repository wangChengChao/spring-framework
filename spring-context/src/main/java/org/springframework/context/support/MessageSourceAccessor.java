 ...
 * getMessage methods.
 *
 * <p>Available from ApplicationObjectSupport, but also reusable as a standalone helper to delegate
 * to in application objects.
 *
...
public class MessageSourceAccessor {
  ...
  @Nullable private final Locale defaultLocale;
   ...
   *
   * <p>The default implementation returns the default locale passed into the corresponding
   * constructor, or LocaleContextHolder's locale as fallback. Can be overridden in subclasses.
   *
  ...
  public String getMessage(
      String code, @Nullable Object[] args, String defaultMessage, Locale locale) {
  ...
  /**
   * Retrieve the given MessageSourceResolvable (e.g. an ObjectError instance) in the default
   * Locale.
   *
