...
/**
 * Base class for {@link org.springframework.context.ApplicationContext} implementations which are
 ...
 *
 * <p>The only method to be implemented by subclasses is {@link #loadBeanDefinitions}, which gets
 * invoked on each refresh. A concrete implementation is supposed to load bean definitions into the
 ...
 * which both derive from the common {@link AbstractXmlApplicationContext} base class; {@link
 * org.springframework.context.annotation.AnnotationConfigApplicationContext} supports
 * {@code @Configuration}-annotated classes as a source of bean definitions.
 *
...
public abstract class AbstractRefreshableApplicationContext extends AbstractApplicationContext {
  ...
  /**
   * Determine whether this context currently holds a bean factory, i.e. has been refreshed at least
   * once and not been closed yet.
   */
