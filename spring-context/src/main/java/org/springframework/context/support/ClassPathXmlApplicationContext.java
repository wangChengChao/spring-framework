...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
  ...
  /**
   * Create a new ClassPathXmlApplicationContext with the given parent, loading the definitions from
   ...
   */
  public ClassPathXmlApplicationContext(
      String[] configLocations, @Nullable ApplicationContext parent) throws BeansException {
   ...
   * and automatically refreshing the context.
   *
   * <p>This is a convenience method to load class path resources relative to a given Class. For
   * full flexibility, consider using a GenericApplicationContext with an XmlBeanDefinitionReader
   * and a ClassPathResource argument.
   *
   ...
   */
  public ClassPathXmlApplicationContext(
      String[] paths, Class<?> clazz, @Nullable ApplicationContext parent) throws BeansException {
