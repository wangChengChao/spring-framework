 ...
 *
 * <p>Subclasses just have to implement the {@link #getConfigResources} and/or the {@link
 * #getConfigLocations} method. Furthermore, they might override the {@link #getResourceByPath} hook
 * to interpret relative paths in an environment-specific fashion, and/or {@link
...
public abstract class AbstractXmlApplicationContext
  ...
  /**
   * Return an array of Resource objects, referring to the XML bean definition files that this
   * context should be built with.
   *
   * <p>The default implementation returns {@code null}. Subclasses can override this to provide
   * pre-built Resource objects rather than location Strings.
   *
