 ...
 * EnableLoadTimeWeaving} annotation. See {@code @EnableLoadTimeWeaving} javadoc for complete usage
 * details.
 *
 * @author Chris Beams
 * @since 3.1
...
public class LoadTimeWeavingConfiguration implements ImportAware, BeanClassLoaderAware {
  ...
  @Nullable private AnnotationAttributes enableLTW;

  @Nullable private LoadTimeWeavingConfigurer ltwConfigurer;
  ...
  public void setImportMetadata(AnnotationMetadata importMetadata) {
    this.enableLTW =
        AnnotationConfigUtils.attributesFor(importMetadata, EnableLoadTimeWeaving.class);
    ...
    if (this.enableLTW != null) {
      ...
      switch (aspectJWeaving) {
        case DISABLED:
          ...
          break;
        case AUTODETECT:
          if (this.beanClassLoader.getResource(AspectJWeavingEnabler.ASPECTJ_AOP_XML_RESOURCE)
              == null) {
