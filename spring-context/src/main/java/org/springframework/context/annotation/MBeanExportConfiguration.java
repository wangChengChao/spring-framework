 ...
 *
 * <p>This configuration class is automatically imported when using the {@link EnableMBeanExport}
...
public class MBeanExportConfiguration implements ImportAware, EnvironmentAware, BeanFactoryAware {
  ...
  @Nullable private AnnotationAttributes enableMBeanExport;
  ...
  public void setImportMetadata(AnnotationMetadata importMetadata) {
    Map<String, Object> map =
        importMetadata.getAnnotationAttributes(EnableMBeanExport.class.getName());
      ...
      public MBeanServer getMBeanServer() {
        try {
          ...
          throw new MBeanServerNotFoundException(
              "Failed to retrieve WebLogic MBeanServer from JNDI", ex);
        }
      }
    },
