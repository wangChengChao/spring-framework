 ...
 *
 * <p>This scope resolver can be used with {@link ClassPathBeanDefinitionScanner} and {@link
 * AnnotatedBeanDefinitionReader} for standard JSR-330 compliance. However, in practice, you will
 * typically use Spring's rich default scoping instead - or extend this resolver with custom scoping
 * annotations that point to extended Spring scopes.
 *
...
public class Jsr330ScopeMetadataResolver implements ScopeMetadataResolver {
   ...
   *
   * <p>The default implementation simply checks against registered scopes. Can be overridden for
   * custom mapping rules, e.g. naming conventions.
   *
        ...
        if (metaAnns.contains("javax.inject.Scope")) {
          if (found != null) {
            throw new IllegalStateException(
                "Found ambiguous scope annotations on bean class ["
