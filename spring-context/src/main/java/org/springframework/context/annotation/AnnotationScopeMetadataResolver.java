...
/**
 * A {@link ScopeMetadataResolver} implementation that by default checks for the presence of
 * Spring's {@link Scope @Scope} annotation on the bean class.
 *
 * <p>The exact type of annotation that is checked for is configurable via {@link
...
public class AnnotationScopeMetadataResolver implements ScopeMetadataResolver {
  ...
  /**
   * Construct a new {@code AnnotationScopeMetadataResolver} using the supplied default {@link
   * ScopedProxyMode}.
   *
  ...
  public ScopeMetadata resolveScopeMetadata(BeanDefinition definition) {
    ...
    if (definition instanceof AnnotatedBeanDefinition) {
      ...
      AnnotationAttributes attributes =
          AnnotationConfigUtils.attributesFor(annDef.getMetadata(), this.scopeAnnotationType);
      if (attributes != null) {
