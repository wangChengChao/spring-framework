 ...
 * annotation-based configuration. Also registers a common {@link
...
public abstract class AnnotationConfigUtils {
  ...
  static {
    ...
    jpaPresent =
        ClassUtils.isPresent("javax.persistence.EntityManagerFactory", classLoader)
   ...
   *
   * @param registry the registry to operate on
   * @param source the configuration source element (already extracted) that this registration was
   *     triggered from. May be {@code null}.
   * @return a Set of BeanDefinitionHolders, containing all bean definitions that have actually been
  ...
  static void processCommonDefinitionAnnotations(
      AnnotatedBeanDefinition abd, AnnotatedTypeMetadata metadata) {
  ...
  @Nullable
  static AnnotationAttributes attributesFor(
  ...
  static Set<AnnotationAttributes> attributesForRepeatable(
      AnnotationMetadata metadata, Class<?> containerClass, Class<?> annotationClass) {
