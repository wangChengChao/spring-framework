...
/**
 * {@link org.springframework.beans.factory.support.BeanNameGenerator} implementation for bean
 * classes annotated with the {@link org.springframework.stereotype.Component @Component} annotation
 * or with another annotation that is itself annotated with {@link
 * org.springframework.stereotype.Component @Component} as a meta-annotation. For example, Spring's
 ...
 * javax.inject.Named} annotations, if available. Note that Spring component annotations always
 ...
 * based on the short name of the class (with the first letter lower-cased). For example:
 *
