 ...
 * the {@link org.springframework.core.annotation.Order} annotation to indicate a precedence against
 * other {@link DeferredImportSelector DeferredImportSelectors}.
 *
 * <p>Implementations may also provide an {@link #getImportGroup() import group} which can provide
 * additional sorting and filtering logic across different selectors.
 *
 * @author Phillip Webb
...
public interface DeferredImportSelector extends ImportSelector {
  ...
  interface Group {
    ...
    /**
     * Process the {@link AnnotationMetadata} of the importing @{@link Configuration} class using
     * the specified {@link DeferredImportSelector}.
     */
