...
/**
 * Interface for RMI invocation handlers instances on the server, wrapping exported services. A
 * client uses a stub implementing this interface to access such a service.
 *
...
public interface RmiInvocationHandler extends Remote {
   ...
   *
   * <p>Called by {@link RmiClientInterceptor#doInvoke(org.aopalliance.intercept.MethodInvocation,
