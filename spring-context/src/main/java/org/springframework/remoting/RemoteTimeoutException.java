...
/**
 * RemoteAccessException subclass to be thrown when the execution of the target method did not
 * complete before a configurable timeout, for example when a reply message was not received.
 *
