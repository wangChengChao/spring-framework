...
/**
 * Encapsulates a remote invocation, providing core method invocation properties in a serializable
 * fashion. Used for RMI and HTTP-based serialization invokers.
 *
...
public class RemoteInvocation implements Serializable {
  ...
  /**
   * Add an additional invocation attribute. Useful to add additional invocation context without
   * having to subclass RemoteInvocation.
   *
   * <p>Attribute keys have to be unique, and no overriding of existing attributes is allowed.
   *
   * <p>The implementation avoids to unnecessarily create the attributes Map, to minimize
   * serialization size.
   *
  ...
  /**
   * Set the attributes Map. Only here for special purposes: Preferably, use {@link #addAttribute}
   * and {@link #getAttribute}.
   *
  ...
  /**
   * Return the attributes Map. Mainly here for debugging purposes: Preferably, use {@link
   * #addAttribute} and {@link #getAttribute}.
   *
  ...
  /**
   * Perform this invocation on the given target object. Typically called when a RemoteInvocation is
  ...
  public String toString() {
    return "RemoteInvocation: method name '"
        + this.methodName
        + "'; parameter types "
