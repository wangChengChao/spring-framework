...
/**
 * {@link org.springframework.beans.factory.FactoryBean} that creates a simple HTTP server, based on
 * the HTTP server that is included in Sun's JRE 1.6. Starts the HTTP server on initialization and
 * stops it on destruction. Exposes the resulting {@link com.sun.net.httpserver.HttpServer} object.
 *
 * <p>Allows for registering {@link com.sun.net.httpserver.HttpHandler HttpHandlers} for specific
 * {@link #setContexts context paths}. Alternatively, register such context-specific handlers
 * programmatically on the {@link com.sun.net.httpserver.HttpServer} itself.
 *
...
public class SimpleHttpServerFactoryBean
  ...
  /**
   * Register common {@link com.sun.net.httpserver.Filter Filters} to be applied to all locally
   * registered {@link #setContexts contexts}.
   */
  ...
  /**
   * Register a common {@link com.sun.net.httpserver.Authenticator} to be applied to all locally
   * registered {@link #setContexts contexts}.
   */
