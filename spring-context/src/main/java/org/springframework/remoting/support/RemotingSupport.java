...
/**
 * Generic support base class for remote accessor and exporters, providing common bean ClassLoader
 * handling.
 *
...
public abstract class RemotingSupport implements BeanClassLoaderAware {
  ...
  /**
   * Return the ClassLoader that this accessor operates in, to be used for deserializing and for
   * generating proxies.
   */
   ...
   *
   * @param original the original thread context ClassLoader, or {@code null} if not overridden (and
   *     hence nothing to reset)
   */
