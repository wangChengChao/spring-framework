...
/**
 * RemoteAccessException subclass to be thrown when the execution of the target method failed on the
 * server side, for example when a method was not found on the target object.
 *
