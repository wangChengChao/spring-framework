...
public interface FormatterRegistry extends ConverterRegistry {
  ...
  /**
   * Adds a Formatter to format fields of a specific type. The field type is implied by the
   * parameterized Formatter instance.
   *
   ...
   *
   * <p>On print, if the Formatter's type T is declared and {@code fieldType} is not assignable to
   * T, a coercion to T will be attempted before delegating to {@code formatter} to print a field
   * value. On parse, if the parsed object returned by {@code formatter} is not assignable to the
   * runtime field type, a coercion to the field type will be attempted before returning the parsed
   * field value.
   *
  ...
  /**
   * Adds a Printer/Parser pair to format fields of a specific type. The formatter will delegate to
   * the specified {@code printer} for printing and the specified {@code parser} for parsing.
   *
   ...
   * On parse, if the object returned by the Parser is not assignable to the runtime field type, a
   * coercion to the field type will be attempted before returning the parsed field value.
   *
   * @param fieldType the field type to format
