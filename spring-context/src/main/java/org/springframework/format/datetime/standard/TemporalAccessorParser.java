...
/**
 * {@link Parser} implementation for a JSR-310 {@link java.time.temporal.TemporalAccessor}, using a
...
public final class TemporalAccessorParser implements Parser<TemporalAccessor> {
   ...
   *
   * @param temporalAccessorType the specific TemporalAccessor class (LocalDate, LocalTime,
   *     LocalDateTime, ZonedDateTime, OffsetDateTime, OffsetTime)
   * @param formatter the base DateTimeFormatter instance
   */
  public TemporalAccessorParser(
      Class<? extends TemporalAccessor> temporalAccessorType, DateTimeFormatter formatter) {
