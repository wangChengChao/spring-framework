...
public class DateTimeFormatterRegistrar implements FormatterRegistrar {
  ...
  /**
   * Set the default format style of {@link java.time.LocalDate} objects. Default is {@link
  ...
  /**
   * Set the default format style of {@link java.time.LocalTime} objects. Default is {@link
   * java.time.format.FormatStyle#SHORT}.
   */
  ...
  /**
   * Set the default format style of {@link java.time.LocalDateTime} objects. Default is {@link
   * java.time.format.FormatStyle#SHORT}.
   */
   ...
   * #setDateStyle dateStyle} and {@link #setUseIsoFormat useIsoFormat} properties will be ignored.
   *
   ...
   *
   * <p>This formatter will be used for the {@link LocalTime} and {@link OffsetTime} types. When
   * specified, the {@link #setTimeStyle timeStyle} and {@link #setUseIsoFormat useIsoFormat}
   ...
   *
   * <p>This formatter will be used for {@link LocalDateTime}, {@link ZonedDateTime} and {@link
   * OffsetDateTime} types. When specified, the {@link #setDateTimeStyle dateTimeStyle} and {@link
   * #setUseIsoFormat useIsoFormat} properties will be ignored.
   *
   * @param formatter the formatter to use
   * @see #setDateFormatter
   * @see #setTimeFormatter
