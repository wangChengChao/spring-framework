...
/**
 * A holder for a thread-local {@link JodaTimeContext} with user-specific Joda-Time settings.
 *
 * @author Keith Donald
...
public final class JodaTimeContextHolder {
   ...
   *
   * @param jodaTimeContext the current JodaTimeContext, or {@code null} to reset the thread-bound
   *     context
   */
