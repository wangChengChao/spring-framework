...
/**
 * A formatter for {@link java.util.Date} types. Allows the configuration of an explicit date
 * pattern and locale.
 *
 * @author Keith Donald
...
public class DateFormatter implements Formatter<Date> {
  ...
  @Nullable private String stylePattern;
  ...
  /**
   * Set the two character to use to format date values. The first character used for the date
   * style, the second is for the time style. Supported characters are
   *
   * <ul>
   *   <li>'S' = Small
   *   <li>'M' = Medium
