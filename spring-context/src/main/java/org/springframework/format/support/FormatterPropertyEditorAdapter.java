...
public class FormatterPropertyEditorAdapter extends PropertyEditorSupport {
   ...
   *
   * @return the field type declared in the wrapped {@link Formatter} implementation (never {@code
   *     null})
   * @throws IllegalArgumentException if the {@link Formatter}-declared field type cannot be
   *     inferred
   */
